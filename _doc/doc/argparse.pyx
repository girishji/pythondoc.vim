*argparse.pyx*                                Last change: 2023 Sep 15
...
such classes:
                           ...
                           *RawDescriptionHelpFormatter..argparse.pyx*
class argparse.RawDescriptionHelpFormatter

                                  *RawTextHelpFormatter..argparse.pyx*
class argparse.RawTextHelpFormatter

                         *ArgumentDefaultsHelpFormatter..argparse.pyx*
class argparse.ArgumentDefaultsHelpFormatter

                              *MetavarTypeHelpFormatter..argparse.pyx*
...
=========================
                         ...
                         *ArgumentParser.add_argument()..argparse.pyx*
...
=======================
                           ...
                           *ArgumentParser.parse_args()..argparse.pyx*
...
class argparse.Namespace                     *Namespace..argparse.pyx*
...
------------
                       ...
                       *ArgumentParser.add_subparsers()..argparse.pyx*
...
---------------
                   ...
                   *ArgumentParser.add_argument_group()..argparse.pyx*
...
----------------
         ...
         *ArgumentParser.add_mutually_exclusive_group()..argparse.pyx*
...
---------------
                         ...
                         *ArgumentParser.set_defaults()..argparse.pyx*
...
<
   ...
   of this type.
                          ...
                          *ArgumentParser.get_default()..argparse.pyx*
...
formatting methods are available:
                          ...
                          *ArgumentParser.print_usage()..argparse.pyx*
ArgumentParser.print_usage(file=None)
   ...
   assumed.
                           ...
                           *ArgumentParser.print_help()..argparse.pyx*
...
instead of printing it:
                         ...
                         *ArgumentParser.format_usage()..argparse.pyx*
ArgumentParser.format_usage()

   Return a string containing a brief description of how the
   "ArgumentParser" should be invoked on the command line.

                          *ArgumentParser.format_help()..argparse.pyx*
...
---------------
                     ...
                     *ArgumentParser.parse_known_args()..argparse.pyx*
...
------------------------
             ...
             *ArgumentParser.convert_arg_line_to_args()..argparse.pyx*
...
---------------
                                 ...
                                 *ArgumentParser.exit()..argparse.pyx*
...
>
      class ErrorCatchingArgumentParser(argparse.ArgumentParser):
          def exit(self, status=0, message=None):
              ...
              exit(status)
<
ArgumentParser.error(message)   *ArgumentParser.error()..argparse.pyx*
...
------------------
                ...
                *ArgumentParser.parse_intermixed_args()..argparse.pyx*
ArgumentParser.parse_intermixed_args(args=None, namespace=None)

          *ArgumentParser.parse_known_intermixed_args()..argparse.pyx*
...
exception argparse.ArgumentError         *ArgumentError..argparse.pyx*
   ...
   information about the argument that caused it.
                                     ...
                                     *ArgumentTypeError..argparse.pyx*
