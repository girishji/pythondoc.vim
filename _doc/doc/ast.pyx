*ast.pyx*                                     Last change: 2023 Sep 15
...
class ast.AST                                           *AST..ast.pyx*
   ...
   lineno                                           *AST.lineno..ast.pyx*
   col_offset                                   *AST.col_offset..ast.pyx*
   end_lineno                                   *AST.end_lineno..ast.pyx*
   end_col_offset                           *AST.end_col_offset..ast.pyx*
...
class ast.Module(body, type_ignores)                 *Module..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.Expression(body)                       *Expression..ast.pyx*
...
<
class ast.Interactive(body)                     *Interactive..ast.pyx*
...
<
class ast.FunctionType(argtypes, returns)      *FunctionType..ast.pyx*
...
class ast.Constant(value)                          *Constant..ast.pyx*
...
class ast.JoinedStr(values)                       *JoinedStr..ast.pyx*
                  ...
                  FormattedValue(
                      ...
                      format_spec=JoinedStr(
                          values=[
                              Constant(value='.3')]))]))
<
class ast.List(elts, ctx)                              *List..ast.pyx*
class ast.Tuple(elts, ctx)                            *Tuple..ast.pyx*
...
>
      ...
      Expression(
          body=Tuple(
              ...
              ctx=Load()))
<
class ast.Set(elts)                                     *Set..ast.pyx*
      ...
      Expression(
          body=Set(
              elts=[
                  ...
                  Constant(value=3)]))
<
class ast.Dict(keys, values)                           *Dict..ast.pyx*
...
class ast.Name(id, ctx)                                *Name..ast.pyx*

   A variable name. "id" holds the name as a string, and "ctx" is one
   of the following types.

class ast.Load                                         *Load..ast.pyx*
class ast.Store                                       *Store..ast.pyx*
class ast.Del                                           *Del..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.Starred(value, ctx)                       *Starred..ast.pyx*
...
class ast.Expr(value)                                  *Expr..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.UnaryOp(op, operand)                      *UnaryOp..ast.pyx*

   A unary operation. "op" is the operator, and "operand" any
   expression node.

class ast.UAdd                                         *UAdd..ast.pyx*
class ast.USub                                         *USub..ast.pyx*
class ast.Not                                           *Not..ast.pyx*
class ast.Invert                                     *Invert..ast.pyx*
...
<
class ast.BinOp(left, op, right)                      *BinOp..ast.pyx*
...
<
class ast.Add                                           *Add..ast.pyx*
class ast.Sub                                           *Sub..ast.pyx*
class ast.Mult                                         *Mult..ast.pyx*
class ast.Div                                           *Div..ast.pyx*
class ast.FloorDiv                                 *FloorDiv..ast.pyx*
class ast.Mod                                           *Mod..ast.pyx*
class ast.Pow                                           *Pow..ast.pyx*
class ast.LShift                                     *LShift..ast.pyx*
class ast.RShift                                     *RShift..ast.pyx*
class ast.BitOr                                       *BitOr..ast.pyx*
class ast.BitXor                                     *BitXor..ast.pyx*
class ast.BitAnd                                     *BitAnd..ast.pyx*
class ast.MatMult                                   *MatMult..ast.pyx*

   Binary operator tokens.

class ast.BoolOp(op, values)                         *BoolOp..ast.pyx*
      ...
      Expression(
          body=BoolOp(
              ...
              values=[
                  ...
                  Name(id='y', ctx=Load())]))
<
class ast.And                                           *And..ast.pyx*
class ast.Or                                             *Or..ast.pyx*

   Boolean operator tokens.

class ast.Compare(left, ops, comparators)           *Compare..ast.pyx*
      ...
      Expression(
          body=Compare(
              ...
              comparators=[
                  ...
                  Constant(value=10)]))
<
class ast.Eq                                             *Eq..ast.pyx*
class ast.NotEq                                       *NotEq..ast.pyx*
class ast.Lt                                             *Lt..ast.pyx*
class ast.LtE                                           *LtE..ast.pyx*
class ast.Gt                                             *Gt..ast.pyx*
class ast.GtE                                           *GtE..ast.pyx*
class ast.Is                                             *Is..ast.pyx*
class ast.IsNot                                       *IsNot..ast.pyx*
class ast.In                                             *In..ast.pyx*
class ast.NotIn                                       *NotIn..ast.pyx*

   Comparison operator tokens.

class ast.Call(func, args, keywords)                   *Call..ast.pyx*
...
<
class ast.keyword(arg, value)                       *keyword..ast.pyx*
...
class ast.IfExp(test, body, orelse)                   *IfExp..ast.pyx*
...
<
class ast.Attribute(value, attr, ctx)             *Attribute..ast.pyx*
...
>
      ...
      Expression(
          body=Attribute(
              ...
              ctx=Load()))
<
class ast.NamedExpr(target, value)                *NamedExpr..ast.pyx*
...
class ast.Subscript(value, slice, ctx)            *Subscript..ast.pyx*
...
>
      ...
      Expression(
          body=Subscript(
              ...
              ctx=Load()))
<
class ast.Slice(lower, upper, step)                   *Slice..ast.pyx*
...
class ast.ListComp(elt, generators)                *ListComp..ast.pyx*
class ast.SetComp(elt, generators)                  *SetComp..ast.pyx*
class ast.GeneratorExp(elt, generators)        *GeneratorExp..ast.pyx*
class ast.DictComp(key, value, generators)         *DictComp..ast.pyx*
...
class ast.Assign(targets, value, type_comment)       *Assign..ast.pyx*
   ...
   type_comment                            *Assign.type_comment..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.AugAssign(target, op, value)            *AugAssign..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.Raise(exc, cause)                           *Raise..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.Assert(test, msg)                          *Assert..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.Delete(targets)                            *Delete..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.TypeAlias(name, type_params, value)     *TypeAlias..ast.pyx*
...
class ast.Import(names)                              *Import..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.ImportFrom(module, names, level)       *ImportFrom..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.alias(name, asname)                         *alias..ast.pyx*
...
class ast.If(test, body, orelse)                         *If..ast.pyx*
...
class ast.For(target, iter, body, orelse, type_comment)
   ...
   type_comment                               *For.type_comment..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.While(test, body, orelse)                   *While..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.Break                                       *Break..ast.pyx*
class ast.Continue                                 *Continue..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.Try(body, handlers, orelse, finalbody)        *Try..ast.pyx*
...
class ast.ExceptHandler(type, name, body)     *ExceptHandler..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.With(items, body, type_comment)              *With..ast.pyx*
   ...
   type_comment                              *With.type_comment..ast.pyx*

      "type_comment" is an optional string with the type annotation as
      a comment.

class ast.withitem(context_expr, optional_vars)    *withitem..ast.pyx*
...
class ast.Match(subject, cases)                       *Match..ast.pyx*
...
class ast.match_case(pattern, guard, body)       *match_case..ast.pyx*
...
class ast.MatchValue(value)                      *MatchValue..ast.pyx*
...
class ast.MatchSingleton(value)              *MatchSingleton..ast.pyx*
...
class ast.MatchSequence(patterns)             *MatchSequence..ast.pyx*
...
class ast.MatchStar(name)                         *MatchStar..ast.pyx*
...
class ast.MatchMapping(keys, patterns, rest)   *MatchMapping..ast.pyx*
...
class ast.MatchAs(pattern, name)                    *MatchAs..ast.pyx*
...
class ast.MatchOr(patterns)                         *MatchOr..ast.pyx*
...
class ast.TypeVar(name, bound)                      *TypeVar..ast.pyx*
...
class ast.ParamSpec(name)                         *ParamSpec..ast.pyx*
...
class ast.TypeVarTuple(name)                   *TypeVarTuple..ast.pyx*
...
class ast.FunctionDef(name, args, body, decorator_list, returns, type_comment, type_params)
   ...
   * "type_params" is a list of type parameters.
   ...
   type_comment                       *FunctionDef.type_comment..ast.pyx*
...
class ast.Lambda(args, body)                         *Lambda..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.Return(value)                              *Return..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.Yield(value)                                *Yield..ast.pyx*
class ast.YieldFrom(value)                        *YieldFrom..ast.pyx*
...
>
      ...
      Module(
          ...
          type_ignores=[])
<
class ast.Global(names)                              *Global..ast.pyx*
class ast.Nonlocal(names)                          *Nonlocal..ast.pyx*
...
class ast.Await(value)                                *Await..ast.pyx*
...
class ast.AsyncWith(items, body, type_comment)    *AsyncWith..ast.pyx*
...
ast.unparse(ast_obj)                              *unparse()..ast.pyx*
...
ast.literal_eval(node_or_string)             *literal_eval()..ast.pyx*
...
ast.get_docstring(node, clean=True)         *get_docstring()..ast.pyx*
...
ast.fix_missing_locations(node)     *fix_missing_locations()..ast.pyx*
...
ast.increment_lineno(node, n=1)          *increment_lineno()..ast.pyx*
...
class ast.NodeVisitor                           *NodeVisitor..ast.pyx*
   ...
   visit(node)                             *NodeVisitor.visit()..ast.pyx*
   ...
   generic_visit(node)             *NodeVisitor.generic_visit()..ast.pyx*
...
class ast.NodeTransformer                   *NodeTransformer..ast.pyx*
...
ast.PyCF_ALLOW_TOP_LEVEL_AWAIT   *PyCF_ALLOW_TOP_LEVEL_AWAIT..ast.pyx*
...
ast.PyCF_ONLY_AST                             *PyCF_ONLY_AST..ast.pyx*

   Generates and returns an abstract syntax tree instead of returning
   a compiled code object.

ast.PyCF_TYPE_COMMENTS                   *PyCF_TYPE_COMMENTS..ast.pyx*
