*asyncio-policy.pyx*                          Last change: 2023 Sep 15
...
current process:
                         ...
                         *get_event_loop_policy()..asyncio-policy.pyx*
asyncio.get_event_loop_policy()

   Return the current process-wide policy.

                         *set_event_loop_policy()..asyncio-policy.pyx*
...
The abstract event loop policy base class is defined as follows:
                         ...
                         *AbstractEventLoopPolicy..asyncio-policy.pyx*
class asyncio.AbstractEventLoopPolicy

   An abstract base class for asyncio policies.

        *AbstractEventLoopPolicy.get_event_loop()..asyncio-policy.pyx*
   get_event_loop()
      ...
      Changed in version 3.6.
        ...
        *AbstractEventLoopPolicy.set_event_loop()..asyncio-policy.pyx*
   set_event_loop(loop)

      Set the event loop for the current context to _loop_.

        *AbstractEventLoopPolicy.new_event_loop()..asyncio-policy.pyx*
   new_event_loop()
     ...
     *AbstractEventLoopPolicy.get_child_watcher()..asyncio-policy.pyx*
   get_child_watcher()
     ...
     *AbstractEventLoopPolicy.set_child_watcher()..asyncio-policy.pyx*
...
asyncio ships with the following built-in policies:
                          ...
                          *DefaultEventLoopPolicy..asyncio-policy.pyx*
class asyncio.DefaultEventLoopPolicy
   ...
   future Python release this will become an error.
                  ...
                  *WindowsSelectorEventLoopPolicy..asyncio-policy.pyx*
class asyncio.WindowsSelectorEventLoopPolicy
   ...
   Availability: Windows.
                  ...
                  *WindowsProactorEventLoopPolicy..asyncio-policy.pyx*
...
watcher implementation used by the asyncio event loop:
                             ...
                             *get_child_watcher()..asyncio-policy.pyx*
asyncio.get_child_watcher()
   ...
   Deprecated since version 3.12.
                             ...
                             *set_child_watcher()..asyncio-policy.pyx*
...
Note:
  ...
  might be prohibited or have no effect.
                            ...
                            *AbstractChildWatcher..asyncio-policy.pyx*
class asyncio.AbstractChildWatcher


        *AbstractChildWatcher.add_child_handler()..asyncio-policy.pyx*
   add_child_handler(pid, callback, *args)
     ...
     *AbstractChildWatcher.remove_child_handler()..asyncio-policy.pyx*
   remove_child_handler(pid)
      ...
      removed, "False" if there was nothing to remove.
              ...
              *AbstractChildWatcher.attach_loop()..asyncio-policy.pyx*
   attach_loop(loop)
   ...
   is_active()     *AbstractChildWatcher.is_active()..asyncio-policy.pyx*
   ...
   close()             *AbstractChildWatcher.close()..asyncio-policy.pyx*
   ...
   Deprecated since version 3.12.
                            ...
                            *ThreadedChildWatcher..asyncio-policy.pyx*
class asyncio.ThreadedChildWatcher
   ...
   New in version 3.8.
                           ...
                           *MultiLoopChildWatcher..asyncio-policy.pyx*
class asyncio.MultiLoopChildWatcher
   ...
   Deprecated since version 3.12.
                                ...
                                *SafeChildWatcher..asyncio-policy.pyx*
class asyncio.SafeChildWatcher
   ...
   Deprecated since version 3.12.
                                ...
                                *FastChildWatcher..asyncio-policy.pyx*
class asyncio.FastChildWatcher
   ...
   Deprecated since version 3.12.
                               ...
                               *PidfdChildWatcher..asyncio-policy.pyx*
