*asyncio-protocol.pyx*                        Last change: 2023 Sep 15
...
class asyncio.BaseTransport      *BaseTransport..asyncio-protocol.pyx*

   Base class for all transports.  Contains methods that all asyncio
   transports share.

                                *WriteTransport..asyncio-protocol.pyx*
class asyncio.WriteTransport(BaseTransport)
   ...
   subprocess-related methods like "loop.subprocess_exec()".
                                 ...
                                 *ReadTransport..asyncio-protocol.pyx*
class asyncio.ReadTransport(BaseTransport)
   ...
   subprocess-related methods like "loop.subprocess_exec()".
                                     ...
                                     *Transport..asyncio-protocol.pyx*
class asyncio.Transport(WriteTransport, ReadTransport)
   ...
   "loop.sendfile()", etc.
                             ...
                             *DatagramTransport..asyncio-protocol.pyx*
class asyncio.DatagramTransport(BaseTransport)
   ...
   "loop.create_datagram_endpoint()" event loop method.
                           ...
                           *SubprocessTransport..asyncio-protocol.pyx*
...
BaseTransport.close()    *BaseTransport.close()..asyncio-protocol.pyx*
   ...
   its argument. The transport should not be used once it is closed.
                    ...
                    *BaseTransport.is_closing()..asyncio-protocol.pyx*
BaseTransport.is_closing()

   Return "True" if the transport is closing or is closed.

                *BaseTransport.get_extra_info()..asyncio-protocol.pyx*
...
<
   ...
   * subprocess:
     ...
     * "'subprocess'": "subprocess.Popen" instance
                  ...
                  *BaseTransport.set_protocol()..asyncio-protocol.pyx*
BaseTransport.set_protocol(protocol)
   ...
   documented to support the switch.
                  ...
                  *BaseTransport.get_protocol()..asyncio-protocol.pyx*
...
--------------------
                    ...
                    *ReadTransport.is_reading()..asyncio-protocol.pyx*
ReadTransport.is_reading()
   ...
   New in version 3.7.
                 ...
                 *ReadTransport.pause_reading()..asyncio-protocol.pyx*
ReadTransport.pause_reading()
   ...
   called when the transport is already paused or closed.
                ...
                *ReadTransport.resume_reading()..asyncio-protocol.pyx*
...
---------------------
                        ...
                        *WriteTransport.abort()..asyncio-protocol.pyx*
WriteTransport.abort()
   ...
   method will eventually be called with "None" as its argument.
                ...
                *WriteTransport.can_write_eof()..asyncio-protocol.pyx*
WriteTransport.can_write_eof()

   Return "True" if the transport supports "write_eof()", "False" if
   not.

        *WriteTransport.get_write_buffer_size()..asyncio-protocol.pyx*
WriteTransport.get_write_buffer_size()

   Return the current size of the output buffer used by the transport.

      *WriteTransport.get_write_buffer_limits()..asyncio-protocol.pyx*
WriteTransport.get_write_buffer_limits()
   ...
   New in version 3.4.2.
      ...
      *WriteTransport.set_write_buffer_limits()..asyncio-protocol.pyx*
WriteTransport.set_write_buffer_limits(high=None, low=None)
   ...
   Use "get_write_buffer_limits()" to get the limits.
                        ...
                        *WriteTransport.write()..asyncio-protocol.pyx*
WriteTransport.write(data)
   ...
   to be sent out asynchronously.
                   ...
                   *WriteTransport.writelines()..asyncio-protocol.pyx*
WriteTransport.writelines(list_of_data)
   ...
   yielded by the iterable, but may be implemented more efficiently.
                    ...
                    *WriteTransport.write_eof()..asyncio-protocol.pyx*
...
-------------------
                    ...
                    *DatagramTransport.sendto()..asyncio-protocol.pyx*
DatagramTransport.sendto(data, addr=None)
   ...
   to be sent out asynchronously.
                     ...
                     *DatagramTransport.abort()..asyncio-protocol.pyx*
...
---------------------
                 ...
                 *SubprocessTransport.get_pid()..asyncio-protocol.pyx*
SubprocessTransport.get_pid()

   Return the subprocess process id as an integer.

      *SubprocessTransport.get_pipe_transport()..asyncio-protocol.pyx*
SubprocessTransport.get_pipe_transport(fd)
   ...
   * other _fd_: "None"
          ...
          *SubprocessTransport.get_returncode()..asyncio-protocol.pyx*
SubprocessTransport.get_returncode()
   ...
   "subprocess.Popen.returncode" attribute.
                    ...
                    *SubprocessTransport.kill()..asyncio-protocol.pyx*
SubprocessTransport.kill()
   ...
   See also "subprocess.Popen.kill()".
             ...
             *SubprocessTransport.send_signal()..asyncio-protocol.pyx*
SubprocessTransport.send_signal(signal)

   Send the _signal_ number to the subprocess, as in
   "subprocess.Popen.send_signal()".

               *SubprocessTransport.terminate()..asyncio-protocol.pyx*
SubprocessTransport.terminate()
   ...
   See also "subprocess.Popen.terminate()".
                   ...
                   *SubprocessTransport.close()..asyncio-protocol.pyx*
...
class asyncio.BaseProtocol        *BaseProtocol..asyncio-protocol.pyx*

   Base protocol with methods that all protocols share.

                                      *Protocol..asyncio-protocol.pyx*
class asyncio.Protocol(BaseProtocol)

   The base class for implementing streaming protocols (TCP, Unix
   sockets, etc).

                              *BufferedProtocol..asyncio-protocol.pyx*
class asyncio.BufferedProtocol(BaseProtocol)

   A base class for implementing streaming protocols with manual
   control of the receive buffer.

                              *DatagramProtocol..asyncio-protocol.pyx*
class asyncio.DatagramProtocol(BaseProtocol)

   The base class for implementing datagram (UDP) protocols.

                            *SubprocessProtocol..asyncio-protocol.pyx*
...
called between those two methods.
                ...
                *BaseProtocol.connection_made()..asyncio-protocol.pyx*
BaseProtocol.connection_made(transport)
   ...
   to its transport.
                ...
                *BaseProtocol.connection_lost()..asyncio-protocol.pyx*
...
more details.
                  ...
                  *BaseProtocol.pause_writing()..asyncio-protocol.pyx*
BaseProtocol.pause_writing()

   Called when the transport’s buffer goes over the high watermark.

                 *BaseProtocol.resume_writing()..asyncio-protocol.pyx*
...
factories that return streaming protocols.
                      ...
                      *Protocol.data_received()..asyncio-protocol.pyx*
Protocol.data_received(data)
   ...
   anymore.
                       ...
                       *Protocol.eof_received()..asyncio-protocol.pyx*
...
The following callbacks are called on "BufferedProtocol" instances:
                 ...
                 *BufferedProtocol.get_buffer()..asyncio-protocol.pyx*
BufferedProtocol.get_buffer(sizehint)
   ...
   protocol.
             ...
             *BufferedProtocol.buffer_updated()..asyncio-protocol.pyx*
BufferedProtocol.buffer_updated(nbytes)
   ...
   buffer.
               ...
               *BufferedProtocol.eof_received()..asyncio-protocol.pyx*
...
factories passed to the "loop.create_datagram_endpoint()" method.
          ...
          *DatagramProtocol.datagram_received()..asyncio-protocol.pyx*
DatagramProtocol.datagram_received(data, addr)
   ...
   sending the data; the exact format depends on the transport.
             ...
             *DatagramProtocol.error_received()..asyncio-protocol.pyx*
...
"loop.subprocess_shell()" methods.
       ...
       *SubprocessProtocol.pipe_data_received()..asyncio-protocol.pyx*
SubprocessProtocol.pipe_data_received(fd, data)
   ...
   _data_ is a non-empty bytes object containing the received data.
     ...
     *SubprocessProtocol.pipe_connection_lost()..asyncio-protocol.pyx*
SubprocessProtocol.pipe_connection_lost(fd, exc)
   ...
   _fd_ is the integer file descriptor that was closed.
           ...
           *SubprocessProtocol.process_exited()..asyncio-protocol.pyx*
