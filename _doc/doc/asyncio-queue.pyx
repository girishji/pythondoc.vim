*asyncio-queue.pyx*                           Last change: 2023 Sep 15
...
class asyncio.Queue(maxsize=0)              *Queue..asyncio-queue.pyx*
   ...
   maxsize                             *Queue.maxsize..asyncio-queue.pyx*

      Number of items allowed in the queue.

   empty()                             *Queue.empty()..asyncio-queue.pyx*

      Return "True" if the queue is empty, "False" otherwise.

   full()                               *Queue.full()..asyncio-queue.pyx*
   ...
   coroutine get()                       *Queue.get()..asyncio-queue.pyx*

      Remove and return an item from the queue. If queue is empty,
      wait until an item is available.

   get_nowait()                   *Queue.get_nowait()..asyncio-queue.pyx*

      Return an item if one is immediately available, else raise
      "QueueEmpty".

   coroutine join()                     *Queue.join()..asyncio-queue.pyx*
   ...
   coroutine put(item)                   *Queue.put()..asyncio-queue.pyx*

      Put an item into the queue. If the queue is full, wait until a
      free slot is available before adding the item.

   put_nowait(item)               *Queue.put_nowait()..asyncio-queue.pyx*

      Put an item into the queue without blocking.

      If no free slot is immediately available, raise "QueueFull".

   qsize()                             *Queue.qsize()..asyncio-queue.pyx*

      Return the number of items in the queue.

   task_done()                     *Queue.task_done()..asyncio-queue.pyx*
...
class asyncio.PriorityQueue         *PriorityQueue..asyncio-queue.pyx*
...
class asyncio.LifoQueue                 *LifoQueue..asyncio-queue.pyx*
...
exception asyncio.QueueEmpty           *QueueEmpty..asyncio-queue.pyx*

   This exception is raised when the "get_nowait()" method is called
   on an empty queue.

exception asyncio.QueueFull             *QueueFull..asyncio-queue.pyx*
