*asyncio-stream.pyx*                          Last change: 2023 Sep 15
...
work with streams:
                               ...
                               *open_connection()..asyncio-stream.pyx*
coroutine asyncio.open_connection(host=None, port=None, *, limit=None, ssl=None, family=0, proto=0, flags=0, sock=None, local_addr=None, server_hostname=None, ssl_handshake_timeout=None, ssl_shutdown_timeout=None, happy_eyeballs_delay=None, interleave=None)
   ...
   parameter.
                                  ...
                                  *start_server()..asyncio-stream.pyx*
...
-[ Unix Sockets ]-
                          ...
                          *open_unix_connection()..asyncio-stream.pyx*
coroutine asyncio.open_unix_connection(path=None, *, limit=None, ssl=None, sock=None, server_hostname=None, ssl_handshake_timeout=None, ssl_shutdown_timeout=None)
   ...
   parameter.
                             ...
                             *start_unix_server()..asyncio-stream.pyx*
...
class asyncio.StreamReader          *StreamReader..asyncio-stream.pyx*
   ...
   coroutine read(n=-1)         *StreamReader.read()..asyncio-stream.pyx*
   ...
   coroutine readline()     *StreamReader.readline()..asyncio-stream.pyx*
      ...
      empty "bytes" object.
                      ...
                      *StreamReader.readexactly()..asyncio-stream.pyx*
   coroutine readexactly(n)
      ...
      the partially read data.
                        ...
                        *StreamReader.readuntil()..asyncio-stream.pyx*
   ...
   at_eof()                   *StreamReader.at_eof()..asyncio-stream.pyx*
...
class asyncio.StreamWriter          *StreamWriter..asyncio-stream.pyx*
   ...
   write(data)                 *StreamWriter.write()..asyncio-stream.pyx*
...
>
         ...
         await stream.drain()
<
   writelines(data)       *StreamWriter.writelines()..asyncio-stream.pyx*
...
>
         ...
         await stream.drain()
<
   close()                     *StreamWriter.close()..asyncio-stream.pyx*
...
<
   can_write_eof()     *StreamWriter.can_write_eof()..asyncio-stream.pyx*

      Return "True" if the underlying transport supports the
      "write_eof()" method, "False" otherwise.

   write_eof()             *StreamWriter.write_eof()..asyncio-stream.pyx*

      Close the write end of the stream after the buffered write data
      is flushed.

   transport                 *StreamWriter.transport..asyncio-stream.pyx*

      Return the underlying asyncio transport.

                   *StreamWriter.get_extra_info()..asyncio-stream.pyx*
   get_extra_info(name, default=None)

      Access optional transport information; see
      "BaseTransport.get_extra_info()" for details.

   coroutine drain()           *StreamWriter.drain()..asyncio-stream.pyx*
...
<
      ...
      immediately.
                        ...
                        *StreamWriter.start_tls()..asyncio-stream.pyx*
   ...
   is_closing()           *StreamWriter.is_closing()..asyncio-stream.pyx*
      ...
      New in version 3.7.
                      ...
                      *StreamWriter.wait_closed()..asyncio-stream.pyx*
