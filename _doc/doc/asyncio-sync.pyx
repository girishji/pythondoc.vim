*asyncio-sync.pyx*                            Last change: 2023 Sep 15
...
class asyncio.Lock                            *Lock..asyncio-sync.pyx*
...
<
   ...
   coroutine acquire()                 *Lock.acquire()..asyncio-sync.pyx*
   ...
   release()                           *Lock.release()..asyncio-sync.pyx*
   ...
   locked()                             *Lock.locked()..asyncio-sync.pyx*
...
class asyncio.Event                          *Event..asyncio-sync.pyx*
...
>
      ...
      asyncio.run(main())
<
   coroutine wait()                      *Event.wait()..asyncio-sync.pyx*
   ...
   set()                                  *Event.set()..asyncio-sync.pyx*
   ...
   clear()                              *Event.clear()..asyncio-sync.pyx*
   ...
   is_set()                            *Event.is_set()..asyncio-sync.pyx*
...
class asyncio.Condition(lock=None)       *Condition..asyncio-sync.pyx*
...
>
      ...
      try:
          ...
          cond.release()
<
   coroutine acquire()            *Condition.acquire()..asyncio-sync.pyx*
   ...
   notify(n=1)                     *Condition.notify()..asyncio-sync.pyx*
   ...
   locked()                        *Condition.locked()..asyncio-sync.pyx*

      Return "True" if the underlying lock is acquired.

   notify_all()                *Condition.notify_all()..asyncio-sync.pyx*
   ...
   release()                      *Condition.release()..asyncio-sync.pyx*

      Release the underlying lock.

      When invoked on an unlocked lock, a "RuntimeError" is raised.

   coroutine wait()                  *Condition.wait()..asyncio-sync.pyx*
      ...
      returns "True".
                              ...
                              *Condition.wait_for()..asyncio-sync.pyx*
...
class asyncio.Semaphore(value=1)         *Semaphore..asyncio-sync.pyx*
...
>
      ...
      try:
          ...
          sem.release()
<
   coroutine acquire()            *Semaphore.acquire()..asyncio-sync.pyx*
   ...
   locked()                        *Semaphore.locked()..asyncio-sync.pyx*

      Returns "True" if semaphore can not be acquired immediately.

   release()                      *Semaphore.release()..asyncio-sync.pyx*
...
================
                                  ...
                                  *BoundedSemaphore..asyncio-sync.pyx*
...
class asyncio.Barrier(parties)             *Barrier..asyncio-sync.pyx*
...
<
   ...
   coroutine wait()                    *Barrier.wait()..asyncio-sync.pyx*
...
<
   ...
   coroutine reset()                  *Barrier.reset()..asyncio-sync.pyx*
   ...
   coroutine abort()                  *Barrier.abort()..asyncio-sync.pyx*
   ...
   parties                            *Barrier.parties..asyncio-sync.pyx*

      The number of tasks required to pass the barrier.

   n_waiting                        *Barrier.n_waiting..asyncio-sync.pyx*

      The number of tasks currently waiting in the barrier while
      filling.

   broken                              *Barrier.broken..asyncio-sync.pyx*

      A boolean that is "True" if the barrier is in the broken state.

                                *BrokenBarrierError..asyncio-sync.pyx*
