*base64.pyx*                                  Last change: 2023 Sep 15
...
base64.b64encode(s, altchars=None)           *b64encode()..base64.pyx*
...
base64.urlsafe_b64decode(s)          *urlsafe_b64decode()..base64.pyx*
...
base64.b32hexencode(s)                    *b32hexencode()..base64.pyx*
...
base64.b32hexdecode(s, casefold=False)    *b32hexdecode()..base64.pyx*
...
base64.b16encode(s)                          *b16encode()..base64.pyx*

   Encode the _bytes-like object_ _s_ using Base16 and return the
   encoded "bytes".

base64.b16decode(s, casefold=False)          *b16decode()..base64.pyx*
...
base64.b85encode(b, pad=False)               *b85encode()..base64.pyx*
...
base64.b85decode(b)                          *b85decode()..base64.pyx*
...
base64.decode(input, output)                    *decode()..base64.pyx*
...
base64.decodebytes(s)                      *decodebytes()..base64.pyx*
...
base64.encode(input, output)                    *encode()..base64.pyx*
...
base64.encodebytes(s)                      *encodebytes()..base64.pyx*
