*cmath.pyx*                                   Last change: 2023 Sep 15
...
cmath.rect(r, phi)                                 *rect()..cmath.pyx*
...
cmath.cos(x)                                        *cos()..cmath.pyx*

   Return the cosine of _x_.

cmath.sin(x)                                        *sin()..cmath.pyx*

   Return the sine of _x_.

cmath.tan(x)                                        *tan()..cmath.pyx*
...
cmath.cosh(x)                                      *cosh()..cmath.pyx*

   Return the hyperbolic cosine of _x_.

cmath.sinh(x)                                      *sinh()..cmath.pyx*

   Return the hyperbolic sine of _x_.

cmath.tanh(x)                                      *tanh()..cmath.pyx*
...
cmath.isfinite(x)                              *isfinite()..cmath.pyx*
...
cmath.tau                                             *tau..cmath.pyx*

   The mathematical constant _τ_, as a float.

   New in version 3.6.

cmath.inf                                             *inf..cmath.pyx*

   Floating-point positive infinity. Equivalent to "float('inf')".

   New in version 3.6.

cmath.infj                                           *infj..cmath.pyx*
