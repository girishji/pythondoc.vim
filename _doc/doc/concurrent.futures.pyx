*concurrent.futures.pyx*                      Last change: 2023 Sep 15
...
class concurrent.futures.Executor   *Executor..concurrent.futures.pyx*
...
<
                              ...
                              *Executor.map()..concurrent.futures.pyx*
      map(func, *iterables, timeout=None, chunksize=1)
         ...
         * _func_ is executed asynchronously and several calls to
         ...
         is called and the result isn’t available after _timeout_
         seconds from the original call to "Executor.map()". _timeout_
         can be an int or a float.  If _timeout_ is not specified or
         ...
         Changed in version 3.5: Added the _chunksize_ argument.
                         ...
                         *Executor.shutdown()..concurrent.futures.pyx*
...
<
                          ...
                          *ThreadPoolExecutor..concurrent.futures.pyx*
...
"ProcessPoolExecutor" will result in deadlock.
                         ...
                         *ProcessPoolExecutor..concurrent.futures.pyx*
...
class concurrent.futures.Future       *Future..concurrent.futures.pyx*
   ...
   created directly except for testing.
      ...
      cancel()                     *Future.cancel()..concurrent.futures.pyx*
      ...
      cancelled()               *Future.cancelled()..concurrent.futures.pyx*

         Return "True" if the call was successfully cancelled.

      running()                   *Future.running()..concurrent.futures.pyx*

         Return "True" if the call is currently being executed and
         cannot be cancelled.

      done()                         *Future.done()..concurrent.futures.pyx*

         Return "True" if the call was successfully cancelled or
         finished running.

      result(timeout=None)         *Future.result()..concurrent.futures.pyx*
      ...
      exception(timeout=None)   *Future.exception()..concurrent.futures.pyx*
         ...
         then a "TimeoutError" will be raised.  _timeout_ can be an
         int or float.  If _timeout_ is not specified or "None", there
         ...
         If the call completed without raising, "None" is returned.
                  ...
                  *Future.add_done_callback()..concurrent.futures.pyx*
   ...
   "Executor" implementations.
      ...
      set_result(result)       *Future.set_result()..concurrent.futures.pyx*
         ...
         already done.
                      ...
                      *Future.set_exception()..concurrent.futures.pyx*
...
concurrent.futures.wait(fs, timeout=None, return_when=ALL_COMPLETED)
   ...
   +-------------------------------+------------------------------------------+
                              ...
                              *as_completed()..concurrent.futures.pyx*
...
=================
                              ...
                              *CancelledError..concurrent.futures.pyx*
exception concurrent.futures.CancelledError

   Raised when a future is cancelled.

                                *TimeoutError..concurrent.futures.pyx*
exception concurrent.futures.TimeoutError
   ...
   "TimeoutError".
                              ...
                              *BrokenExecutor..concurrent.futures.pyx*
exception concurrent.futures.BrokenExecutor
   ...
   New in version 3.7.
                           ...
                           *InvalidStateError..concurrent.futures.pyx*
exception concurrent.futures.InvalidStateError
   ...
   New in version 3.8.
                            ...
                            *BrokenThreadPool..concurrent.futures.pyx*
exception concurrent.futures.thread.BrokenThreadPool
   ...
   New in version 3.7.
                           ...
                           *BrokenProcessPool..concurrent.futures.pyx*
