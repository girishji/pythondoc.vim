*contextlib.pyx*                              Last change: 2023 Sep 15
...
Functions and classes provided:
                              ...
                              *AbstractContextManager..contextlib.pyx*
class contextlib.AbstractContextManager
   ...
   New in version 3.6.
                         ...
                         *AbstractAsyncContextManager..contextlib.pyx*
...
@contextlib.contextmanager          *contextmanager()..contextlib.pyx*
...
<
   ...
   Changed in version 3.2: Use of "ContextDecorator".
                               ...
                               *asynccontextmanager()..contextlib.pyx*
...
contextlib.closing(thing)                  *closing()..contextlib.pyx*
...
contextlib.aclosing(thing)                *aclosing()..contextlib.pyx*
...
contextlib.suppress(*exceptions)          *suppress()..contextlib.pyx*
...
<
   ...
   If the code within the "with" block raises an "ExceptionGroup",
   ...
   exceptions raised as part of an "ExceptionGroup".

                                   *redirect_stdout()..contextlib.pyx*
...
<
   ...
   New in version 3.4.
                                   ...
                                   *redirect_stderr()..contextlib.pyx*
...
contextlib.chdir(path)                       *chdir()..contextlib.pyx*
...
class contextlib.ContextDecorator   *ContextDecorator..contextlib.pyx*
...
<
   ...
   New in version 3.2.
                               ...
                               *AsyncContextDecorator..contextlib.pyx*
...
class contextlib.ExitStack                 *ExitStack..contextlib.pyx*
...
<
   ...
   enter_context(cm)          *ExitStack.enter_context()..contextlib.pyx*
   ...
   push(exit)                          *ExitStack.push()..contextlib.pyx*
      ...
      this method to be used as a function decorator.
                                ...
                                *ExitStack.callback()..contextlib.pyx*
   ...
   pop_all()                        *ExitStack.pop_all()..contextlib.pyx*
...
<
   close()                            *ExitStack.close()..contextlib.pyx*
...
class contextlib.AsyncExitStack       *AsyncExitStack..contextlib.pyx*
   ...
   instead.
                ...
                *AsyncExitStack.enter_async_context()..contextlib.pyx*
