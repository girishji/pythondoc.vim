*contextvars.pyx*                             Last change: 2023 Sep 15
...
<
   ...
   **Important:** Context Variables should be created at the top
   ...
   name                                *ContextVar.name..contextvars.pyx*

      The name of the variable.  This is a read-only property.

      New in version 3.7.1.

   get([default])                     *ContextVar.get()..contextvars.pyx*
   ...
   set(value)                         *ContextVar.set()..contextvars.pyx*
   ...
   reset(token)                     *ContextVar.reset()..contextvars.pyx*
...
<
class contextvars.Token                       *Token..contextvars.pyx*
   ...
   var                                       *Token.var..contextvars.pyx*

      A read-only property.  Points to the "ContextVar" object that
      created the token.

   old_value                           *Token.old_value..contextvars.pyx*
   ...
   MISSING                               *Token.MISSING..contextvars.pyx*
...
contextvars.copy_context()           *copy_context()..contextvars.pyx*
...
class contextvars.Context                   *Context..contextvars.pyx*
   ...
   run(callable, *args, **kwargs)        *Context.run()..contextvars.pyx*
...
<
   ...
   copy()                               *Context.copy()..contextvars.pyx*
   ...
   get(var[, default])                   *Context.get()..contextvars.pyx*
   ...
   keys()                               *Context.keys()..contextvars.pyx*

      Return a list of all variables in the context object.

   values()                           *Context.values()..contextvars.pyx*

      Return a list of all variables’ values in the context object.

   items()                             *Context.items()..contextvars.pyx*
