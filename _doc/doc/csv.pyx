*csv.pyx*                                     Last change: 2023 Sep 15
...
csv.list_dialects()                         *list_dialects()..csv.pyx*

   Return the names of all registered dialects.

csv.field_size_limit([new_limit])        *field_size_limit()..csv.pyx*
...
<
class csv.Dialect                                   *Dialect..csv.pyx*
...
class csv.unix_dialect                         *unix_dialect..csv.pyx*
...
class csv.Sniffer                                   *Sniffer..csv.pyx*

   The "Sniffer" class is used to deduce the format of a CSV file.

   The "Sniffer" class provides two methods:

   sniff(sample, delimiters=None)              *Sniffer.sniff()..csv.pyx*
   ...
   has_header(sample)                     *Sniffer.has_header()..csv.pyx*
...
csv.QUOTE_ALL                                     *QUOTE_ALL..csv.pyx*

   Instructs "writer" objects to quote all fields.

csv.QUOTE_MINIMAL                             *QUOTE_MINIMAL..csv.pyx*
...
csv.QUOTE_NONNUMERIC                       *QUOTE_NONNUMERIC..csv.pyx*
...
csv.QUOTE_NONE                                   *QUOTE_NONE..csv.pyx*
...
csv.QUOTE_NOTNULL                             *QUOTE_NOTNULL..csv.pyx*
...
csv.QUOTE_STRINGS                             *QUOTE_STRINGS..csv.pyx*
...
exception csv.Error                                   *Error..csv.pyx*
...
Dialect.delimiter                         *Dialect.delimiter..csv.pyx*

   A one-character string used to separate fields.  It defaults to
   "','".

Dialect.doublequote                     *Dialect.doublequote..csv.pyx*
...
Dialect.escapechar                       *Dialect.escapechar..csv.pyx*
...
Dialect.lineterminator               *Dialect.lineterminator..csv.pyx*
...
Dialect.quotechar                         *Dialect.quotechar..csv.pyx*
...
Dialect.quoting                             *Dialect.quoting..csv.pyx*
...
Dialect.skipinitialspace           *Dialect.skipinitialspace..csv.pyx*

   When "True", spaces immediately following the _delimiter_ are
   ignored. The default is "False".

Dialect.strict                               *Dialect.strict..csv.pyx*
...
csvreader.__next__()                   *csvreader.__next__()..csv.pyx*
...
csvreader.dialect                         *csvreader.dialect..csv.pyx*

   A read-only description of the dialect in use by the parser.

csvreader.line_num                       *csvreader.line_num..csv.pyx*
...
DictReader.fieldnames                 *DictReader.fieldnames..csv.pyx*
...
csvwriter.writerow(row)                *csvwriter.writerow()..csv.pyx*
...
csvwriter.writerows(rows)             *csvwriter.writerows()..csv.pyx*
...
csvwriter.dialect                         *csvwriter.dialect..csv.pyx*

   A read-only description of the dialect in use by the writer.

DictWriter objects have the following public method:

DictWriter.writeheader()           *DictWriter.writeheader()..csv.pyx*
