*ctypes.pyx*                                  Last change: 2023 Sep 15
...
ctypes.util.find_library(name)              *find_library..ctypes.pyx*
...
PyDLL._handle                              *PyDLL._handle..ctypes.pyx*

   The system handle used to access the library.

PyDLL._name                                  *PyDLL._name..ctypes.pyx*
...
class ctypes.LibraryLoader(dlltype)        *LibraryLoader..ctypes.pyx*
   ...
   LoadLibrary(name)            *LibraryLoader.LoadLibrary()..ctypes.pyx*
...
ctypes.cdll                                         *cdll..ctypes.pyx*

   Creates "CDLL" instances.

ctypes.windll                                     *windll..ctypes.pyx*

   Windows only: Creates "WinDLL" instances.

ctypes.oledll                                     *oledll..ctypes.pyx*

   Windows only: Creates "OleDLL" instances.

ctypes.pydll                                       *pydll..ctypes.pyx*
...
ctypes.pythonapi                               *pythonapi..ctypes.pyx*
...
class ctypes._FuncPtr                           *_FuncPtr..ctypes.pyx*
   ...
   restype                                 *_FuncPtr.restype..ctypes.pyx*
   ...
   argtypes                               *_FuncPtr.argtypes..ctypes.pyx*
...
exception ctypes.ArgumentError             *ArgumentError..ctypes.pyx*
...
ctypes.PYFUNCTYPE(restype, *argtypes)       *PYFUNCTYPE()..ctypes.pyx*
...
the parameters in the call:
   ...
   prototype(address)                           *prototype()..ctypes.pyx*
...
ctypes.addressof(obj)                        *addressof()..ctypes.pyx*
...
ctypes.cast(obj, type)                            *cast()..ctypes.pyx*
   ...
   that can be interpreted as a pointer.
                                  ...
                                  *create_string_buffer()..ctypes.pyx*
ctypes.create_string_buffer(init_or_size, size=None)
   ...
   arguments "init", "size".
                                 ...
                                 *create_unicode_buffer()..ctypes.pyx*
...
ctypes.DllCanUnloadNow()               *DllCanUnloadNow()..ctypes.pyx*
...
ctypes.DllGetClassObject()           *DllGetClassObject()..ctypes.pyx*
...
ctypes.util.find_msvcrt()                  *find_msvcrt()..ctypes.pyx*
...
ctypes.FormatError([code])                 *FormatError()..ctypes.pyx*
...
ctypes.GetLastError()                     *GetLastError()..ctypes.pyx*
...
ctypes.get_errno()                           *get_errno()..ctypes.pyx*
...
ctypes.get_last_error()                 *get_last_error()..ctypes.pyx*
...
ctypes.memmove(dst, src, count)                *memmove()..ctypes.pyx*
...
ctypes.memset(dst, c, count)                    *memset()..ctypes.pyx*
...
ctypes.POINTER(type, /)                        *POINTER()..ctypes.pyx*
...
ctypes.pointer(obj, /)                         *pointer()..ctypes.pyx*
...
ctypes.resize(obj, size)                        *resize()..ctypes.pyx*
...
ctypes.set_errno(value)                      *set_errno()..ctypes.pyx*
...
ctypes.set_last_error(value)            *set_last_error()..ctypes.pyx*
...
ctypes.sizeof(obj_or_type)                      *sizeof()..ctypes.pyx*

   Returns the size in bytes of a ctypes type or instance memory
   buffer. Does the same as the C "sizeof" operator.

ctypes.string_at(address, size=-1)           *string_at()..ctypes.pyx*
...
ctypes.WinError(code=None, descr=None)        *WinError()..ctypes.pyx*
...
ctypes.wstring_at(address, size=-1)         *wstring_at()..ctypes.pyx*
...
class ctypes._CData                               *_CData..ctypes.pyx*
   ...
   from_buffer(source[, offset])       *_CData.from_buffer()..ctypes.pyx*
      ...
      "pointer", "size", "offset".
                               ...
                               *_CData.from_buffer_copy()..ctypes.pyx*
   ...
   from_address(address)              *_CData.from_address()..ctypes.pyx*
   ...
   from_param(obj)                      *_CData.from_param()..ctypes.pyx*
   ...
   in_dll(library, name)                    *_CData.in_dll()..ctypes.pyx*
   ...
   _b_base_                                 *_CData._b_base_..ctypes.pyx*
...
class ctypes._SimpleCData                   *_SimpleCData..ctypes.pyx*
   ...
   value                                 *_SimpleCData.value..ctypes.pyx*
...
class ctypes.c_byte                               *c_byte..ctypes.pyx*
...
class ctypes.c_char                               *c_char..ctypes.pyx*
...
class ctypes.c_char_p                           *c_char_p..ctypes.pyx*
...
class ctypes.c_double                           *c_double..ctypes.pyx*

   Represents the C double datatype.  The constructor accepts an
   optional float initializer.

class ctypes.c_longdouble                   *c_longdouble..ctypes.pyx*
...
class ctypes.c_float                             *c_float..ctypes.pyx*

   Represents the C float datatype.  The constructor accepts an
   optional float initializer.

class ctypes.c_int                                 *c_int..ctypes.pyx*
...
class ctypes.c_short                             *c_short..ctypes.pyx*

   Represents the C signed short datatype.  The constructor accepts an
   optional integer initializer; no overflow checking is done.

class ctypes.c_size_t                           *c_size_t..ctypes.pyx*

   Represents the C "size_t" datatype.

class ctypes.c_ssize_t                         *c_ssize_t..ctypes.pyx*

   Represents the C "ssize_t" datatype.

   New in version 3.2.

class ctypes.c_time_t                           *c_time_t..ctypes.pyx*

   Represents the C "time_t" datatype.

   New in version 3.12.

class ctypes.c_ubyte                             *c_ubyte..ctypes.pyx*

   Represents the C unsigned char datatype, it interprets the value as
   small integer.  The constructor accepts an optional integer
   initializer; no overflow checking is done.

class ctypes.c_uint                               *c_uint..ctypes.pyx*
...
class ctypes.c_wchar_p                         *c_wchar_p..ctypes.pyx*
...
class ctypes.c_bool                               *c_bool..ctypes.pyx*
...
class ctypes.HRESULT                             *HRESULT..ctypes.pyx*

   Windows only: Represents a "HRESULT" value, which contains success
   or error information for a function or method call.

class ctypes.py_object                         *py_object..ctypes.pyx*
...
class ctypes.Union(*args, **kw)                    *Union..ctypes.pyx*

   Abstract base class for unions in native byte order.

                                          *BigEndianUnion..ctypes.pyx*
...
class ctypes.Structure(*args, **kw)            *Structure..ctypes.pyx*
   ...
   _fields_                              *Structure._fields_..ctypes.pyx*
...
<
   ...
   _pack_                                  *Structure._pack_..ctypes.pyx*
   ...
   _anonymous_                        *Structure._anonymous_..ctypes.pyx*
...
class ctypes.Array(*args)                          *Array..ctypes.pyx*
...
class ctypes._Pointer                           *_Pointer..ctypes.pyx*
   ...
   _type_                                   *_Pointer._type_..ctypes.pyx*

      Specifies the type pointed to.

   contents                               *_Pointer.contents..ctypes.pyx*
