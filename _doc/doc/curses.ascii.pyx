*curses.ascii.pyx*                            Last change: 2023 Sep 15
...
curses.ascii.isalnum(c)                  *isalnum()..curses.ascii.pyx*

   Checks for an ASCII alphanumeric character; it is equivalent to
   "isalpha(c) or isdigit(c)".

curses.ascii.isalpha(c)                  *isalpha()..curses.ascii.pyx*

   Checks for an ASCII alphabetic character; it is equivalent to
   "isupper(c) or islower(c)".

curses.ascii.isascii(c)                  *isascii()..curses.ascii.pyx*

   Checks for a character value that fits in the 7-bit ASCII set.

curses.ascii.isblank(c)                  *isblank()..curses.ascii.pyx*

   Checks for an ASCII whitespace character; space or horizontal tab.

curses.ascii.iscntrl(c)                  *iscntrl()..curses.ascii.pyx*

   Checks for an ASCII control character (in the range 0x00 to 0x1f or
   0x7f).

curses.ascii.isdigit(c)                  *isdigit()..curses.ascii.pyx*

   Checks for an ASCII decimal digit, "'0'" through "'9'".  This is
   equivalent to "c in string.digits".

curses.ascii.isgraph(c)                  *isgraph()..curses.ascii.pyx*

   Checks for ASCII any printable character except space.

curses.ascii.islower(c)                  *islower()..curses.ascii.pyx*

   Checks for an ASCII lower-case character.

curses.ascii.isprint(c)                  *isprint()..curses.ascii.pyx*

   Checks for any ASCII printable character including space.

curses.ascii.ispunct(c)                  *ispunct()..curses.ascii.pyx*

   Checks for any printable ASCII character which is not a space or an
   alphanumeric character.

curses.ascii.isspace(c)                  *isspace()..curses.ascii.pyx*

   Checks for ASCII white-space characters; space, line feed, carriage
   return, form feed, horizontal tab, vertical tab.

curses.ascii.isupper(c)                  *isupper()..curses.ascii.pyx*

   Checks for an ASCII uppercase letter.

curses.ascii.isxdigit(c)                *isxdigit()..curses.ascii.pyx*

   Checks for an ASCII hexadecimal digit.  This is equivalent to "c in
   string.hexdigits".

curses.ascii.isctrl(c)                    *isctrl()..curses.ascii.pyx*

   Checks for an ASCII control character (ordinal values 0 to 31).

curses.ascii.ismeta(c)                    *ismeta()..curses.ascii.pyx*
...
curses.ascii.unctrl(c)                    *unctrl()..curses.ascii.pyx*
...
curses.ascii.controlnames             *controlnames..curses.ascii.pyx*
