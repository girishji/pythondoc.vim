*dataclasses.pyx*                             Last change: 2023 Sep 15
...
class dataclasses.Field                       *Field..dataclasses.pyx*
...
dataclasses.fields(class_or_instance)      *fields()..dataclasses.pyx*
...
<
   ...
   instance.
                                   ...
                                   *make_dataclass()..dataclasses.pyx*
...
>
      ...
      class C:
          ...
          def add_one(self):
              return self.x + 1
<
dataclasses.replace(obj, /, **changes)    *replace()..dataclasses.pyx*
...
dataclasses.is_dataclass(obj)        *is_dataclass()..dataclasses.pyx*
...
<
dataclasses.MISSING                         *MISSING..dataclasses.pyx*

   A sentinel value signifying a missing default or default_factory.

dataclasses.KW_ONLY                         *KW_ONLY..dataclasses.pyx*
...
<
   ...
   New in version 3.10.
                                ...
                                *FrozenInstanceError..dataclasses.pyx*
...
dataclasses.__post_init__()         *__post_init__()..dataclasses.pyx*
