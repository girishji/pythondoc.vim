*dbm.pyx*                                     Last change: 2023 Sep 15
...
exception dbm.error                                   *error..dbm.pyx*
...
dbm.whichdb(filename)                             *whichdb()..dbm.pyx*
...
dbm.open(file, flag='r', mode=0o666)                 *open()..dbm.pyx*
...
Changed in version 3.11: Accepts _path-like object_ for file.
...
dbm.gnu.open(filename[, flag[, mode]])
   ...
   gdbm.firstkey()                             *gdbm.firstkey()..dbm.pyx*
   ...
   gdbm.nextkey(key)                            *gdbm.nextkey()..dbm.pyx*
...
>
         ...
         while k is not None:
             ...
             k = db.nextkey(k)
<
   gdbm.reorganize()                         *gdbm.reorganize()..dbm.pyx*
...
dbm.ndbm.library                                    *library..dbm.pyx*
...
dbm.ndbm.open(filename[, flag[, mode]])
   ...
   ndbm.close()                                   *ndbm.close()..dbm.pyx*

      Close the "ndbm" database.

   ndbm.clear()                                   *ndbm.clear()..dbm.pyx*
