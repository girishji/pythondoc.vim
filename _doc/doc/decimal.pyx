*decimal.pyx*                                 Last change: 2023 Sep 15
...
<
   ...
   adjusted()                           *Decimal.adjusted()..decimal.pyx*
   ...
   as_integer_ratio()           *Decimal.as_integer_ratio()..decimal.pyx*
...
<
   ...
   as_tuple()                           *Decimal.as_tuple()..decimal.pyx*

      Return a _named tuple_ representation of the number:
      "DecimalTuple(sign, digits, exponent)".

   canonical()                         *Decimal.canonical()..decimal.pyx*
   ...
   compare(other, context=None)          *Decimal.compare()..decimal.pyx*
...
<
                               ...
                               *Decimal.compare_signal()..decimal.pyx*
   compare_signal(other, context=None)
      ...
      were a signaling NaN.
                                ...
                                *Decimal.compare_total()..decimal.pyx*
   compare_total(other, context=None)
      ...
      cannot be converted exactly.
                            ...
                            *Decimal.compare_total_mag()..decimal.pyx*
   ...
   copy_negate()                     *Decimal.copy_negate()..decimal.pyx*

      Return the negation of the argument.  This operation is
      unaffected by the context and is quiet: no flags are changed and
      no rounding is performed.

   copy_sign(other, context=None)      *Decimal.copy_sign()..decimal.pyx*
   ...
   exp(context=None)                         *Decimal.exp()..decimal.pyx*
   ...
   classmethod from_float(f)          *Decimal.from_float()..decimal.pyx*
...
<
   ...
   fma(other, third, context=None)           *Decimal.fma()..decimal.pyx*
   ...
   is_canonical()                   *Decimal.is_canonical()..decimal.pyx*
   ...
   logb(context=None)                       *Decimal.logb()..decimal.pyx*
      ...
      "Decimal('Infinity')" is returned.
                                  ...
                                  *Decimal.logical_and()..decimal.pyx*
   ...
   max(other, context=None)                  *Decimal.max()..decimal.pyx*
   ...
   max_mag(other, context=None)          *Decimal.max_mag()..decimal.pyx*

      Similar to the "max()" method, but the comparison is done using
      the absolute values of the operands.

   min(other, context=None)                  *Decimal.min()..decimal.pyx*
   ...
   min_mag(other, context=None)          *Decimal.min_mag()..decimal.pyx*

      Similar to the "min()" method, but the comparison is done using
      the absolute values of the operands.

   next_minus(context=None)           *Decimal.next_minus()..decimal.pyx*
   ...
   next_plus(context=None)             *Decimal.next_plus()..decimal.pyx*
      ...
      is larger than the given operand.
                                  ...
                                  *Decimal.next_toward()..decimal.pyx*
   ...
   normalize(context=None)             *Decimal.normalize()..decimal.pyx*
   ...
   number_class(context=None)       *Decimal.number_class()..decimal.pyx*
   ...
   rotate(other, context=None)            *Decimal.rotate()..decimal.pyx*
      ...
      of the first operand are unchanged.
                                 ...
                                 *Decimal.same_quantum()..decimal.pyx*
   ...
   sqrt(context=None)                       *Decimal.sqrt()..decimal.pyx*

      Return the square root of the argument to full precision.

   to_eng_string(context=None)     *Decimal.to_eng_string()..decimal.pyx*
      ...
      "Decimal('1.23E+3')".
                                  ...
                                  *Decimal.to_integral()..decimal.pyx*
   to_integral(rounding=None, context=None)
      ...
      versions.
                            ...
                            *Decimal.to_integral_exact()..decimal.pyx*
   to_integral_exact(rounding=None, context=None)
      ...
      rounding mode of the current context is used.
                            ...
                            *Decimal.to_integral_value()..decimal.pyx*
...
decimal.getcontext()                       *getcontext()..decimal.pyx*

   Return the current context for the active thread.

decimal.setcontext(c)                      *setcontext()..decimal.pyx*
...
class decimal.BasicContext                 *BasicContext..decimal.pyx*
...
class decimal.ExtendedContext           *ExtendedContext..decimal.pyx*
...
class decimal.DefaultContext             *DefaultContext..decimal.pyx*
...
<
   ...
   clear_flags()                     *Context.clear_flags()..decimal.pyx*

      Resets all of the flags to "0".

   clear_traps()                     *Context.clear_traps()..decimal.pyx*

      Resets all of the traps to "0".

      New in version 3.3.

   copy()                                   *Context.copy()..decimal.pyx*

      Return a duplicate of the context.

   copy_decimal(num)                *Context.copy_decimal()..decimal.pyx*

      Return a copy of the Decimal instance num.

   create_decimal(num)            *Context.create_decimal()..decimal.pyx*
...
<
      ...
      trailing whitespace or underscores are permitted.
                    ...
                    *Context.create_decimal_from_float()..decimal.pyx*
...
<
   ...
   Etiny()                                 *Context.Etiny()..decimal.pyx*
   ...
   abs(x)                                    *Context.abs()..decimal.pyx*

      Returns the absolute value of _x_.

   add(x, y)                                 *Context.add()..decimal.pyx*

      Return the sum of _x_ and _y_.

   canonical(x)                        *Context.canonical()..decimal.pyx*

      Returns the same Decimal object _x_.

   compare(x, y)                         *Context.compare()..decimal.pyx*

      Compares _x_ and _y_ numerically.

   compare_signal(x, y)           *Context.compare_signal()..decimal.pyx*

      Compares the values of the two operands numerically.

   compare_total(x, y)             *Context.compare_total()..decimal.pyx*

      Compares two operands using their abstract representation.

   compare_total_mag(x, y)     *Context.compare_total_mag()..decimal.pyx*

      Compares two operands using their abstract representation,
      ignoring sign.

   copy_abs(x)                          *Context.copy_abs()..decimal.pyx*

      Returns a copy of _x_ with the sign set to 0.

   copy_negate(x)                    *Context.copy_negate()..decimal.pyx*

      Returns a copy of _x_ with the sign inverted.

   copy_sign(x, y)                     *Context.copy_sign()..decimal.pyx*

      Copies the sign from _y_ to _x_.

   divide(x, y)                           *Context.divide()..decimal.pyx*

      Return _x_ divided by _y_.

   divide_int(x, y)                   *Context.divide_int()..decimal.pyx*

      Return _x_ divided by _y_, truncated to an integer.

   divmod(x, y)                           *Context.divmod()..decimal.pyx*

      Divides two numbers and returns the integer part of the result.

   exp(x)                                    *Context.exp()..decimal.pyx*

      Returns "e ** x".

   fma(x, y, z)                              *Context.fma()..decimal.pyx*

      Returns _x_ multiplied by _y_, plus _z_.

   is_canonical(x)                  *Context.is_canonical()..decimal.pyx*

      Returns "True" if _x_ is canonical; otherwise returns "False".

   is_finite(x)                        *Context.is_finite()..decimal.pyx*

      Returns "True" if _x_ is finite; otherwise returns "False".

   is_infinite(x)                    *Context.is_infinite()..decimal.pyx*

      Returns "True" if _x_ is infinite; otherwise returns "False".

   is_nan(x)                              *Context.is_nan()..decimal.pyx*

      Returns "True" if _x_ is a qNaN or sNaN; otherwise returns
      "False".

   is_normal(x)                        *Context.is_normal()..decimal.pyx*

      Returns "True" if _x_ is a normal number; otherwise returns
      "False".

   is_qnan(x)                            *Context.is_qnan()..decimal.pyx*

      Returns "True" if _x_ is a quiet NaN; otherwise returns "False".

   is_signed(x)                        *Context.is_signed()..decimal.pyx*

      Returns "True" if _x_ is negative; otherwise returns "False".

   is_snan(x)                            *Context.is_snan()..decimal.pyx*

      Returns "True" if _x_ is a signaling NaN; otherwise returns
      "False".

   is_subnormal(x)                  *Context.is_subnormal()..decimal.pyx*

      Returns "True" if _x_ is subnormal; otherwise returns "False".

   is_zero(x)                            *Context.is_zero()..decimal.pyx*

      Returns "True" if _x_ is a zero; otherwise returns "False".

   ln(x)                                      *Context.ln()..decimal.pyx*

      Returns the natural (base e) logarithm of _x_.

   log10(x)                                *Context.log10()..decimal.pyx*

      Returns the base 10 logarithm of _x_.

   logb(x)                                  *Context.logb()..decimal.pyx*

      Returns the exponent of the magnitude of the operand’s MSD.

   logical_and(x, y)                 *Context.logical_and()..decimal.pyx*

      Applies the logical operation _and_ between each operand’s
      digits.

   logical_invert(x)              *Context.logical_invert()..decimal.pyx*

      Invert all the digits in _x_.

   logical_or(x, y)                   *Context.logical_or()..decimal.pyx*

      Applies the logical operation _or_ between each operand’s
      digits.

   logical_xor(x, y)                 *Context.logical_xor()..decimal.pyx*

      Applies the logical operation _xor_ between each operand’s
      digits.

   max(x, y)                                 *Context.max()..decimal.pyx*

      Compares two values numerically and returns the maximum.

   max_mag(x, y)                         *Context.max_mag()..decimal.pyx*

      Compares the values numerically with their sign ignored.

   min(x, y)                                 *Context.min()..decimal.pyx*

      Compares two values numerically and returns the minimum.

   min_mag(x, y)                         *Context.min_mag()..decimal.pyx*

      Compares the values numerically with their sign ignored.

   minus(x)                                *Context.minus()..decimal.pyx*

      Minus corresponds to the unary prefix minus operator in Python.

   multiply(x, y)                       *Context.multiply()..decimal.pyx*

      Return the product of _x_ and _y_.

   next_minus(x)                      *Context.next_minus()..decimal.pyx*

      Returns the largest representable number smaller than _x_.

   next_plus(x)                        *Context.next_plus()..decimal.pyx*

      Returns the smallest representable number larger than _x_.

   next_toward(x, y)                 *Context.next_toward()..decimal.pyx*

      Returns the number closest to _x_, in direction towards _y_.

   normalize(x)                        *Context.normalize()..decimal.pyx*

      Reduces _x_ to its simplest form.

   number_class(x)                  *Context.number_class()..decimal.pyx*

      Returns an indication of the class of _x_.

   plus(x)                                  *Context.plus()..decimal.pyx*
   ...
   power(x, y, modulo=None)                *Context.power()..decimal.pyx*
   ...
   quantize(x, y)                       *Context.quantize()..decimal.pyx*

      Returns a value equal to _x_ (rounded), having the exponent of
      _y_.

   radix()                                 *Context.radix()..decimal.pyx*

      Just returns 10, as this is Decimal, :)

   remainder(x, y)                     *Context.remainder()..decimal.pyx*
   ...
   remainder_near(x, y)           *Context.remainder_near()..decimal.pyx*

      Returns "x - y * n", where _n_ is the integer nearest the exact
      value of "x / y" (if the result is 0 then its sign will be the
      sign of _x_).

   rotate(x, y)                           *Context.rotate()..decimal.pyx*

      Returns a rotated copy of _x_, _y_ times.

   same_quantum(x, y)               *Context.same_quantum()..decimal.pyx*

      Returns "True" if the two operands have the same exponent.

   scaleb(x, y)                           *Context.scaleb()..decimal.pyx*

      Returns the first operand after adding the second value its exp.

   shift(x, y)                             *Context.shift()..decimal.pyx*

      Returns a shifted copy of _x_, _y_ times.

   sqrt(x)                                  *Context.sqrt()..decimal.pyx*

      Square root of a non-negative number to context precision.

   subtract(x, y)                       *Context.subtract()..decimal.pyx*

      Return the difference between _x_ and _y_.

   to_eng_string(x)                *Context.to_eng_string()..decimal.pyx*
   ...
   to_integral_exact(x)        *Context.to_integral_exact()..decimal.pyx*

      Rounds to an integer.

   to_sci_string(x)                *Context.to_sci_string()..decimal.pyx*
...
decimal.HAVE_THREADS                       *HAVE_THREADS..decimal.pyx*
...
decimal.HAVE_CONTEXTVAR                 *HAVE_CONTEXTVAR..decimal.pyx*
...
decimal.ROUND_CEILING                     *ROUND_CEILING..decimal.pyx*

   Round towards "Infinity".

decimal.ROUND_DOWN                           *ROUND_DOWN..decimal.pyx*

   Round towards zero.

decimal.ROUND_FLOOR                         *ROUND_FLOOR..decimal.pyx*

   Round towards "-Infinity".

decimal.ROUND_HALF_DOWN                 *ROUND_HALF_DOWN..decimal.pyx*

   Round to nearest with ties going towards zero.

decimal.ROUND_HALF_EVEN                 *ROUND_HALF_EVEN..decimal.pyx*

   Round to nearest with ties going to nearest even integer.

decimal.ROUND_HALF_UP                     *ROUND_HALF_UP..decimal.pyx*

   Round to nearest with ties going away from zero.

decimal.ROUND_UP                               *ROUND_UP..decimal.pyx*

   Round away from zero.

decimal.ROUND_05UP                           *ROUND_05UP..decimal.pyx*
...
class decimal.Clamped                           *Clamped..decimal.pyx*
...
class decimal.DecimalException         *DecimalException..decimal.pyx*

   Base class for other signals and a subclass of "ArithmeticError".

class decimal.DivisionByZero             *DivisionByZero..decimal.pyx*
...
class decimal.Inexact                           *Inexact..decimal.pyx*
...
class decimal.InvalidOperation         *InvalidOperation..decimal.pyx*
...
>
      ...
      x ** Infinity
<
class decimal.Overflow                         *Overflow..decimal.pyx*
...
class decimal.Rounded                           *Rounded..decimal.pyx*
...
class decimal.Subnormal                       *Subnormal..decimal.pyx*
...
class decimal.Underflow                       *Underflow..decimal.pyx*
...
class decimal.FloatOperation             *FloatOperation..decimal.pyx*
