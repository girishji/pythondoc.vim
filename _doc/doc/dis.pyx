*dis.pyx*                                     Last change: 2023 Sep 15
...
class dis.Bytecode(x, *, first_line=None, current_offset=None, show_caches=False, adaptive=False)
   ...
   that may be different from the original bytecode.
                                  ...
                                  *Bytecode.from_traceback()..dis.pyx*
...
dis.code_info(x)                                *code_info()..dis.pyx*
...
dis.show_code(x, *, file=None)                  *show_code()..dis.pyx*
...
dis.findlinestarts(code)                   *findlinestarts()..dis.pyx*
...
class dis.Instruction                           *Instruction..dis.pyx*

   Details for a bytecode operation

   opcode                                   *Instruction.opcode..dis.pyx*
   ...
   opname                                   *Instruction.opname..dis.pyx*

      human readable name for operation

   baseopcode                           *Instruction.baseopcode..dis.pyx*

      numeric code for the base operation if operation is specialized;
      otherwise equal to "opcode"

   baseopname                           *Instruction.baseopname..dis.pyx*

      human readable name for the base operation if operation is
      specialized; otherwise equal to "opname"

   arg                                         *Instruction.arg..dis.pyx*

      numeric argument to operation (if any), otherwise "None"

   oparg                                     *Instruction.oparg..dis.pyx*

      alias for "arg"

   argval                                   *Instruction.argval..dis.pyx*

      resolved arg value (if any), otherwise "None"

   argrepr                                 *Instruction.argrepr..dis.pyx*

      human readable description of operation argument (if any),
      otherwise an empty string.

   offset                                   *Instruction.offset..dis.pyx*

      start index of operation within bytecode sequence

   start_offset                       *Instruction.start_offset..dis.pyx*

      start index of operation within bytecode sequence, including
      prefixed "EXTENDED_ARG" operations if present; otherwise equal
      to "offset"

   cache_offset                       *Instruction.cache_offset..dis.pyx*

      start index of the cache entries following the operation

   end_offset                           *Instruction.end_offset..dis.pyx*

      end index of the cache entries following the operation

   starts_line                         *Instruction.starts_line..dis.pyx*

      "True" if this opcode starts a source line, otherwise "False"

   line_number                         *Instruction.line_number..dis.pyx*

      source line number associated with this opcode (if any),
      otherwise "None"

   is_jump_target                   *Instruction.is_jump_target..dis.pyx*

      "True" if other code jumps to here, otherwise "False"

   jump_target                         *Instruction.jump_target..dis.pyx*

      bytecode index of the jump target if this is a jump operation,
      otherwise "None"

   positions                             *Instruction.positions..dis.pyx*
...
class dis.Positions                               *Positions..dis.pyx*

   In case the information is not available, some fields might be
   "None".

   lineno                                     *Positions.lineno..dis.pyx*

   end_lineno                             *Positions.end_lineno..dis.pyx*

   col_offset                             *Positions.col_offset..dis.pyx*

   end_col_offset                     *Positions.end_col_offset..dis.pyx*
...
dis.opname                                           *opname..dis.pyx*

   Sequence of operation names, indexable using the bytecode.

dis.opmap                                             *opmap..dis.pyx*

   Dictionary mapping operation names to bytecodes.

dis.cmp_op                                           *cmp_op..dis.pyx*

   Sequence of all compare operation names.

dis.hasarg                                           *hasarg..dis.pyx*

   Sequence of bytecodes that use their argument.

   New in version 3.12.

dis.hasconst                                       *hasconst..dis.pyx*

   Sequence of bytecodes that access a constant.

dis.hasfree                                         *hasfree..dis.pyx*
...
dis.hasname                                         *hasname..dis.pyx*

   Sequence of bytecodes that access an attribute by name.

dis.hasjump                                         *hasjump..dis.pyx*
...
dis.haslocal                                       *haslocal..dis.pyx*

   Sequence of bytecodes that access a local variable.

dis.hascompare                                   *hascompare..dis.pyx*

   Sequence of bytecodes of Boolean operations.

dis.hasexc                                           *hasexc..dis.pyx*

   Sequence of bytecodes that set an exception handler.

   New in version 3.12.

dis.hasjrel                                         *hasjrel..dis.pyx*
