*doctest.pyx*                                 Last change: 2023 Sep 15
...
<
That doctest succeeds if "ValueError" is raised, with the "42 is not
...
doctest.DONT_ACCEPT_TRUE_FOR_1   *DONT_ACCEPT_TRUE_FOR_1..doctest.pyx*
...
doctest.DONT_ACCEPT_BLANKLINE     *DONT_ACCEPT_BLANKLINE..doctest.pyx*
...
doctest.NORMALIZE_WHITESPACE       *NORMALIZE_WHITESPACE..doctest.pyx*
...
doctest.ELLIPSIS                               *ELLIPSIS..doctest.pyx*
   ...
   prone to in regular expressions.
                                ...
                                *IGNORE_EXCEPTION_DETAIL..doctest.pyx*
...
doctest.COMPARISON_FLAGS               *COMPARISON_FLAGS..doctest.pyx*

   A bitmask or’ing together all the comparison flags above.

The second group of options controls how test failures are reported:

doctest.REPORT_UDIFF                       *REPORT_UDIFF..doctest.pyx*

   When specified, failures that involve multi-line expected and
   actual outputs are displayed using a unified diff.

doctest.REPORT_CDIFF                       *REPORT_CDIFF..doctest.pyx*

   When specified, failures that involve multi-line expected and
   actual outputs will be displayed using a context diff.

doctest.REPORT_NDIFF                       *REPORT_NDIFF..doctest.pyx*
   ...
   with a caret marking the mismatching column positions.
                              ...
                              *REPORT_ONLY_FIRST_FAILURE..doctest.pyx*
...
doctest.FAIL_FAST                             *FAIL_FAST..doctest.pyx*
...
doctest.REPORTING_FLAGS                 *REPORTING_FLAGS..doctest.pyx*
...
subclassing:
                                  ...
                                  *register_optionflag()..doctest.pyx*
...
doctest.testmod(m=None, name=None, globs=None, verbose=None, report=True, optionflags=0, extraglobs=None, raise_on_error=False, exclude_empty=False)
   ...
   "m.__dict__".
                               ...
                               *run_docstring_examples()..doctest.pyx*
...
reporting flags specific to "unittest" support, via this function:
                             ...
                             *set_unittest_reportflags()..doctest.pyx*
...
class doctest.DocTest(examples, globs, name, filename, lineno, docstring)
   ...
   lineno                                   *DocTest.lineno..doctest.pyx*
   ...
   docstring                             *DocTest.docstring..doctest.pyx*
...
class doctest.Example(source, want, exc_msg=None, lineno=0, indent=0, options=None)
   ...
   source                                   *Example.source..doctest.pyx*
   ...
   exc_msg                                 *Example.exc_msg..doctest.pyx*
   ...
   lineno                                   *Example.lineno..doctest.pyx*
...
class doctest.DocTestFinder(verbose=False, parser=DocTestParser(), recurse=True, exclude_empty=True)
   ...
   "DocTestFinder" defines the following method:
                                   ...
                                   *DocTestFinder.find()..doctest.pyx*
...
class doctest.DocTestParser               *DocTestParser..doctest.pyx*
   ...
   "DocTestParser" defines the following methods:
                            ...
                            *DocTestParser.get_doctest()..doctest.pyx*
   get_doctest(string, globs, name, filename, lineno)
      ...
      more information.
                           ...
                           *DocTestParser.get_examples()..doctest.pyx*
   ...
   parse(string, name='<string>')    *DocTestParser.parse()..doctest.pyx*
...
-------------------
                                            ...
                                            *TestResults..doctest.pyx*
class doctest.TestResults(failed, attempted)

   failed                               *TestResults.failed..doctest.pyx*

      Number of failed tests.

   attempted                         *TestResults.attempted..doctest.pyx*

      Number of attempted tests.

   skipped                             *TestResults.skipped..doctest.pyx*
...
class doctest.DocTestRunner(checker=None, verbose=None, optionflags=0)
   ...
   "DocTestParser" defines the following methods:
                           ...
                           *DocTestRunner.report_start()..doctest.pyx*
   report_start(out, test, example)
      ...
      was passed to "DocTestRunner.run()".
                         ...
                         *DocTestRunner.report_success()..doctest.pyx*
   report_success(out, test, example, got)
      ...
      "DocTestRunner.run()".
                         ...
                         *DocTestRunner.report_failure()..doctest.pyx*
   report_failure(out, test, example, got)
      ...
      "DocTestRunner.run()".
            ...
            *DocTestRunner.report_unexpected_exception()..doctest.pyx*
   ...
   summarize(verbose=None)       *DocTestRunner.summarize()..doctest.pyx*
   ...
   tries                               *DocTestRunner.tries..doctest.pyx*

      Number of attempted examples.

   failures                         *DocTestRunner.failures..doctest.pyx*

      Number of failed examples.

   skips                               *DocTestRunner.skips..doctest.pyx*
...
class doctest.OutputChecker               *OutputChecker..doctest.pyx*
   ...
   "OutputChecker" defines the following methods:
                           ...
                           *OutputChecker.check_output()..doctest.pyx*
   check_output(want, got, optionflags)
      ...
      information about option flags.
                      ...
                      *OutputChecker.output_difference()..doctest.pyx*
...
synthesized code under the debugger:
                                 ...
                                 *script_from_examples()..doctest.pyx*
...
doctest.testsource(module, name)           *testsource()..doctest.pyx*
...
doctest.debug(module, name, pm=False)           *debug()..doctest.pyx*
...
DocTestFailure.test                 *DocTestFailure.test..doctest.pyx*

   The "DocTest" object that was being run when the example failed.

DocTestFailure.example           *DocTestFailure.example..doctest.pyx*

   The "Example" that failed.

DocTestFailure.got                   *DocTestFailure.got..doctest.pyx*

   The example’s actual output.

                                    *UnexpectedException..doctest.pyx*
...
UnexpectedException.test       *UnexpectedException.test..doctest.pyx*

   The "DocTest" object that was being run when the example failed.

                            *UnexpectedException.example..doctest.pyx*
UnexpectedException.example

   The "Example" that failed.

                           *UnexpectedException.exc_info..doctest.pyx*
