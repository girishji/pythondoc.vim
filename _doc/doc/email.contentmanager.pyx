*email.contentmanager.pyx*                    Last change: 2023 Sep 15
...
New in version 3.6: [1]
                            ...
                            *ContentManager..email.contentmanager.pyx*
class email.contentmanager.ContentManager
   ...
   dispatch methods.
              ...
              *ContentManager.get_content()..email.contentmanager.pyx*
   get_content(msg, *args, **kw)
      ...
      the full MIME type.
              ...
              *ContentManager.set_content()..email.contentmanager.pyx*
   set_content(msg, obj, *args, **kw)
      ...
      "MIMEPart").
          ...
          *ContentManager.add_get_handler()..email.contentmanager.pyx*
   add_get_handler(key, handler)

      Record the function _handler_ as the handler for _key_.  For the
      possible values of _key_, see "get_content()".

          *ContentManager.add_set_handler()..email.contentmanager.pyx*
...
and its derivatives.
                          ...
                          *raw_data_manager..email.contentmanager.pyx*
email.contentmanager.raw_data_manager
   ...
   multipart messages.
                             ...
                             *get_content()..email.contentmanager.pyx*
   email.contentmanager.get_content(msg, errors='replace')
      ...
      handler is "replace".
                             ...
                             *set_content()..email.contentmanager.pyx*
