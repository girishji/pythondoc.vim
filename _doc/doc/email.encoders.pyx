*email.encoders.pyx*                          Last change: 2023 Sep 15
...
Here are the encoding functions provided:
                                 ...
                                 *encode_quopri()..email.encoders.pyx*
email.encoders.encode_quopri(msg)
   ...
   printable data, but contains a few unprintable characters.
                                 ...
                                 *encode_base64()..email.encoders.pyx*
email.encoders.encode_base64(msg)
   ...
   encoding is that it renders the text non-human readable.
                                ...
                                *encode_7or8bit()..email.encoders.pyx*
...
email.encoders.encode_noop(msg)    *encode_noop()..email.encoders.pyx*
