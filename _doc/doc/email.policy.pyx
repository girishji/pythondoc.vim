*email.policy.pyx*                            Last change: 2023 Sep 15
...
>
   ...
   100
<
class email.policy.Policy(**kw)             *Policy..email.policy.pyx*
   ...
   max_line_length             *Policy.max_line_length..email.policy.pyx*
   ...
   linesep                             *Policy.linesep..email.policy.pyx*
   ...
   cte_type                           *Policy.cte_type..email.policy.pyx*
   ...
   raise_on_defect             *Policy.raise_on_defect..email.policy.pyx*
   ...
   mangle_from_                   *Policy.mangle_from_..email.policy.pyx*
   ...
   message_factory             *Policy.message_factory..email.policy.pyx*
   ...
   clone(**kw)                         *Policy.clone()..email.policy.pyx*
   ...
   email package. A custom policy must implement all of these methods.
                            ...
                            *Policy.handle_defect()..email.policy.pyx*
   handle_defect(obj, defect)
      ...
      "register_defect()".
                          ...
                          *Policy.register_defect()..email.policy.pyx*
   ...
   header_max_count(name)   *Policy.header_max_count()..email.policy.pyx*
      ...
      The default implementation returns "None" for all header names.
                      ...
                      *Policy.header_source_parse()..email.policy.pyx*
   header_source_parse(sourcelines)
      ...
      There is no default implementation
                       ...
                       *Policy.header_store_parse()..email.policy.pyx*
   header_store_parse(name, value)
      ...
      There is no default implementation
                       ...
                       *Policy.header_fetch_parse()..email.policy.pyx*
   ...
   fold(name, value)                    *Policy.fold()..email.policy.pyx*
   ...
   fold_binary(name, value)      *Policy.fold_binary()..email.policy.pyx*
...
class email.policy.EmailPolicy(**kw)   *EmailPolicy..email.policy.pyx*
   ...
   utf8                              *EmailPolicy.utf8..email.policy.pyx*
   ...
   refold_source            *EmailPolicy.refold_source..email.policy.pyx*
   ...
   header_factory          *EmailPolicy.header_factory..email.policy.pyx*
   ...
   content_manager        *EmailPolicy.content_manager..email.policy.pyx*
   ...
   abstract methods of "Policy":
                    ...
                    *EmailPolicy.header_max_count()..email.policy.pyx*
   header_max_count(name)
      ...
      name.
                 ...
                 *EmailPolicy.header_source_parse()..email.policy.pyx*
   header_source_parse(sourcelines)
      ...
      return or linefeed characters.
                  ...
                  *EmailPolicy.header_store_parse()..email.policy.pyx*
   header_store_parse(name, value)
      ...
      input value contains CR or LF characters.
                  ...
                  *EmailPolicy.header_fetch_parse()..email.policy.pyx*
   header_fetch_parse(name, value)
   ...
   fold(name, value)               *EmailPolicy.fold()..email.policy.pyx*
      ...
      charset.
                         ...
                         *EmailPolicy.fold_binary()..email.policy.pyx*
...
class email.policy.Compat32(**kw)         *Compat32..email.policy.pyx*
   ...
   mangle_from_                 *Compat32.mangle_from_..email.policy.pyx*
   ...
   abstract methods of "Policy":
                    ...
                    *Compat32.header_source_parse()..email.policy.pyx*
   header_source_parse(sourcelines)
      ...
      return or linefeed characters.
                     ...
                     *Compat32.header_store_parse()..email.policy.pyx*
   header_store_parse(name, value)

      The name and value are returned unmodified.

                     *Compat32.header_fetch_parse()..email.policy.pyx*
   header_fetch_parse(name, value)
   ...
   fold(name, value)                  *Compat32.fold()..email.policy.pyx*
   ...
   fold_binary(name, value)    *Compat32.fold_binary()..email.policy.pyx*
...
email.policy.compat32                     *compat32..email.policy.pyx*
