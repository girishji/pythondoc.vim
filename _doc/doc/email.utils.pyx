*email.utils.pyx*                             Last change: 2023 Sep 15
...
email.utils.localtime(dt=None)          *localtime()..email.utils.pyx*
...
email.utils.quote(str)                      *quote()..email.utils.pyx*

   Return a new string with backslashes in _str_ replaced by two
   backslashes, and double quotes replaced by backslash-double quote.

email.utils.unquote(str)                  *unquote()..email.utils.pyx*
...
email.utils.parseaddr(address)          *parseaddr()..email.utils.pyx*
...
<
email.utils.parsedate(date)             *parsedate()..email.utils.pyx*
...
email.utils.parsedate_tz(date)       *parsedate_tz()..email.utils.pyx*
   ...
   Note that indexes 6, 7, and 8 of the result tuple are not usable.
                            ...
                            *parsedate_to_datetime()..email.utils.pyx*
...
email.utils.mktime_tz(tuple)            *mktime_tz()..email.utils.pyx*
...
<
   ...
   "False".
                                  ...
                                  *format_datetime()..email.utils.pyx*
...
email.utils.decode_rfc2231(s)      *decode_rfc2231()..email.utils.pyx*

   Decode the string _s_ according to **RFC 2231**.

                                   *encode_rfc2231()..email.utils.pyx*
email.utils.encode_rfc2231(s, charset=None, language=None)
   ...
   using the empty string for _language_.
                           ...
                           *collapse_rfc2231_value()..email.utils.pyx*
...
email.utils.decode_params(params)   *decode_params()..email.utils.pyx*
