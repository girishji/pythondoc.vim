*enum.pyx*                                    Last change: 2023 Sep 15
...
class enum.EnumType                               *EnumType..enum.pyx*
   ...
   __contains__(cls, member)          *EnumType.__contains__()..enum.pyx*
...
<
   ...
   __dir__(cls)                            *EnumType.__dir__()..enum.pyx*
...
<
   __getitem__(cls, name)              *EnumType.__getitem__()..enum.pyx*
...
>
         ...
         <Color.BLUE: 3>
<
   __iter__(cls)                          *EnumType.__iter__()..enum.pyx*
...
<
   __len__(cls)                            *EnumType.__len__()..enum.pyx*
...
>
         ...
         3
<
   __reversed__(cls)                  *EnumType.__reversed__()..enum.pyx*
...
class enum.Enum                                       *Enum..enum.pyx*

   _Enum_ is the base class for all _enum_ enumerations.

   name                                             *Enum.name..enum.pyx*
...
<
   ...
   _ignore_                                     *Enum._ignore_..enum.pyx*
   ...
   __dir__(self)                               *Enum.__dir__()..enum.pyx*
...
<
                              ...
                              *Enum._generate_next_value_()..enum.pyx*
...
>
         ...
         9
<
   __init_subclass__(cls, \**kwds)   *Enum.__init_subclass__()..enum.pyx*

      A _classmethod_ that is used to further configure subsequent
      subclasses. By default, does nothing.

   _missing_(cls, value)                     *Enum._missing_()..enum.pyx*
...
>
         ...
         <Build.DEBUG: 'debug'>
<
   __repr__(self)                             *Enum.__repr__()..enum.pyx*
...
<
   __str__(self)                               *Enum.__str__()..enum.pyx*
...
<
   __format__(self)                         *Enum.__format__()..enum.pyx*
...
class enum.IntEnum                                 *IntEnum..enum.pyx*
...
class enum.StrEnum                                 *StrEnum..enum.pyx*
...
class enum.Flag                                       *Flag..enum.pyx*
   ...
   __contains__(self, value)              *Flag.__contains__()..enum.pyx*
...
>
         ...
         False
<
   __or__(self, other)                          *Flag.__or__()..enum.pyx*
...
>
         ...
         <Color.RED|GREEN: 3>
<
   __and__(self, other)                        *Flag.__and__()..enum.pyx*
...
>
         ...
         <Color: 0>
<
   __xor__(self, other)                        *Flag.__xor__()..enum.pyx*
...
>
         ...
         <Color.GREEN|BLUE: 6>
<
   _numeric_repr_()                     *Flag._numeric_repr_()..enum.pyx*
...
class enum.IntFlag                                 *IntFlag..enum.pyx*
...
class enum.ReprEnum                               *ReprEnum..enum.pyx*
...
class enum.EnumCheck                             *EnumCheck..enum.pyx*
   ...
   UNIQUE                                    *EnumCheck.UNIQUE..enum.pyx*
...
<
   CONTINUOUS                            *EnumCheck.CONTINUOUS..enum.pyx*
...
<
   NAMED_FLAGS                          *EnumCheck.NAMED_FLAGS..enum.pyx*
...
>
         ...
         ValueError: <flag 'StrictFlag'> invalid value 20
           ...
           allowed 0b0 00111
<
   CONFORM                               *FlagBoundary.CONFORM..enum.pyx*
...
>
         ...
         <ConformFlag.BLUE: 4>
<
   EJECT                                   *FlagBoundary.EJECT..enum.pyx*
   ...
   KEEP                                     *FlagBoundary.KEEP..enum.pyx*
...
class enum.auto                                       *auto..enum.pyx*
   ...
   assignment:
      ...
      * "THREE = [auto(), -3]" will _not_ work ("<auto instance>, -3"
...
@enum.property                                  *property()..enum.pyx*
...
@enum.member                                      *member()..enum.pyx*

   A decorator for use in enums: its target will become a member.

   New in version 3.11.

@enum.nonmember                                *nonmember()..enum.pyx*

   A decorator for use in enums: its target will not become a member.

   New in version 3.11.

@enum.global_enum                            *global_enum()..enum.pyx*
...
enum.show_flag_values(value)            *show_flag_values()..enum.pyx*
