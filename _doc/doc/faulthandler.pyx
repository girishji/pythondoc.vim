*faulthandler.pyx*                            Last change: 2023 Sep 15
...
=====================
                                  ...
                                  *dump_traceback()..faulthandler.pyx*
...
faulthandler.disable()                   *disable()..faulthandler.pyx*

   Disable the fault handler: uninstall the signal handlers installed
   by "enable()".

faulthandler.is_enabled()             *is_enabled()..faulthandler.pyx*
...
======================================
                            ...
                            *dump_traceback_later()..faulthandler.pyx*
faulthandler.dump_traceback_later(timeout, repeat=False, file=sys.stderr, exit=False)
   ...
   to this function.
                     ...
                     *cancel_dump_traceback_later()..faulthandler.pyx*
...
faulthandler.unregister(signum)       *unregister()..faulthandler.pyx*
