*filecmp.pyx*                                 Last change: 2023 Sep 15
...
filecmp.cmp(f1, f2, shallow=True)                 *cmp()..filecmp.pyx*
...
filecmp.clear_cache()                     *clear_cache()..filecmp.pyx*
...
class filecmp.dircmp(a, b, ignore=None, hide=None)
   ...
   report()                                *dircmp.report()..filecmp.pyx*

      Print (to "sys.stdout") a comparison between _a_ and _b_.

                        *dircmp.report_partial_closure()..filecmp.pyx*
   report_partial_closure()

      Print a comparison between _a_ and _b_ and common immediate
      subdirectories.

   report_full_closure()      *dircmp.report_full_closure()..filecmp.pyx*
...
filecmp.DEFAULT_IGNORES                 *DEFAULT_IGNORES..filecmp.pyx*
