*fractions.pyx*                               Last change: 2023 Sep 15
...
<
   ...
   numerator                          *Fraction.numerator..fractions.pyx*

      Numerator of the Fraction in lowest term.

   denominator                      *Fraction.denominator..fractions.pyx*

      Denominator of the Fraction in lowest term.

   as_integer_ratio()        *Fraction.as_integer_ratio()..fractions.pyx*
   ...
   is_integer()                    *Fraction.is_integer()..fractions.pyx*

      Return "True" if the Fraction is an integer.

      New in version 3.12.

   classmethod from_float(flt)     *Fraction.from_float()..fractions.pyx*
      ...
      Note:
        ...
        instance directly from a "float".
                              ...
                              *Fraction.from_decimal()..fractions.pyx*
   classmethod from_decimal(dec)
      ...
      Note:
        ...
        instance directly from a "decimal.Decimal" instance.
                         ...
                         *Fraction.limit_denominator()..fractions.pyx*
   ...
   __floor__()                      *Fraction.__floor__()..fractions.pyx*
   ...
   __format__(format_spec, /)      *Fraction.__format__()..fractions.pyx*
