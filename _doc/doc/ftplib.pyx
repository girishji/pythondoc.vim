*ftplib.pyx*                                  Last change: 2023 Sep 15
...
FTP.set_debuglevel(level)           *FTP.set_debuglevel()..ftplib.pyx*
...
FTP.getwelcome()                        *FTP.getwelcome()..ftplib.pyx*
...
FTP.voidcmd(cmd)                           *FTP.voidcmd()..ftplib.pyx*
...
FTP.retrlines(cmd, callback=None)        *FTP.retrlines()..ftplib.pyx*
...
FTP.storlines(cmd, fp, callback=None)    *FTP.storlines()..ftplib.pyx*
...
FTP.transfercmd(cmd, rest=None)        *FTP.transfercmd()..ftplib.pyx*
...
FTP.ntransfercmd(cmd, rest=None)      *FTP.ntransfercmd()..ftplib.pyx*
...
FTP.mlsd(path='', facts=[])                   *FTP.mlsd()..ftplib.pyx*
...
FTP.nlst(argument[, ...])                     *FTP.nlst()..ftplib.pyx*
...
FTP.dir(argument[, ...])                       *FTP.dir()..ftplib.pyx*
...
FTP.rename(fromname, toname)                *FTP.rename()..ftplib.pyx*

   Rename file _fromname_ on the server to _toname_.

FTP.delete(filename)                        *FTP.delete()..ftplib.pyx*
...
FTP.cwd(pathname)                              *FTP.cwd()..ftplib.pyx*

   Set the current directory on the server.

FTP.mkd(pathname)                              *FTP.mkd()..ftplib.pyx*

   Create a new directory on the server.

FTP.pwd()                                      *FTP.pwd()..ftplib.pyx*

   Return the pathname of the current directory on the server.

FTP.rmd(dirname)                               *FTP.rmd()..ftplib.pyx*

   Remove the directory named _dirname_ on the server.

FTP.size(filename)                            *FTP.size()..ftplib.pyx*
...
FTP.close()                                  *FTP.close()..ftplib.pyx*
...
FTP_TLS.ssl_version                  *FTP_TLS.ssl_version..ftplib.pyx*

   The SSL version to use (defaults to "ssl.PROTOCOL_SSLv23").

FTP_TLS.auth()                            *FTP_TLS.auth()..ftplib.pyx*
...
FTP_TLS.ccc()                              *FTP_TLS.ccc()..ftplib.pyx*
...
FTP_TLS.prot_p()                        *FTP_TLS.prot_p()..ftplib.pyx*

   Set up secure data connection.

FTP_TLS.prot_c()                        *FTP_TLS.prot_c()..ftplib.pyx*
