*functions.pyx*                               Last change: 2023 Sep 15
...
aiter(async_iterable)                         *aiter()..functions.pyx*
...
all(iterable)                                   *all()..functions.pyx*
...
>
      def all(iterable):
          ...
          return True
<
awaitable anext(async_iterator)               *anext()..functions.pyx*
...
any(iterable)                                   *any()..functions.pyx*
...
>
      def any(iterable):
          ...
          return False
<
ascii(object)                                 *ascii()..functions.pyx*
...
class bool(x=False)                              *bool..functions.pyx*
...
breakpoint(*args, **kws)                 *breakpoint()..functions.pyx*
...
class bytearray(source=b'')                 *bytearray..functions.pyx*
...
class bytes(source=b'')                         *bytes..functions.pyx*
...
callable(object)                           *callable()..functions.pyx*
...
@classmethod                            *classmethod()..functions.pyx*
...
class complex(real=0, imag=0)                 *complex..functions.pyx*
...
delattr(object, name)                       *delattr()..functions.pyx*
...
class dict(**kwarg)                              *dict..functions.pyx*
...
divmod(a, b)                                 *divmod()..functions.pyx*
...
enumerate(iterable, start=0)              *enumerate()..functions.pyx*
...
>
      def enumerate(iterable, start=0):
          ...
          for elem in iterable:
              ...
              n += 1
<
eval(expression, globals=None, locals=None)    *eval()..functions.pyx*
...
filter(function, iterable)                   *filter()..functions.pyx*
...
class float(x=0.0)                              *float..functions.pyx*
...
format(value, format_spec='')                *format()..functions.pyx*
...
class frozenset(iterable=set())             *frozenset..functions.pyx*
...
getattr(object, name)                       *getattr()..functions.pyx*
...
hasattr(object, name)                       *hasattr()..functions.pyx*
...
hash(object)                                   *hash()..functions.pyx*
...
class int(x=0)                                    *int..functions.pyx*
class int(x, base=10)
...
isinstance(object, classinfo)            *isinstance()..functions.pyx*
...
issubclass(class, classinfo)             *issubclass()..functions.pyx*
...
iter(object)                                   *iter()..functions.pyx*
...
map(function, iterable, *iterables)             *map()..functions.pyx*
...
max(iterable, *, key=None)                      *max()..functions.pyx*
...
class memoryview(object)                   *memoryview..functions.pyx*

   Return a “memory view” object created from the given argument.  See
   Memory Views for more information.

min(iterable, *, key=None)                      *min()..functions.pyx*
...
next(iterator)                                 *next()..functions.pyx*
...
class object                                   *object..functions.pyx*
...
pow(base, exp, mod=None)                        *pow()..functions.pyx*
...
class range(stop)                               *range..functions.pyx*
...
repr(object)                                   *repr()..functions.pyx*
...
reversed(seq)                              *reversed()..functions.pyx*
...
round(number, ndigits=None)                   *round()..functions.pyx*
...
setattr(object, name, value)                *setattr()..functions.pyx*
...
class slice(stop)                               *slice..functions.pyx*
...
@staticmethod                          *staticmethod()..functions.pyx*
...
class str(object='')                              *str..functions.pyx*
...
sum(iterable, /, start=0)                       *sum()..functions.pyx*
...
class super                                     *super..functions.pyx*
...
class tuple                                     *tuple..functions.pyx*
...
class type(object)                               *type..functions.pyx*
...
zip(*iterables, strict=False)                   *zip()..functions.pyx*
