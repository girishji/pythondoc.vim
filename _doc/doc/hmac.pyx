*hmac.pyx*                                    Last change: 2023 Sep 15
...
hmac.new(key, msg=None, digestmod='')                *new()..hmac.pyx*
...
hmac.digest(key, msg, digest)                     *digest()..hmac.pyx*
...
HMAC.update(msg)                             *HMAC.update()..hmac.pyx*
...
HMAC.digest()                                *HMAC.digest()..hmac.pyx*
...
HMAC.hexdigest()                          *HMAC.hexdigest()..hmac.pyx*
...
HMAC.digest_size                          *HMAC.digest_size..hmac.pyx*

   The size of the resulting HMAC digest in bytes.

HMAC.block_size                            *HMAC.block_size..hmac.pyx*

   The internal block size of the hash algorithm in bytes.

   New in version 3.4.

HMAC.name                                        *HMAC.name..hmac.pyx*
...
hmac.compare_digest(a, b)                 *compare_digest()..hmac.pyx*
