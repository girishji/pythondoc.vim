*howto-pyporting.pyx*                         Last change: 2023 Sep 15
...
8. Consider using optional static type checking to make sure your type
   usage works in both Python 2 and 3 (e.g. use mypy to check your
   typing under both Python 2 and Python 3; "python -m pip install
   mypy").
