*html.entities.pyx*                           Last change: 2023 Sep 15
...
html.entities.html5                         *html5..html.entities.pyx*
...
html.entities.entitydefs               *entitydefs..html.entities.pyx*

   A dictionary mapping XHTML 1.0 entity definitions to their
   replacement text in ISO Latin-1.

html.entities.name2codepoint       *name2codepoint..html.entities.pyx*

   A dictionary that maps HTML4 entity names to the Unicode code
   points.

html.entities.codepoint2name       *codepoint2name..html.entities.pyx*
