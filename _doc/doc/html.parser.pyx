*html.parser.pyx*                             Last change: 2023 Sep 15
...
HTMLParser.feed(data)             *HTMLParser.feed()..html.parser.pyx*
...
HTMLParser.close()               *HTMLParser.close()..html.parser.pyx*
...
HTMLParser.reset()               *HTMLParser.reset()..html.parser.pyx*

   Reset the instance.  Loses all unprocessed data.  This is called
   implicitly at instantiation time.

HTMLParser.getpos()             *HTMLParser.getpos()..html.parser.pyx*

   Return current line number and offset.

                     *HTMLParser.get_starttag_text()..html.parser.pyx*
...
"handle_startendtag()"):
                       ...
                       *HTMLParser.handle_starttag()..html.parser.pyx*
HTMLParser.handle_starttag(tag, attrs)
   ...
   attribute values.
                         ...
                         *HTMLParser.handle_endtag()..html.parser.pyx*
HTMLParser.handle_endtag(tag)
   ...
   The _tag_ argument is the name of the tag converted to lower case.
                    ...
                    *HTMLParser.handle_startendtag()..html.parser.pyx*
HTMLParser.handle_startendtag(tag, attrs)
   ...
   "handle_starttag()" and "handle_endtag()".
                           ...
                           *HTMLParser.handle_data()..html.parser.pyx*
HTMLParser.handle_data(data)
   ...
   "<style>...</style>").
                      ...
                      *HTMLParser.handle_entityref()..html.parser.pyx*
HTMLParser.handle_entityref(name)
   ...
   _convert_charrefs_ is "True".
                        ...
                        *HTMLParser.handle_charref()..html.parser.pyx*
HTMLParser.handle_charref(name)
   ...
   _convert_charrefs_ is "True".
                        ...
                        *HTMLParser.handle_comment()..html.parser.pyx*
HTMLParser.handle_comment(data)
   ...
   "'[if IE 9]>IE9-specific content<![endif]'".
                           ...
                           *HTMLParser.handle_decl()..html.parser.pyx*
...
HTMLParser.handle_pi(data)   *HTMLParser.handle_pi()..html.parser.pyx*
   ...
   Note:
     ...
     the trailing "'?'" will cause the "'?'" to be included in _data_.
                          ...
                          *HTMLParser.unknown_decl()..html.parser.pyx*
