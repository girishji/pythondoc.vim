*importlib.pyx*                               Last change: 2023 Sep 15
...
importlib.invalidate_caches()     *invalidate_caches()..importlib.pyx*
...
importlib.reload(module)                     *reload()..importlib.pyx*
    ...
    +-- Loader
         ...
         +-- InspectLoader          |
              +-- ExecutionLoader --+
                                    ...
                                    +-- SourceLoader
<
class importlib.abc.MetaPathFinder     *MetaPathFinder..importlib.pyx*
   ...
   Changed in version 3.10: No longer a subclass of "Finder".
                           ...
                           *MetaPathFinder.find_spec()..importlib.pyx*
   find_spec(fullname, path, target=None)
      ...
      New in version 3.4.
                   ...
                   *MetaPathFinder.invalidate_caches()..importlib.pyx*
   invalidate_caches()
...
class importlib.abc.PathEntryFinder   *PathEntryFinder..importlib.pyx*
   ...
   Changed in version 3.10: No longer a subclass of "Finder".
                          ...
                          *PathEntryFinder.find_spec()..importlib.pyx*
   find_spec(fullname, target=None)
      ...
      New in version 3.4.
                  ...
                  *PathEntryFinder.invalidate_caches()..importlib.pyx*
   invalidate_caches()
...
class importlib.abc.Loader                     *Loader..importlib.pyx*
   ...
   create_module(spec)            *Loader.create_module()..importlib.pyx*
   ...
   exec_module(module)              *Loader.exec_module()..importlib.pyx*
   ...
   load_module(fullname)            *Loader.load_module()..importlib.pyx*
...
class importlib.abc.ResourceLoader     *ResourceLoader..importlib.pyx*
   ...
   **PEP 302** protocol for loading arbitrary resources from the
   ...
   "importlib.resources.abc.ResourceReader".
                            ...
                            *ResourceLoader.get_data()..importlib.pyx*
...
class importlib.abc.InspectLoader       *InspectLoader..importlib.pyx*

   An abstract base class for a _loader_ which implements the optional
   **PEP 302** protocol for loaders that inspect modules.

   get_code(fullname)           *InspectLoader.get_code()..importlib.pyx*
      ...
      implementation is provided.
                           ...
                           *InspectLoader.get_source()..importlib.pyx*
   ...
   is_package(fullname)       *InspectLoader.is_package()..importlib.pyx*
      ...
      "NotImplementedError".
                       ...
                       *InspectLoader.source_to_code()..importlib.pyx*
   ...
   exec_module(module)       *InspectLoader.exec_module()..importlib.pyx*

      Implementation of "Loader.exec_module()".

      New in version 3.4.

   load_module(fullname)     *InspectLoader.load_module()..importlib.pyx*

      Implementation of "Loader.load_module()".

      Deprecated since version 3.4: use "exec_module()" instead.

class importlib.abc.ExecutionLoader   *ExecutionLoader..importlib.pyx*
   ...
   ABC represents an optional **PEP 302** protocol.
                       ...
                       *ExecutionLoader.get_filename()..importlib.pyx*
...
class importlib.abc.FileLoader(fullname, path)
   ...
   name                                  *FileLoader.name..importlib.pyx*

      The name of the module the loader can handle.

   path                                  *FileLoader.path..importlib.pyx*

      Path to the file of the module.

   load_module(fullname)        *FileLoader.load_module()..importlib.pyx*
      ...
      instead.
                            ...
                            *FileLoader.get_filename()..importlib.pyx*
   abstractmethod get_filename(fullname)

      Returns "path".

   abstractmethod get_data(path)   *FileLoader.get_data()..importlib.pyx*

      Reads _path_ as a binary file and returns the bytes from it.

class importlib.abc.SourceLoader         *SourceLoader..importlib.pyx*
   ...
   * "ExecutionLoader.get_filename()"
   ...
   path_stats(path)            *SourceLoader.path_stats()..importlib.pyx*
   ...
   path_mtime(path)            *SourceLoader.path_mtime()..importlib.pyx*
   ...
   set_data(path, data)          *SourceLoader.set_data()..importlib.pyx*
   ...
   get_code(fullname)            *SourceLoader.get_code()..importlib.pyx*

      Concrete implementation of "InspectLoader.get_code()".

   exec_module(module)        *SourceLoader.exec_module()..importlib.pyx*

      Concrete implementation of "Loader.exec_module()".

      New in version 3.4.

   load_module(fullname)      *SourceLoader.load_module()..importlib.pyx*

      Concrete implementation of "Loader.load_module()".

      Deprecated since version 3.4: Use "exec_module()" instead.

   get_source(fullname)        *SourceLoader.get_source()..importlib.pyx*

      Concrete implementation of "InspectLoader.get_source()".

   is_package(fullname)        *SourceLoader.is_package()..importlib.pyx*
...
importlib.machinery.SOURCE_SUFFIXES   *SOURCE_SUFFIXES..importlib.pyx*
   ...
   New in version 3.3.
                              ...
                              *DEBUG_BYTECODE_SUFFIXES..importlib.pyx*
importlib.machinery.DEBUG_BYTECODE_SUFFIXES
   ...
   Deprecated since version 3.5: Use "BYTECODE_SUFFIXES" instead.
                          ...
                          *OPTIMIZED_BYTECODE_SUFFIXES..importlib.pyx*
importlib.machinery.OPTIMIZED_BYTECODE_SUFFIXES
   ...
   Deprecated since version 3.5: Use "BYTECODE_SUFFIXES" instead.
                                    ...
                                    *BYTECODE_SUFFIXES..importlib.pyx*
importlib.machinery.BYTECODE_SUFFIXES
   ...
   "__debug__".
                                   ...
                                   *EXTENSION_SUFFIXES..importlib.pyx*
...
importlib.machinery.all_suffixes()     *all_suffixes()..importlib.pyx*
...
class importlib.machinery.FrozenImporter
   ...
   "exec_module()" methods.
                                ...
                                *WindowsRegistryFinder..importlib.pyx*
...
class importlib.machinery.PathFinder       *PathFinder..importlib.pyx*
   ...
   for instantiation.
                               ...
                               *PathFinder.find_spec()..importlib.pyx*
   classmethod find_spec(fullname, path=None, target=None)
      ...
      is returned but no value is cached in "sys.path_importer_cache".
                       ...
                       *PathFinder.invalidate_caches()..importlib.pyx*
...
class importlib.machinery.FileFinder(path, *loader_details)
   ...
   path                                  *FileFinder.path..importlib.pyx*

      The path the finder will search in.

                               *FileFinder.find_spec()..importlib.pyx*
   find_spec(fullname, target=None)
   ...
   invalidate_caches()    *FileFinder.invalidate_caches()..importlib.pyx*

      Clear out the internal cache.

                               *FileFinder.path_hook()..importlib.pyx*
   classmethod path_hook(*loader_details)
      ...
      "ImportError" is raised.
                                     ...
                                     *SourceFileLoader..importlib.pyx*
class importlib.machinery.SourceFileLoader(fullname, path)
   ...
   name                            *SourceFileLoader.name..importlib.pyx*

      The name of the module that this loader will handle.

   path                            *SourceFileLoader.path..importlib.pyx*

      The path to the source file.

   is_package(fullname)    *SourceFileLoader.is_package()..importlib.pyx*

      Return "True" if "path" appears to be for a package.

   path_stats(path)        *SourceFileLoader.path_stats()..importlib.pyx*

      Concrete implementation of
      "importlib.abc.SourceLoader.path_stats()".

   set_data(path, data)      *SourceFileLoader.set_data()..importlib.pyx*

      Concrete implementation of
      "importlib.abc.SourceLoader.set_data()".

                       *SourceFileLoader.load_module()..importlib.pyx*
   load_module(name=None)
      ...
      "importlib.abc.Loader.exec_module()" instead.
                                 ...
                                 *SourcelessFileLoader..importlib.pyx*
class importlib.machinery.SourcelessFileLoader(fullname, path)
   ...
   name                        *SourcelessFileLoader.name..importlib.pyx*

      The name of the module the loader will handle.

   path                        *SourcelessFileLoader.path..importlib.pyx*

      The path to the bytecode file.

                    *SourcelessFileLoader.is_package()..importlib.pyx*
   is_package(fullname)

      Determines if the module is a package based on "path".

   get_code(fullname)    *SourcelessFileLoader.get_code()..importlib.pyx*

      Returns the code object for "name" created from "path".

                    *SourcelessFileLoader.get_source()..importlib.pyx*
   get_source(fullname)

      Returns "None" as bytecode files have no source when this loader
      is used.

                   *SourcelessFileLoader.load_module()..importlib.pyx*
   load_module(name=None)
   ...
   "importlib.abc.Loader.exec_module()" instead.
                                  ...
                                  *ExtensionFileLoader..importlib.pyx*
class importlib.machinery.ExtensionFileLoader(fullname, path)
   ...
   name                         *ExtensionFileLoader.name..importlib.pyx*

      Name of the module the loader supports.

   path                         *ExtensionFileLoader.path..importlib.pyx*

      Path to the extension module.

                  *ExtensionFileLoader.create_module()..importlib.pyx*
   create_module(spec)
      ...
      New in version 3.5.
                    ...
                    *ExtensionFileLoader.exec_module()..importlib.pyx*
   exec_module(module)
      ...
      New in version 3.5.
                     ...
                     *ExtensionFileLoader.is_package()..importlib.pyx*
   is_package(fullname)

      Returns "True" if the file path points to a package’s "__init__"
      module based on "EXTENSION_SUFFIXES".

   get_code(fullname)     *ExtensionFileLoader.get_code()..importlib.pyx*

      Returns "None" as extension modules lack a code object.

                     *ExtensionFileLoader.get_source()..importlib.pyx*
   get_source(fullname)

      Returns "None" as extension modules do not have source code.

                   *ExtensionFileLoader.get_filename()..importlib.pyx*
...
class importlib.machinery.ModuleSpec(name, loader, *, origin=None, loader_state=None, is_package=None)
   ...
   name                                  *ModuleSpec.name..importlib.pyx*
   ...
   loader                              *ModuleSpec.loader..importlib.pyx*
   ...
   origin                              *ModuleSpec.origin..importlib.pyx*
   ...
   one (like for namespace packages), it should be set to "None".
                ...
                *ModuleSpec.submodule_search_locations..importlib.pyx*
   ...
   loader_state                  *ModuleSpec.loader_state..importlib.pyx*
   ...
   cached                              *ModuleSpec.cached..importlib.pyx*
   ...
   parent                              *ModuleSpec.parent..importlib.pyx*
   ...
   has_location                  *ModuleSpec.has_location..importlib.pyx*
...
importlib.util.MAGIC_NUMBER              *MAGIC_NUMBER..importlib.pyx*
   ...
   New in version 3.4.
                                  ...
                                  *cache_from_source()..importlib.pyx*
importlib.util.cache_from_source(path, debug_override=None, *, optimization=None)
   ...
   Changed in version 3.6: Accepts a _path-like object_.
                                  ...
                                  *source_from_cache()..importlib.pyx*
...
importlib.util.find_spec(name, package=None)
   ...
   **name** and **package** work the same as for "import_module()".
   ...
   lacks a "__path__" attribute).
                                   ...
                                   *module_from_spec()..importlib.pyx*
importlib.util.module_from_spec(spec)
   ...
   **spec** or setting an attribute on the module.
   ...
   New in version 3.5.
                                   ...
                                   *spec_from_loader()..importlib.pyx*
importlib.util.spec_from_loader(name, loader, *, origin=None, is_package=None)
   ...
   New in version 3.4.
                            ...
                            *spec_from_file_location()..importlib.pyx*
...
importlib.util.source_hash(source_bytes)
   ...
   New in version 3.7.
        ...
        *_incompatible_extension_module_restrictions()..importlib.pyx*
...
class importlib.util.LazyLoader(loader)    *LazyLoader..importlib.pyx*
   ...
   classmethod factory(loader)      *LazyLoader.factory()..importlib.pyx*
