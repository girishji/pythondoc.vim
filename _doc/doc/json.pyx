*json.pyx*                                    Last change: 2023 Sep 15
...
class json.JSONDecoder(*, object_hook=None, parse_float=None, parse_int=None, parse_constant=None, strict=True, object_pairs_hook=None)
   ...
   decode(s)                             *JSONDecoder.decode()..json.pyx*
   ...
   raw_decode(s)                     *JSONDecoder.raw_decode()..json.pyx*
...
class json.JSONEncoder(*, skipkeys=False, ensure_ascii=True, check_circular=True, allow_nan=True, sort_keys=False, indent=None, separators=None, default=None)
   ...
   default(o)                           *JSONEncoder.default()..json.pyx*
...
<
   encode(o)                             *JSONEncoder.encode()..json.pyx*
...
>
         ...
         '{"foo": ["bar", "baz"]}'
<
   iterencode(o)                     *JSONEncoder.iterencode()..json.pyx*
...
==========
                                           ...
                                           *JSONDecodeError..json.pyx*
exception json.JSONDecodeError(msg, doc, pos)

   Subclass of "ValueError" with the following additional attributes:

   msg                                    *JSONDecodeError.msg..json.pyx*

      The unformatted error message.

   doc                                    *JSONDecodeError.doc..json.pyx*

      The JSON document being parsed.

   pos                                    *JSONDecodeError.pos..json.pyx*

      The start index of _doc_ where parsing failed.

   lineno                              *JSONDecodeError.lineno..json.pyx*

      The line corresponding to _pos_.

   colno                                *JSONDecodeError.colno..json.pyx*
