*locale.pyx*                                  Last change: 2023 Sep 15
...
exception locale.Error                             *Error..locale.pyx*

   Exception raised when the locale passed to "setlocale()" is not
   recognized.

locale.setlocale(category, locale=None)      *setlocale()..locale.pyx*
...
locale.localeconv()                         *localeconv()..locale.pyx*
...
locale.nl_langinfo(option)                 *nl_langinfo()..locale.pyx*
   ...
   locale.CRNCYSTR                                 *CRNCYSTR..locale.pyx*
...
locale.getlocale(category=LC_CTYPE)          *getlocale()..locale.pyx*
   ...
   values cannot be determined.
                                  ...
                                  *getpreferredencoding()..locale.pyx*
...
locale.getencoding()                       *getencoding()..locale.pyx*
...
locale.normalize(localename)                 *normalize()..locale.pyx*
...
locale.strcoll(string1, string2)               *strcoll()..locale.pyx*
...
locale.strxfrm(string)                         *strxfrm()..locale.pyx*
...
locale.str(float)                                  *str()..locale.pyx*
...
locale.delocalize(string)                   *delocalize()..locale.pyx*
...
locale.LC_NUMERIC                             *LC_NUMERIC..locale.pyx*
...
locale.LC_ALL                                     *LC_ALL..locale.pyx*
...
locale.CHAR_MAX                                 *CHAR_MAX..locale.pyx*
...
locale.gettext(msg)                            *gettext()..locale.pyx*

locale.dgettext(domain, msg)                  *dgettext()..locale.pyx*

locale.dcgettext(domain, msg, category)      *dcgettext()..locale.pyx*

locale.textdomain(domain)                   *textdomain()..locale.pyx*

locale.bindtextdomain(domain, dir)      *bindtextdomain()..locale.pyx*
