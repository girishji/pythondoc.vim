*logging.config.pyx*                          Last change: 2023 Sep 15
...
logging.config.dictConfig(config)   *dictConfig()..logging.config.pyx*
...
logging.config.stopListening()   *stopListening()..logging.config.pyx*
