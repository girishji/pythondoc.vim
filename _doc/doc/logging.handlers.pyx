*logging.handlers.pyx*                        Last change: 2023 Sep 15
...
"write()" and "flush()" methods).
                                 ...
                                 *StreamHandler..logging.handlers.pyx*
class logging.StreamHandler(stream=None)
   ...
   emit(record)              *StreamHandler.emit()..logging.handlers.pyx*
   ...
   flush()                  *StreamHandler.flush()..logging.handlers.pyx*
   ...
   setStream(stream)    *StreamHandler.setStream()..logging.handlers.pyx*
   ...
   terminator            *StreamHandler.terminator..logging.handlers.pyx*
...
from "StreamHandler".
                                   ...
                                   *FileHandler..logging.handlers.pyx*
class logging.FileHandler(filename, mode='a', encoding=None, delay=False, errors=None)
   ...
   close()                    *FileHandler.close()..logging.handlers.pyx*

      Closes the file.

   emit(record)                *FileHandler.emit()..logging.handlers.pyx*
...
class logging.NullHandler          *NullHandler..logging.handlers.pyx*

   Returns a new instance of the "NullHandler" class.

   emit(record)                *NullHandler.emit()..logging.handlers.pyx*

      This method does nothing.

   handle(record)            *NullHandler.handle()..logging.handlers.pyx*

      This method does nothing.

   createLock()          *NullHandler.createLock()..logging.handlers.pyx*
...
"stat()" always returns zero for this value.
                            ...
                            *WatchedFileHandler..logging.handlers.pyx*
class logging.handlers.WatchedFileHandler(filename, mode='a', encoding=None, delay=False, errors=None)
   ...
   Changed in version 3.9: The _errors_ parameter was added.
           ...
           *WatchedFileHandler.reopenIfNeeded()..logging.handlers.pyx*
   reopenIfNeeded()
   ...
   emit(record)         *WatchedFileHandler.emit()..logging.handlers.pyx*
...
may need to override.
                           ...
                           *BaseRotatingHandler..logging.handlers.pyx*
class logging.handlers.BaseRotatingHandler(filename, mode, encoding=None, delay=False, errors=None)

   The parameters are as for "FileHandler". The attributes are:

   namer                *BaseRotatingHandler.namer..logging.handlers.pyx*
   ...
   rotator            *BaseRotatingHandler.rotator..logging.handlers.pyx*
       ...
       *BaseRotatingHandler.rotation_filename()..logging.handlers.pyx*
   rotation_filename(default_name)
      ...
      New in version 3.3.
                  ...
                  *BaseRotatingHandler.rotate()..logging.handlers.pyx*
   rotate(source, dest)
...
module, supports rotation of disk log files.
                           ...
                           *RotatingFileHandler..logging.handlers.pyx*
class logging.handlers.RotatingFileHandler(filename, mode='a', maxBytes=0, backupCount=0, encoding=None, delay=False, errors=None)
   ...
   Changed in version 3.9: The _errors_ parameter was added.
              ...
              *RotatingFileHandler.doRollover()..logging.handlers.pyx*
   doRollover()

      Does a rollover, as described above.

   emit(record)        *RotatingFileHandler.emit()..logging.handlers.pyx*
...
certain timed intervals.
                      ...
                      *TimedRotatingFileHandler..logging.handlers.pyx*
class logging.handlers.TimedRotatingFileHandler(filename, when='h', interval=1, backupCount=0, encoding=None, delay=False, utc=False, atTime=None, errors=None)
   ...
   Changed in version 3.9: The _errors_ parameter was added.
         ...
         *TimedRotatingFileHandler.doRollover()..logging.handlers.pyx*
   doRollover()

      Does a rollover, as described above.

   emit(record)   *TimedRotatingFileHandler.emit()..logging.handlers.pyx*

      Outputs the record to the file, catering for rollover as
      described above.

   *TimedRotatingFileHandler.getFilesToDelete()..logging.handlers.pyx*
   getFilesToDelete()
...
socket.
                                 ...
                                 *SocketHandler..logging.handlers.pyx*
class logging.handlers.SocketHandler(host, port)
   ...
   close()                  *SocketHandler.close()..logging.handlers.pyx*

      Closes the socket.

   emit()                    *SocketHandler.emit()..logging.handlers.pyx*
   ...
   handleError()      *SocketHandler.handleError()..logging.handlers.pyx*
   ...
   makeSocket()        *SocketHandler.makeSocket()..logging.handlers.pyx*
      ...
      creates a TCP socket ("socket.SOCK_STREAM").
                    ...
                    *SocketHandler.makePickle()..logging.handlers.pyx*
   makePickle(record)
...
<
   ...
   send(packet)              *SocketHandler.send()..logging.handlers.pyx*
   ...
   createSocket()    *SocketHandler.createSocket()..logging.handlers.pyx*
...
UDP sockets.
                               ...
                               *DatagramHandler..logging.handlers.pyx*
class logging.handlers.DatagramHandler(host, port)
   ...
   emit()                  *DatagramHandler.emit()..logging.handlers.pyx*
   ...
   makeSocket()      *DatagramHandler.makeSocket()..logging.handlers.pyx*

      The factory method of "SocketHandler" is here overridden to
      create a UDP socket ("socket.SOCK_DGRAM").

   send(s)                 *DatagramHandler.send()..logging.handlers.pyx*
...
supports sending logging messages to a remote or local Unix syslog.
                                 ...
                                 *SysLogHandler..logging.handlers.pyx*
class logging.handlers.SysLogHandler(address=('localhost', SYSLOG_UDP_PORT), facility=LOG_USER, socktype=socket.SOCK_DGRAM)
   ...
   close()                  *SysLogHandler.close()..logging.handlers.pyx*

      Closes the socket to the remote host.

   createSocket()    *SysLogHandler.createSocket()..logging.handlers.pyx*
      ...
      called again when emitting an event, if but it’s not regarded as
      an error if the other end isn’t listening yet — the method will
      be called again when emitting an event, if there is no socket at
      that point.

      New in version 3.11.

   emit(record)              *SysLogHandler.emit()..logging.handlers.pyx*
      ...
      text, not bytes, and is prepended to the message exactly as is.
                ...
                *SysLogHandler.encodePriority()..logging.handlers.pyx*
   encodePriority(facility, priority)
      ...
      **Facilities**
      ...
      +-----------------+-----------------+
                   ...
                   *SysLogHandler.mapPriority()..logging.handlers.pyx*
...
Mark Hammond’s Win32 extensions for Python installed.
                             ...
                             *NTEventLogHandler..logging.handlers.pyx*
class logging.handlers.NTEventLogHandler(appname, dllname=None, logtype='Application')
   ...
   close()              *NTEventLogHandler.close()..logging.handlers.pyx*
   ...
   emit(record)          *NTEventLogHandler.emit()..logging.handlers.pyx*

      Determines the message ID, event category and event type, and
      then logs the message in the NT event log.

          *NTEventLogHandler.getEventCategory()..logging.handlers.pyx*
   getEventCategory(record)
      ...
      want to specify your own categories. This version returns 0.
              ...
              *NTEventLogHandler.getEventType()..logging.handlers.pyx*
   getEventType(record)
      ...
      suitable dictionary in the handler’s _typemap_ attribute.
              ...
              *NTEventLogHandler.getMessageID()..logging.handlers.pyx*
   getMessageID(record)
...
supports sending logging messages to an email address via SMTP.
                                   ...
                                   *SMTPHandler..logging.handlers.pyx*
class logging.handlers.SMTPHandler(mailhost, fromaddr, toaddrs, subject, credentials=None, secure=None, timeout=1.0)
   ...
   emit(record)                *SMTPHandler.emit()..logging.handlers.pyx*

      Formats the record and sends it to the specified addressees.

   getSubject(record)    *SMTPHandler.getSubject()..logging.handlers.pyx*
...
class logging.handlers.MemoryHandler(capacity, flushLevel=ERROR, target=None, flushOnClose=True)
   ...
   close()                  *MemoryHandler.close()..logging.handlers.pyx*

      Calls "flush()", sets the target to "None" and clears the
      buffer.

   flush()                  *MemoryHandler.flush()..logging.handlers.pyx*
   ...
   setTarget(target)    *MemoryHandler.setTarget()..logging.handlers.pyx*

      Sets the target handler for this handler.

                   *MemoryHandler.shouldFlush()..logging.handlers.pyx*
   shouldFlush(record)
...
or "POST" semantics.
                                   ...
                                   *HTTPHandler..logging.handlers.pyx*
class logging.handlers.HTTPHandler(host, url, method='GET', secure=False, credentials=None, context=None)
   ...
   Changed in version 3.5: The _context_ parameter was added.
                    ...
                    *HTTPHandler.mapLogRecord()..logging.handlers.pyx*
   mapLogRecord(record)
   ...
   emit(record)                *HTTPHandler.emit()..logging.handlers.pyx*
...
sending an email via "SMTPHandler") are done on a separate thread.
                                  ...
                                  *QueueHandler..logging.handlers.pyx*
class logging.handlers.QueueHandler(queue)
   ...
   emit(record)               *QueueHandler.emit()..logging.handlers.pyx*
   ...
   prepare(record)         *QueueHandler.prepare()..logging.handlers.pyx*
...
sending an email via "SMTPHandler") are done on a separate thread.
                                 ...
                                 *QueueListener..logging.handlers.pyx*
class logging.handlers.QueueListener(queue, *handlers, respect_handler_level=False)
   ...
   dequeue(block)         *QueueListener.dequeue()..logging.handlers.pyx*
   ...
   prepare(record)        *QueueListener.prepare()..logging.handlers.pyx*
   ...
   handle(record)          *QueueListener.handle()..logging.handlers.pyx*
   ...
   start()                  *QueueListener.start()..logging.handlers.pyx*
   ...
   stop()                    *QueueListener.stop()..logging.handlers.pyx*
      ...
      won’t be processed.
              ...
              *QueueListener.enqueue_sentinel()..logging.handlers.pyx*
   enqueue_sentinel()
