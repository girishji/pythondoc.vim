*math.pyx*                                    Last change: 2023 Sep 15
...
math.copysign(x, y)                             *copysign()..math.pyx*
...
math.fabs(x)                                        *fabs()..math.pyx*

   Return the absolute value of _x_.

math.factorial(n)                              *factorial()..math.pyx*
...
math.fsum(iterable)                                 *fsum()..math.pyx*
...
math.gcd(*integers)                                  *gcd()..math.pyx*
...
math.isfinite(x)                                *isfinite()..math.pyx*
...
math.lcm(*integers)                                  *lcm()..math.pyx*
...
math.perm(n, k=None)                                *perm()..math.pyx*
...
math.prod(iterable, *, start=1)                     *prod()..math.pyx*
...
math.remainder(x, y)                           *remainder()..math.pyx*
...
math.sumprod(p, q)                               *sumprod()..math.pyx*
...
math.cbrt(x)                                        *cbrt()..math.pyx*

   Return the cube root of _x_.

   New in version 3.11.

math.exp(x)                                          *exp()..math.pyx*
...
math.exp2(x)                                        *exp2()..math.pyx*

   Return _2_ raised to the power _x_.

   New in version 3.11.

math.expm1(x)                                      *expm1()..math.pyx*
...
math.cos(x)                                          *cos()..math.pyx*

   Return the cosine of _x_ radians.

math.dist(p, q)                                     *dist()..math.pyx*
...
math.hypot(*coordinates)                           *hypot()..math.pyx*
...
math.sin(x)                                          *sin()..math.pyx*

   Return the sine of _x_ radians.

math.tan(x)                                          *tan()..math.pyx*
...
math.degrees(x)                                  *degrees()..math.pyx*

   Convert angle _x_ from radians to degrees.

math.radians(x)                                  *radians()..math.pyx*
...
math.gamma(x)                                      *gamma()..math.pyx*

   Return the Gamma function at _x_.

   New in version 3.2.

math.lgamma(x)                                    *lgamma()..math.pyx*
