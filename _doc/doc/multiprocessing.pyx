*multiprocessing.pyx*                         Last change: 2023 Sep 15
...
class multiprocessing.Process(group=None, target=None, name=None, args=(), kwargs={}, *, daemon=None)
   ...
   run()                             *Process.run()..multiprocessing.pyx*
...
>
         ...
         1
<
   start()                         *Process.start()..multiprocessing.pyx*
   ...
   join([timeout])                  *Process.join()..multiprocessing.pyx*
   ...
   name                               *Process.name..multiprocessing.pyx*
   ...
   is_alive()                   *Process.is_alive()..multiprocessing.pyx*
   ...
   daemon                           *Process.daemon..multiprocessing.pyx*
   ...
   pid                                 *Process.pid..multiprocessing.pyx*

      Return the process ID.  Before the process is spawned, this will
      be "None".

   exitcode                       *Process.exitcode..multiprocessing.pyx*
   ...
   authkey                         *Process.authkey..multiprocessing.pyx*
   ...
   sentinel                       *Process.sentinel..multiprocessing.pyx*
   ...
   terminate()                 *Process.terminate()..multiprocessing.pyx*
   ...
   kill()                           *Process.kill()..multiprocessing.pyx*

      Same as "terminate()" but using the "SIGKILL" signal on POSIX.

      New in version 3.7.

   close()                         *Process.close()..multiprocessing.pyx*
...
<
                                   ...
                                   *ProcessError..multiprocessing.pyx*
exception multiprocessing.ProcessError

   The base class of all "multiprocessing" exceptions.

                                 *BufferTooShort..multiprocessing.pyx*
exception multiprocessing.BufferTooShort
   ...
   give the message as a byte string.
                            ...
                            *AuthenticationError..multiprocessing.pyx*
exception multiprocessing.AuthenticationError

   Raised when there is an authentication error.

                                   *TimeoutError..multiprocessing.pyx*
...
multiprocessing.Pipe([duplex])           *Pipe()..multiprocessing.pyx*
...
class multiprocessing.Queue([maxsize])    *Queue..multiprocessing.pyx*
   ...
   qsize()                           *Queue.qsize()..multiprocessing.pyx*
   ...
   put_nowait(obj)              *Queue.put_nowait()..multiprocessing.pyx*

      Equivalent to "put(obj, False)".

   get([block[, timeout]])             *Queue.get()..multiprocessing.pyx*
   ...
   get_nowait()                 *Queue.get_nowait()..multiprocessing.pyx*
   ...
   close()                           *Queue.close()..multiprocessing.pyx*
   ...
   join_thread()               *Queue.join_thread()..multiprocessing.pyx*
      ...
      do nothing.
                     ...
                     *Queue.cancel_join_thread()..multiprocessing.pyx*
   cancel_join_thread()
...
class multiprocessing.SimpleQueue   *SimpleQueue..multiprocessing.pyx*

   It is a simplified "Queue" type, very close to a locked "Pipe".

   close()                     *SimpleQueue.close()..multiprocessing.pyx*
   ...
   empty()                     *SimpleQueue.empty()..multiprocessing.pyx*

      Return "True" if the queue is empty, "False" otherwise.

   get()                         *SimpleQueue.get()..multiprocessing.pyx*

      Remove and return an item from the queue.

   put(item)                     *SimpleQueue.put()..multiprocessing.pyx*

      Put _item_ into the queue.

                                  *JoinableQueue..multiprocessing.pyx*
class multiprocessing.JoinableQueue([maxsize])

   "JoinableQueue", a "Queue" subclass, is a queue which additionally
   has "task_done()" and "join()" methods.

   task_done()           *JoinableQueue.task_done()..multiprocessing.pyx*
   ...
   join()                     *JoinableQueue.join()..multiprocessing.pyx*
...
-------------
                              ...
                              *active_children()..multiprocessing.pyx*
...
multiprocessing.cpu_count()         *cpu_count()..multiprocessing.pyx*
   ...
   See also: "os.cpu_count()"
                              ...
                              *current_process()..multiprocessing.pyx*
multiprocessing.current_process()
   ...
   An analogue of "threading.current_thread()".
                               ...
                               *parent_process()..multiprocessing.pyx*
multiprocessing.parent_process()
   ...
   New in version 3.8.
                               ...
                               *freeze_support()..multiprocessing.pyx*
...
<
   ...
   effect.
                        ...
                        *get_all_start_methods()..multiprocessing.pyx*
multiprocessing.get_all_start_methods()
   ...
   New in version 3.4.
                                  ...
                                  *get_context()..multiprocessing.pyx*
multiprocessing.get_context(method=None)
   ...
   New in version 3.4.
                             ...
                             *get_start_method()..multiprocessing.pyx*
...
New in version 3.4.
                               ...
                               *set_executable()..multiprocessing.pyx*
...
<
   ...
   Changed in version 3.11: Accepts a _path-like object_.
                       ...
                       *set_forkserver_preload()..multiprocessing.pyx*
multiprocessing.set_forkserver_preload(module_names)
   ...
   New in version 3.4.
                             ...
                             *set_start_method()..multiprocessing.pyx*
...
Listeners and Clients.
                                     ...
                                     *Connection..multiprocessing.pyx*
class multiprocessing.connection.Connection

   send(obj)                     *Connection.send()..multiprocessing.pyx*
   ...
   recv()                        *Connection.recv()..multiprocessing.pyx*
   ...
   fileno()                    *Connection.fileno()..multiprocessing.pyx*

      Return the file descriptor or handle used by the connection.

   close()                      *Connection.close()..multiprocessing.pyx*
   ...
   poll([timeout])               *Connection.poll()..multiprocessing.pyx*
      ...
      using "multiprocessing.connection.wait()".
                        ...
                        *Connection.send_bytes()..multiprocessing.pyx*
   send_bytes(buffer[, offset[, size]])
      ...
      it depends on the OS) may raise a "ValueError" exception
                        ...
                        *Connection.recv_bytes()..multiprocessing.pyx*
   recv_bytes([maxlength])
      ...
      which is now an alias of "OSError".
                   ...
                   *Connection.recv_bytes_into()..multiprocessing.pyx*
...
class multiprocessing.Barrier(parties[, action[, timeout]])
   ...
   New in version 3.3.
                               ...
                               *BoundedSemaphore..multiprocessing.pyx*
...
class multiprocessing.Event               *Event..multiprocessing.pyx*

   A clone of "threading.Event".

class multiprocessing.Lock                 *Lock..multiprocessing.pyx*
   ...
   in "with" statements.
                                 ...
                                 *Lock.acquire()..multiprocessing.pyx*
   ...
   release()                        *Lock.release()..multiprocessing.pyx*
...
class multiprocessing.RLock               *RLock..multiprocessing.pyx*
   ...
   used in "with" statements.
                                ...
                                *RLock.acquire()..multiprocessing.pyx*
   acquire(block=True, timeout=None)
   ...
   release()                       *RLock.release()..multiprocessing.pyx*
...
multiprocessing.sharedctypes.copy(obj)   *copy()..multiprocessing.pyx*

   Return a ctypes object allocated from shared memory which is a copy
   of the ctypes object _obj_.

                                 *synchronized()..multiprocessing.pyx*
...
access the shared objects by using proxies.
                      ...
                      *multiprocessing.Manager()..multiprocessing.pyx*
...
defined in the "multiprocessing.managers" module:
                                    ...
                                    *BaseManager..multiprocessing.pyx*
class multiprocessing.managers.BaseManager(address=None, authkey=None, serializer='pickle', ctx=None, *, shutdown_timeout=1.0)
   ...
   Changed in version 3.11: Added the _shutdown_timeout_ parameter.
                            ...
                            *BaseManager.start()..multiprocessing.pyx*
   ...
   get_server()           *BaseManager.get_server()..multiprocessing.pyx*
...
<
   ...
   connect()                 *BaseManager.connect()..multiprocessing.pyx*
...
>
         ...
         >>> m.connect()
<
   shutdown()               *BaseManager.shutdown()..multiprocessing.pyx*
      ...
      This can be called multiple times.
                         ...
                         *BaseManager.register()..multiprocessing.pyx*
   ...
   address                     *BaseManager.address..multiprocessing.pyx*
   ...
   process if it was not already started.
                                    ...
                                    *SyncManager..multiprocessing.pyx*
class multiprocessing.managers.SyncManager
   ...
   notably includes shared lists and dictionaries.
                          ...
                          *SyncManager.Barrier()..multiprocessing.pyx*
   Barrier(parties[, action[, timeout]])
      ...
      New in version 3.3.
                 ...
                 *SyncManager.BoundedSemaphore()..multiprocessing.pyx*
   BoundedSemaphore([value])

      Create a shared "threading.BoundedSemaphore" object and return a
      proxy for it.

   Condition([lock])       *SyncManager.Condition()..multiprocessing.pyx*
   ...
   Event()                     *SyncManager.Event()..multiprocessing.pyx*

      Create a shared "threading.Event" object and return a proxy for
      it.

   Lock()                       *SyncManager.Lock()..multiprocessing.pyx*

      Create a shared "threading.Lock" object and return a proxy for
      it.

   Namespace()             *SyncManager.Namespace()..multiprocessing.pyx*

      Create a shared "Namespace" object and return a proxy for it.

   Queue([maxsize])            *SyncManager.Queue()..multiprocessing.pyx*

      Create a shared "queue.Queue" object and return a proxy for it.

   RLock()                     *SyncManager.RLock()..multiprocessing.pyx*

      Create a shared "threading.RLock" object and return a proxy for
      it.

   Semaphore([value])      *SyncManager.Semaphore()..multiprocessing.pyx*

      Create a shared "threading.Semaphore" object and return a proxy
      for it.

   Array(typecode, sequence)   *SyncManager.Array()..multiprocessing.pyx*

      Create an array and return a proxy for it.

   Value(typecode, value)      *SyncManager.Value()..multiprocessing.pyx*

      Create an object with a writable "value" attribute and return a
      proxy for it.

   dict()                       *SyncManager.dict()..multiprocessing.pyx*
   dict(mapping)
   dict(sequence)

      Create a shared "dict" object and return a proxy for it.

   list()                       *SyncManager.list()..multiprocessing.pyx*
   list(sequence)
...
<
  ...
  comparisons.
                                      ...
                                      *BaseProxy..multiprocessing.pyx*
class multiprocessing.managers.BaseProxy

   Proxy objects are instances of subclasses of "BaseProxy".

                        *BaseProxy._callmethod()..multiprocessing.pyx*
...
<
   _getvalue()               *BaseProxy._getvalue()..multiprocessing.pyx*
   ...
   __repr__()                 *BaseProxy.__repr__()..multiprocessing.pyx*

      Return a representation of the proxy object.

   __str__()                   *BaseProxy.__str__()..multiprocessing.pyx*
...
class multiprocessing.pool.Pool([processes[, initializer[, initargs[, maxtasksperchild[, context]]]]])
   ...
   apply(func[, args[, kwds]])        *Pool.apply()..multiprocessing.pyx*
      ...
      workers of the pool.
                             ...
                             *Pool.apply_async()..multiprocessing.pyx*
   ...
   map(func, iterable[, chunksize])     *Pool.map()..multiprocessing.pyx*
      ...
      explicit _chunksize_ option for better efficiency.
                               ...
                               *Pool.map_async()..multiprocessing.pyx*
   ...
   imap(func, iterable[, chunksize])   *Pool.imap()..multiprocessing.pyx*
      ...
      within _timeout_ seconds.
                          ...
                          *Pool.imap_unordered()..multiprocessing.pyx*
   imap_unordered(func, iterable[, chunksize])
      ...
      guaranteed to be “correct”.)
                                 ...
                                 *Pool.starmap()..multiprocessing.pyx*
   starmap(func, iterable[, chunksize])
      ...
      New in version 3.3.
                           ...
                           *Pool.starmap_async()..multiprocessing.pyx*
   ...
   pool object, and "__exit__()" calls "terminate()".
                                    ...
                                    *AsyncResult..multiprocessing.pyx*
class multiprocessing.pool.AsyncResult

   The class of the result returned by "Pool.apply_async()" and
   "Pool.map_async()".

   get([timeout])                *AsyncResult.get()..multiprocessing.pyx*
   ...
   wait([timeout])              *AsyncResult.wait()..multiprocessing.pyx*

      Wait until the result is available or until _timeout_ seconds
      pass.

   ready()                     *AsyncResult.ready()..multiprocessing.pyx*

      Return whether the call has completed.

   successful()           *AsyncResult.successful()..multiprocessing.pyx*
...
multiple connections at the same time.
                            ...
                            *deliver_challenge()..multiprocessing.pyx*
multiprocessing.connection.deliver_challenge(connection, authkey)
   ...
   connection.  Otherwise "AuthenticationError" is raised.
                             ...
                             *answer_challenge()..multiprocessing.pyx*
...
class multiprocessing.connection.Listener([address[, family[, backlog[, authkey]]]])
   ...
   accept()                      *Listener.accept()..multiprocessing.pyx*
   ...
   close()                        *Listener.close()..multiprocessing.pyx*
   ...
   address                        *Listener.address..multiprocessing.pyx*

      The address which is being used by the Listener object.

   last_accepted            *Listener.last_accepted..multiprocessing.pyx*
...
multiprocessing.get_logger()       *get_logger()..multiprocessing.pyx*
   ...
   will not be inherited.
                                ...
                                *log_to_stderr()..multiprocessing.pyx*
...
threads rather than worker processes.
                                     ...
                                     *ThreadPool..multiprocessing.pyx*
