*numbers.pyx*                                 Last change: 2023 Sep 15
...
class numbers.Number                             *Number..numbers.pyx*
...
class numbers.Complex                           *Complex..numbers.pyx*
   ...
   real                                       *Complex.real..numbers.pyx*

      Abstract. Retrieves the real component of this number.

   imag                                       *Complex.imag..numbers.pyx*

      Abstract. Retrieves the imaginary component of this number.

   abstractmethod conjugate()          *Complex.conjugate()..numbers.pyx*

      Abstract. Returns the complex conjugate. For example,
      "(1+3j).conjugate() == (1-3j)".

class numbers.Real                                 *Real..numbers.pyx*
...
class numbers.Rational                         *Rational..numbers.pyx*
   ...
   numerator                            *Rational.numerator..numbers.pyx*

      Abstract.

   denominator                        *Rational.denominator..numbers.pyx*

      Abstract.

class numbers.Integral                         *Integral..numbers.pyx*
