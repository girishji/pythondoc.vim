*os.path.pyx*                                 Last change: 2023 Sep 15
...
os.path.abspath(path)                         *abspath()..os.path.pyx*
...
os.path.basename(path)                       *basename()..os.path.pyx*
...
os.path.commonpath(paths)                  *commonpath()..os.path.pyx*
...
os.path.commonprefix(list)               *commonprefix()..os.path.pyx*
...
os.path.dirname(path)                         *dirname()..os.path.pyx*
...
os.path.exists(path)                           *exists()..os.path.pyx*
...
os.path.lexists(path)                         *lexists()..os.path.pyx*
...
os.path.expanduser(path)                   *expanduser()..os.path.pyx*
...
os.path.expandvars(path)                   *expandvars()..os.path.pyx*
...
os.path.getatime(path)                       *getatime()..os.path.pyx*
...
os.path.getmtime(path)                       *getmtime()..os.path.pyx*
...
os.path.getctime(path)                       *getctime()..os.path.pyx*
...
os.path.getsize(path)                         *getsize()..os.path.pyx*
...
os.path.isabs(path)                             *isabs()..os.path.pyx*
...
os.path.isfile(path)                           *isfile()..os.path.pyx*
...
os.path.isdir(path)                             *isdir()..os.path.pyx*
...
os.path.isjunction(path)                   *isjunction()..os.path.pyx*
...
os.path.islink(path)                           *islink()..os.path.pyx*
...
os.path.ismount(path)                         *ismount()..os.path.pyx*
...
os.path.isdevdrive(path)                   *isdevdrive()..os.path.pyx*
...
os.path.join(path, *paths)                       *join()..os.path.pyx*
...
os.path.normcase(path)                       *normcase()..os.path.pyx*
...
os.path.normpath(path)                       *normpath()..os.path.pyx*
...
os.path.realpath(path, *, strict=False)      *realpath()..os.path.pyx*
...
os.path.relpath(path, start=os.curdir)        *relpath()..os.path.pyx*
...
os.path.samefile(path1, path2)               *samefile()..os.path.pyx*
...
os.path.sameopenfile(fp1, fp2)           *sameopenfile()..os.path.pyx*
...
os.path.samestat(stat1, stat2)               *samestat()..os.path.pyx*
...
os.path.split(path)                             *split()..os.path.pyx*
...
os.path.splitdrive(path)                   *splitdrive()..os.path.pyx*
...
os.path.splitroot(path)                     *splitroot()..os.path.pyx*
...
os.path.splitext(path)                       *splitext()..os.path.pyx*
...
<
   Changed in version 3.6: Accepts a _path-like object_.
                             ...
                             *supports_unicode_filenames..os.path.pyx*
