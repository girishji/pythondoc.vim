*os.pyx*                                      Last change: 2023 Sep 15
...
exception os.error                                     *error..os.pyx*
...
os.chdir(path)                                       *chdir()..os.pyx*
os.fchdir(fd)                                       *fchdir()..os.pyx*
os.getcwd()                                         *getcwd()..os.pyx*

   These functions are described in Files and Directories.

os.fsencode(filename)                             *fsencode()..os.pyx*
...
os.fsdecode(filename)                             *fsdecode()..os.pyx*
...
class os.PathLike                                   *PathLike..os.pyx*
   ...
   abstractmethod __fspath__()            *PathLike.__fspath__()..os.pyx*
...
os.getenv(key, default=None)                        *getenv()..os.pyx*
...
os.getenvb(key, default=None)                      *getenvb()..os.pyx*
...
os.get_exec_path(env=None)                   *get_exec_path()..os.pyx*
...
os.geteuid()                                       *geteuid()..os.pyx*

   Return the current process’s effective user id.

   Availability: Unix, not Emscripten, not WASI.

os.getgid()                                         *getgid()..os.pyx*
...
os.getgrouplist(user, group, /)               *getgrouplist()..os.pyx*
...
os.getpgrp()                                       *getpgrp()..os.pyx*

   Return the id of the current process group.

   Availability: Unix, not Emscripten, not WASI.

os.getpid()                                         *getpid()..os.pyx*
...
os.getpriority(which, who)                     *getpriority()..os.pyx*
...
os.PRIO_PROCESS                                 *PRIO_PROCESS..os.pyx*
os.PRIO_PGRP                                       *PRIO_PGRP..os.pyx*
os.PRIO_USER                                       *PRIO_USER..os.pyx*
...
os.PRIO_DARWIN_THREAD                     *PRIO_DARWIN_THREAD..os.pyx*
os.PRIO_DARWIN_PROCESS                   *PRIO_DARWIN_PROCESS..os.pyx*
os.PRIO_DARWIN_BG                             *PRIO_DARWIN_BG..os.pyx*
os.PRIO_DARWIN_NONUI                       *PRIO_DARWIN_NONUI..os.pyx*
...
os.initgroups(username, gid, /)                 *initgroups()..os.pyx*
...
os.putenv(key, value, /)                            *putenv()..os.pyx*
...
os.setegid(egid, /)                                *setegid()..os.pyx*

   Set the current process’s effective group id.

   Availability: Unix, not Emscripten, not WASI.

os.seteuid(euid, /)                                *seteuid()..os.pyx*

   Set the current process’s effective user id.

   Availability: Unix, not Emscripten, not WASI.

os.setgid(gid, /)                                   *setgid()..os.pyx*

   Set the current process’ group id.

   Availability: Unix, not Emscripten, not WASI.

os.setgroups(groups, /)                          *setgroups()..os.pyx*
...
os.setns(fd, nstype=0)                               *setns()..os.pyx*
...
os.setpgid(pid, pgrp, /)                           *setpgid()..os.pyx*
...
os.setpriority(which, who, priority)           *setpriority()..os.pyx*
...
os.setregid(rgid, egid, /)                        *setregid()..os.pyx*

   Set the current process’s real and effective group ids.

   Availability: Unix, not Emscripten, not WASI.

os.setresgid(rgid, egid, sgid, /)                *setresgid()..os.pyx*
...
os.setresuid(ruid, euid, suid, /)                *setresuid()..os.pyx*
...
os.setreuid(ruid, euid, /)                        *setreuid()..os.pyx*

   Set the current process’s real and effective user ids.

   Availability: Unix, not Emscripten, not WASI.

os.getsid(pid, /)                                   *getsid()..os.pyx*
...
os.setuid(uid, /)                                   *setuid()..os.pyx*

   Set the current process’s user id.

   Availability: Unix, not Emscripten, not WASI.

os.strerror(code, /)                              *strerror()..os.pyx*
...
os.supports_bytes_environ             *supports_bytes_environ..os.pyx*
...
os.unsetenv(key, /)                               *unsetenv()..os.pyx*
...
os.unshare(flags)                                  *unshare()..os.pyx*
...
os.CLONE_FILES                                   *CLONE_FILES..os.pyx*
os.CLONE_FS                                         *CLONE_FS..os.pyx*
os.CLONE_NEWCGROUP                           *CLONE_NEWCGROUP..os.pyx*
os.CLONE_NEWIPC                                 *CLONE_NEWIPC..os.pyx*
os.CLONE_NEWNET                                 *CLONE_NEWNET..os.pyx*
os.CLONE_NEWNS                                   *CLONE_NEWNS..os.pyx*
os.CLONE_NEWPID                                 *CLONE_NEWPID..os.pyx*
os.CLONE_NEWTIME                               *CLONE_NEWTIME..os.pyx*
os.CLONE_NEWUSER                               *CLONE_NEWUSER..os.pyx*
os.CLONE_NEWUTS                                 *CLONE_NEWUTS..os.pyx*
os.CLONE_SIGHAND                               *CLONE_SIGHAND..os.pyx*
os.CLONE_SYSVSEM                               *CLONE_SYSVSEM..os.pyx*
os.CLONE_THREAD                                 *CLONE_THREAD..os.pyx*
os.CLONE_VM                                         *CLONE_VM..os.pyx*
...
os.fdopen(fd, *args, **kwargs)                      *fdopen()..os.pyx*
...
os.closerange(fd_low, fd_high, /)               *closerange()..os.pyx*
...
os.device_encoding(fd)                     *device_encoding()..os.pyx*
...
os.dup2(fd, fd2, inheritable=True)                    *dup2()..os.pyx*
...
os.fchmod(fd, mode)                                 *fchmod()..os.pyx*
...
os.fchown(fd, uid, gid)                             *fchown()..os.pyx*
...
os.fdatasync(fd)                                 *fdatasync()..os.pyx*
...
os.fpathconf(fd, name, /)                        *fpathconf()..os.pyx*
...
os.fstatvfs(fd, /)                                *fstatvfs()..os.pyx*
...
os.ftruncate(fd, length, /)                      *ftruncate()..os.pyx*
...
os.get_blocking(fd, /)                        *get_blocking()..os.pyx*
...
os.F_LOCK                                             *F_LOCK..os.pyx*
os.F_TLOCK                                           *F_TLOCK..os.pyx*
os.F_ULOCK                                           *F_ULOCK..os.pyx*
os.F_TEST                                             *F_TEST..os.pyx*
...
os.login_tty(fd, /)                              *login_tty()..os.pyx*
...
os.lseek(fd, pos, whence, /)                         *lseek()..os.pyx*
...
os.SEEK_SET                                         *SEEK_SET..os.pyx*
os.SEEK_CUR                                         *SEEK_CUR..os.pyx*
os.SEEK_END                                         *SEEK_END..os.pyx*
...
os.SEEK_HOLE                                       *SEEK_HOLE..os.pyx*
os.SEEK_DATA                                       *SEEK_DATA..os.pyx*
...
os.open(path, flags, mode=0o777, *, dir_fd=None)      *open()..os.pyx*
...
os.O_RDONLY                                         *O_RDONLY..os.pyx*
os.O_WRONLY                                         *O_WRONLY..os.pyx*
os.O_RDWR                                             *O_RDWR..os.pyx*
os.O_APPEND                                         *O_APPEND..os.pyx*
os.O_CREAT                                           *O_CREAT..os.pyx*
os.O_EXCL                                             *O_EXCL..os.pyx*
os.O_TRUNC                                           *O_TRUNC..os.pyx*

   The above constants are available on Unix and Windows.

os.O_DSYNC                                           *O_DSYNC..os.pyx*
os.O_RSYNC                                           *O_RSYNC..os.pyx*
os.O_SYNC                                             *O_SYNC..os.pyx*
os.O_NDELAY                                         *O_NDELAY..os.pyx*
os.O_NONBLOCK                                     *O_NONBLOCK..os.pyx*
os.O_NOCTTY                                         *O_NOCTTY..os.pyx*
os.O_CLOEXEC                                       *O_CLOEXEC..os.pyx*

   The above constants are only available on Unix.

   Changed in version 3.3: Add "O_CLOEXEC" constant.

os.O_BINARY                                         *O_BINARY..os.pyx*
os.O_NOINHERIT                                   *O_NOINHERIT..os.pyx*
os.O_SHORT_LIVED                               *O_SHORT_LIVED..os.pyx*
os.O_TEMPORARY                                   *O_TEMPORARY..os.pyx*
os.O_RANDOM                                         *O_RANDOM..os.pyx*
os.O_SEQUENTIAL                                 *O_SEQUENTIAL..os.pyx*
os.O_TEXT                                             *O_TEXT..os.pyx*

   The above constants are only available on Windows.

os.O_EVTONLY                                       *O_EVTONLY..os.pyx*
os.O_FSYNC                                           *O_FSYNC..os.pyx*
os.O_SYMLINK                                       *O_SYMLINK..os.pyx*
os.O_NOFOLLOW_ANY                             *O_NOFOLLOW_ANY..os.pyx*
...
os.O_ASYNC                                           *O_ASYNC..os.pyx*
os.O_DIRECT                                         *O_DIRECT..os.pyx*
os.O_DIRECTORY                                   *O_DIRECTORY..os.pyx*
os.O_NOFOLLOW                                     *O_NOFOLLOW..os.pyx*
os.O_NOATIME                                       *O_NOATIME..os.pyx*
os.O_PATH                                             *O_PATH..os.pyx*
os.O_TMPFILE                                       *O_TMPFILE..os.pyx*
os.O_SHLOCK                                         *O_SHLOCK..os.pyx*
os.O_EXLOCK                                         *O_EXLOCK..os.pyx*
...
os.posix_fallocate(fd, offset, len, /)     *posix_fallocate()..os.pyx*
...
os.POSIX_FADV_NORMAL                       *POSIX_FADV_NORMAL..os.pyx*
os.POSIX_FADV_SEQUENTIAL               *POSIX_FADV_SEQUENTIAL..os.pyx*
os.POSIX_FADV_RANDOM                       *POSIX_FADV_RANDOM..os.pyx*
os.POSIX_FADV_NOREUSE                     *POSIX_FADV_NOREUSE..os.pyx*
os.POSIX_FADV_WILLNEED                   *POSIX_FADV_WILLNEED..os.pyx*
os.POSIX_FADV_DONTNEED                   *POSIX_FADV_DONTNEED..os.pyx*
...
os.pread(fd, n, offset, /)                           *pread()..os.pyx*
...
os.preadv(fd, buffers, offset, flags=0, /)          *preadv()..os.pyx*
...
os.RWF_NOWAIT                                     *RWF_NOWAIT..os.pyx*
...
os.pwrite(fd, str, offset, /)                       *pwrite()..os.pyx*
...
os.pwritev(fd, buffers, offset, flags=0, /)        *pwritev()..os.pyx*
...
os.RWF_APPEND                                     *RWF_APPEND..os.pyx*
...
os.sendfile(out_fd, in_fd, offset, count)         *sendfile()..os.pyx*
...
os.SF_NODISKIO                                   *SF_NODISKIO..os.pyx*
os.SF_MNOWAIT                                     *SF_MNOWAIT..os.pyx*
os.SF_SYNC                                           *SF_SYNC..os.pyx*
...
os.SF_NOCACHE                                     *SF_NOCACHE..os.pyx*
...
os.set_blocking(fd, blocking, /)              *set_blocking()..os.pyx*
...
os.SPLICE_F_MOVE                               *SPLICE_F_MOVE..os.pyx*
os.SPLICE_F_NONBLOCK                       *SPLICE_F_NONBLOCK..os.pyx*
os.SPLICE_F_MORE                               *SPLICE_F_MORE..os.pyx*

   New in version 3.10.

os.readv(fd, buffers, /)                             *readv()..os.pyx*
...
os.tcgetpgrp(fd, /)                              *tcgetpgrp()..os.pyx*
...
os.tcsetpgrp(fd, pg, /)                          *tcsetpgrp()..os.pyx*
...
os.writev(fd, buffers, /)                           *writev()..os.pyx*
...
class os.terminal_size                         *terminal_size..os.pyx*

   A subclass of tuple, holding "(columns, lines)" of the terminal
   window size.

   columns                                *terminal_size.columns..os.pyx*

      Width of the terminal window in characters.

   lines                                    *terminal_size.lines..os.pyx*
...
os.get_inheritable(fd, /)                  *get_inheritable()..os.pyx*

   Get the “inheritable” flag of the specified file descriptor (a
   boolean).

os.set_inheritable(fd, inheritable, /)     *set_inheritable()..os.pyx*

   Set the “inheritable” flag of the specified file descriptor.

                                    *get_handle_inheritable()..os.pyx*
...
os.chflags(path, flags, *, follow_symlinks=True)   *chflags()..os.pyx*
...
os.lchflags(path, flags)                          *lchflags()..os.pyx*
...
os.lchmod(path, mode)                               *lchmod()..os.pyx*
...
os.lchown(path, uid, gid)                           *lchown()..os.pyx*
...
os.listdir(path='.')                               *listdir()..os.pyx*
...
os.listdrives()                                 *listdrives()..os.pyx*
...
os.listmounts(volume)                           *listmounts()..os.pyx*
...
os.listvolumes()                               *listvolumes()..os.pyx*
...
os.lstat(path, *, dir_fd=None)                       *lstat()..os.pyx*
...
os.mkdir(path, mode=0o777, *, dir_fd=None)           *mkdir()..os.pyx*
...
os.makedirs(name, mode=0o777, exist_ok=False)     *makedirs()..os.pyx*
...
os.mkfifo(path, mode=0o666, *, dir_fd=None)         *mkfifo()..os.pyx*
...
os.pathconf_names                             *pathconf_names..os.pyx*
...
os.readlink(path, *, dir_fd=None)                 *readlink()..os.pyx*
...
os.remove(path, *, dir_fd=None)                     *remove()..os.pyx*
...
os.removedirs(name)                             *removedirs()..os.pyx*
...
os.renames(old, new)                               *renames()..os.pyx*
...
os.rmdir(path, *, dir_fd=None)                       *rmdir()..os.pyx*
...
os.scandir(path='.')                               *scandir()..os.pyx*
   ...
   scandir.close()                              *scandir.close()..os.pyx*
...
class os.DirEntry                                   *DirEntry..os.pyx*
   ...
   is_dir(*, follow_symlinks=True)            *DirEntry.is_dir()..os.pyx*
   ...
   is_file(*, follow_symlinks=True)          *DirEntry.is_file()..os.pyx*
   ...
   is_symlink()                           *DirEntry.is_symlink()..os.pyx*
   ...
   is_junction()                         *DirEntry.is_junction()..os.pyx*
   ...
   stat(*, follow_symlinks=True)                *DirEntry.stat()..os.pyx*
...
os.stat(path, *, dir_fd=None, follow_symlinks=True)   *stat()..os.pyx*
...
class os.stat_result                             *stat_result..os.pyx*
   ...
   st_mode                                  *stat_result.st_mode..os.pyx*

      File mode: file type and file mode bits (permissions).

   st_ino                                    *stat_result.st_ino..os.pyx*
   ...
   st_dev                                    *stat_result.st_dev..os.pyx*

      Identifier of the device on which this file resides.

   st_nlink                                *stat_result.st_nlink..os.pyx*

      Number of hard links.

   st_uid                                    *stat_result.st_uid..os.pyx*

      User identifier of the file owner.

   st_gid                                    *stat_result.st_gid..os.pyx*

      Group identifier of the file owner.

   st_size                                  *stat_result.st_size..os.pyx*
   ...
   st_atime                                *stat_result.st_atime..os.pyx*

      Time of most recent access expressed in seconds.

   st_mtime                                *stat_result.st_mtime..os.pyx*

      Time of most recent content modification expressed in seconds.

   st_ctime                                *stat_result.st_ctime..os.pyx*
   ...
   st_birthtime                        *stat_result.st_birthtime..os.pyx*
   ...
   st_birthtime_ns                  *stat_result.st_birthtime_ns..os.pyx*
   ...
   st_rdev                                  *stat_result.st_rdev..os.pyx*

      Type of device if an inode device.

   st_flags                                *stat_result.st_flags..os.pyx*
   ...
   st_gen                                    *stat_result.st_gen..os.pyx*
   ...
   st_fstype                              *stat_result.st_fstype..os.pyx*
   ...
   st_rsize                                *stat_result.st_rsize..os.pyx*

      Real size of the file.

   st_creator                            *stat_result.st_creator..os.pyx*

      Creator of the file.

   st_type                                  *stat_result.st_type..os.pyx*

      File type.

   On Windows systems, the following attributes are also available:

   st_file_attributes            *stat_result.st_file_attributes..os.pyx*
   ...
   st_reparse_tag                    *stat_result.st_reparse_tag..os.pyx*
   ...
   creation time. Use "st_birthtime" for the creation time.

   Changed in version 3.12: On Windows, "st_ino" may now be up to 128
   bits, depending on the file system. Previously it would not be
   above 64 bits, and larger file identifiers would be arbitrarily
   packed.

   Changed in version 3.12: On Windows, "st_rdev" no longer returns a
   value. Previously it would contain the same as "st_dev", which was
   incorrect.

   New in version 3.12: Added the "st_birthtime" member on Windows.

os.statvfs(path)                                   *statvfs()..os.pyx*
...
os.supports_dir_fd                           *supports_dir_fd..os.pyx*
...
os.supports_effective_ids             *supports_effective_ids..os.pyx*
...
os.supports_fd                                   *supports_fd..os.pyx*
...
os.supports_follow_symlinks         *supports_follow_symlinks..os.pyx*
...
os.truncate(path, length)                         *truncate()..os.pyx*
...
os.unlink(path, *, dir_fd=None)                     *unlink()..os.pyx*
...
os.MFD_CLOEXEC                                   *MFD_CLOEXEC..os.pyx*
os.MFD_ALLOW_SEALING                       *MFD_ALLOW_SEALING..os.pyx*
os.MFD_HUGETLB                                   *MFD_HUGETLB..os.pyx*
os.MFD_HUGE_SHIFT                             *MFD_HUGE_SHIFT..os.pyx*
os.MFD_HUGE_MASK                               *MFD_HUGE_MASK..os.pyx*
os.MFD_HUGE_64KB                               *MFD_HUGE_64KB..os.pyx*
os.MFD_HUGE_512KB                             *MFD_HUGE_512KB..os.pyx*
os.MFD_HUGE_1MB                                 *MFD_HUGE_1MB..os.pyx*
os.MFD_HUGE_2MB                                 *MFD_HUGE_2MB..os.pyx*
os.MFD_HUGE_8MB                                 *MFD_HUGE_8MB..os.pyx*
os.MFD_HUGE_16MB                               *MFD_HUGE_16MB..os.pyx*
os.MFD_HUGE_32MB                               *MFD_HUGE_32MB..os.pyx*
os.MFD_HUGE_256MB                             *MFD_HUGE_256MB..os.pyx*
os.MFD_HUGE_512MB                             *MFD_HUGE_512MB..os.pyx*
os.MFD_HUGE_1GB                                 *MFD_HUGE_1GB..os.pyx*
os.MFD_HUGE_2GB                                 *MFD_HUGE_2GB..os.pyx*
os.MFD_HUGE_16GB                               *MFD_HUGE_16GB..os.pyx*
...
os.eventfd(initval[, flags=os.EFD_CLOEXEC])        *eventfd()..os.pyx*
...
os.eventfd_read(fd)                           *eventfd_read()..os.pyx*
...
os.eventfd_write(fd, value)                  *eventfd_write()..os.pyx*
...
os.EFD_CLOEXEC                                   *EFD_CLOEXEC..os.pyx*
...
os.EFD_NONBLOCK                                 *EFD_NONBLOCK..os.pyx*
...
os.EFD_SEMAPHORE                               *EFD_SEMAPHORE..os.pyx*
...
os.add_dll_directory(path)               *add_dll_directory()..os.pyx*
...
os.execl(path, arg0, arg1, ...)                      *execl()..os.pyx*
os.execle(path, arg0, arg1, ..., env)               *execle()..os.pyx*
os.execlp(file, arg0, arg1, ...)                    *execlp()..os.pyx*
os.execlpe(file, arg0, arg1, ..., env)             *execlpe()..os.pyx*
os.execv(path, args)                                 *execv()..os.pyx*
os.execve(path, args, env)                          *execve()..os.pyx*
os.execvp(file, args)                               *execvp()..os.pyx*
os.execvpe(file, args, env)                        *execvpe()..os.pyx*
...
os.EX_DATAERR                                     *EX_DATAERR..os.pyx*

   Exit code that means the input data was incorrect.

   Availability: Unix, not Emscripten, not WASI.

os.EX_NOINPUT                                     *EX_NOINPUT..os.pyx*
...
os.EX_NOUSER                                       *EX_NOUSER..os.pyx*

   Exit code that means a specified user did not exist.

   Availability: Unix, not Emscripten, not WASI.

os.EX_NOHOST                                       *EX_NOHOST..os.pyx*

   Exit code that means a specified host did not exist.

   Availability: Unix, not Emscripten, not WASI.

os.EX_UNAVAILABLE                             *EX_UNAVAILABLE..os.pyx*

   Exit code that means that a required service is unavailable.

   Availability: Unix, not Emscripten, not WASI.

os.EX_SOFTWARE                                   *EX_SOFTWARE..os.pyx*

   Exit code that means an internal software error was detected.

   Availability: Unix, not Emscripten, not WASI.

os.EX_OSERR                                         *EX_OSERR..os.pyx*
...
os.EX_CANTCREAT                                 *EX_CANTCREAT..os.pyx*
...
os.EX_TEMPFAIL                                   *EX_TEMPFAIL..os.pyx*
...
os.EX_PROTOCOL                                   *EX_PROTOCOL..os.pyx*
...
os.EX_NOTFOUND                                   *EX_NOTFOUND..os.pyx*
...
os.killpg(pgid, sig, /)                             *killpg()..os.pyx*
...
os.pidfd_open(pid, flags=0)                     *pidfd_open()..os.pyx*
   ...
   os.PIDFD_NONBLOCK                             *PIDFD_NONBLOCK..os.pyx*
...
os.popen(cmd, mode='r', buffering=-1)                *popen()..os.pyx*
...
os.posix_spawn(path, argv, env, *, file_actions=None, setpgroup=None, resetids=False, setsid=False, setsigmask=(), setsigdef=(), scheduler=None)
   ...
   os.POSIX_SPAWN_OPEN                         *POSIX_SPAWN_OPEN..os.pyx*

      ("os.POSIX_SPAWN_OPEN", _fd_, _path_, _flags_, _mode_)

      Performs "os.dup2(os.open(path, flags, mode), fd)".

   os.POSIX_SPAWN_CLOSE                       *POSIX_SPAWN_CLOSE..os.pyx*

      ("os.POSIX_SPAWN_CLOSE", _fd_)

      Performs "os.close(fd)".

   os.POSIX_SPAWN_DUP2                         *POSIX_SPAWN_DUP2..os.pyx*
...
os.spawnl(mode, path, ...)                          *spawnl()..os.pyx*
os.spawnle(mode, path, ..., env)                   *spawnle()..os.pyx*
os.spawnlp(mode, file, ...)                        *spawnlp()..os.pyx*
os.spawnlpe(mode, file, ..., env)                 *spawnlpe()..os.pyx*
os.spawnv(mode, path, args)                         *spawnv()..os.pyx*
os.spawnve(mode, path, args, env)                  *spawnve()..os.pyx*
os.spawnvp(mode, file, args)                       *spawnvp()..os.pyx*
os.spawnvpe(mode, file, args, env)                *spawnvpe()..os.pyx*
...
os.P_NOWAIT                                         *P_NOWAIT..os.pyx*
os.P_NOWAITO                                       *P_NOWAITO..os.pyx*
...
os.P_DETACH                                         *P_DETACH..os.pyx*
os.P_OVERLAY                                       *P_OVERLAY..os.pyx*
...
os.system(command)                                  *system()..os.pyx*
...
os.waitid(idtype, id, options, /)                   *waitid()..os.pyx*
...
os.waitpid(pid, options, /)                        *waitpid()..os.pyx*
...
os.wait4(pid, options)                               *wait4()..os.pyx*
...
os.P_PID                                               *P_PID..os.pyx*
os.P_PGID                                             *P_PGID..os.pyx*
os.P_ALL                                               *P_ALL..os.pyx*
os.P_PIDFD                                           *P_PIDFD..os.pyx*
...
os.WCONTINUED                                     *WCONTINUED..os.pyx*
...
os.CLD_EXITED                                     *CLD_EXITED..os.pyx*
os.CLD_KILLED                                     *CLD_KILLED..os.pyx*
os.CLD_DUMPED                                     *CLD_DUMPED..os.pyx*
os.CLD_TRAPPED                                   *CLD_TRAPPED..os.pyx*
os.CLD_STOPPED                                   *CLD_STOPPED..os.pyx*
os.CLD_CONTINUED                               *CLD_CONTINUED..os.pyx*
...
os.waitstatus_to_exitcode(status)   *waitstatus_to_exitcode()..os.pyx*
...
os.WCOREDUMP(status, /)                          *WCOREDUMP()..os.pyx*
...
os.WIFCONTINUED(status)                       *WIFCONTINUED()..os.pyx*
...
os.WIFSTOPPED(status)                           *WIFSTOPPED()..os.pyx*
...
os.WIFSIGNALED(status)                         *WIFSIGNALED()..os.pyx*
...
os.WIFEXITED(status)                             *WIFEXITED()..os.pyx*
...
os.WEXITSTATUS(status)                         *WEXITSTATUS()..os.pyx*
...
os.WSTOPSIG(status)                               *WSTOPSIG()..os.pyx*
...
os.WTERMSIG(status)                               *WTERMSIG()..os.pyx*
...
os.SCHED_OTHER                                   *SCHED_OTHER..os.pyx*

   The default scheduling policy.

os.SCHED_BATCH                                   *SCHED_BATCH..os.pyx*

   Scheduling policy for CPU-intensive processes that tries to
   preserve interactivity on the rest of the computer.

os.SCHED_IDLE                                     *SCHED_IDLE..os.pyx*

   Scheduling policy for extremely low priority background tasks.

os.SCHED_SPORADIC                             *SCHED_SPORADIC..os.pyx*

   Scheduling policy for sporadic server programs.

os.SCHED_FIFO                                     *SCHED_FIFO..os.pyx*

   A First In First Out scheduling policy.

os.SCHED_RR                                         *SCHED_RR..os.pyx*

   A round-robin scheduling policy.

os.SCHED_RESET_ON_FORK                   *SCHED_RESET_ON_FORK..os.pyx*
...
class os.sched_param(sched_priority)             *sched_param..os.pyx*
   ...
   sched_priority                    *sched_param.sched_priority..os.pyx*

      The scheduling priority for a scheduling policy.

os.sched_get_priority_min(policy)   *sched_get_priority_min()..os.pyx*

   Get the minimum priority value for _policy_. _policy_ is one of the
   scheduling policy constants above.

os.sched_get_priority_max(policy)   *sched_get_priority_max()..os.pyx*

   Get the maximum priority value for _policy_. _policy_ is one of the
   scheduling policy constants above.

                                        *sched_setscheduler()..os.pyx*
...
os.sched_getscheduler(pid, /)           *sched_getscheduler()..os.pyx*
...
os.sched_setparam(pid, param, /)            *sched_setparam()..os.pyx*
...
os.sched_getparam(pid, /)                   *sched_getparam()..os.pyx*
...
os.sched_rr_get_interval(pid, /)     *sched_rr_get_interval()..os.pyx*

   Return the round-robin quantum in seconds for the process with PID
   _pid_. A _pid_ of 0 means the calling process.

os.sched_yield()                               *sched_yield()..os.pyx*

   Voluntarily relinquish the CPU.

os.sched_setaffinity(pid, mask, /)       *sched_setaffinity()..os.pyx*
...
os.sched_getaffinity(pid, /)             *sched_getaffinity()..os.pyx*
...
os.confstr(name, /)                                *confstr()..os.pyx*
...
os.confstr_names                               *confstr_names..os.pyx*
...
os.getloadavg()                                 *getloadavg()..os.pyx*
...
os.sysconf(name, /)                                *sysconf()..os.pyx*
...
os.sysconf_names                               *sysconf_names..os.pyx*
...
os.devnull                                           *devnull..os.pyx*

   The file path of the null device. For example: "'/dev/null'" for
   POSIX, "'nul'" for Windows.  Also available via "os.path".

os.RTLD_LAZY                                       *RTLD_LAZY..os.pyx*
os.RTLD_NOW                                         *RTLD_NOW..os.pyx*
os.RTLD_GLOBAL                                   *RTLD_GLOBAL..os.pyx*
os.RTLD_LOCAL                                     *RTLD_LOCAL..os.pyx*
os.RTLD_NODELETE                               *RTLD_NODELETE..os.pyx*
os.RTLD_NOLOAD                                   *RTLD_NOLOAD..os.pyx*
os.RTLD_DEEPBIND                               *RTLD_DEEPBIND..os.pyx*
...
os.getrandom(size, flags=0)                      *getrandom()..os.pyx*
...
os.urandom(size, /)                                *urandom()..os.pyx*
...
os.GRND_NONBLOCK                               *GRND_NONBLOCK..os.pyx*
...
os.GRND_RANDOM                                   *GRND_RANDOM..os.pyx*
