*pickle.pyx*                                  Last change: 2023 Sep 15
...
pickle.HIGHEST_PROTOCOL                 *HIGHEST_PROTOCOL..pickle.pyx*
...
pickle.DEFAULT_PROTOCOL                 *DEFAULT_PROTOCOL..pickle.pyx*
...
exception pickle.PickleError                 *PickleError..pickle.pyx*

   Common base class for the other pickling exceptions.  It inherits
   "Exception".

exception pickle.PicklingError             *PicklingError..pickle.pyx*
...
exception pickle.UnpicklingError         *UnpicklingError..pickle.pyx*
...
class pickle.Pickler(file, protocol=None, *, fix_imports=True, buffer_callback=None)
   ...
   dump(obj)                                 *Pickler.dump()..pickle.pyx*

      Write the pickled representation of _obj_ to the open file
      object given in the constructor.

   persistent_id(obj)               *Pickler.persistent_id()..pickle.pyx*
   ...
   dispatch_table                    *Pickler.dispatch_table..pickle.pyx*
   ...
   reducer_override(obj)         *Pickler.reducer_override()..pickle.pyx*
...
class pickle.Unpickler(file, *, fix_imports=True, encoding='ASCII', errors='strict', buffers=None)
   ...
   load()                                  *Unpickler.load()..pickle.pyx*
   ...
   persistent_load(pid)         *Unpickler.persistent_load()..pickle.pyx*
   ...
   find_class(module, name)          *Unpickler.find_class()..pickle.pyx*
...
class pickle.PickleBuffer(buffer)           *PickleBuffer..pickle.pyx*
   ...
   raw()                                 *PickleBuffer.raw()..pickle.pyx*
   ...
   release()                         *PickleBuffer.release()..pickle.pyx*
...
object.__getnewargs_ex__()    *object.__getnewargs_ex__()..pickle.pyx*
...
object.__getnewargs__()          *object.__getnewargs__()..pickle.pyx*
...
object.__getstate__()              *object.__getstate__()..pickle.pyx*
...
object.__setstate__(state)         *object.__setstate__()..pickle.pyx*
...
object.__reduce__()                  *object.__reduce__()..pickle.pyx*
...
object.__reduce_ex__(protocol)    *object.__reduce_ex__()..pickle.pyx*
