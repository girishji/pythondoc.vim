*py_compile.pyx*                              Last change: 2023 Sep 15
...
exception py_compile.PyCompileError   *PyCompileError..py_compile.pyx*

   Exception raised when an error occurs while attempting to compile
   the file.

                                           *compile()..py_compile.pyx*
py_compile.compile(file, cfile=None, dfile=None, doraise=False, optimize=-1, invalidation_mode=PycInvalidationMode.TIMESTAMP, quiet=0)
   ...
   **PEP 3147**-compliant.  Previous default was _file_ + "'c'" ("'o'"
   ...
   Changed in version 3.8: The _quiet_ parameter was added.
                                 ...
                                 *PycInvalidationMode..py_compile.pyx*
class py_compile.PycInvalidationMode
   ...
   TIMESTAMP              *PycInvalidationMode.TIMESTAMP..py_compile.pyx*
   ...
   CHECKED_HASH        *PycInvalidationMode.CHECKED_HASH..py_compile.pyx*
   ...
   UNCHECKED_HASH    *PycInvalidationMode.UNCHECKED_HASH..py_compile.pyx*
