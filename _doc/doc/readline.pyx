*readline.pyx*                                Last change: 2023 Sep 15
...
readline.parse_and_bind(string)       *parse_and_bind()..readline.pyx*

   Execute the init line provided in the _string_ argument. This calls
   "rl_parse_and_bind()" in the underlying library.

readline.read_init_file([filename])   *read_init_file()..readline.pyx*
...
readline.get_line_buffer()           *get_line_buffer()..readline.pyx*

   Return the current contents of the line buffer ("rl_line_buffer" in
   the underlying library).

readline.insert_text(string)             *insert_text()..readline.pyx*
...
readline.redisplay()                       *redisplay()..readline.pyx*
...
The following functions operate on a history file:
                                   ...
                                   *read_history_file()..readline.pyx*
readline.read_history_file([filename])
   ...
   in the underlying library.
                                  ...
                                  *write_history_file()..readline.pyx*
readline.write_history_file([filename])
   ...
   "write_history()" in the underlying library.
                                 ...
                                 *append_history_file()..readline.pyx*
...
readline.get_history_length()     *get_history_length()..readline.pyx*

                                  *set_history_length()..readline.pyx*
...
readline.clear_history()               *clear_history()..readline.pyx*
   ...
   compiled for a version of the library that supports it.
                          ...
                          *get_current_history_length()..readline.pyx*
...
readline.get_history_item(index)    *get_history_item()..readline.pyx*
   ...
   library.
                                 ...
                                 *remove_history_item()..readline.pyx*
readline.remove_history_item(pos)
   ...
   underlying library.
                                ...
                                *replace_history_item()..readline.pyx*
...
readline.set_startup_hook([function])
   ...
   arguments just before readline prints the first prompt.
                                  ...
                                  *set_pre_input_hook()..readline.pyx*
...
readline.set_completer([function])     *set_completer()..readline.pyx*
...
readline.get_completer()               *get_completer()..readline.pyx*

   Get the completer function, or "None" if no completer function has
   been set.

readline.get_completion_type()   *get_completion_type()..readline.pyx*

   Get the type of completion being attempted.  This returns the
   "rl_completion_type" variable in the underlying library as an
   integer.

readline.get_begidx()                     *get_begidx()..readline.pyx*
readline.get_endidx()                     *get_endidx()..readline.pyx*
   ...
   libedit is known to behave differently than libreadline.
                                ...
                                *set_completer_delims()..readline.pyx*
readline.set_completer_delims(string)

                                *get_completer_delims()..readline.pyx*
readline.get_completer_delims()
   ...
   library.
                 ...
                 *set_completion_display_matches_hook()..readline.pyx*
