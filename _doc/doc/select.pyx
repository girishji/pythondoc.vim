*select.pyx*                                  Last change: 2023 Sep 15
...
exception select.error                             *error..select.pyx*
...
select.devpoll()                               *devpoll()..select.pyx*
...
select.epoll(sizehint=-1, flags=0)               *epoll()..select.pyx*
...
select.kqueue()                                 *kqueue()..select.pyx*
...
select.select(rlist, wlist, xlist[, timeout])   *select()..select.pyx*
...
select.PIPE_BUF                                 *PIPE_BUF..select.pyx*
...
devpoll.close()                          *devpoll.close()..select.pyx*

   Close the file descriptor of the polling object.

   New in version 3.4.

devpoll.closed                            *devpoll.closed..select.pyx*

   "True" if the polling object is closed.

   New in version 3.4.

devpoll.fileno()                        *devpoll.fileno()..select.pyx*

   Return the file descriptor number of the polling object.

   New in version 3.4.

devpoll.register(fd[, eventmask])     *devpoll.register()..select.pyx*
...
devpoll.poll([timeout])                   *devpoll.poll()..select.pyx*
...
epoll.close()                              *epoll.close()..select.pyx*

   Close the control file descriptor of the epoll object.

epoll.closed                                *epoll.closed..select.pyx*

   "True" if the epoll object is closed.

epoll.fileno()                            *epoll.fileno()..select.pyx*

   Return the file descriptor number of the control fd.

epoll.fromfd(fd)                          *epoll.fromfd()..select.pyx*

   Create an epoll object from a given file descriptor.

epoll.register(fd[, eventmask])         *epoll.register()..select.pyx*

   Register a fd descriptor with the epoll object.

epoll.modify(fd, eventmask)               *epoll.modify()..select.pyx*

   Modify a registered file descriptor.

epoll.unregister(fd)                  *epoll.unregister()..select.pyx*
...
epoll.poll(timeout=None, maxevents=-1)      *epoll.poll()..select.pyx*
...
poll.register(fd[, eventmask])           *poll.register()..select.pyx*
...
poll.modify(fd, eventmask)                 *poll.modify()..select.pyx*
...
poll.unregister(fd)                    *poll.unregister()..select.pyx*
...
poll.poll([timeout])                         *poll.poll()..select.pyx*
...
kqueue.close()                            *kqueue.close()..select.pyx*

   Close the control file descriptor of the kqueue object.

kqueue.closed                              *kqueue.closed..select.pyx*

   "True" if the kqueue object is closed.

kqueue.fileno()                          *kqueue.fileno()..select.pyx*

   Return the file descriptor number of the control fd.

kqueue.fromfd(fd)                        *kqueue.fromfd()..select.pyx*

   Create a kqueue object from a given file descriptor.

                                        *kqueue.control()..select.pyx*
...
kevent.ident                                *kevent.ident..select.pyx*
...
kevent.filter                              *kevent.filter..select.pyx*
...
kevent.flags                                *kevent.flags..select.pyx*
...
kevent.fflags                              *kevent.fflags..select.pyx*
...
kevent.data                                  *kevent.data..select.pyx*

   Filter specific data.

kevent.udata                                *kevent.udata..select.pyx*
