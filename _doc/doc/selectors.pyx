*selectors.pyx*                               Last change: 2023 Sep 15
...
class selectors.SelectorKey               *SelectorKey..selectors.pyx*
   ...
   fileobj                           *SelectorKey.fileobj..selectors.pyx*

      File object registered.

   fd                                     *SelectorKey.fd..selectors.pyx*

      Underlying file descriptor.

   events                             *SelectorKey.events..selectors.pyx*

      Events that must be waited for on this file object.

   data                                 *SelectorKey.data..selectors.pyx*

      Optional opaque data associated to this file object: for
      example, this could be used to store a per-client session ID.

class selectors.BaseSelector             *BaseSelector..selectors.pyx*
   ...
   _context manager_ protocol.
                              ...
                              *BaseSelector.register()..selectors.pyx*
   abstractmethod register(fileobj, events, data=None)
      ...
      or "KeyError" if the file object is already registered.
                            ...
                            *BaseSelector.unregister()..selectors.pyx*
   abstractmethod unregister(fileobj)
      ...
      method or its "fileno()" method has an invalid return value).
                                ...
                                *BaseSelector.modify()..selectors.pyx*
   modify(fileobj, events, data=None)
      ...
      or "KeyError" if the file object is not registered.
                                ...
                                *BaseSelector.select()..selectors.pyx*
   ...
   close()                          *BaseSelector.close()..selectors.pyx*
   ...
   get_key(fileobj)               *BaseSelector.get_key()..selectors.pyx*
   ...
   abstractmethod get_map()       *BaseSelector.get_map()..selectors.pyx*
...
class selectors.DefaultSelector       *DefaultSelector..selectors.pyx*

   The default selector class, using the most efficient implementation
   available on the current platform. This should be the default
   choice for most users.

class selectors.SelectSelector         *SelectSelector..selectors.pyx*

   "select.select()"-based selector.

class selectors.PollSelector             *PollSelector..selectors.pyx*

   "select.poll()"-based selector.

class selectors.EpollSelector           *EpollSelector..selectors.pyx*

   "select.epoll()"-based selector.

   fileno()                       *EpollSelector.fileno()..selectors.pyx*

      This returns the file descriptor used by the underlying
      "select.epoll()" object.

class selectors.DevpollSelector       *DevpollSelector..selectors.pyx*

   "select.devpoll()"-based selector.

   fileno()                     *DevpollSelector.fileno()..selectors.pyx*
...
class selectors.KqueueSelector         *KqueueSelector..selectors.pyx*

   "select.kqueue()"-based selector.

   fileno()                      *KqueueSelector.fileno()..selectors.pyx*
