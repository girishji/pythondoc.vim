*shutil.pyx*                                  Last change: 2023 Sep 15
...
shutil.copyfileobj(fsrc, fdst[, length])   *copyfileobj()..shutil.pyx*
...
exception shutil.SameFileError             *SameFileError..shutil.pyx*
...
shutil.copy(src, dst, *, follow_symlinks=True)    *copy()..shutil.pyx*
...
shutil.ignore_patterns(*patterns)      *ignore_patterns()..shutil.pyx*
...
shutil.rmtree(path, ignore_errors=False, onerror=None, *, onexc=None, dir_fd=None)
   ...
   _onerror_.
                           ...
                           *rmtree.avoids_symlink_attacks..shutil.pyx*
...
shutil.move(src, dst, copy_function=copy2)        *move()..shutil.pyx*
   ...
   "copytree()" is called, passing it the _copy_function_. The default
   _copy_function_ is "copy2()".  Using "copy()" as the
...
shutil.disk_usage(path)                     *disk_usage()..shutil.pyx*
...
shutil.chown(path, user=None, group=None)        *chown()..shutil.pyx*
...
exception shutil.Error                             *Error..shutil.pyx*
...
shutil.get_archive_formats()       *get_archive_formats()..shutil.pyx*
   ...
   * _xztar_: xz’ed tar-file (if the "lzma" module is available).
   ...
   existing formats, by using "register_archive_format()".
                               ...
                               *register_archive_format()..shutil.pyx*
...
shutil.unpack_archive(filename[, extract_dir[, format[, filter]]])
   ...
   Changed in version 3.12: Added the _filter_ argument.
                                ...
                                *register_unpack_format()..shutil.pyx*
shutil.register_unpack_format(name, extensions, function[, extra_args[, description]])
   ...
   * additional keyword arguments, specified by _extra_args_ as a
   ...
   returned by the "get_unpack_formats()" function.
                              ...
                              *unregister_unpack_format()..shutil.pyx*
shutil.unregister_unpack_format(name)

   Unregister an unpack format. _name_ is the name of the format.

shutil.get_unpack_formats()         *get_unpack_formats()..shutil.pyx*
