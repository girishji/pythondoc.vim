*signal.pyx*                                  Last change: 2023 Sep 15
...
class signal.Signals                             *Signals..signal.pyx*
...
class signal.Handlers                           *Handlers..signal.pyx*

   "enum.IntEnum" collection the constants "SIG_DFL" and "SIG_IGN".

   New in version 3.5.

class signal.Sigmasks                           *Sigmasks..signal.pyx*
...
signal.SIG_DFL                                   *SIG_DFL..signal.pyx*
...
signal.SIG_IGN                                   *SIG_IGN..signal.pyx*

   This is another standard signal handler, which will simply ignore
   the given signal.

signal.SIGABRT                                   *SIGABRT..signal.pyx*

   Abort signal from _abort(3)_.

signal.SIGALRM                                   *SIGALRM..signal.pyx*

   Timer signal from _alarm(2)_.

   Availability: Unix.

signal.SIGBREAK                                 *SIGBREAK..signal.pyx*

   Interrupt from keyboard (CTRL + BREAK).

   Availability: Windows.

signal.SIGBUS                                     *SIGBUS..signal.pyx*

   Bus error (bad memory access).

   Availability: Unix.

signal.SIGCHLD                                   *SIGCHLD..signal.pyx*

   Child process stopped or terminated.

   Availability: Unix.

signal.SIGCLD                                     *SIGCLD..signal.pyx*

   Alias to "SIGCHLD".

signal.SIGCONT                                   *SIGCONT..signal.pyx*

   Continue the process if it is currently stopped

   Availability: Unix.

signal.SIGFPE                                     *SIGFPE..signal.pyx*
...
signal.SIGHUP                                     *SIGHUP..signal.pyx*
...
signal.SIGILL                                     *SIGILL..signal.pyx*

   Illegal instruction.

signal.SIGINT                                     *SIGINT..signal.pyx*

   Interrupt from keyboard (CTRL + C).

   Default action is to raise "KeyboardInterrupt".

signal.SIGKILL                                   *SIGKILL..signal.pyx*
...
signal.SIGPIPE                                   *SIGPIPE..signal.pyx*
...
signal.SIGSEGV                                   *SIGSEGV..signal.pyx*

   Segmentation fault: invalid memory reference.

signal.SIGSTKFLT                               *SIGSTKFLT..signal.pyx*
...
signal.SIGTERM                                   *SIGTERM..signal.pyx*

   Termination signal.

signal.SIGUSR1                                   *SIGUSR1..signal.pyx*

   User-defined signal 1.

   Availability: Unix.

signal.SIGUSR2                                   *SIGUSR2..signal.pyx*

   User-defined signal 2.

   Availability: Unix.

signal.SIGWINCH                                 *SIGWINCH..signal.pyx*
...
signal.CTRL_C_EVENT                         *CTRL_C_EVENT..signal.pyx*
...
signal.CTRL_BREAK_EVENT                 *CTRL_BREAK_EVENT..signal.pyx*
...
signal.SIG_BLOCK                               *SIG_BLOCK..signal.pyx*
...
signal.SIG_UNBLOCK                           *SIG_UNBLOCK..signal.pyx*
...
signal.SIG_SETMASK                           *SIG_SETMASK..signal.pyx*
...
exception signal.ItimerError                 *ItimerError..signal.pyx*
...
signal.alarm(time)                               *alarm()..signal.pyx*
...
signal.getsignal(signalnum)                  *getsignal()..signal.pyx*
...
signal.strsignal(signalnum)                  *strsignal()..signal.pyx*
...
signal.valid_signals()                   *valid_signals()..signal.pyx*
...
signal.raise_signal(signum)               *raise_signal()..signal.pyx*

   Sends a signal to the calling process. Returns nothing.

   New in version 3.8.

                                     *pidfd_send_signal()..signal.pyx*
...
signal.pthread_sigmask(how, mask)      *pthread_sigmask()..signal.pyx*
...
signal.getitimer(which)                      *getitimer()..signal.pyx*
...
signal.siginterrupt(signalnum, flag)      *siginterrupt()..signal.pyx*
...
signal.signal(signalnum, handler)               *signal()..signal.pyx*
...
signal.sigpending()                         *sigpending()..signal.pyx*
...
signal.sigwait(sigset)                         *sigwait()..signal.pyx*
...
signal.sigwaitinfo(sigset)                 *sigwaitinfo()..signal.pyx*
...
signal.sigtimedwait(sigset, timeout)      *sigtimedwait()..signal.pyx*
