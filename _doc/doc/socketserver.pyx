*socketserver.pyx*                            Last change: 2023 Sep 15
...
class socketserver.UDPServer(server_address, RequestHandlerClass, bind_and_activate=True)
   ...
   parameters are the same as for "TCPServer".
                                  ...
                                  *UnixStreamServer..socketserver.pyx*
class socketserver.UnixStreamServer(server_address, RequestHandlerClass, bind_and_activate=True)

                                *UnixDatagramServer..socketserver.pyx*
...
class socketserver.ForkingMixIn       *ForkingMixIn..socketserver.pyx*
class socketserver.ThreadingMixIn   *ThreadingMixIn..socketserver.pyx*
...
<
   ...
   in for the pre-3.7 behaviour.
                                  ...
                                  *ForkingTCPServer..socketserver.pyx*
class socketserver.ForkingTCPServer

                                  *ForkingUDPServer..socketserver.pyx*
class socketserver.ForkingUDPServer

                                *ThreadingTCPServer..socketserver.pyx*
class socketserver.ThreadingTCPServer

                                *ThreadingUDPServer..socketserver.pyx*
class socketserver.ThreadingUDPServer

                           *ForkingUnixStreamServer..socketserver.pyx*
class socketserver.ForkingUnixStreamServer

                         *ForkingUnixDatagramServer..socketserver.pyx*
class socketserver.ForkingUnixDatagramServer

                         *ThreadingUnixStreamServer..socketserver.pyx*
class socketserver.ThreadingUnixStreamServer

                       *ThreadingUnixDatagramServer..socketserver.pyx*
...
class socketserver.BaseServer(server_address, RequestHandlerClass)
   ...
   fileno()                       *BaseServer.fileno()..socketserver.pyx*
   ...
   handle_request()       *BaseServer.handle_request()..socketserver.pyx*
      ...
      called and "handle_request()" will return.
                        ...
                        *BaseServer.serve_forever()..socketserver.pyx*
   ...
   service_actions()     *BaseServer.service_actions()..socketserver.pyx*
   ...
   socket                           *BaseServer.socket..socketserver.pyx*
   ...
   The server classes support the following class variables:
                    ...
                    *BaseServer.allow_reuse_address..socketserver.pyx*
   allow_reuse_address
   ...
   request_queue_size   *BaseServer.request_queue_size..socketserver.pyx*
   ...
   aren’t useful to external users of the server object.
                       ...
                       *BaseServer.finish_request()..socketserver.pyx*
   finish_request(request, client_address)

      Actually processes the request by instantiating
      "RequestHandlerClass" and calling its "handle()" method.

   get_request()             *BaseServer.get_request()..socketserver.pyx*
      ...
      with the client, and the client’s address.
                         ...
                         *BaseServer.handle_error()..socketserver.pyx*
   ...
   handle_timeout()       *BaseServer.handle_timeout()..socketserver.pyx*
      ...
      nothing.
                      ...
                      *BaseServer.process_request()..socketserver.pyx*
   ...
   server_activate()     *BaseServer.server_activate()..socketserver.pyx*
   ...
   server_bind()             *BaseServer.server_bind()..socketserver.pyx*

      Called by the server’s constructor to bind the socket to the
      desired address. May be overridden.

                       *BaseServer.verify_request()..socketserver.pyx*
...
=======================
                                ...
                                *BaseRequestHandler..socketserver.pyx*
class socketserver.BaseRequestHandler
   ...
   finish()               *BaseRequestHandler.finish()..socketserver.pyx*
      ...
      "setup()" raises an exception, this function will not be called.
                              ...
                              *StreamRequestHandler..socketserver.pyx*
class socketserver.StreamRequestHandler

                            *DatagramRequestHandler..socketserver.pyx*
