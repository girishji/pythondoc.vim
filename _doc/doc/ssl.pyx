*ssl.pyx*                                     Last change: 2023 Sep 15
...
purposes.
                                   ...
                                   *create_default_context()..ssl.pyx*
...
exception ssl.SSLError                             *SSLError..ssl.pyx*
   ...
   library                                    *SSLError.library..ssl.pyx*
   ...
   reason                                      *SSLError.reason..ssl.pyx*
...
exception ssl.SSLZeroReturnError         *SSLZeroReturnError..ssl.pyx*
...
exception ssl.SSLWantReadError             *SSLWantReadError..ssl.pyx*
...
exception ssl.SSLWantWriteError           *SSLWantWriteError..ssl.pyx*
...
exception ssl.SSLSyscallError               *SSLSyscallError..ssl.pyx*
...
exception ssl.SSLEOFError                       *SSLEOFError..ssl.pyx*
   ...
   New in version 3.3.
                                   ...
                                   *SSLCertVerificationError..ssl.pyx*
exception ssl.SSLCertVerificationError
   ...
   verify_code            *SSLCertVerificationError.verify_code..ssl.pyx*

      A numeric error number that denotes the verification error.

   verify_message      *SSLCertVerificationError.verify_message..ssl.pyx*

      A human readable string of the verification error.

exception ssl.CertificateError             *CertificateError..ssl.pyx*
...
ssl.RAND_bytes(num)                            *RAND_bytes()..ssl.pyx*
...
ssl.RAND_status()                             *RAND_status()..ssl.pyx*
...
ssl.RAND_add(bytes, entropy)                     *RAND_add()..ssl.pyx*
...
<
   ...
   the input format)
                                   ...
                                   *get_server_certificate()..ssl.pyx*
...
ssl.enum_certificates(store_name)       *enum_certificates()..ssl.pyx*
...
ssl.enum_crls(store_name)                       *enum_crls()..ssl.pyx*
...
ssl.CERT_NONE                                     *CERT_NONE..ssl.pyx*
...
ssl.CERT_OPTIONAL                             *CERT_OPTIONAL..ssl.pyx*
...
ssl.CERT_REQUIRED                             *CERT_REQUIRED..ssl.pyx*
...
class ssl.VerifyMode                             *VerifyMode..ssl.pyx*

   "enum.IntEnum" collection of CERT_* constants.

   New in version 3.6.

ssl.VERIFY_DEFAULT                           *VERIFY_DEFAULT..ssl.pyx*
...
ssl.VERIFY_CRL_CHECK_LEAF             *VERIFY_CRL_CHECK_LEAF..ssl.pyx*
...
ssl.VERIFY_CRL_CHECK_CHAIN           *VERIFY_CRL_CHECK_CHAIN..ssl.pyx*
...
ssl.VERIFY_X509_STRICT                   *VERIFY_X509_STRICT..ssl.pyx*
...
ssl.VERIFY_ALLOW_PROXY_CERTS       *VERIFY_ALLOW_PROXY_CERTS..ssl.pyx*
...
ssl.VERIFY_X509_TRUSTED_FIRST     *VERIFY_X509_TRUSTED_FIRST..ssl.pyx*
...
ssl.VERIFY_X509_PARTIAL_CHAIN     *VERIFY_X509_PARTIAL_CHAIN..ssl.pyx*
...
class ssl.VerifyFlags                           *VerifyFlags..ssl.pyx*

   "enum.IntFlag" collection of VERIFY_* constants.

   New in version 3.6.

ssl.PROTOCOL_TLS                               *PROTOCOL_TLS..ssl.pyx*
...
ssl.PROTOCOL_TLS_CLIENT                 *PROTOCOL_TLS_CLIENT..ssl.pyx*
...
ssl.PROTOCOL_TLS_SERVER                 *PROTOCOL_TLS_SERVER..ssl.pyx*
...
ssl.PROTOCOL_SSLv23                         *PROTOCOL_SSLv23..ssl.pyx*

   Alias for "PROTOCOL_TLS".

   Deprecated since version 3.6: Use "PROTOCOL_TLS" instead.

ssl.PROTOCOL_SSLv3                           *PROTOCOL_SSLv3..ssl.pyx*
...
ssl.PROTOCOL_TLSv1                           *PROTOCOL_TLSv1..ssl.pyx*
...
ssl.PROTOCOL_TLSv1_1                       *PROTOCOL_TLSv1_1..ssl.pyx*
...
ssl.PROTOCOL_TLSv1_2                       *PROTOCOL_TLSv1_2..ssl.pyx*
...
ssl.OP_NO_SSLv2                                 *OP_NO_SSLv2..ssl.pyx*
...
ssl.OP_NO_SSLv3                                 *OP_NO_SSLv3..ssl.pyx*
...
ssl.OP_NO_TLSv1                                 *OP_NO_TLSv1..ssl.pyx*
...
ssl.OP_NO_TLSv1_1                             *OP_NO_TLSv1_1..ssl.pyx*
...
ssl.OP_NO_TLSv1_2                             *OP_NO_TLSv1_2..ssl.pyx*
...
ssl.OP_NO_TLSv1_3                             *OP_NO_TLSv1_3..ssl.pyx*
...
ssl.OP_NO_RENEGOTIATION                 *OP_NO_RENEGOTIATION..ssl.pyx*
   ...
   New in version 3.7.
                                ...
                                *OP_CIPHER_SERVER_PREFERENCE..ssl.pyx*
...
ssl.OP_SINGLE_DH_USE                       *OP_SINGLE_DH_USE..ssl.pyx*
...
ssl.OP_SINGLE_ECDH_USE                   *OP_SINGLE_ECDH_USE..ssl.pyx*
...
ssl.OP_ENABLE_MIDDLEBOX_COMPAT   *OP_ENABLE_MIDDLEBOX_COMPAT..ssl.pyx*
...
ssl.OP_NO_COMPRESSION                     *OP_NO_COMPRESSION..ssl.pyx*
...
class ssl.Options                                   *Options..ssl.pyx*

   "enum.IntFlag" collection of OP_* constants.

ssl.OP_NO_TICKET                               *OP_NO_TICKET..ssl.pyx*

   Prevent client side from requesting a session ticket.

   New in version 3.6.

ssl.OP_IGNORE_UNEXPECTED_EOF       *OP_IGNORE_UNEXPECTED_EOF..ssl.pyx*
...
ssl.OP_ENABLE_KTLS                           *OP_ENABLE_KTLS..ssl.pyx*
...
ssl.OP_LEGACY_SERVER_CONNECT       *OP_LEGACY_SERVER_CONNECT..ssl.pyx*
...
ssl.HAS_ALPN                                       *HAS_ALPN..ssl.pyx*
   ...
   New in version 3.5.
                                ...
                                *HAS_NEVER_CHECK_COMMON_NAME..ssl.pyx*
...
ssl.HAS_SSLv2                                     *HAS_SSLv2..ssl.pyx*
...
ssl.HAS_SSLv3                                     *HAS_SSLv3..ssl.pyx*
...
ssl.HAS_TLSv1                                     *HAS_TLSv1..ssl.pyx*
...
ssl.HAS_TLSv1_1                                 *HAS_TLSv1_1..ssl.pyx*
...
ssl.HAS_TLSv1_2                                 *HAS_TLSv1_2..ssl.pyx*
...
ssl.HAS_TLSv1_3                                 *HAS_TLSv1_3..ssl.pyx*
...
ssl.CHANNEL_BINDING_TYPES             *CHANNEL_BINDING_TYPES..ssl.pyx*
...
ssl.OPENSSL_VERSION                         *OPENSSL_VERSION..ssl.pyx*
...
ssl.OPENSSL_VERSION_INFO               *OPENSSL_VERSION_INFO..ssl.pyx*
...
ssl.OPENSSL_VERSION_NUMBER           *OPENSSL_VERSION_NUMBER..ssl.pyx*
...
<
   New in version 3.2.
                        ...
                        *ALERT_DESCRIPTION_HANDSHAKE_FAILURE..ssl.pyx*
ssl.ALERT_DESCRIPTION_HANDSHAKE_FAILURE

                           *ALERT_DESCRIPTION_INTERNAL_ERROR..ssl.pyx*
...
class ssl.AlertDescription                 *AlertDescription..ssl.pyx*

   "enum.IntEnum" collection of ALERT_DESCRIPTION_* constants.

   New in version 3.6.

Purpose.SERVER_AUTH                     *Purpose.SERVER_AUTH..ssl.pyx*
...
Purpose.CLIENT_AUTH                     *Purpose.CLIENT_AUTH..ssl.pyx*
...
class ssl.SSLErrorNumber                     *SSLErrorNumber..ssl.pyx*

   "enum.IntEnum" collection of SSL_ERROR_* constants.

   New in version 3.6.

class ssl.TLSVersion                             *TLSVersion..ssl.pyx*
...
TLSVersion.MINIMUM_SUPPORTED   *TLSVersion.MINIMUM_SUPPORTED..ssl.pyx*

TLSVersion.MAXIMUM_SUPPORTED   *TLSVersion.MAXIMUM_SUPPORTED..ssl.pyx*
...
TLSVersion.SSLv3                           *TLSVersion.SSLv3..ssl.pyx*

TLSVersion.TLSv1                           *TLSVersion.TLSv1..ssl.pyx*

TLSVersion.TLSv1_1                       *TLSVersion.TLSv1_1..ssl.pyx*

TLSVersion.TLSv1_2                       *TLSVersion.TLSv1_2..ssl.pyx*

TLSVersion.TLSv1_3                       *TLSVersion.TLSv1_3..ssl.pyx*
...
class ssl.SSLSocket(socket.socket)                *SSLSocket..ssl.pyx*
...
SSLSocket.read(len=1024, buffer=None)      *SSLSocket.read()..ssl.pyx*
...
SSLSocket.write(buf)                      *SSLSocket.write()..ssl.pyx*
...
SSLSocket.do_handshake()           *SSLSocket.do_handshake()..ssl.pyx*
...
SSLSocket.cipher()                       *SSLSocket.cipher()..ssl.pyx*
...
SSLSocket.shared_ciphers()       *SSLSocket.shared_ciphers()..ssl.pyx*
...
SSLSocket.compression()             *SSLSocket.compression()..ssl.pyx*
   ...
   New in version 3.3.
                            ...
                            *SSLSocket.get_channel_binding()..ssl.pyx*
SSLSocket.get_channel_binding(cb_type='tls-unique')
   ...
   New in version 3.3.
                         ...
                         *SSLSocket.selected_alpn_protocol()..ssl.pyx*
SSLSocket.selected_alpn_protocol()
   ...
   New in version 3.5.
                          ...
                          *SSLSocket.selected_npn_protocol()..ssl.pyx*
...
SSLSocket.unwrap()                       *SSLSocket.unwrap()..ssl.pyx*
   ...
   connection, rather than the original socket.
                   ...
                   *SSLSocket.verify_client_post_handshake()..ssl.pyx*
...
SSLSocket.version()                     *SSLSocket.version()..ssl.pyx*
...
SSLSocket.pending()                     *SSLSocket.pending()..ssl.pyx*

   Returns the number of already decrypted bytes available for read,
   pending on the connection.

SSLSocket.context                         *SSLSocket.context..ssl.pyx*

   The "SSLContext" object this SSL socket is tied to.

   New in version 3.2.

SSLSocket.server_side                 *SSLSocket.server_side..ssl.pyx*
...
SSLSocket.server_hostname         *SSLSocket.server_hostname..ssl.pyx*
...
SSLSocket.session                         *SSLSocket.session..ssl.pyx*
...
SSLSocket.session_reused           *SSLSocket.session_reused..ssl.pyx*
...
class ssl.SSLContext(protocol=None)              *SSLContext..ssl.pyx*
...
"SSLContext" objects have the following methods and attributes:
                              ...
                              *SSLContext.cert_store_stats()..ssl.pyx*
...
<
   New in version 3.4.
                               ...
                               *SSLContext.load_cert_chain()..ssl.pyx*
SSLContext.load_cert_chain(certfile, keyfile=None, password=None)
   ...
   Changed in version 3.3: New optional argument _password_.
                            ...
                            *SSLContext.load_default_certs()..ssl.pyx*
SSLContext.load_default_certs(purpose=Purpose.SERVER_AUTH)
   ...
   New in version 3.4.
                         ...
                         *SSLContext.load_verify_locations()..ssl.pyx*
SSLContext.load_verify_locations(cafile=None, capath=None, cadata=None)
   ...
   Changed in version 3.4: New optional argument _cadata_
                                  ...
                                  *SSLContext.get_ca_certs()..ssl.pyx*
...
SSLContext.get_ciphers()           *SSLContext.get_ciphers()..ssl.pyx*
...
<
   New in version 3.6.
                      ...
                      *SSLContext.set_default_verify_paths()..ssl.pyx*
...
SSLContext.set_ciphers(ciphers)    *SSLContext.set_ciphers()..ssl.pyx*
   ...
   Note:
     ...
     cannot be disabled with "set_ciphers()".
                            ...
                            *SSLContext.set_alpn_protocols()..ssl.pyx*
SSLContext.set_alpn_protocols(protocols)
   ...
   New in version 3.5.
                             ...
                             *SSLContext.set_npn_protocols()..ssl.pyx*
...
SSLContext.sni_callback             *SSLContext.sni_callback..ssl.pyx*
   ...
   New in version 3.7.
                         ...
                         *SSLContext.set_servername_callback..ssl.pyx*
SSLContext.set_servername_callback(server_name_callback)
   ...
   New in version 3.4.
                                ...
                                *SSLContext.load_dh_params()..ssl.pyx*
SSLContext.load_dh_params(dhfile)
   ...
   New in version 3.3.
                                ...
                                *SSLContext.set_ecdh_curve()..ssl.pyx*
   ...
   See also:
     ...
     SSL/TLS & Perfect Forward Secrecy
        Vincent Bernat.
                                   ...
                                   *SSLContext.wrap_socket()..ssl.pyx*
...
SSLContext.sslsocket_class       *SSLContext.sslsocket_class..ssl.pyx*
...
SSLContext.sslobject_class       *SSLContext.sslobject_class..ssl.pyx*
...
SSLContext.session_stats()       *SSLContext.session_stats()..ssl.pyx*
...
>
      ...
      (0, 0)
<
SSLContext.check_hostname         *SSLContext.check_hostname..ssl.pyx*
...
SSLContext.keylog_filename       *SSLContext.keylog_filename..ssl.pyx*
...
SSLContext.maximum_version       *SSLContext.maximum_version..ssl.pyx*
...
SSLContext.minimum_version       *SSLContext.minimum_version..ssl.pyx*
...
SSLContext.num_tickets               *SSLContext.num_tickets..ssl.pyx*
...
SSLContext.options                       *SSLContext.options..ssl.pyx*
   ...
   instead.
                             ...
                             *SSLContext.post_handshake_auth..ssl.pyx*
...
SSLContext.protocol                     *SSLContext.protocol..ssl.pyx*

   The protocol version chosen when constructing the context.  This
   attribute is read-only.

                     *SSLContext.hostname_checks_common_name..ssl.pyx*
...
SSLContext.security_level         *SSLContext.security_level..ssl.pyx*
...
SSLContext.verify_flags             *SSLContext.verify_flags..ssl.pyx*
...
SSLContext.verify_mode               *SSLContext.verify_mode..ssl.pyx*
...
class ssl.SSLObject                               *SSLObject..ssl.pyx*
...
class ssl.MemoryBIO                               *MemoryBIO..ssl.pyx*
   ...
   write_eof()                           *MemoryBIO.write_eof()..ssl.pyx*
...
class ssl.SSLSession                             *SSLSession..ssl.pyx*

   Session object used by "session".

   id                                            *SSLSession.id..ssl.pyx*

   time                                        *SSLSession.time..ssl.pyx*

   timeout                                  *SSLSession.timeout..ssl.pyx*

   ticket_lifetime_hint        *SSLSession.ticket_lifetime_hint..ssl.pyx*

   has_ticket                            *SSLSession.has_ticket..ssl.pyx*
