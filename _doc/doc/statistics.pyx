*statistics.pyx*                              Last change: 2023 Sep 15
...
statistics.mean(data)                         *mean()..statistics.pyx*
...
statistics.fmean(data, weights=None)         *fmean()..statistics.pyx*
...
statistics.geometric_mean(data)     *geometric_mean()..statistics.pyx*
...
statistics.median(data)                     *median()..statistics.pyx*
...
statistics.median_low(data)             *median_low()..statistics.pyx*
...
statistics.median_high(data)           *median_high()..statistics.pyx*
...
statistics.mode(data)                         *mode()..statistics.pyx*
...
statistics.multimode(data)               *multimode()..statistics.pyx*
...
statistics.pstdev(data, mu=None)            *pstdev()..statistics.pyx*
...
>
      ...
      0.986893273527251
<
statistics.pvariance(data, mu=None)      *pvariance()..statistics.pyx*
...
statistics.stdev(data, xbar=None)            *stdev()..statistics.pyx*
...
>
      ...
      1.0810874155219827
<
statistics.variance(data, xbar=None)      *variance()..statistics.pyx*
...
statistics.covariance(x, y, /)          *covariance()..statistics.pyx*
...
<
   ...
   correlation coefficient.
                                 ...
                                 *linear_regression()..statistics.pyx*
...
A single exception is defined:
                                     ...
                                     *StatisticsError..statistics.pyx*
...
class statistics.NormalDist(mu=0.0, sigma=1.0)
   ...
   samples(n, *, seed=None)        *NormalDist.samples()..statistics.pyx*
   ...
   pdf(x)                              *NormalDist.pdf()..statistics.pyx*
   ...
   cdf(x)                              *NormalDist.cdf()..statistics.pyx*
   ...
   inv_cdf(p)                      *NormalDist.inv_cdf()..statistics.pyx*
   ...
   overlap(other)                  *NormalDist.overlap()..statistics.pyx*
   ...
   quantiles(n=4)                *NormalDist.quantiles()..statistics.pyx*
   ...
   zscore(x)                        *NormalDist.zscore()..statistics.pyx*
...
The degree of smoothing is controlled by a single parameter, "h",
representing the variance of the kernel function.
>
   import math
