*stdtypes.pyx*                                Last change: 2023 Sep 15
...
int.bit_length()                      *int.bit_length()..stdtypes.pyx*
...
int.bit_count()                        *int.bit_count()..stdtypes.pyx*
...
int.as_integer_ratio()          *int.as_integer_ratio()..stdtypes.pyx*
...
int.is_integer()                      *int.is_integer()..stdtypes.pyx*
...
float.as_integer_ratio()      *float.as_integer_ratio()..stdtypes.pyx*
...
float.is_integer()                  *float.is_integer()..stdtypes.pyx*
...
container.__iter__()              *container.__iter__()..stdtypes.pyx*
...
iterator.__iter__()                *iterator.__iter__()..stdtypes.pyx*
...
iterator.__next__()                *iterator.__next__()..stdtypes.pyx*
...
class list([iterable])                            *list..stdtypes.pyx*
   ...
   * Using the type constructor: "list()" or "list(iterable)"
   ...
   sort(*, key=None, reverse=False)           *list.sort()..stdtypes.pyx*
...
class tuple([iterable])                          *tuple..stdtypes.pyx*
...
class range(stop)                                *range..stdtypes.pyx*
...
class str(object='')                               *str..stdtypes.pyx*
...
str.capitalize()                      *str.capitalize()..stdtypes.pyx*
...
str.casefold()                          *str.casefold()..stdtypes.pyx*
...
str.center(width[, fillchar])             *str.center()..stdtypes.pyx*
...
str.count(sub[, start[, end]])             *str.count()..stdtypes.pyx*
...
str.endswith(suffix[, start[, end]])    *str.endswith()..stdtypes.pyx*
...
str.expandtabs(tabsize=8)             *str.expandtabs()..stdtypes.pyx*
...
str.find(sub[, start[, end]])               *str.find()..stdtypes.pyx*
...
>
        ...
        True
<
str.format(*args, **kwargs)               *str.format()..stdtypes.pyx*
...
str.format_map(mapping)               *str.format_map()..stdtypes.pyx*
...
str.index(sub[, start[, end]])             *str.index()..stdtypes.pyx*

   Like "find()", but raise "ValueError" when the substring is not
   found.

str.isalnum()                            *str.isalnum()..stdtypes.pyx*
...
str.isalpha()                            *str.isalpha()..stdtypes.pyx*
...
str.isascii()                            *str.isascii()..stdtypes.pyx*
...
str.isdecimal()                        *str.isdecimal()..stdtypes.pyx*
...
str.isdigit()                            *str.isdigit()..stdtypes.pyx*
...
str.isidentifier()                  *str.isidentifier()..stdtypes.pyx*
...
>
      ...
      (True, True)
<
str.islower()                            *str.islower()..stdtypes.pyx*

   Return "True" if all cased characters [4] in the string are
   lowercase and there is at least one cased character, "False"
   otherwise.

str.isnumeric()                        *str.isnumeric()..stdtypes.pyx*
...
str.isprintable()                    *str.isprintable()..stdtypes.pyx*
...
str.isspace()                            *str.isspace()..stdtypes.pyx*
...
str.istitle()                            *str.istitle()..stdtypes.pyx*
...
str.isupper()                            *str.isupper()..stdtypes.pyx*
...
str.join(iterable)                          *str.join()..stdtypes.pyx*
...
str.ljust(width[, fillchar])               *str.ljust()..stdtypes.pyx*
...
str.lower()                                *str.lower()..stdtypes.pyx*
...
str.lstrip([chars])                       *str.lstrip()..stdtypes.pyx*
...
>
      ...
      'three!'
<
static str.maketrans(x[, y[, z]])      *str.maketrans()..stdtypes.pyx*
...
str.partition(sep)                     *str.partition()..stdtypes.pyx*
...
str.removeprefix(prefix, /)         *str.removeprefix()..stdtypes.pyx*
...
str.removesuffix(suffix, /)         *str.removesuffix()..stdtypes.pyx*
...
str.replace(old, new, count=-1)          *str.replace()..stdtypes.pyx*
...
str.rfind(sub[, start[, end]])             *str.rfind()..stdtypes.pyx*
...
str.rindex(sub[, start[, end]])           *str.rindex()..stdtypes.pyx*

   Like "rfind()" but raises "ValueError" when the substring _sub_ is
   not found.

str.rjust(width[, fillchar])               *str.rjust()..stdtypes.pyx*
...
str.rpartition(sep)                   *str.rpartition()..stdtypes.pyx*
...
str.rsplit(sep=None, maxsplit=-1)         *str.rsplit()..stdtypes.pyx*
...
str.rstrip([chars])                       *str.rstrip()..stdtypes.pyx*
...
>
      ...
      'Monty'
<
str.split(sep=None, maxsplit=-1)           *str.split()..stdtypes.pyx*
...
>
      ...
      ['1', '2', '3']
<
str.splitlines(keepends=False)        *str.splitlines()..stdtypes.pyx*
...
str.strip([chars])                         *str.strip()..stdtypes.pyx*
...
<
str.swapcase()                          *str.swapcase()..stdtypes.pyx*

   Return a copy of the string with uppercase characters converted to
   lowercase and vice versa. Note that it is not necessarily true that
   "s.swapcase().swapcase() == s".

str.title()                                *str.title()..stdtypes.pyx*
...
<
str.translate(table)                   *str.translate()..stdtypes.pyx*
...
str.upper()                                *str.upper()..stdtypes.pyx*
...
str.zfill(width)                           *str.zfill()..stdtypes.pyx*
...
class bytes([source[, encoding[, errors]]])      *bytes..stdtypes.pyx*
   ...
   * Copying existing binary data via the buffer protocol:
   ...
   classmethod fromhex(string)            *bytes.fromhex()..stdtypes.pyx*
   ...
   hex([sep[, bytes_per_sep]])                *bytes.hex()..stdtypes.pyx*
...
class bytearray([source[, encoding[, errors]]])
   ...
   * Copying existing binary data via the buffer protocol:
   ...
   classmethod fromhex(string)        *bytearray.fromhex()..stdtypes.pyx*
   ...
   hex([sep[, bytes_per_sep]])            *bytearray.hex()..stdtypes.pyx*
...
bytes.count(sub[, start[, end]])         *bytes.count()..stdtypes.pyx*

                                     *bytearray.count()..stdtypes.pyx*
...
bytes.removeprefix(prefix, /)     *bytes.removeprefix()..stdtypes.pyx*

                              *bytearray.removeprefix()..stdtypes.pyx*
...
bytes.removesuffix(suffix, /)     *bytes.removesuffix()..stdtypes.pyx*

                              *bytearray.removesuffix()..stdtypes.pyx*
...
<
   ...
   New in version 3.9.
                                        ...
                                        *bytes.decode()..stdtypes.pyx*
bytes.decode(encoding='utf-8', errors='strict')

                                    *bytearray.decode()..stdtypes.pyx*
bytearray.decode(encoding='utf-8', errors='strict')
   ...
   checked in Python Development Mode and in debug mode.
                                      ...
                                      *bytes.endswith()..stdtypes.pyx*
bytes.endswith(suffix[, start[, end]])

                                  *bytearray.endswith()..stdtypes.pyx*
...
bytes.find(sub[, start[, end]])           *bytes.find()..stdtypes.pyx*
bytearray.find(sub[, start[, end]])   *bytearray.find()..stdtypes.pyx*
...
bytes.index(sub[, start[, end]])         *bytes.index()..stdtypes.pyx*

                                     *bytearray.index()..stdtypes.pyx*
...
bytes.join(iterable)                      *bytes.join()..stdtypes.pyx*
bytearray.join(iterable)              *bytearray.join()..stdtypes.pyx*
...
static bytes.maketrans(from, to)     *bytes.maketrans()..stdtypes.pyx*

                                 *bytearray.maketrans()..stdtypes.pyx*
...
bytes.partition(sep)                 *bytes.partition()..stdtypes.pyx*
bytearray.partition(sep)         *bytearray.partition()..stdtypes.pyx*
...
bytes.replace(old, new[, count])       *bytes.replace()..stdtypes.pyx*

                                   *bytearray.replace()..stdtypes.pyx*
...
bytes.rfind(sub[, start[, end]])         *bytes.rfind()..stdtypes.pyx*

                                     *bytearray.rfind()..stdtypes.pyx*
...
bytes.rindex(sub[, start[, end]])       *bytes.rindex()..stdtypes.pyx*

                                    *bytearray.rindex()..stdtypes.pyx*
...
bytes.rpartition(sep)               *bytes.rpartition()..stdtypes.pyx*
bytearray.rpartition(sep)       *bytearray.rpartition()..stdtypes.pyx*
   ...
   The separator to search for may be any _bytes-like object_.
                                    ...
                                    *bytes.startswith()..stdtypes.pyx*
bytes.startswith(prefix[, start[, end]])

                                *bytearray.startswith()..stdtypes.pyx*
bytearray.startswith(prefix[, start[, end]])
   ...
   The prefix(es) to search for may be any _bytes-like object_.
                                     ...
                                     *bytes.translate()..stdtypes.pyx*
bytes.translate(table, /, delete=b'')

                                 *bytearray.translate()..stdtypes.pyx*
...
bytes.center(width[, fillbyte])         *bytes.center()..stdtypes.pyx*

                                    *bytearray.center()..stdtypes.pyx*
...
bytes.ljust(width[, fillbyte])           *bytes.ljust()..stdtypes.pyx*
bytearray.ljust(width[, fillbyte])   *bytearray.ljust()..stdtypes.pyx*
...
bytes.lstrip([chars])                   *bytes.lstrip()..stdtypes.pyx*
bytearray.lstrip([chars])           *bytearray.lstrip()..stdtypes.pyx*
...
bytes.rjust(width[, fillbyte])           *bytes.rjust()..stdtypes.pyx*
bytearray.rjust(width[, fillbyte])   *bytearray.rjust()..stdtypes.pyx*
...
bytes.rsplit(sep=None, maxsplit=-1)     *bytes.rsplit()..stdtypes.pyx*

                                    *bytearray.rsplit()..stdtypes.pyx*
...
bytes.rstrip([chars])                   *bytes.rstrip()..stdtypes.pyx*
bytearray.rstrip([chars])           *bytearray.rstrip()..stdtypes.pyx*
...
bytes.split(sep=None, maxsplit=-1)       *bytes.split()..stdtypes.pyx*

                                     *bytearray.split()..stdtypes.pyx*
...
>
      ...
      [b'1', b'2', b'3']
<
bytes.strip([chars])                     *bytes.strip()..stdtypes.pyx*
bytearray.strip([chars])             *bytearray.strip()..stdtypes.pyx*
...
bytes.capitalize()                  *bytes.capitalize()..stdtypes.pyx*
bytearray.capitalize()          *bytearray.capitalize()..stdtypes.pyx*
...
bytes.expandtabs(tabsize=8)         *bytes.expandtabs()..stdtypes.pyx*

                                *bytearray.expandtabs()..stdtypes.pyx*
...
bytes.isalnum()                        *bytes.isalnum()..stdtypes.pyx*
bytearray.isalnum()                *bytearray.isalnum()..stdtypes.pyx*
...
>
      ...
      False
<
bytes.isalpha()                        *bytes.isalpha()..stdtypes.pyx*
bytearray.isalpha()                *bytearray.isalpha()..stdtypes.pyx*
...
>
      ...
      False
<
bytes.isascii()                        *bytes.isascii()..stdtypes.pyx*
bytearray.isascii()                *bytearray.isascii()..stdtypes.pyx*
...
bytes.isdigit()                        *bytes.isdigit()..stdtypes.pyx*
bytearray.isdigit()                *bytearray.isdigit()..stdtypes.pyx*
...
>
      ...
      False
<
bytes.islower()                        *bytes.islower()..stdtypes.pyx*
bytearray.islower()                *bytearray.islower()..stdtypes.pyx*
...
bytes.isspace()                        *bytes.isspace()..stdtypes.pyx*
bytearray.isspace()                *bytearray.isspace()..stdtypes.pyx*
...
bytes.istitle()                        *bytes.istitle()..stdtypes.pyx*
bytearray.istitle()                *bytearray.istitle()..stdtypes.pyx*
...
>
      ...
      False
<
bytes.isupper()                        *bytes.isupper()..stdtypes.pyx*
bytearray.isupper()                *bytearray.isupper()..stdtypes.pyx*
...
bytes.lower()                            *bytes.lower()..stdtypes.pyx*
bytearray.lower()                    *bytearray.lower()..stdtypes.pyx*
...
bytes.splitlines(keepends=False)    *bytes.splitlines()..stdtypes.pyx*

                                *bytearray.splitlines()..stdtypes.pyx*
...
>
      ...
      ([], [b'One line'])
<
bytes.swapcase()                      *bytes.swapcase()..stdtypes.pyx*
bytearray.swapcase()              *bytearray.swapcase()..stdtypes.pyx*
...
bytes.title()                            *bytes.title()..stdtypes.pyx*
bytearray.title()                    *bytearray.title()..stdtypes.pyx*
...
bytes.upper()                            *bytes.upper()..stdtypes.pyx*
bytearray.upper()                    *bytearray.upper()..stdtypes.pyx*
...
bytes.zfill(width)                       *bytes.zfill()..stdtypes.pyx*
bytearray.zfill(width)               *bytearray.zfill()..stdtypes.pyx*
...
class memoryview(object)                    *memoryview..stdtypes.pyx*
...
<
   ...
   __eq__(exporter)                   *memoryview.__eq__()..stdtypes.pyx*
...
<
   ...
   tobytes(order='C')                *memoryview.tobytes()..stdtypes.pyx*
...
<
   ...
   hex([sep[, bytes_per_sep]])           *memoryview.hex()..stdtypes.pyx*
...
<
   ...
   tolist()                           *memoryview.tolist()..stdtypes.pyx*
...
<
   ...
   toreadonly()                   *memoryview.toreadonly()..stdtypes.pyx*
...
<
   ...
   release()                         *memoryview.release()..stdtypes.pyx*
...
<
   ...
   cast(format[, shape])                *memoryview.cast()..stdtypes.pyx*
...
<
   ...
   obj                                     *memoryview.obj..stdtypes.pyx*
...
<
   ...
   nbytes                               *memoryview.nbytes..stdtypes.pyx*
...
<
   ...
   readonly                           *memoryview.readonly..stdtypes.pyx*

      A bool indicating whether the memory is read only.

   format                               *memoryview.format..stdtypes.pyx*
   ...
   itemsize                           *memoryview.itemsize..stdtypes.pyx*
...
>
         ...
         True
<
   ndim                                   *memoryview.ndim..stdtypes.pyx*

      An integer indicating how many dimensions of a multi-dimensional
      array the memory represents.

   shape                                 *memoryview.shape..stdtypes.pyx*
   ...
   strides                             *memoryview.strides..stdtypes.pyx*
   ...
   suboffsets                       *memoryview.suboffsets..stdtypes.pyx*

      Used internally for PIL-style arrays. The value is informational
      only.

   c_contiguous                   *memoryview.c_contiguous..stdtypes.pyx*

      A bool indicating whether the memory is C-_contiguous_.

      New in version 3.3.

   f_contiguous                   *memoryview.f_contiguous..stdtypes.pyx*

      A bool indicating whether the memory is Fortran _contiguous_.

      New in version 3.3.

   contiguous                       *memoryview.contiguous..stdtypes.pyx*
...
class set([iterable])                              *set..stdtypes.pyx*
class frozenset([iterable])                  *frozenset..stdtypes.pyx*
   ...
   * Use the type constructor: "set()", "set('foobar')", "set(['a',
   ...
   isdisjoint(other)               *frozenset.isdisjoint()..stdtypes.pyx*
   ...
   issubset(other)                   *frozenset.issubset()..stdtypes.pyx*
   set <= other
   ...
   issuperset(other)               *frozenset.issuperset()..stdtypes.pyx*
   set >= other
   ...
   union(*others)                       *frozenset.union()..stdtypes.pyx*
   set | other | ...

      Return a new set with elements from the set and all others.

   intersection(*others)         *frozenset.intersection()..stdtypes.pyx*
   set & other & ...

      Return a new set with elements common to the set and all others.

   difference(*others)             *frozenset.difference()..stdtypes.pyx*
   set - other - ...

      Return a new set with elements in the set that are not in the
      others.

                      *frozenset.symmetric_difference()..stdtypes.pyx*
   ...
   copy()                                *frozenset.copy()..stdtypes.pyx*
   ...
   update(*others)                     *frozenset.update()..stdtypes.pyx*
   set |= other | ...

      Update the set, adding elements from all others.

                       *frozenset.intersection_update()..stdtypes.pyx*
   ...
   set &= other & ...
      ...
      others.
                         ...
                         *frozenset.difference_update()..stdtypes.pyx*
   difference_update(*others)
   set -= other | ...

      Update the set, removing elements found in others.

               *frozenset.symmetric_difference_update()..stdtypes.pyx*
   ...
   add(elem)                              *frozenset.add()..stdtypes.pyx*

      Add element _elem_ to the set.

   remove(elem)                        *frozenset.remove()..stdtypes.pyx*

      Remove element _elem_ from the set.  Raises "KeyError" if _elem_
      is not contained in the set.

   discard(elem)                      *frozenset.discard()..stdtypes.pyx*

      Remove element _elem_ from the set if it is present.

   pop()                                  *frozenset.pop()..stdtypes.pyx*

      Remove and return an arbitrary element from the set.  Raises
      "KeyError" if the set is empty.

   clear()                              *frozenset.clear()..stdtypes.pyx*
...
class dict(**kwargs)                              *dict..stdtypes.pyx*
...
<
   ...
   clear()                                   *dict.clear()..stdtypes.pyx*

      Remove all items from the dictionary.

   copy()                                     *dict.copy()..stdtypes.pyx*

      Return a shallow copy of the dictionary.

                                       *dict.fromkeys()..stdtypes.pyx*
   ...
   get(key[, default])                         *dict.get()..stdtypes.pyx*
   ...
   items()                                   *dict.items()..stdtypes.pyx*

      Return a new view of the dictionary’s items ("(key, value)"
      pairs). See the documentation of view objects.

   keys()                                     *dict.keys()..stdtypes.pyx*

      Return a new view of the dictionary’s keys.  See the
      documentation of view objects.

   pop(key[, default])                         *dict.pop()..stdtypes.pyx*
   ...
   popitem()                               *dict.popitem()..stdtypes.pyx*
   ...
   setdefault(key[, default])           *dict.setdefault()..stdtypes.pyx*
   ...
   update([other])                          *dict.update()..stdtypes.pyx*
   ...
   values()                                 *dict.values()..stdtypes.pyx*
...
the statement ends:
                            ...
                            *contextmanager.__enter__()..stdtypes.pyx*
contextmanager.__enter__()
   ...
   without affecting code outside the "with" statement.
                             ...
                             *contextmanager.__exit__()..stdtypes.pyx*
...
genericalias.__origin__        *genericalias.__origin__..stdtypes.pyx*
...
>
      ...
      <class 'list'>
<
genericalias.__args__            *genericalias.__args__..stdtypes.pyx*
...
<
                           ...
                           *genericalias.__parameters__..stdtypes.pyx*
...
genericalias.__unpacked__    *genericalias.__unpacked__..stdtypes.pyx*
...
object.__dict__                        *object.__dict__..stdtypes.pyx*

   A dictionary or other mapping object used to store an object’s
   (writable) attributes.

instance.__class__                  *instance.__class__..stdtypes.pyx*

   The class to which a class instance belongs.

class.__bases__                        *class.__bases__..stdtypes.pyx*

   The tuple of base classes of a class object.

definition.__name__                *definition.__name__..stdtypes.pyx*

   The name of the class, function, method, descriptor, or generator
   instance.

definition.__qualname__        *definition.__qualname__..stdtypes.pyx*
   ...
   New in version 3.3.
                            ...
                            *definition.__type_params__..stdtypes.pyx*
...
class.__mro__                            *class.__mro__..stdtypes.pyx*

   This attribute is a tuple of classes that are considered when
   looking for base classes during method resolution.

class.mro()                                *class.mro()..stdtypes.pyx*

   This method can be overridden by a metaclass to customize the
   method resolution order for its instances.  It is called at class
   instantiation, and its result is stored in "__mro__".

class.__subclasses__()          *class.__subclasses__()..stdtypes.pyx*
