*string.pyx*                                  Last change: 2023 Sep 15
...
class string.Formatter                         *Formatter..string.pyx*

   The "Formatter" class has the following public methods:

                                      *Formatter.format()..string.pyx*
   ...
   parse(format_string)                   *Formatter.parse()..string.pyx*
      ...
      _field_name_, _format_spec_ and _conversion_ will be "None".
                                   ...
                                   *Formatter.get_field()..string.pyx*
   ...
   get_value(key, args, kwargs)       *Formatter.get_value()..string.pyx*
      ...
      then an "IndexError" or "KeyError" should be raised.
                           ...
                           *Formatter.check_unused_args()..string.pyx*
...
class string.Template(template)                 *Template..string.pyx*

   The constructor takes a single argument which is the template
   string.

                                   *Template.substitute()..string.pyx*
   substitute(mapping={}, /, **kwds)
      ...
      duplicates, the placeholders from _kwds_ take precedence.
                              ...
                              *Template.safe_substitute()..string.pyx*
   ...
   is_valid()                           *Template.is_valid()..string.pyx*
   ...
   get_identifiers()             *Template.get_identifiers()..string.pyx*
   ...
   template                               *Template.template..string.pyx*
...
string.capwords(s, sep=None)                  *capwords()..string.pyx*
