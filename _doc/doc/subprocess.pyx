*subprocess.pyx*                              Last change: 2023 Sep 15
...
class subprocess.CompletedProcess   *CompletedProcess..subprocess.pyx*

   The return value from "run()", representing a process that has
   finished.

   args                           *CompletedProcess.args..subprocess.pyx*

      The arguments used to launch the process. This may be a list or
      a string.

   returncode               *CompletedProcess.returncode..subprocess.pyx*
   ...
   stdout                       *CompletedProcess.stdout..subprocess.pyx*
...
subprocess.DEVNULL                           *DEVNULL..subprocess.pyx*
...
subprocess.STDOUT                             *STDOUT..subprocess.pyx*
   ...
   standard output.
                                     ...
                                     *SubprocessError..subprocess.pyx*
...
exception subprocess.TimeoutExpired   *TimeoutExpired..subprocess.pyx*

   Subclass of "SubprocessError", raised when a timeout expires while
   waiting for a child process.

   cmd                               *TimeoutExpired.cmd..subprocess.pyx*

      Command that was used to spawn the child process.

   timeout                       *TimeoutExpired.timeout..subprocess.pyx*

      Timeout in seconds.

   output                         *TimeoutExpired.output..subprocess.pyx*
   ...
   stdout                         *TimeoutExpired.stdout..subprocess.pyx*

      Alias for output, for symmetry with "stderr".

   stderr                         *TimeoutExpired.stderr..subprocess.pyx*
   ...
   Changed in version 3.5: _stdout_ and _stderr_ attributes added
                                  ...
                                  *CalledProcessError..subprocess.pyx*
exception subprocess.CalledProcessError
   ...
   returncode             *CalledProcessError.returncode..subprocess.pyx*

      Exit status of the child process.  If the process exited due to
      a signal, this will be the negative signal number.

   cmd                           *CalledProcessError.cmd..subprocess.pyx*

      Command that was used to spawn the child process.

   output                     *CalledProcessError.output..subprocess.pyx*

      Output of the child process if it was captured by "run()" or
      "check_output()".  Otherwise, "None".

   stdout                     *CalledProcessError.stdout..subprocess.pyx*

      Alias for output, for symmetry with "stderr".

   stderr                     *CalledProcessError.stderr..subprocess.pyx*
...
Popen.poll()                            *Popen.poll()..subprocess.pyx*

   Check if child process has terminated.  Set and return "returncode"
   attribute. Otherwise, returns "None".

Popen.wait(timeout=None)                *Popen.wait()..subprocess.pyx*
   ...
   Changed in version 3.3: _timeout_ was added.
                                 ...
                                 *Popen.communicate()..subprocess.pyx*
...
Popen.send_signal(signal)        *Popen.send_signal()..subprocess.pyx*
...
Popen.terminate()                  *Popen.terminate()..subprocess.pyx*
...
Popen.kill()                            *Popen.kill()..subprocess.pyx*
...
Popen.args                                *Popen.args..subprocess.pyx*
...
Popen.stdin                              *Popen.stdin..subprocess.pyx*
...
Popen.stdout                            *Popen.stdout..subprocess.pyx*
...
Popen.stderr                            *Popen.stderr..subprocess.pyx*
...
Popen.pid                                  *Popen.pid..subprocess.pyx*
...
Popen.returncode                    *Popen.returncode..subprocess.pyx*
...
class subprocess.STARTUPINFO(*, dwFlags=0, hStdInput=None, hStdOutput=None, hStdError=None, wShowWindow=0, lpAttributeList=None)
   ...
   dwFlags                          *STARTUPINFO.dwFlags..subprocess.pyx*
...
<
   hStdInput                      *STARTUPINFO.hStdInput..subprocess.pyx*
   ...
   hStdOutput                    *STARTUPINFO.hStdOutput..subprocess.pyx*
   ...
   hStdError                      *STARTUPINFO.hStdError..subprocess.pyx*
   ...
   wShowWindow                  *STARTUPINFO.wShowWindow..subprocess.pyx*
   ...
   lpAttributeList          *STARTUPINFO.lpAttributeList..subprocess.pyx*
...
subprocess.STD_INPUT_HANDLE         *STD_INPUT_HANDLE..subprocess.pyx*

   The standard input device. Initially, this is the console input
   buffer, "CONIN$".

subprocess.STD_OUTPUT_HANDLE       *STD_OUTPUT_HANDLE..subprocess.pyx*

   The standard output device. Initially, this is the active console
   screen buffer, "CONOUT$".

subprocess.STD_ERROR_HANDLE         *STD_ERROR_HANDLE..subprocess.pyx*

   The standard error device. Initially, this is the active console
   screen buffer, "CONOUT$".

subprocess.SW_HIDE                           *SW_HIDE..subprocess.pyx*

   Hides the window. Another window will be activated.

                                *STARTF_USESTDHANDLES..subprocess.pyx*
...
subprocess.CREATE_NEW_PROCESS_GROUP
   ...
   This flag is ignored if "CREATE_NEW_CONSOLE" is specified.
                         ...
                         *ABOVE_NORMAL_PRIORITY_CLASS..subprocess.pyx*
subprocess.ABOVE_NORMAL_PRIORITY_CLASS
   ...
   New in version 3.7.
                         ...
                         *BELOW_NORMAL_PRIORITY_CLASS..subprocess.pyx*
...
subprocess.HIGH_PRIORITY_CLASS   *HIGH_PRIORITY_CLASS..subprocess.pyx*
...
subprocess.IDLE_PRIORITY_CLASS   *IDLE_PRIORITY_CLASS..subprocess.pyx*
   ...
   New in version 3.7.
                               ...
                               *NORMAL_PRIORITY_CLASS..subprocess.pyx*
subprocess.NORMAL_PRIORITY_CLASS
   ...
   New in version 3.7.
                             ...
                             *REALTIME_PRIORITY_CLASS..subprocess.pyx*
...
subprocess.CREATE_NO_WINDOW         *CREATE_NO_WINDOW..subprocess.pyx*
...
subprocess.DETACHED_PROCESS         *DETACHED_PROCESS..subprocess.pyx*
   ...
   New in version 3.7.
                           ...
                           *CREATE_DEFAULT_ERROR_MODE..subprocess.pyx*
subprocess.CREATE_DEFAULT_ERROR_MODE
   ...
   New in version 3.7.
                           ...
                           *CREATE_BREAKAWAY_FROM_JOB..subprocess.pyx*
...
exception handling consistency are valid for these functions.
                                   ...
                                   *getstatusoutput()..subprocess.pyx*
...
<
   ...
   New in version 3.11: Added _encoding_ and _errors_ arguments.

                                         *getoutput()..subprocess.pyx*
