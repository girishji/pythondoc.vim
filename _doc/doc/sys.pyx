*sys.pyx*                                     Last change: 2023 Sep 15
...
sys.addaudithook(hook)                       *addaudithook()..sys.pyx*
...
sys.audit(event, *args)                             *audit()..sys.pyx*
...
sys.base_exec_prefix                       *base_exec_prefix..sys.pyx*
...
sys.base_prefix                                 *base_prefix..sys.pyx*
...
sys.byteorder                                     *byteorder..sys.pyx*
...
sys.builtin_module_names               *builtin_module_names..sys.pyx*
...
sys.call_tracing(func, args)                 *call_tracing()..sys.pyx*

   Call "func(*args)", while tracing is enabled.  The tracing state is
   saved, and restored afterwards.  This is intended to be called from
   a debugger from a checkpoint, to recursively debug some other code.

sys.copyright                                     *copyright..sys.pyx*

   A string containing the copyright pertaining to the Python
   interpreter.

sys._clear_type_cache()                 *_clear_type_cache()..sys.pyx*
...
sys._current_frames()                     *_current_frames()..sys.pyx*
...
sys._current_exceptions()             *_current_exceptions()..sys.pyx*
...
sys.breakpointhook()                       *breakpointhook()..sys.pyx*
...
sys._debugmallocstats()                 *_debugmallocstats()..sys.pyx*
...
sys.dllhandle                                     *dllhandle..sys.pyx*

   Integer specifying the handle of the Python DLL.

   Availability: Windows.

sys.displayhook(value)                        *displayhook()..sys.pyx*
...
sys.dont_write_bytecode                 *dont_write_bytecode..sys.pyx*
...
sys._emscripten_info                       *_emscripten_info..sys.pyx*
...
sys.pycache_prefix                           *pycache_prefix..sys.pyx*
...
sys.excepthook(type, value, traceback)         *excepthook()..sys.pyx*
...
sys.__breakpointhook__                   *__breakpointhook__..sys.pyx*
sys.__displayhook__                         *__displayhook__..sys.pyx*
sys.__excepthook__                           *__excepthook__..sys.pyx*
sys.__unraisablehook__                   *__unraisablehook__..sys.pyx*
...
sys.exception()                                 *exception()..sys.pyx*
...
sys.exec_prefix                                 *exec_prefix..sys.pyx*
...
sys.executable                                   *executable..sys.pyx*
...
sys.float_info                                   *float_info..sys.pyx*
...
>
      ...
      '9876543211234568'
<
sys.float_repr_style                       *float_repr_style..sys.pyx*
...
sys.getallocatedblocks()               *getallocatedblocks()..sys.pyx*
...
sys.getunicodeinternedsize()       *getunicodeinternedsize()..sys.pyx*

   Return the number of unicode objects that have been interned.

   New in version 3.12.

sys.getandroidapilevel()               *getandroidapilevel()..sys.pyx*
...
sys.getdefaultencoding()               *getdefaultencoding()..sys.pyx*

   Return the name of the current default string encoding used by the
   Unicode implementation.

sys.getdlopenflags()                       *getdlopenflags()..sys.pyx*
...
sys.getfilesystemencoding()         *getfilesystemencoding()..sys.pyx*
   ...
   is enabled.
                                ...
                                *getfilesystemencodeerrors()..sys.pyx*
...
sys.get_int_max_str_digits()       *get_int_max_str_digits()..sys.pyx*
...
sys.getrefcount(object)                       *getrefcount()..sys.pyx*
...
sys.getrecursionlimit()                 *getrecursionlimit()..sys.pyx*
...
sys.getsizeof(object[, default])                *getsizeof()..sys.pyx*
...
sys.getswitchinterval()                 *getswitchinterval()..sys.pyx*
...
sys._getframe([depth])                          *_getframe()..sys.pyx*
...
sys._getframemodulename([depth])      *_getframemodulename()..sys.pyx*
...
sys.getprofile()                               *getprofile()..sys.pyx*

   Get the profiler function as set by "setprofile()".

sys.gettrace()                                   *gettrace()..sys.pyx*
...
sys.getwindowsversion()                 *getwindowsversion()..sys.pyx*
...
sys.get_asyncgen_hooks()               *get_asyncgen_hooks()..sys.pyx*
   ...
   Note:
     ...
     411** for details.)
                      ...
                      *get_coroutine_origin_tracking_depth()..sys.pyx*
...
sys.hash_info                                     *hash_info..sys.pyx*
   ...
   hash_info.width                             *hash_info.width..sys.pyx*

      The width in bits used for hash values

   hash_info.modulus                         *hash_info.modulus..sys.pyx*

      The prime modulus P used for numeric hash scheme

   hash_info.inf                                 *hash_info.inf..sys.pyx*

      The hash value returned for a positive infinity

   hash_info.nan                                 *hash_info.nan..sys.pyx*

      (This attribute is no longer used)

   hash_info.imag                               *hash_info.imag..sys.pyx*

      The multiplier used for the imaginary part of a complex number

   hash_info.algorithm                     *hash_info.algorithm..sys.pyx*

      The name of the algorithm for hashing of str, bytes, and
      memoryview

   hash_info.hash_bits                     *hash_info.hash_bits..sys.pyx*

      The internal output size of the hash algorithm

   hash_info.seed_bits                     *hash_info.seed_bits..sys.pyx*
...
sys.hexversion                                   *hexversion..sys.pyx*
...
sys.implementation                           *implementation..sys.pyx*
...
sys.int_info                                       *int_info..sys.pyx*
   ...
   int_info.default_max_str_digits
      ...
      not otherwise explicitly configured.
                        ...
                        *int_info.str_digits_check_threshold..sys.pyx*
...
sys.__interactivehook__                 *__interactivehook__..sys.pyx*
...
sys.intern(string)                                 *intern()..sys.pyx*
...
sys.is_finalizing()                         *is_finalizing()..sys.pyx*
...
sys.last_type                                     *last_type..sys.pyx*
sys.last_value                                   *last_value..sys.pyx*
sys.last_traceback                           *last_traceback..sys.pyx*
...
sys.maxunicode                                   *maxunicode..sys.pyx*
...
sys.meta_path                                     *meta_path..sys.pyx*
...
sys.orig_argv                                     *orig_argv..sys.pyx*
...
sys.path_hooks                                   *path_hooks..sys.pyx*
...
sys.path_importer_cache                 *path_importer_cache..sys.pyx*
...
sys.platlibdir                                   *platlibdir..sys.pyx*
...
sys.setdlopenflags(n)                      *setdlopenflags()..sys.pyx*
   ...
   Availability: Unix.
                                   ...
                                   *set_int_max_str_digits()..sys.pyx*
...
sys.setprofile(profilefunc)                    *setprofile()..sys.pyx*
...
sys.setrecursionlimit(limit)            *setrecursionlimit()..sys.pyx*
...
sys.setswitchinterval(interval)         *setswitchinterval()..sys.pyx*
...
sys.settrace(tracefunc)                          *settrace()..sys.pyx*
...
sys.set_asyncgen_hooks(firstiter, finalizer)
   ...
   Note:
     ...
     411** for details.)
                      ...
                      *set_coroutine_origin_tracking_depth()..sys.pyx*
sys.set_coroutine_origin_tracking_depth(depth)
   ...
   Note:
     ...
     411** for details.)  Use it only for debugging purposes.
                                ...
                                *activate_stack_trampoline()..sys.pyx*
sys.activate_stack_trampoline(backend, /)
   ...
   See also:
     ...
     * https://perf.wiki.kernel.org
                              ...
                              *deactivate_stack_trampoline()..sys.pyx*
sys.deactivate_stack_trampoline()
   ...
   New in version 3.12.
                               ...
                               *is_stack_trampoline_active()..sys.pyx*
sys.is_stack_trampoline_active()
   ...
   New in version 3.12.
                           ...
                           *_enablelegacywindowsfsencoding()..sys.pyx*
...
sys.stdin                                             *stdin..sys.pyx*
sys.stdout                                           *stdout..sys.pyx*
sys.stderr                                           *stderr..sys.pyx*
...
sys.__stdin__                                     *__stdin__..sys.pyx*
sys.__stdout__                                   *__stdout__..sys.pyx*
sys.__stderr__                                   *__stderr__..sys.pyx*
...
sys.stdlib_module_names                 *stdlib_module_names..sys.pyx*
...
sys.thread_info                                 *thread_info..sys.pyx*

   A _named tuple_ holding information about the thread
   implementation.

   thread_info.name                           *thread_info.name..sys.pyx*
   ...
   thread_info.lock                           *thread_info.lock..sys.pyx*
   ...
   thread_info.version                     *thread_info.version..sys.pyx*
...
sys.tracebacklimit                           *tracebacklimit..sys.pyx*
...
sys.unraisablehook(unraisable, /)          *unraisablehook()..sys.pyx*
...
sys.api_version                                 *api_version..sys.pyx*
...
sys.version_info                               *version_info..sys.pyx*
...
sys.warnoptions                                 *warnoptions..sys.pyx*
...
sys.monitoring                                   *monitoring..sys.pyx*
...
sys._xoptions                                     *_xoptions..sys.pyx*
