*threading.pyx*                               Last change: 2023 Sep 15
...
threading.active_count()               *active_count()..threading.pyx*
...
threading.current_thread()           *current_thread()..threading.pyx*
...
threading.excepthook(args, /)            *excepthook()..threading.pyx*
...
threading.__excepthook__               *__excepthook__..threading.pyx*
...
threading.get_ident()                     *get_ident()..threading.pyx*
...
threading.get_native_id()             *get_native_id()..threading.pyx*
...
threading.enumerate()                     *enumerate()..threading.pyx*
...
threading.main_thread()                 *main_thread()..threading.pyx*
...
threading.settrace(func)                   *settrace()..threading.pyx*
   ...
   thread, before its "run()" method is called.
                               ...
                               *settrace_all_threads()..threading.pyx*
...
threading.gettrace()                       *gettrace()..threading.pyx*

   Get the trace function as set by "settrace()".

   New in version 3.10.

threading.setprofile(func)               *setprofile()..threading.pyx*
   ...
   thread, before its "run()" method is called.
                             ...
                             *setprofile_all_threads()..threading.pyx*
...
threading.getprofile()                   *getprofile()..threading.pyx*

   Get the profiler function as set by "setprofile()".

   New in version 3.10.

threading.stack_size([size])             *stack_size()..threading.pyx*
...
threading.TIMEOUT_MAX                     *TIMEOUT_MAX..threading.pyx*
...
class threading.local                           *local..threading.pyx*
...
class threading.Thread(group=None, target=None, name=None, args=(), kwargs={}, *, daemon=None)
   ...
   start()                                *Thread.start()..threading.pyx*
...
>
         ...
         1
<
   join(timeout=None)                      *Thread.join()..threading.pyx*
   ...
   ident                                    *Thread.ident..threading.pyx*
   ...
   native_id                            *Thread.native_id..threading.pyx*
   ...
   is_alive()                          *Thread.is_alive()..threading.pyx*
   ...
   daemon                                  *Thread.daemon..threading.pyx*
   ...
   isDaemon()                          *Thread.isDaemon()..threading.pyx*
   setDaemon()                        *Thread.setDaemon()..threading.pyx*
...
class threading.Lock                             *Lock..threading.pyx*
   ...
   acquire(blocking=True, timeout=-1)     *Lock.acquire()..threading.pyx*
   ...
   release()                              *Lock.release()..threading.pyx*
   ...
   locked()                                *Lock.locked()..threading.pyx*
...
class threading.RLock                           *RLock..threading.pyx*
   ...
   acquire(blocking=True, timeout=-1)    *RLock.acquire()..threading.pyx*
   ...
   release()                             *RLock.release()..threading.pyx*
...
class threading.Condition(lock=None)        *Condition..threading.pyx*
   ...
   acquire(*args)                    *Condition.acquire()..threading.pyx*
   ...
   wait(timeout=None)                   *Condition.wait()..threading.pyx*
      ...
      "None".
                                 ...
                                 *Condition.wait_for()..threading.pyx*
...
<
   ...
   notify(n=1)                        *Condition.notify()..threading.pyx*
   ...
   notify_all()                   *Condition.notify_all()..threading.pyx*
...
class threading.Semaphore(value=1)          *Semaphore..threading.pyx*
   ...
   Changed in version 3.3: changed from a factory function to a class.
                                  ...
                                  *Semaphore.acquire()..threading.pyx*
   ...
   release(n=1)                      *Semaphore.release()..threading.pyx*
      ...
      multiple waiting threads at once.
                                     ...
                                     *BoundedSemaphore..threading.pyx*
...
class threading.Event                           *Event..threading.pyx*
   ...
   clear()                                 *Event.clear()..threading.pyx*

      Reset the internal flag to false. Subsequently, threads calling
      "wait()" will block until "set()" is called to set the internal
      flag to true again.

   wait(timeout=None)                       *Event.wait()..threading.pyx*
...
class threading.Timer(interval, function, args=None, kwargs=None)
   ...
   cancel()                               *Timer.cancel()..threading.pyx*
...
class threading.Barrier(parties, action=None, timeout=None)
   ...
   wait(timeout=None)                     *Barrier.wait()..threading.pyx*
...
<
   ...
   reset()                               *Barrier.reset()..threading.pyx*
   ...
   abort()                               *Barrier.abort()..threading.pyx*
   ...
   parties                               *Barrier.parties..threading.pyx*

      The number of threads required to pass the barrier.

   n_waiting                           *Barrier.n_waiting..threading.pyx*

      The number of threads currently waiting in the barrier.

   broken                                 *Barrier.broken..threading.pyx*

      A boolean that is "True" if the barrier is in the broken state.

                                   *BrokenBarrierError..threading.pyx*
