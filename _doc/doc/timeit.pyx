*timeit.pyx*                                  Last change: 2023 Sep 15
...
timeit.default_timer()                   *default_timer()..timeit.pyx*
...
class timeit.Timer(stmt='pass', setup='pass', timer=<timer function>, globals=None)
   ...
   timeit(number=1000000)                    *Timer.timeit()..timeit.pyx*
...
<
   autorange(callback=None)               *Timer.autorange()..timeit.pyx*
   ...
   repeat(repeat=5, number=1000000)          *Timer.repeat()..timeit.pyx*
   ...
   print_exc(file=None)                   *Timer.print_exc()..timeit.pyx*
