*tkinter.pyx*                                 Last change: 2023 Sep 15
...
class tkinter.Tk(screenName=None, baseName=None, className='Tk', useTk=True, sync=False, use=None)
   ...
   children                                    *Tk.children..tkinter.pyx*
...
"os.read(file.fileno(), maxbytecount)".
                          ...
                          *Widget.tk.createfilehandler()..tkinter.pyx*
...
<
                          ...
                          *Widget.tk.deletefilehandler()..tkinter.pyx*
Widget.tk.deletefilehandler(file)

   Unregisters a file handler.

tkinter.READABLE                               *READABLE..tkinter.pyx*
tkinter.WRITABLE                               *WRITABLE..tkinter.pyx*
tkinter.EXCEPTION                             *EXCEPTION..tkinter.pyx*
