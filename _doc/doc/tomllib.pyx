*tomllib.pyx*                                 Last change: 2023 Sep 15
...
tomllib.load(fp, /, *, parse_float=float)        *load()..tomllib.pyx*
...
tomllib.loads(s, /, *, parse_float=float)       *loads()..tomllib.pyx*
...
exception tomllib.TOMLDecodeError       *TOMLDecodeError..tomllib.pyx*
