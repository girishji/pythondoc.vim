*traceback.pyx*                               Last change: 2023 Sep 15
...
traceback.extract_tb(tb, limit=None)     *extract_tb()..traceback.pyx*
...
traceback.format_list(extracted_list)   *format_list()..traceback.pyx*
   ...
   those items whose source text line is not "None".
                              ...
                              *format_exception_only()..traceback.pyx*
traceback.format_exception_only(exc, /[, value])
   ...
   _exc_ and is now positional-only.
                                   ...
                                   *format_exception()..traceback.pyx*
traceback.format_exception(exc, /[, value, tb], limit=None, chain=True)
   ...
   were modified to match "print_exception()".
                                         ...
                                         *format_exc()..traceback.pyx*
traceback.format_exc(limit=None, chain=True)

   This is like "print_exc(limit)" but returns a string instead of
   printing to a file.

traceback.format_tb(tb, limit=None)       *format_tb()..traceback.pyx*

   A shorthand for "format_list(extract_tb(tb, limit))".

                                       *format_stack()..traceback.pyx*
traceback.format_stack(f=None, limit=None)

   A shorthand for "format_list(extract_stack(f, limit))".

traceback.clear_frames(tb)             *clear_frames()..traceback.pyx*
...
traceback.walk_stack(f)                  *walk_stack()..traceback.pyx*
...
traceback.walk_tb(tb)                       *walk_tb()..traceback.pyx*
...
capture data for later printing in a lightweight fashion.
                                   ...
                                   *TracebackException..traceback.pyx*
class traceback.TracebackException(exc_type, exc_value, exc_traceback, *, limit=None, lookup_lines=True, capture_locals=False, compact=False, max_group_width=15, max_group_depth=10)
   ...
   __cause__                *TracebackException.__cause__..traceback.pyx*

      A "TracebackException" of the original "__cause__".

   __context__            *TracebackException.__context__..traceback.pyx*

      A "TracebackException" of the original "__context__".

   exceptions              *TracebackException.exceptions..traceback.pyx*
      ...
      New in version 3.11.
              ...
              *TracebackException.__suppress_context__..traceback.pyx*
   __suppress_context__

      The "__suppress_context__" value from the original exception.

   __notes__                *TracebackException.__notes__..traceback.pyx*
   ...
   stack                        *TracebackException.stack..traceback.pyx*

      A "StackSummary" representing the traceback.

   exc_type                  *TracebackException.exc_type..traceback.pyx*

      The class of the original traceback.

   filename                  *TracebackException.filename..traceback.pyx*

      For syntax errors - the file name where the error occurred.

   lineno                      *TracebackException.lineno..traceback.pyx*

      For syntax errors - the line number where the error occurred.

   end_lineno              *TracebackException.end_lineno..traceback.pyx*
   ...
   text                          *TracebackException.text..traceback.pyx*

      For syntax errors - the text where the error occurred.

   offset                      *TracebackException.offset..traceback.pyx*

      For syntax errors - the offset into the text where the error
      occurred.

   end_offset              *TracebackException.end_offset..traceback.pyx*
   ...
   msg                            *TracebackException.msg..traceback.pyx*

      For syntax errors - the compiler error message.

                  *TracebackException.from_exception()..traceback.pyx*
   classmethod from_exception(exc, *, limit=None, lookup_lines=True, capture_locals=False)
      ...
      traceback.
                           ...
                           *TracebackException.print()..traceback.pyx*
   ...
   format(*, chain=True)     *TracebackException.format()..traceback.pyx*
      ...
      last string in the output.
           ...
           *TracebackException.format_exception_only()..traceback.pyx*
   format_exception_only(*, show_group=False)
      ...
      When _show_group_ is "False", the generator normally emits a
      single string; however, for "SyntaxError" exceptions, it emits
      several lines that (when printed) display detailed information
      about where the syntax error occurred.  The message indicating
      which exception occurred is always the last string in the
      output.
...
class traceback.StackSummary             *StackSummary..traceback.pyx*


                               *StackSummary.extract()..traceback.pyx*
   classmethod extract(frame_gen, *, limit=None, lookup_lines=True, capture_locals=False)
      ...
      propagated to the caller.
                             ...
                             *StackSummary.from_list()..traceback.pyx*
   ...
   format()                        *StackSummary.format()..traceback.pyx*
      ...
      now abbreviated.
                  ...
                  *StackSummary.format_frame_summary()..traceback.pyx*
