*tut-datastructures.pyx*                      Last change: 2023 Sep 15
...
list.append(x)                 *list.append()..tut-datastructures.pyx*

   Add an item to the end of the list.  Equivalent to "a[len(a):] =
   [x]".

list.extend(iterable)          *list.extend()..tut-datastructures.pyx*

   Extend the list by appending all the items from the iterable.
   Equivalent to "a[len(a):] = iterable".

list.insert(i, x)              *list.insert()..tut-datastructures.pyx*
...
list.remove(x)                 *list.remove()..tut-datastructures.pyx*

   Remove the first item from the list whose value is equal to _x_.
   It raises a "ValueError" if there is no such item.

list.pop([i])                     *list.pop()..tut-datastructures.pyx*
...
list.clear()                    *list.clear()..tut-datastructures.pyx*

   Remove all items from the list.  Equivalent to "del a[:]".

list.index(x[, start[, end]])   *list.index()..tut-datastructures.pyx*
...
list.count(x)                   *list.count()..tut-datastructures.pyx*

   Return the number of times _x_ appears in the list.

                                 *list.sort()..tut-datastructures.pyx*
...
list.reverse()                *list.reverse()..tut-datastructures.pyx*

   Reverse the elements of the list in place.

list.copy()                      *list.copy()..tut-datastructures.pyx*
