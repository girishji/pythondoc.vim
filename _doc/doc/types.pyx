*types.pyx*                                   Last change: 2023 Sep 15
...
types.resolve_bases(bases)                *resolve_bases()..types.pyx*
...
types.get_original_bases(cls, /)     *get_original_bases()..types.pyx*
...
types.NoneType                                   *NoneType..types.pyx*

   The type of "None".

   New in version 3.10.

types.FunctionType                           *FunctionType..types.pyx*
types.LambdaType                               *LambdaType..types.pyx*
...
types.GeneratorType                         *GeneratorType..types.pyx*

   The type of _generator_-iterator objects, created by generator
   functions.

types.CoroutineType                         *CoroutineType..types.pyx*

   The type of _coroutine_ objects, created by "async def" functions.

   New in version 3.5.

types.AsyncGeneratorType               *AsyncGeneratorType..types.pyx*
...
class types.CodeType(**kwargs)                   *CodeType..types.pyx*
   ...
   replace(**kwargs)                      *CodeType.replace()..types.pyx*

      Return a copy of the code object with new values for the
      specified fields.

      Code objects are also supported by generic function
      "copy.replace()".

      New in version 3.8.

types.CellType                                   *CellType..types.pyx*
...
types.MethodType                               *MethodType..types.pyx*

   The type of methods of user-defined class instances.

types.BuiltinFunctionType             *BuiltinFunctionType..types.pyx*
types.BuiltinMethodType                 *BuiltinMethodType..types.pyx*

   The type of built-in functions like "len()" or "sys.exit()", and
   methods of built-in classes.  (Here, the term “built-in” means
   “written in C”.)

types.WrapperDescriptorType         *WrapperDescriptorType..types.pyx*
...
types.MethodWrapperType                 *MethodWrapperType..types.pyx*
...
types.NotImplementedType               *NotImplementedType..types.pyx*

   The type of "NotImplemented".

   New in version 3.10.

types.MethodDescriptorType           *MethodDescriptorType..types.pyx*
   ...
   New in version 3.7.
                                ...
                                *ClassMethodDescriptorType..types.pyx*
...
class types.ModuleType(name, doc=None)         *ModuleType..types.pyx*
   ...
   __doc__                                *ModuleType.__doc__..types.pyx*

      The _docstring_ of the module. Defaults to "None".

   __loader__                          *ModuleType.__loader__..types.pyx*
   ...
   __name__                              *ModuleType.__name__..types.pyx*

      The name of the module. Expected to match
      "importlib.machinery.ModuleSpec.name".

   __package__                        *ModuleType.__package__..types.pyx*
   ...
   __spec__                              *ModuleType.__spec__..types.pyx*
...
types.EllipsisType                           *EllipsisType..types.pyx*

   The type of "Ellipsis".

   New in version 3.10.

class types.GenericAlias(t_origin, t_args)   *GenericAlias..types.pyx*
...
class types.UnionType                           *UnionType..types.pyx*

   The type of union type expressions.

   New in version 3.10.

                                            *TracebackType..types.pyx*
...
types.FrameType                                 *FrameType..types.pyx*
...
types.GetSetDescriptorType           *GetSetDescriptorType..types.pyx*
...
types.MemberDescriptorType           *MemberDescriptorType..types.pyx*
...
class types.MappingProxyType(mapping)    *MappingProxyType..types.pyx*
   ...
   copy()                            *MappingProxyType.copy()..types.pyx*

      Return a shallow copy of the underlying mapping.

   get(key[, default])                *MappingProxyType.get()..types.pyx*
   ...
   items()                          *MappingProxyType.items()..types.pyx*

      Return a new view of the underlying mapping’s items ("(key,
      value)" pairs).

   keys()                            *MappingProxyType.keys()..types.pyx*

      Return a new view of the underlying mapping’s keys.

   values()                        *MappingProxyType.values()..types.pyx*
...
class types.SimpleNamespace               *SimpleNamespace..types.pyx*
...
<
   ...
   alphabetical to insertion (like "dict").
                                  ...
                                  *DynamicClassAttribute()..types.pyx*
...
types.coroutine(gen_func)                     *coroutine()..types.pyx*
