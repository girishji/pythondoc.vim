*unittest.mock.pyx*                           Last change: 2023 Sep 15
...
class unittest.mock.Mock(spec=None, side_effect=None, return_value=DEFAULT, wraps=None, name=None, spec_set=None, unsafe=False, **kwargs)
   ...
   * _name_: If the mock has a name then it will be used in the repr
   ...
   assert_called()              *Mock.assert_called()..unittest.mock.pyx*
   ...
   assert_called_once()    *Mock.assert_called_once()..unittest.mock.pyx*
      ...
      New in version 3.6.
                        ...
                        *Mock.assert_called_with()..unittest.mock.pyx*
   assert_called_with(*args, **kwargs)
      ...
      >>> mock.method.assert_called_with(1, 2, 3, test='wow')
                   ...
                   *Mock.assert_called_once_with()..unittest.mock.pyx*
   assert_called_once_with(*args, **kwargs)
      ...
      AssertionError: Expected 'mock' to be called once. Called 2 times.
                           ...
                           *Mock.assert_any_call()..unittest.mock.pyx*
   assert_any_call(*args, **kwargs)
      ...
      >>> mock.assert_any_call(1, 2, arg='thing')
                          ...
                          *Mock.assert_has_calls()..unittest.mock.pyx*
   ...
   assert_not_called()      *Mock.assert_not_called()..unittest.mock.pyx*
      ...
      New in version 3.5.
                                ...
                                *Mock.reset_mock()..unittest.mock.pyx*
   reset_mock(*, return_value=False, side_effect=False)
      ...
      Note:
        ...
        _return_value_, and "side_effect" are keyword-only arguments.
                             ...
                             *Mock.mock_add_spec()..unittest.mock.pyx*
   ...
   attach_mock(mock, attribute)   *Mock.attach_mock()..unittest.mock.pyx*
   ...
   configure_mock(**kwargs)    *Mock.configure_mock()..unittest.mock.pyx*
   ...
   __dir__()                          *Mock.__dir__()..unittest.mock.pyx*
   ...
   _get_child_mock(**kw)      *Mock._get_child_mock()..unittest.mock.pyx*
   ...
   called                                *Mock.called..unittest.mock.pyx*
   ...
   call_count                        *Mock.call_count..unittest.mock.pyx*
   ...
   return_value                    *Mock.return_value..unittest.mock.pyx*
   ...
   side_effect                      *Mock.side_effect..unittest.mock.pyx*
   ...
   call_args                          *Mock.call_args..unittest.mock.pyx*
   ...
   call_args_list                *Mock.call_args_list..unittest.mock.pyx*
   ...
   method_calls                    *Mock.method_calls..unittest.mock.pyx*
   ...
   mock_calls                        *Mock.mock_calls..unittest.mock.pyx*
   ...
   __class__                          *Mock.__class__..unittest.mock.pyx*
      ...
      True
                                  ...
                                  *NonCallableMock..unittest.mock.pyx*
...
will also apply to method calls on the mock object.
   ...
   and autospecced mock objects.
                                     ...
                                     *PropertyMock..unittest.mock.pyx*
...
class unittest.mock.AsyncMock(spec=None, side_effect=None, return_value=DEFAULT, wraps=None, name=None, spec_set=None, unsafe=False, **kwargs)
   ...
   * if "side_effect" is not defined, the async function will return
   ...
   assert_awaited()       *AsyncMock.assert_awaited()..unittest.mock.pyx*
      ...
      >>> mock.assert_awaited()
                  ...
                  *AsyncMock.assert_awaited_once()..unittest.mock.pyx*
   assert_awaited_once()
      ...
      AssertionError: Expected mock to have been awaited once. Awaited 2 times.
                  ...
                  *AsyncMock.assert_awaited_with()..unittest.mock.pyx*
   assert_awaited_with(*args, **kwargs)
      ...
      Actual: mock('foo', bar='bar')
             ...
             *AsyncMock.assert_awaited_once_with()..unittest.mock.pyx*
   assert_awaited_once_with(*args, **kwargs)
      ...
      AssertionError: Expected mock to have been awaited once. Awaited 2 times.
                     ...
                     *AsyncMock.assert_any_await()..unittest.mock.pyx*
   assert_any_await(*args, **kwargs)
      ...
      AssertionError: mock('other') await not found
                    ...
                    *AsyncMock.assert_has_awaits()..unittest.mock.pyx*
   assert_has_awaits(calls, any_order=False)
      ...
      >>> mock.assert_has_awaits(calls)
                   ...
                   *AsyncMock.assert_not_awaited()..unittest.mock.pyx*
   assert_not_awaited()
   ...
   await_args                   *AsyncMock.await_args..unittest.mock.pyx*
   ...
   await_args_list         *AsyncMock.await_args_list..unittest.mock.pyx*
      ...
      [call('foo'), call('bar')]
                                    ...
                                    *ThreadingMock..unittest.mock.pyx*
class unittest.mock.ThreadingMock(spec=None, side_effect=None, return_value=DEFAULT, wraps=None, name=None, spec_set=None, unsafe=False, *, timeout=UNSET, **kwargs)
   ...
   "ThreadingMock.DEFAULT_TIMEOUT".
                ...
                *ThreadingMock.wait_until_called()..unittest.mock.pyx*
   wait_until_called(*, timeout=UNSET)
      ...
      >>> thread.join()
         ...
         *ThreadingMock.wait_until_any_call_with()..unittest.mock.pyx*
   ...
   DEFAULT_TIMEOUT     *ThreadingMock.DEFAULT_TIMEOUT..unittest.mock.pyx*
...
------------
                                   ...
                                   *patch.object()..unittest.mock.pyx*
...
--------------
                                 ...
                                 *patch.multiple()..unittest.mock.pyx*
...
patch.stopall()                   *patch.stopall()..unittest.mock.pyx*
...
class unittest.mock.MagicMock(*args, **kw)
   ...
   methods that exist in the spec will be created.
                             ...
                             *NonCallableMagicMock..unittest.mock.pyx*
...
unittest.mock.sentinel                   *sentinel..unittest.mock.pyx*
...
unittest.mock.DEFAULT                     *DEFAULT..unittest.mock.pyx*
...
unittest.mock.call(*args, **kwargs)        *call()..unittest.mock.pyx*
...
call.call_list()                 *call.call_list()..unittest.mock.pyx*
...
---------------
                                ...
                                *create_autospec()..unittest.mock.pyx*
...
unittest.mock.ANY                             *ANY..unittest.mock.pyx*
...
unittest.mock.FILTER_DIR               *FILTER_DIR..unittest.mock.pyx*
...
unittest.mock.seal(mock)                   *seal()..unittest.mock.pyx*
