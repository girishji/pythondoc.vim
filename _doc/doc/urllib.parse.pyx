*urllib.parse.pyx*                            Last change: 2023 Sep 15
...
urllib.parse.urlunparse(parts)        *urlunparse()..urllib.parse.pyx*
...
urllib.parse.urlunsplit(parts)        *urlunsplit()..urllib.parse.pyx*
...
urllib.parse.urldefrag(url)            *urldefrag()..urllib.parse.pyx*
...
urllib.parse.unwrap(url)                  *unwrap()..urllib.parse.pyx*
...
section, as well as an additional method:
                 ...
                 *urllib.parse.SplitResult.geturl()..urllib.parse.pyx*
...
when operating on "bytes" or "bytearray" objects:
                                 ...
                                 *DefragResultBytes..urllib.parse.pyx*
class urllib.parse.DefragResultBytes(url, fragment)
   ...
   New in version 3.2.
                                  ...
                                  *ParseResultBytes..urllib.parse.pyx*
class urllib.parse.ParseResultBytes(scheme, netloc, path, params, query, fragment)
   ...
   New in version 3.2.
                                  ...
                                  *SplitResultBytes..urllib.parse.pyx*
...
urllib.parse.quote_plus(string, safe='', encoding=None, errors=None)
   ...
   Example: "quote_plus('/El Niño/')" yields "'%2FEl+Ni%C3%B1o%2F'".
                                ...
                                *quote_from_bytes()..urllib.parse.pyx*
...
urllib.parse.unquote_plus(string, encoding='utf-8', errors='replace')
   ...
   Example: "unquote_plus('/El+Ni%C3%B1o/')" yields "'/El Niño/'".
                                ...
                                *unquote_to_bytes()..urllib.parse.pyx*
