*urllib.request.pyx*                          Last change: 2023 Sep 15
...
urllib.request.urlopen(url, data=None[, timeout], *, context=None)
   ...
   parameters: use the _context_ parameter instead.
                                ...
                                *install_opener()..urllib.request.pyx*
urllib.request.install_opener(opener)
   ...
   work.
                                  ...
                                  *build_opener()..urllib.request.pyx*
urllib.request.build_opener([handler, ...])
   ...
   attribute to modify its position in the handlers list.
                                  ...
                                  *pathname2url()..urllib.request.pyx*
urllib.request.pathname2url(path)
   ...
   "quote()" function.
                                  ...
                                  *url2pathname()..urllib.request.pyx*
...
urllib.request.getproxies()         *getproxies()..urllib.request.pyx*
...
class urllib.request.Request(url, data=None, headers={}, origin_req_host=None, unverifiable=False, method=None)
   ...
   bytes object. Fall back to use chunked transfer encoding instead.
                                  ...
                                  *OpenerDirector..urllib.request.pyx*
...
class urllib.request.BaseHandler     *BaseHandler..urllib.request.pyx*

   This is the base class for all registered handlers — and handles
   only the simple mechanics of registration.

                         *HTTPDefaultErrorHandler..urllib.request.pyx*
class urllib.request.HTTPDefaultErrorHandler
   ...
   all responses are turned into "HTTPError" exceptions.
                             ...
                             *HTTPRedirectHandler..urllib.request.pyx*
class urllib.request.HTTPRedirectHandler

   A class to handle redirections.

                             *HTTPCookieProcessor..urllib.request.pyx*
class urllib.request.HTTPCookieProcessor(cookiejar=None)

   A class to handle HTTP Cookies.

                                    *ProxyHandler..urllib.request.pyx*
   ...
   appended, for example "cern.ch,ncsa.uiuc.edu,some.host:8080".
      ...
      Note:
        ...
        set; see the documentation on "getproxies()".
                                 ...
                                 *HTTPPasswordMgr..urllib.request.pyx*
class urllib.request.HTTPPasswordMgr

   Keep a database of  "(realm, uri) -> (user, password)" mappings.

                 *HTTPPasswordMgrWithDefaultRealm..urllib.request.pyx*
class urllib.request.HTTPPasswordMgrWithDefaultRealm
   ...
   if no other realm fits.
                    ...
                    *HTTPPasswordMgrWithPriorAuth..urllib.request.pyx*
class urllib.request.HTTPPasswordMgrWithPriorAuth
   ...
   New in version 3.5.
                        ...
                        *AbstractBasicAuthHandler..urllib.request.pyx*
class urllib.request.AbstractBasicAuthHandler(password_mgr=None)
   ...
   New in version 3.5: Added "is_authenticated" support.
                            ...
                            *HTTPBasicAuthHandler..urllib.request.pyx*
class urllib.request.HTTPBasicAuthHandler(password_mgr=None)
   ...
   a wrong Authentication scheme.
                           ...
                           *ProxyBasicAuthHandler..urllib.request.pyx*
class urllib.request.ProxyBasicAuthHandler(password_mgr=None)
   ...
   interface that must be supported.
                       ...
                       *AbstractDigestAuthHandler..urllib.request.pyx*
class urllib.request.AbstractDigestAuthHandler(password_mgr=None)
   ...
   that must be supported.
                           ...
                           *HTTPDigestAuthHandler..urllib.request.pyx*
class urllib.request.HTTPDigestAuthHandler(password_mgr=None)
   ...
   Authentication Scheme.
                          ...
                          *ProxyDigestAuthHandler..urllib.request.pyx*
...
class urllib.request.HTTPHandler     *HTTPHandler..urllib.request.pyx*

   A class to handle opening of HTTP URLs.

                                    *HTTPSHandler..urllib.request.pyx*
...
class urllib.request.FileHandler     *FileHandler..urllib.request.pyx*

   Open local files.

class urllib.request.DataHandler     *DataHandler..urllib.request.pyx*

   Open data URLs.

   New in version 3.4.

class urllib.request.FTPHandler       *FTPHandler..urllib.request.pyx*

   Open FTP URLs.

                                 *CacheFTPHandler..urllib.request.pyx*
class urllib.request.CacheFTPHandler

   Open FTP URLs, keeping a cache of open FTP connections to minimize
   delays.

                                  *UnknownHandler..urllib.request.pyx*
class urllib.request.UnknownHandler

   A catch-all class to handle unknown URLs.

                              *HTTPErrorProcessor..urllib.request.pyx*
...
Request.full_url                *Request.full_url..urllib.request.pyx*
...
Request.type                        *Request.type..urllib.request.pyx*

   The URI scheme.

Request.host                        *Request.host..urllib.request.pyx*

   The URI authority, typically a host, but may also contain a port
   separated by a colon.

                         *Request.origin_req_host..urllib.request.pyx*
Request.origin_req_host

   The original host for the request, without port.

Request.selector                *Request.selector..urllib.request.pyx*

   The URI path.  If the "Request" uses a proxy, then selector will be
   the full URL that is passed to the proxy.

Request.data                        *Request.data..urllib.request.pyx*
...
Request.unverifiable        *Request.unverifiable..urllib.request.pyx*

   boolean, indicates whether the request is unverifiable as defined
   by **RFC 2965**.

Request.method                    *Request.method..urllib.request.pyx*
...
Request.get_method()        *Request.get_method()..urllib.request.pyx*
   ...
   "Request.method".
                            ...
                            *Request.add_header()..urllib.request.pyx*
Request.add_header(key, val)
   ...
   added using this method are also added to redirected requests.
               ...
               *Request.add_unredirected_header()..urllib.request.pyx*
Request.add_unredirected_header(key, header)

   Add a header that will not be added to a redirected request.

                            *Request.has_header()..urllib.request.pyx*
Request.has_header(header)

   Return whether the instance has the named header (checks both
   regular and unredirected).

                         *Request.remove_header()..urllib.request.pyx*
...
Request.get_full_url()    *Request.get_full_url()..urllib.request.pyx*
   ...
   Returns "Request.full_url"
                             ...
                             *Request.set_proxy()..urllib.request.pyx*
Request.set_proxy(host, type)
   ...
   selector will be the original URL given in the constructor.
                            ...
                            *Request.get_header()..urllib.request.pyx*
Request.get_header(header_name, default=None)

   Return the value of the given header. If the header is not present,
   return the default value.

Request.header_items()    *Request.header_items()..urllib.request.pyx*
...
"OpenerDirector" instances have the following methods:
                    ...
                    *OpenerDirector.add_handler()..urllib.request.pyx*
OpenerDirector.add_handler(handler)
   ...
   * "<protocol>_response()" — signal that the handler knows how to
     ...
     See "BaseHandler.<protocol>_response()" for more information.
                           ...
                           *OpenerDirector.open()..urllib.request.pyx*
OpenerDirector.open(url, data=None[, timeout])
   ...
   and FTP connections.
                          ...
                          *OpenerDirector.error()..urllib.request.pyx*
...
These are intended for direct use:
                        ...
                        *BaseHandler.add_parent()..urllib.request.pyx*
BaseHandler.add_parent(director)

   Add a director as parent.

BaseHandler.close()          *BaseHandler.close()..urllib.request.pyx*
...
BaseHandler.parent            *BaseHandler.parent..urllib.request.pyx*

   A valid "OpenerDirector", which can be used to open using a
   different protocol, or handle errors.

                      *BaseHandler.default_open()..urllib.request.pyx*
...
BaseHandler.<protocol>_open(req)
   ...
   "default_open()".
                      ...
                      *BaseHandler.unknown_open()..urllib.request.pyx*
BaseHandler.unknown_open(req)
   ...
   "default_open()".
                ...
                *BaseHandler.http_error_default()..urllib.request.pyx*
...
Note:
  ...
  not an HTTP, HTTPS or FTP URL.
          ...
          *HTTPRedirectHandler.redirect_request()..urllib.request.pyx*
HTTPRedirectHandler.redirect_request(req, fp, code, msg, hdrs, newurl)
   ...
   Note:
     ...
     "GET", and the default implementation reproduces this behavior.
            ...
            *HTTPRedirectHandler.http_error_301()..urllib.request.pyx*
HTTPRedirectHandler.http_error_301(req, fp, code, msg, hdrs)
   ...
   permanently’ response.
            ...
            *HTTPRedirectHandler.http_error_302()..urllib.request.pyx*
HTTPRedirectHandler.http_error_302(req, fp, code, msg, hdrs)

   The same as "http_error_301()", but called for the ‘found’
   response.

            *HTTPRedirectHandler.http_error_303()..urllib.request.pyx*
HTTPRedirectHandler.http_error_303(req, fp, code, msg, hdrs)

   The same as "http_error_301()", but called for the ‘see other’
   response.

            *HTTPRedirectHandler.http_error_307()..urllib.request.pyx*
HTTPRedirectHandler.http_error_307(req, fp, code, msg, hdrs)
   ...
   from "POST" to "GET".
            ...
            *HTTPRedirectHandler.http_error_308()..urllib.request.pyx*
...
"HTTPCookieProcessor" instances have one attribute:
                   ...
                   *HTTPCookieProcessor.cookiejar..urllib.request.pyx*
...
"HTTPPasswordMgrWithDefaultRealm" objects.
                  ...
                  *HTTPPasswordMgr.add_password()..urllib.request.pyx*
HTTPPasswordMgr.add_password(realm, uri, user, passwd)
   ...
   and a super-URI of any of the given URIs is given.
            ...
            *HTTPPasswordMgr.find_user_password()..urllib.request.pyx*
...
always be sent.
     ...
     *HTTPPasswordMgrWithPriorAuth.add_password()..urllib.request.pyx*
...
*HTTPPasswordMgrWithPriorAuth.find_user_password()..urllib.request.pyx*
HTTPPasswordMgrWithPriorAuth.find_user_password(realm, authuri)

   Same as for "HTTPPasswordMgrWithDefaultRealm" objects

*HTTPPasswordMgrWithPriorAuth.update_authenticated()..urllib.request.pyx*
HTTPPasswordMgrWithPriorAuth.update_authenticated(self, uri, is_authenticated=False)

   Update the "is_authenticated" flag for the given _uri_ or list of
   URIs.

 *HTTPPasswordMgrWithPriorAuth.is_authenticated()..urllib.request.pyx*
...
*AbstractBasicAuthHandler.http_error_auth_reqed()..urllib.request.pyx*
...
============================
           ...
           *HTTPBasicAuthHandler.http_error_401()..urllib.request.pyx*
...
=============================
          ...
          *ProxyBasicAuthHandler.http_error_407()..urllib.request.pyx*
...
*AbstractDigestAuthHandler.http_error_auth_reqed()..urllib.request.pyx*
...
=============================
          ...
          *HTTPDigestAuthHandler.http_error_401()..urllib.request.pyx*
...
==============================
         ...
         *ProxyDigestAuthHandler.http_error_407()..urllib.request.pyx*
...
===================
                         ...
                         *HTTPHandler.http_open()..urllib.request.pyx*
...
====================
                       ...
                       *HTTPSHandler.https_open()..urllib.request.pyx*
...
===================
                         ...
                         *FileHandler.file_open()..urllib.request.pyx*
...
===================
                         ...
                         *DataHandler.data_open()..urllib.request.pyx*
...
FTPHandler.ftp_open(req)   *FTPHandler.ftp_open()..urllib.request.pyx*
...
additional methods:
                    ...
                    *CacheFTPHandler.setTimeout()..urllib.request.pyx*
CacheFTPHandler.setTimeout(t)

   Set timeout of connections to _t_ seconds.

                   *CacheFTPHandler.setMaxConns()..urllib.request.pyx*
...
======================
                   ...
                   *UnknownHandler.unknown_open()..urllib.request.pyx*
...
==========================
              ...
              *HTTPErrorProcessor.http_response()..urllib.request.pyx*
HTTPErrorProcessor.http_response(request, response)
   ...
   will raise an "HTTPError" if no other handler handles the error.
             ...
             *HTTPErrorProcessor.https_response()..urllib.request.pyx*
...
deprecated at some point in the future.
                                   ...
                                   *urlretrieve()..urllib.request.pyx*
...
class urllib.request.URLopener(proxies=None, **x509)
   ...
   open(fullurl, data=None)        *URLopener.open()..urllib.request.pyx*
      ...
      This method always quotes _fullurl_ using "quote()".
                        ...
                        *URLopener.open_unknown()..urllib.request.pyx*
   open_unknown(fullurl, data=None)

      Overridable interface to open unknown URL types.

                            *URLopener.retrieve()..urllib.request.pyx*
   ...
   version                        *URLopener.version..urllib.request.pyx*
      ...
      before calling the base constructor.
                                  ...
                                  *FancyURLopener..urllib.request.pyx*
class urllib.request.FancyURLopener(...)
   ...
   be overloaded to provide the appropriate behavior:
             ...
             *FancyURLopener.prompt_user_passwd()..urllib.request.pyx*
...
class urllib.response.addinfourl      *addinfourl..urllib.request.pyx*

   url                               *addinfourl.url..urllib.request.pyx*

      URL of the resource retrieved, commonly used to determine if a
      redirect was followed.

   headers                       *addinfourl.headers..urllib.request.pyx*

      Returns the headers of the response in the form of an
      "EmailMessage" instance.

   status                         *addinfourl.status..urllib.request.pyx*

      New in version 3.9.

      Status code returned by server.

   geturl()                     *addinfourl.geturl()..urllib.request.pyx*

      Deprecated since version 3.9: Deprecated in favor of "url".

   info()                         *addinfourl.info()..urllib.request.pyx*

      Deprecated since version 3.9: Deprecated in favor of "headers".

   code                             *addinfourl.code..urllib.request.pyx*

      Deprecated since version 3.9: Deprecated in favor of "status".

   getcode()                   *addinfourl.getcode()..urllib.request.pyx*
