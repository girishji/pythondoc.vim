*urllib.robotparser.pyx*                      Last change: 2023 Sep 15
...
http://www.robotstxt.org/orig.html.
                             ...
                             *RobotFileParser..urllib.robotparser.pyx*
class urllib.robotparser.RobotFileParser(url='')

   This class provides methods to read, parse and answer questions
   about the "robots.txt" file at _url_.

   set_url(url)       *RobotFileParser.set_url()..urllib.robotparser.pyx*

      Sets the URL referring to a "robots.txt" file.

   read()                *RobotFileParser.read()..urllib.robotparser.pyx*

      Reads the "robots.txt" URL and feeds it to the parser.

   parse(lines)         *RobotFileParser.parse()..urllib.robotparser.pyx*

      Parses the lines argument.

                 *RobotFileParser.can_fetch()..urllib.robotparser.pyx*
   ...
   mtime()              *RobotFileParser.mtime()..urllib.robotparser.pyx*
   ...
   modified()        *RobotFileParser.modified()..urllib.robotparser.pyx*

      Sets the time the "robots.txt" file was last fetched to the
      current time.

               *RobotFileParser.crawl_delay()..urllib.robotparser.pyx*
   crawl_delay(useragent)
      ...
      New in version 3.6.
              ...
              *RobotFileParser.request_rate()..urllib.robotparser.pyx*
   ...
   site_maps()      *RobotFileParser.site_maps()..urllib.robotparser.pyx*
