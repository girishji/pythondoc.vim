*webbrowser.pyx*                              Last change: 2023 Sep 15
...
exception webbrowser.Error                     *Error..webbrowser.pyx*

   Exception raised when a browser control error occurs.

The following functions are defined:

webbrowser.open(url, new=0, autoraise=True)   *open()..webbrowser.pyx*
...
New in version 3.2: A new "MacOSXOSAScript" class has been added and
...
controller.name                      *controller.name..webbrowser.pyx*

   System-dependent name for the browser.

                                   *controller.open()..webbrowser.pyx*
...
controller.open_new(url)       *controller.open_new()..webbrowser.pyx*
   ...
   window.  Alias "open_new()".
                           ...
                           *controller.open_new_tab()..webbrowser.pyx*
