*wsgiref.pyx*                                 Last change: 2023 Sep 15
...
wsgiref.util.guess_scheme(environ)       *guess_scheme()..wsgiref.pyx*
...
wsgiref.util.shift_path_info(environ)
   ...
   traversal.
                               ...
                               *setup_testing_defaults()..wsgiref.pyx*
...
module also provides these miscellaneous utilities:
                                        ...
                                        *is_hop_by_hop()..wsgiref.pyx*
wsgiref.util.is_hop_by_hop(header_name)

   Return "True" if ‘header_name’ is an HTTP/1.1 “Hop-by-Hop” header,
   as defined by **RFC 2616**.

                                            *FileWrapper..wsgiref.pyx*
...
class wsgiref.headers.Headers([headers])        *Headers..wsgiref.pyx*
   ...
   get_all(name)                         *Headers.get_all()..wsgiref.pyx*
      ...
      given name, returns an empty list.
                                   ...
                                   *Headers.add_header()..wsgiref.pyx*
...
class wsgiref.simple_server.WSGIServer(server_address, RequestHandlerClass)
   ...
   set_app(application)               *WSGIServer.set_app()..wsgiref.pyx*

      Sets the callable _application_ as the WSGI application that
      will receive requests.

   get_app()                          *WSGIServer.get_app()..wsgiref.pyx*
   ...
   instances.
                                     ...
                                     *WSGIRequestHandler..wsgiref.pyx*
class wsgiref.simple_server.WSGIRequestHandler(request, client_address, server)
   ...
   get_environ()          *WSGIRequestHandler.get_environ()..wsgiref.pyx*
...
wsgiref.validate.validator(application)     *validator()..wsgiref.pyx*
...
class wsgiref.handlers.CGIHandler            *CGIHandler..wsgiref.pyx*
...
class wsgiref.handlers.IISCGIHandler      *IISCGIHandler..wsgiref.pyx*
...
class wsgiref.handlers.BaseHandler          *BaseHandler..wsgiref.pyx*
   ...
   run(app)                              *BaseHandler.run()..wsgiref.pyx*
   ...
   _write(data)                       *BaseHandler._write()..wsgiref.pyx*
   ...
   wsgi_multithread           *BaseHandler.wsgi_multithread..wsgiref.pyx*
   ...
   wsgi_multiprocess         *BaseHandler.wsgi_multiprocess..wsgiref.pyx*
   ...
   wsgi_run_once                 *BaseHandler.wsgi_run_once..wsgiref.pyx*
   ...
   os_environ                       *BaseHandler.os_environ..wsgiref.pyx*
   ...
   server_software             *BaseHandler.server_software..wsgiref.pyx*
   ...
   get_scheme()                   *BaseHandler.get_scheme()..wsgiref.pyx*
   ...
   setup_environ()             *BaseHandler.setup_environ()..wsgiref.pyx*
   ...
   log_exception(exc_info)     *BaseHandler.log_exception()..wsgiref.pyx*
   ...
   error_body                       *BaseHandler.error_body..wsgiref.pyx*
   ...
   wsgi_file_wrapper         *BaseHandler.wsgi_file_wrapper..wsgiref.pyx*
   ...
   sendfile()                       *BaseHandler.sendfile()..wsgiref.pyx*
   ...
   origin_server                 *BaseHandler.origin_server..wsgiref.pyx*
   ...
   http_version                   *BaseHandler.http_version..wsgiref.pyx*
...
wsgiref.handlers.read_environ()          *read_environ()..wsgiref.pyx*
...
class wsgiref.types.StartResponse         *StartResponse..wsgiref.pyx*

   A "typing.Protocol" describing start_response() callables (**PEP
   3333**).

wsgiref.types.WSGIEnvironment           *WSGIEnvironment..wsgiref.pyx*

   A type alias describing a WSGI environment dictionary.

wsgiref.types.WSGIApplication           *WSGIApplication..wsgiref.pyx*

   A type alias describing a WSGI application callable.

class wsgiref.types.InputStream             *InputStream..wsgiref.pyx*

   A "typing.Protocol" describing a WSGI Input Stream.

class wsgiref.types.ErrorStream             *ErrorStream..wsgiref.pyx*
