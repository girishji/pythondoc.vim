*xml.etree.elementtree.pyx*                   Last change: 2023 Sep 15
...
---------
                           ...
                           *canonicalize()..xml.etree.elementtree.pyx*
...
<
   ...
   * _exclude_tags_: a set of tag names that should not be serialised
   ...
   New in version 3.8.
                                ...
                                *Comment()..xml.etree.elementtree.pyx*
...
xml.etree.ElementTree.dump(elem)   *dump()..xml.etree.elementtree.pyx*
   ...
   attribute order specified by the user.
                             ...
                             *fromstring()..xml.etree.elementtree.pyx*
xml.etree.ElementTree.fromstring(text, parser=None)
   ...
   used. Returns an "Element" instance.
                         ...
                         *fromstringlist()..xml.etree.elementtree.pyx*
xml.etree.ElementTree.fromstringlist(sequence, parser=None)
   ...
   New in version 3.2.
                                 ...
                                 *indent()..xml.etree.elementtree.pyx*
xml.etree.ElementTree.indent(tree, space='  ', level=0)
   ...
   New in version 3.9.
                              ...
                              *iselement()..xml.etree.elementtree.pyx*
xml.etree.ElementTree.iselement(element)
   ...
   object.
                              ...
                              *iterparse()..xml.etree.elementtree.pyx*
xml.etree.ElementTree.iterparse(source, events=None, parser=None)
   ...
   Changed in version 3.8: The "comment" and "pi" events were added.
                                  ...
                                  *parse()..xml.etree.elementtree.pyx*
xml.etree.ElementTree.parse(source, parser=None)
   ...
   Returns an "ElementTree" instance.
                  ...
                  *ProcessingInstruction()..xml.etree.elementtree.pyx*
xml.etree.ElementTree.ProcessingInstruction(target, text=None)
   ...
   methods.
                     ...
                     *register_namespace()..xml.etree.elementtree.pyx*
xml.etree.ElementTree.register_namespace(prefix, uri)
   ...
   New in version 3.2.
                             ...
                             *SubElement()..xml.etree.elementtree.pyx*
xml.etree.ElementTree.SubElement(parent, tag, attrib={}, **extra)
   ...
   element instance.
                               ...
                               *tostring()..xml.etree.elementtree.pyx*
xml.etree.ElementTree.tostring(element, encoding='us-ascii', method='xml', *, xml_declaration=None, default_namespace=None, short_empty_elements=True)
   ...
   attribute order specified by the user.
                           ...
                           *tostringlist()..xml.etree.elementtree.pyx*
...
xml.etree.ElementTree.XML(text, parser=None)
   ...
   "Element" instance.
                                  ...
                                  *XMLID()..xml.etree.elementtree.pyx*
...
*xml.etree.ElementInclude.default_loader()..xml.etree.elementtree.pyx*
xml.etree.ElementInclude.default_loader(href, parse, encoding=None)
   ...
   can return None or raise an exception.
       ...
       *xml.etree.ElementInclude.include()..xml.etree.elementtree.pyx*
...
---------------
                                  ...
                                  *Element..xml.etree.elementtree.pyx*
class xml.etree.ElementTree.Element(tag, attrib={}, **extra)
   ...
   tag                           *Element.tag..xml.etree.elementtree.pyx*

      A string identifying what kind of data this element represents
      (the element type, in other words).

   text                         *Element.text..xml.etree.elementtree.pyx*
   tail                         *Element.tail..xml.etree.elementtree.pyx*
...
<
   ...
   attrib                     *Element.attrib..xml.etree.elementtree.pyx*
   ...
   extend(subelements)      *Element.extend()..xml.etree.elementtree.pyx*
      ...
      New in version 3.2.
                           ...
                           *Element.find()..xml.etree.elementtree.pyx*
   find(match, namespaces=None)
      ...
      in the expression into the given namespace.
                        ...
                        *Element.findall()..xml.etree.elementtree.pyx*
   findall(match, namespaces=None)
      ...
      in the expression into the given namespace.
                       ...
                       *Element.findtext()..xml.etree.elementtree.pyx*
   ...
   iter(tag=None)             *Element.iter()..xml.etree.elementtree.pyx*
      ...
      New in version 3.2.
                       ...
                       *Element.iterfind()..xml.etree.elementtree.pyx*
   ...
   itertext()             *Element.itertext()..xml.etree.elementtree.pyx*
      ...
      New in version 3.2.
                    ...
                    *Element.makeelement()..xml.etree.elementtree.pyx*
   ...
   remove(subelement)       *Element.remove()..xml.etree.elementtree.pyx*
...
-------------------
                              ...
                              *ElementTree..xml.etree.elementtree.pyx*
class xml.etree.ElementTree.ElementTree(element=None, file=None)
   ...
   contents of the XML _file_ if given.
                   ...
                   *ElementTree._setroot()..xml.etree.elementtree.pyx*
   _setroot(element)
      ...
      element.  Use with care.  _element_ is an element instance.
                       ...
                       *ElementTree.find()..xml.etree.elementtree.pyx*
   find(match, namespaces=None)

      Same as "Element.find()", starting at the root of the tree.

                    *ElementTree.findall()..xml.etree.elementtree.pyx*
   findall(match, namespaces=None)

      Same as "Element.findall()", starting at the root of the tree.

                   *ElementTree.findtext()..xml.etree.elementtree.pyx*
   findtext(match, default=None, namespaces=None)

      Same as "Element.findtext()", starting at the root of the tree.

   getroot()           *ElementTree.getroot()..xml.etree.elementtree.pyx*

      Returns the root element for this tree.

   iter(tag=None)         *ElementTree.iter()..xml.etree.elementtree.pyx*
      ...
      elements).
                   ...
                   *ElementTree.iterfind()..xml.etree.elementtree.pyx*
   iterfind(match, namespaces=None)
      ...
      New in version 3.2.
                      ...
                      *ElementTree.parse()..xml.etree.elementtree.pyx*
   parse(source, parser=None)
      ...
      Returns the section root element.
                      ...
                      *ElementTree.write()..xml.etree.elementtree.pyx*
...
-------------
                                    ...
                                    *QName..xml.etree.elementtree.pyx*
...
-------------------
                              ...
                              *TreeBuilder..xml.etree.elementtree.pyx*
class xml.etree.ElementTree.TreeBuilder(element_factory=None, *, comment_factory=None, pi_factory=None, insert_comments=False, insert_pis=False)
   ...
   pi(target, text)         *TreeBuilder.pi()..xml.etree.elementtree.pyx*
   ...
   following methods:
                    ...
                    *TreeBuilder.doctype()..xml.etree.elementtree.pyx*
   doctype(name, pubid, system)
      ...
      New in version 3.2.
                   ...
                   *TreeBuilder.start_ns()..xml.etree.elementtree.pyx*
   start_ns(prefix, uri)
   ...
   end_ns(prefix)       *TreeBuilder.end_ns()..xml.etree.elementtree.pyx*
      ...
      New in version 3.8.
                         ...
                         *C14NWriterTarget..xml.etree.elementtree.pyx*
...
-----------------
                                ...
                                *XMLParser..xml.etree.elementtree.pyx*
class xml.etree.ElementTree.XMLParser(*, target=None, encoding=None)
   ...
   close()                 *XMLParser.close()..xml.etree.elementtree.pyx*
   ...
   feed(data)               *XMLParser.feed()..xml.etree.elementtree.pyx*
...
---------------------
                            ...
                            *XMLPullParser..xml.etree.elementtree.pyx*
class xml.etree.ElementTree.XMLPullParser(events=None)
   ...
   feed(data)           *XMLPullParser.feed()..xml.etree.elementtree.pyx*

      Feed the given bytes data to the parser.

   close()             *XMLPullParser.close()..xml.etree.elementtree.pyx*
      ...
      read with "read_events()".
              ...
              *XMLPullParser.read_events()..xml.etree.elementtree.pyx*
   read_events()
...
----------
                               ...
                               *ParseError..xml.etree.elementtree.pyx*
