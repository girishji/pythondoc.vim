*xml.sax.handler.pyx*                         Last change: 2023 Sep 15
...
"xml.sax.handler", so that all methods get default implementations.
                                 ...
                                 *ContentHandler..xml.sax.handler.pyx*
...
class xml.sax.handler.DTDHandler     *DTDHandler..xml.sax.handler.pyx*
   ...
   parsing (unparsed entities and attributes).
                                 ...
                                 *EntityResolver..xml.sax.handler.pyx*
class xml.sax.handler.EntityResolver
   ...
   all external entities.
                                   ...
                                   *ErrorHandler..xml.sax.handler.pyx*
class xml.sax.handler.ErrorHandler
   ...
   some other way.
                                 ...
                                 *LexicalHandler..xml.sax.handler.pyx*
...
constants for the feature and property names.
                             ...
                             *feature_namespaces..xml.sax.handler.pyx*
xml.sax.handler.feature_namespaces
      ...
      access: (parsing) read-only; (not parsing) read/write
                     ...
                     *feature_namespace_prefixes..xml.sax.handler.pyx*
xml.sax.handler.feature_namespace_prefixes
      ...
      access: (parsing) read-only; (not parsing) read/write
                       ...
                       *feature_string_interning..xml.sax.handler.pyx*
xml.sax.handler.feature_string_interning
      ...
      access: (parsing) read-only; (not parsing) read/write
                             ...
                             *feature_validation..xml.sax.handler.pyx*
xml.sax.handler.feature_validation
      ...
      access: (parsing) read-only; (not parsing) read/write
                           ...
                           *feature_external_ges..xml.sax.handler.pyx*
xml.sax.handler.feature_external_ges
      ...
      access: (parsing) read-only; (not parsing) read/write
                           ...
                           *feature_external_pes..xml.sax.handler.pyx*
...
xml.sax.handler.all_features       *all_features..xml.sax.handler.pyx*

   List of all features.

                       *property_lexical_handler..xml.sax.handler.pyx*
xml.sax.handler.property_lexical_handler
      ...
      access: read/write
                   ...
                   *property_declaration_handler..xml.sax.handler.pyx*
xml.sax.handler.property_declaration_handler
      ...
      access: read/write
                              ...
                              *property_dom_node..xml.sax.handler.pyx*
xml.sax.handler.property_dom_node
      ...
      access: (parsing) read-only; (not parsing) read/write
                            ...
                            *property_xml_string..xml.sax.handler.pyx*
...
xml.sax.handler.all_properties   *all_properties..xml.sax.handler.pyx*
...
appropriate events in the input document:
            ...
            *ContentHandler.setDocumentLocator()..xml.sax.handler.pyx*
ContentHandler.setDocumentLocator(locator)
   ...
   should not attempt to use it at any other time.
                 ...
                 *ContentHandler.startDocument()..xml.sax.handler.pyx*
ContentHandler.startDocument()
   ...
   "setDocumentLocator()").
                   ...
                   *ContentHandler.endDocument()..xml.sax.handler.pyx*
ContentHandler.endDocument()
   ...
   of an unrecoverable error) or reached the end of input.
            ...
            *ContentHandler.startPrefixMapping()..xml.sax.handler.pyx*
ContentHandler.startPrefixMapping(prefix, uri)
   ...
   their order is not guaranteed.
              ...
              *ContentHandler.endPrefixMapping()..xml.sax.handler.pyx*
ContentHandler.endPrefixMapping(prefix)
   ...
   of "endPrefixMapping()" events is not otherwise guaranteed.
                  ...
                  *ContentHandler.startElement()..xml.sax.handler.pyx*
ContentHandler.startElement(name, attrs)
   ...
   the attributes, use the "copy()" method of the _attrs_ object.
                    ...
                    *ContentHandler.endElement()..xml.sax.handler.pyx*
ContentHandler.endElement(name)
   ...
   with the "startElement()" event.
                ...
                *ContentHandler.startElementNS()..xml.sax.handler.pyx*
ContentHandler.startElementNS(name, qname, attrs)
   ...
   "feature_namespace_prefixes" feature is activated.
                  ...
                  *ContentHandler.endElementNS()..xml.sax.handler.pyx*
ContentHandler.endElementNS(name, qname)
   ...
   with the "startElementNS()" method, likewise the _qname_ parameter.
                    ...
                    *ContentHandler.characters()..xml.sax.handler.pyx*
ContentHandler.characters(content)
   ...
   Note:
     ...
     of slicing content with the old _offset_ and _length_ parameters.
           ...
           *ContentHandler.ignorableWhitespace()..xml.sax.handler.pyx*
ContentHandler.ignorableWhitespace(whitespace)
   ...
   entity, so that the Locator provides useful information.
         ...
         *ContentHandler.processingInstruction()..xml.sax.handler.pyx*
ContentHandler.processingInstruction(target, data)
   ...
   this method.
                 ...
                 *ContentHandler.skippedEntity()..xml.sax.handler.pyx*
...
"DTDHandler" instances provide the following methods:
                      ...
                      *DTDHandler.notationDecl()..xml.sax.handler.pyx*
DTDHandler.notationDecl(name, publicId, systemId)

   Handle a notation declaration event.

                *DTDHandler.unparsedEntityDecl()..xml.sax.handler.pyx*
...
======================
                 ...
                 *EntityResolver.resolveEntity()..xml.sax.handler.pyx*
...
exception object.
                           ...
                           *ErrorHandler.error()..xml.sax.handler.pyx*
ErrorHandler.error(exception)
   ...
   errors to be discovered in the input document.
                      ...
                      *ErrorHandler.fatalError()..xml.sax.handler.pyx*
ErrorHandler.fatalError(exception)
   ...
   parsing is expected to terminate when this method returns.
                         ...
                         *ErrorHandler.warning()..xml.sax.handler.pyx*
...
handler'".
                       ...
                       *LexicalHandler.comment()..xml.sax.handler.pyx*
...
LexicalHandler.startCDATA()
   ...
   the characters handler.
                      ...
                      *LexicalHandler.endCDATA()..xml.sax.handler.pyx*
