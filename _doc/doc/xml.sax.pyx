*xml.sax.pyx*                                 Last change: 2023 Sep 15
...
xml.sax.make_parser(parser_list=[])       *make_parser()..xml.sax.pyx*
...
exception xml.sax.SAXParseException(msg, exception, locator)
   ...
   interface.
                              ...
                              *SAXNotRecognizedException..xml.sax.pyx*
exception xml.sax.SAXNotRecognizedException(msg, exception=None)
   ...
   purposes.
                               ...
                               *SAXNotSupportedException..xml.sax.pyx*
...
SAXException.getMessage()     *SAXException.getMessage()..xml.sax.pyx*

   Return a human-readable message describing the error condition.

                            *SAXException.getException()..xml.sax.pyx*
