*xmlrpc.client.pyx*                           Last change: 2023 Sep 15
...
methods grouped under the reserved "system" attribute:
                 ...
                 *ServerProxy.system.listMethods()..xmlrpc.client.pyx*
ServerProxy.system.listMethods()

   This method returns a list of strings, one for each (non-system)
   method supported by the XML-RPC server.

             *ServerProxy.system.methodSignature()..xmlrpc.client.pyx*
ServerProxy.system.methodSignature(name)
   ...
   will be something other than list.
                  ...
                  *ServerProxy.system.methodHelp()..xmlrpc.client.pyx*
...
class xmlrpc.client.DateTime             *DateTime..xmlrpc.client.pyx*
   ...
   decode(string)                  *DateTime.decode()..xmlrpc.client.pyx*

      Accept a string as the instance’s new time value.

   encode(out)                     *DateTime.encode()..xmlrpc.client.pyx*
...
class xmlrpc.client.Binary                 *Binary..xmlrpc.client.pyx*
   ...
   data                                  *Binary.data..xmlrpc.client.pyx*
   ...
   decode(bytes)                     *Binary.decode()..xmlrpc.client.pyx*

      Accept a base64 "bytes" object and decode it as the instance’s
      new data.

   encode(out)                       *Binary.encode()..xmlrpc.client.pyx*
...
class xmlrpc.client.Fault                   *Fault..xmlrpc.client.pyx*

   A "Fault" object encapsulates the content of an XML-RPC fault tag.
   Fault objects have the following attributes:

   faultCode                         *Fault.faultCode..xmlrpc.client.pyx*

      An int indicating the fault type.

   faultString                     *Fault.faultString..xmlrpc.client.pyx*
...
class xmlrpc.client.ProtocolError   *ProtocolError..xmlrpc.client.pyx*
   ...
   url                             *ProtocolError.url..xmlrpc.client.pyx*

      The URI or URL that triggered the error.

   errcode                     *ProtocolError.errcode..xmlrpc.client.pyx*

      The error code.

   errmsg                       *ProtocolError.errmsg..xmlrpc.client.pyx*

      The error message or diagnostic string.

   headers                     *ProtocolError.headers..xmlrpc.client.pyx*
...
class xmlrpc.client.MultiCall(server)   *MultiCall..xmlrpc.client.pyx*
