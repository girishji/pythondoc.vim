*xmlrpc.server.pyx*                           Last change: 2023 Sep 15
...
more information.
                               ...
                               *SimpleXMLRPCServer..xmlrpc.server.pyx*
class xmlrpc.server.SimpleXMLRPCServer(addr, requestHandler=SimpleXMLRPCRequestHandler, logRequests=True, allow_none=False, encoding=None, bind_and_activate=True, use_builtin_types=False)
   ...
   Changed in version 3.3: The _use_builtin_types_ flag was added.
                          ...
                          *CGIXMLRPCRequestHandler..xmlrpc.server.pyx*
class xmlrpc.server.CGIXMLRPCRequestHandler(allow_none=False, encoding=None, use_builtin_types=False)
   ...
   Changed in version 3.3: The _use_builtin_types_ flag was added.
                       ...
                       *SimpleXMLRPCRequestHandler..xmlrpc.server.pyx*
...
and provides a means of creating simple, stand alone XML-RPC servers.
           ...
           *SimpleXMLRPCServer.register_function()..xmlrpc.server.pyx*
SimpleXMLRPCServer.register_function(function=None, name=None)
   ...
   decorator.
           ...
           *SimpleXMLRPCServer.register_instance()..xmlrpc.server.pyx*
...
*SimpleXMLRPCServer.register_introspection_functions()..xmlrpc.server.pyx*
SimpleXMLRPCServer.register_introspection_functions()

   Registers the XML-RPC introspection functions "system.listMethods",
   "system.methodHelp" and "system.methodSignature".

*SimpleXMLRPCServer.register_multicall_functions()..xmlrpc.server.pyx*
SimpleXMLRPCServer.register_multicall_functions()

   Registers the XML-RPC multicall function system.multicall.

             *SimpleXMLRPCRequestHandler.rpc_paths..xmlrpc.server.pyx*
...
requests sent to Python CGI scripts.
      ...
      *CGIXMLRPCRequestHandler.register_function()..xmlrpc.server.pyx*
CGIXMLRPCRequestHandler.register_function(function=None, name=None)
   ...
   decorator.
      ...
      *CGIXMLRPCRequestHandler.register_instance()..xmlrpc.server.pyx*
...
*CGIXMLRPCRequestHandler.register_introspection_functions()..xmlrpc.server.pyx*
CGIXMLRPCRequestHandler.register_introspection_functions()

   Register the XML-RPC introspection functions  "system.listMethods",
   "system.methodHelp" and  "system.methodSignature".

*CGIXMLRPCRequestHandler.register_multicall_functions()..xmlrpc.server.pyx*
CGIXMLRPCRequestHandler.register_multicall_functions()

   Register the XML-RPC multicall function "system.multicall".

         *CGIXMLRPCRequestHandler.handle_request()..xmlrpc.server.pyx*
...
"DocCGIXMLRPCRequestHandler".
                                  ...
                                  *DocXMLRPCServer..xmlrpc.server.pyx*
class xmlrpc.server.DocXMLRPCServer(addr, requestHandler=DocXMLRPCRequestHandler, logRequests=True, allow_none=False, encoding=None, bind_and_activate=True, use_builtin_types=True)
   ...
   Changed in version 3.3: The _use_builtin_types_ flag was added.
                       ...
                       *DocCGIXMLRPCRequestHandler..xmlrpc.server.pyx*
class xmlrpc.server.DocCGIXMLRPCRequestHandler

   Create a new instance to handle XML-RPC requests in a CGI
   environment.

                          *DocXMLRPCRequestHandler..xmlrpc.server.pyx*
...
DocXMLRPCServer.set_server_name(server_name)
   ...
   element.
       ...
       *DocXMLRPCServer.set_server_documentation()..xmlrpc.server.pyx*
...
own web-based documentation.
    ...
    *DocCGIXMLRPCRequestHandler.set_server_title()..xmlrpc.server.pyx*
DocCGIXMLRPCRequestHandler.set_server_title(server_title)

   Set the title used in the generated HTML documentation. This title
   will be used inside the HTML “title” element.

     *DocCGIXMLRPCRequestHandler.set_server_name()..xmlrpc.server.pyx*
...
*DocCGIXMLRPCRequestHandler.set_server_documentation()..xmlrpc.server.pyx*
