*zipfile.pyx*                                 Last change: 2023 Sep 15
...
exception zipfile.BadZipFile                 *BadZipFile..zipfile.pyx*
...
class zipfile.PyZipFile                       *PyZipFile..zipfile.pyx*
...
zipfile.is_zipfile(filename)               *is_zipfile()..zipfile.pyx*
...
zipfile.ZIP_STORED                           *ZIP_STORED..zipfile.pyx*

   The numeric constant for an uncompressed archive member.

zipfile.ZIP_DEFLATED                       *ZIP_DEFLATED..zipfile.pyx*

   The numeric constant for the usual ZIP compression method.  This
   requires the "zlib" module.

zipfile.ZIP_BZIP2                             *ZIP_BZIP2..zipfile.pyx*
...
zipfile.ZIP_LZMA                               *ZIP_LZMA..zipfile.pyx*
...
ZipFile.infolist()                   *ZipFile.infolist()..zipfile.pyx*
...
ZipFile.namelist()                   *ZipFile.namelist()..zipfile.pyx*

   Return a list of archive members by name.

                                         *ZipFile.open()..zipfile.pyx*
...
ZipFile.extract(member, path=None, pwd=None)
   ...
   object_.
                                   ...
                                   *ZipFile.extractall()..zipfile.pyx*
...
ZipFile.printdir()                   *ZipFile.printdir()..zipfile.pyx*

   Print a table of contents for the archive to "sys.stdout".

ZipFile.setpassword(pwd)          *ZipFile.setpassword()..zipfile.pyx*

   Set _pwd_ (a "bytes" object) as default password to extract
   encrypted files.

ZipFile.read(name, pwd=None)             *ZipFile.read()..zipfile.pyx*
...
ZipFile.testzip()                     *ZipFile.testzip()..zipfile.pyx*
...
ZipFile.filename                       *ZipFile.filename..zipfile.pyx*

   Name of the ZIP file.

ZipFile.debug                             *ZipFile.debug..zipfile.pyx*
...
ZipFile.comment                         *ZipFile.comment..zipfile.pyx*
...
Path.name                                     *Path.name..zipfile.pyx*

   The final path component.

Path.open(mode='r', *, pwd, **)             *Path.open()..zipfile.pyx*
...
Path.iterdir()                           *Path.iterdir()..zipfile.pyx*

   Enumerate the children of the current directory.

Path.is_dir()                             *Path.is_dir()..zipfile.pyx*

   Return "True" if the current context references a directory.

Path.is_file()                           *Path.is_file()..zipfile.pyx*

   Return "True" if the current context references a file.

Path.exists()                             *Path.exists()..zipfile.pyx*

   Return "True" if the current context references a file or directory
   in the zip file.

Path.suffix                                 *Path.suffix..zipfile.pyx*
...
Path.read_bytes()                     *Path.read_bytes()..zipfile.pyx*

   Read the current file as bytes.

Path.joinpath(*other)                   *Path.joinpath()..zipfile.pyx*
...
ZipInfo.is_dir()                       *ZipInfo.is_dir()..zipfile.pyx*
...
ZipInfo.filename                       *ZipInfo.filename..zipfile.pyx*

   Name of the file in the archive.

ZipInfo.date_time                     *ZipInfo.date_time..zipfile.pyx*
...
ZipInfo.compress_type             *ZipInfo.compress_type..zipfile.pyx*

   Type of compression for the archive member.

ZipInfo.comment                         *ZipInfo.comment..zipfile.pyx*

   Comment for the individual archive member as a "bytes" object.

ZipInfo.extra                             *ZipInfo.extra..zipfile.pyx*
...
ZipInfo.create_system             *ZipInfo.create_system..zipfile.pyx*

   System which created ZIP archive.

ZipInfo.create_version           *ZipInfo.create_version..zipfile.pyx*

   PKZIP version which created ZIP archive.

ZipInfo.extract_version         *ZipInfo.extract_version..zipfile.pyx*

   PKZIP version needed to extract archive.

ZipInfo.reserved                       *ZipInfo.reserved..zipfile.pyx*

   Must be zero.

ZipInfo.flag_bits                     *ZipInfo.flag_bits..zipfile.pyx*

   ZIP flag bits.

ZipInfo.volume                           *ZipInfo.volume..zipfile.pyx*

   Volume number of file header.

ZipInfo.internal_attr             *ZipInfo.internal_attr..zipfile.pyx*

   Internal attributes.

ZipInfo.external_attr             *ZipInfo.external_attr..zipfile.pyx*

   External file attributes.

ZipInfo.header_offset             *ZipInfo.header_offset..zipfile.pyx*

   Byte offset to the file header.

ZipInfo.CRC                                 *ZipInfo.CRC..zipfile.pyx*

   CRC-32 of the uncompressed file.

ZipInfo.compress_size             *ZipInfo.compress_size..zipfile.pyx*

   Size of the compressed data.

ZipInfo.file_size                     *ZipInfo.file_size..zipfile.pyx*
