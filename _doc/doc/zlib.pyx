*zlib.pyx*                                    Last change: 2023 Sep 15
...
exception zlib.error                                 *error..zlib.pyx*

   Exception raised on compression and decompression errors.

zlib.adler32(data[, value])                      *adler32()..zlib.pyx*
...
zlib.crc32(data[, value])                          *crc32()..zlib.pyx*
...
Compress.compress(data)                *Compress.compress()..zlib.pyx*
...
Compress.flush([mode])                    *Compress.flush()..zlib.pyx*
...
Compress.copy()                            *Compress.copy()..zlib.pyx*
...
Decompress.unused_data              *Decompress.unused_data..zlib.pyx*
...
Decompress.unconsumed_tail      *Decompress.unconsumed_tail..zlib.pyx*
...
Decompress.eof                              *Decompress.eof..zlib.pyx*
   ...
   New in version 3.3.
                                   ...
                                   *Decompress.decompress()..zlib.pyx*
...
Decompress.flush([length])              *Decompress.flush()..zlib.pyx*
...
Decompress.copy()                        *Decompress.copy()..zlib.pyx*
...
zlib.ZLIB_VERSION                             *ZLIB_VERSION..zlib.pyx*
...
zlib.ZLIB_RUNTIME_VERSION             *ZLIB_RUNTIME_VERSION..zlib.pyx*
