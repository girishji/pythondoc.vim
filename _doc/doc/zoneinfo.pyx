*zoneinfo.pyx*                                Last change: 2023 Sep 15
...
class zoneinfo.ZoneInfo(key)                  *ZoneInfo..zoneinfo.pyx*
...
The "ZoneInfo" class has two alternate constructors:
                                  ...
                                  *ZoneInfo.from_file()..zoneinfo.pyx*
classmethod ZoneInfo.from_file(fobj, /, key=None)
   ...
   pickling).
                                   ...
                                   *ZoneInfo.no_cache()..zoneinfo.pyx*
...
The following class methods are also available:
                                ...
                                *ZoneInfo.clear_cache()..zoneinfo.pyx*
...
ZoneInfo.key                              *ZoneInfo.key..zoneinfo.pyx*
...
zoneinfo.available_timezones()   *available_timezones()..zoneinfo.pyx*
...
zoneinfo.reset_tzpath(to=None)          *reset_tzpath()..zoneinfo.pyx*
...
zoneinfo.TZPATH                                 *TZPATH..zoneinfo.pyx*
...
=======================
                                 ...
                                 *ZoneInfoNotFoundError..zoneinfo.pyx*
exception zoneinfo.ZoneInfoNotFoundError
   ...
   of "KeyError".
                                  ...
                                  *InvalidTZPathWarning..zoneinfo.pyx*
