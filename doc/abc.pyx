*abc.pyx*                                     Last change: 2023 Sep 15
...
class abc.ABCMeta                                   *ABCMeta..abc.pyx*
   ...
   register(subclass)                       *ABCMeta.register()..abc.pyx*
...
<
   ...
   __subclasshook__(subclass)       *ABCMeta.__subclasshook__()..abc.pyx*
...
@abc.abstractmethod                        *abstractmethod()..abc.pyx*
...
@abc.abstractclassmethod              *abstractclassmethod()..abc.pyx*
...
>
      class C(ABC):
          ...
          def my_abstract_classmethod(cls, arg):
              ...
<
@abc.abstractstaticmethod            *abstractstaticmethod()..abc.pyx*
...
>
      class C(ABC):
          ...
          def my_abstract_staticmethod(arg):
              ...
<
@abc.abstractproperty                    *abstractproperty()..abc.pyx*
...
abc.get_cache_token()                     *get_cache_token()..abc.pyx*
...
abc.update_abstractmethods(cls)    *update_abstractmethods()..abc.pyx*
