*asyncio-task.pyx*                            Last change: 2023 Sep 15
...
class asyncio.TaskGroup                  *TaskGroup..asyncio-task.pyx*
   ...
   New in version 3.11.
                           ...
                           *TaskGroup.create_task()..asyncio-task.pyx*
...
==================
                              ...
                              *eager_task_factory()..asyncio-task.pyx*
asyncio.eager_task_factory(loop, coro, *, name=None, context=None)
   ...
   New in version 3.12.
                       ...
                       *create_eager_task_factory()..asyncio-task.pyx*
...
awaitable asyncio.shield(aw)              *shield()..asyncio-task.pyx*
...
asyncio.timeout(delay)                   *timeout()..asyncio-task.pyx*
...
<
   ...
   class asyncio.Timeout(when)                *Timeout..asyncio-task.pyx*
      ...
      * If "when < loop.time()", the timeout will trigger on the next
        iteration of the event loop.
         ...
         when() -> float | None              *Timeout.when()..asyncio-task.pyx*

            Return the current deadline, or "None" if the current
            deadline is not set.

                              *Timeout.reschedule()..asyncio-task.pyx*
         reschedule(when: float | None)

            Reschedule the timeout.

         expired() -> bool                *Timeout.expired()..asyncio-task.pyx*
...
asyncio.timeout_at(when)              *timeout_at()..asyncio-task.pyx*
...
=============================
                        ...
                        *run_coroutine_threadsafe()..asyncio-task.pyx*
...
asyncio.current_task(loop=None)     *current_task()..asyncio-task.pyx*
...
asyncio.all_tasks(loop=None)           *all_tasks()..asyncio-task.pyx*
...
asyncio.iscoroutine(obj)             *iscoroutine()..asyncio-task.pyx*
...
class asyncio.Task(coro, *, loop=None, name=None, context=None, eager_start=False)
   ...
   done()                                 *Task.done()..asyncio-task.pyx*
   ...
   result()                             *Task.result()..asyncio-task.pyx*
   ...
   exception()                       *Task.exception()..asyncio-task.pyx*
      ...
      "InvalidStateError" exception.
                          ...
                          *Task.add_done_callback()..asyncio-task.pyx*
   add_done_callback(callback, *, context=None)
      ...
      details.
                       ...
                       *Task.remove_done_callback()..asyncio-task.pyx*
   ...
   get_stack(*, limit=None)          *Task.get_stack()..asyncio-task.pyx*
      ...
      (This matches the behavior of the traceback module.)
                                ...
                                *Task.print_stack()..asyncio-task.pyx*
   ...
   get_coro()                         *Task.get_coro()..asyncio-task.pyx*
   ...
   get_context()                   *Task.get_context()..asyncio-task.pyx*
   ...
   get_name()                         *Task.get_name()..asyncio-task.pyx*
   ...
   set_name(value)                    *Task.set_name()..asyncio-task.pyx*
   ...
   cancel(msg=None)                     *Task.cancel()..asyncio-task.pyx*
...
<
   cancelled()                       *Task.cancelled()..asyncio-task.pyx*
   ...
   uncancel()                         *Task.uncancel()..asyncio-task.pyx*
...
<
   ...
   cancelling()                     *Task.cancelling()..asyncio-task.pyx*
