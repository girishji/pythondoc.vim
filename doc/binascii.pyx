*binascii.pyx*                                Last change: 2023 Sep 15
...
binascii.a2b_uu(string)                       *a2b_uu()..binascii.pyx*
...
binascii.b2a_uu(data, *, backtick=False)      *b2a_uu()..binascii.pyx*
...
binascii.a2b_qp(data, header=False)           *a2b_qp()..binascii.pyx*
...
binascii.crc_hqx(data, value)                *crc_hqx()..binascii.pyx*
...
binascii.crc32(data[, value])                  *crc32()..binascii.pyx*
...
<
   Changed in version 3.0: The result is always unsigned.
                                             ...
                                             *b2a_hex()..binascii.pyx*
binascii.b2a_hex(data[, sep[, bytes_per_sep=1]])

                                             *hexlify()..binascii.pyx*
...
binascii.a2b_hex(hexstr)                     *a2b_hex()..binascii.pyx*
binascii.unhexlify(hexstr)                 *unhexlify()..binascii.pyx*
...
exception binascii.Error                         *Error..binascii.pyx*

   Exception raised on errors. These are usually programming errors.

exception binascii.Incomplete               *Incomplete..binascii.pyx*
