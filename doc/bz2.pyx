*bz2.pyx*                                     Last change: 2023 Sep 15
...
class bz2.BZ2Compressor(compresslevel=9)      *BZ2Compressor..bz2.pyx*
   ...
   compress(data)                     *BZ2Compressor.compress()..bz2.pyx*
   ...
   flush()                               *BZ2Compressor.flush()..bz2.pyx*
...
class bz2.BZ2Decompressor                   *BZ2Decompressor..bz2.pyx*
   ...
   Note:
     ...
     stream.
                               ...
                               *BZ2Decompressor.decompress()..bz2.pyx*
   ...
   eof                                     *BZ2Decompressor.eof..bz2.pyx*

      "True" if the end-of-stream marker has been reached.

      New in version 3.3.

   unused_data                     *BZ2Decompressor.unused_data..bz2.pyx*
   ...
   needs_input                     *BZ2Decompressor.needs_input..bz2.pyx*
...
bz2.compress(data, compresslevel=9)              *compress()..bz2.pyx*
...
bz2.decompress(data)                           *decompress()..bz2.pyx*
