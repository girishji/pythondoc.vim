*cmd.pyx*                                     Last change: 2023 Sep 15
...
Cmd.cmdloop(intro=None)                       *Cmd.cmdloop()..cmd.pyx*
...
Cmd.onecmd(str)                                *Cmd.onecmd()..cmd.pyx*
...
Cmd.emptyline()                             *Cmd.emptyline()..cmd.pyx*
...
Cmd.columnize(list, displaywidth=80)        *Cmd.columnize()..cmd.pyx*
...
Cmd.precmd(line)                               *Cmd.precmd()..cmd.pyx*
...
Cmd.postcmd(stop, line)                       *Cmd.postcmd()..cmd.pyx*
...
Cmd.prompt                                       *Cmd.prompt..cmd.pyx*

   The prompt issued to solicit input.

Cmd.identchars                               *Cmd.identchars..cmd.pyx*

   The string of characters accepted for the command prefix.

Cmd.lastcmd                                     *Cmd.lastcmd..cmd.pyx*

   The last nonempty command prefix seen.

Cmd.cmdqueue                                   *Cmd.cmdqueue..cmd.pyx*
...
Cmd.undoc_header                           *Cmd.undoc_header..cmd.pyx*

   The header to issue if the help output has a section for
   undocumented  commands (that is, there are "do_*()" methods without
   corresponding "help_*()" methods).

Cmd.ruler                                         *Cmd.ruler..cmd.pyx*

   The character used to draw separator lines under the help-message
   headers.  If empty, no ruler line is drawn.  It defaults to "'='".

Cmd.use_rawinput                           *Cmd.use_rawinput..cmd.pyx*
