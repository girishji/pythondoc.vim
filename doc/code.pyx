*code.pyx*                                    Last change: 2023 Sep 15
...
interpreter prompt.
                                    ...
                                    *InteractiveInterpreter..code.pyx*
...
===============================
                        ...
                        *InteractiveInterpreter.runsource()..code.pyx*
InteractiveInterpreter.runsource(source, filename='<input>', symbol='single')
   ...
   * The input is complete; "compile_command()" returned a code
   ...
   "sys.ps2" to prompt the next line.
                          ...
                          *InteractiveInterpreter.runcode()..code.pyx*
InteractiveInterpreter.runcode(code)
   ...
   should be prepared to deal with it.
                  ...
                  *InteractiveInterpreter.showsyntaxerror()..code.pyx*
InteractiveInterpreter.showsyntaxerror(filename=None)
   ...
   by the "write()" method.
                    ...
                    *InteractiveInterpreter.showtraceback()..code.pyx*
InteractiveInterpreter.showtraceback()
   ...
   instead of just the primary traceback.
                            ...
                            *InteractiveInterpreter.write()..code.pyx*
...
interpreter objects as well as the following additions.
                             ...
                             *InteractiveConsole.interact()..code.pyx*
...
InteractiveConsole.push(line)    *InteractiveConsole.push()..code.pyx*
   ...
   dealt with in some way (this is the same as "runsource()").
                          ...
                          *InteractiveConsole.resetbuffer()..code.pyx*
InteractiveConsole.resetbuffer()

   Remove any unhandled source text from the input buffer.

                            *InteractiveConsole.raw_input()..code.pyx*
