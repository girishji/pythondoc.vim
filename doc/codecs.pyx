*codecs.pyx*                                  Last change: 2023 Sep 15
...
codecs.lookup(encoding)                         *lookup()..codecs.pyx*
   ...
   caller.
                                               ...
                                               *CodecInfo..codecs.pyx*
class codecs.CodecInfo(encode, decode, streamreader=None, streamwriter=None, incrementalencoder=None, incrementaldecoder=None, name=None)

   Codec details when looking up the codec registry. The constructor
   arguments are stored in attributes of the same name:

   name                                      *CodecInfo.name..codecs.pyx*

      The name of the encoding.

   encode                                  *CodecInfo.encode..codecs.pyx*
   decode                                  *CodecInfo.decode..codecs.pyx*
   ...
   incrementalencoder          *CodecInfo.incrementalencoder..codecs.pyx*
   incrementaldecoder          *CodecInfo.incrementaldecoder..codecs.pyx*
   ...
   streamwriter                      *CodecInfo.streamwriter..codecs.pyx*
   streamreader                      *CodecInfo.streamreader..codecs.pyx*
...
codecs.getencoder(encoding)                 *getencoder()..codecs.pyx*
...
codecs.getdecoder(encoding)                 *getdecoder()..codecs.pyx*
   ...
   Raises a "LookupError" in case the encoding cannot be found.
                                 ...
                                 *getincrementalencoder()..codecs.pyx*
codecs.getincrementalencoder(encoding)
   ...
   codec doesn’t support an incremental encoder.
                                 ...
                                 *getincrementaldecoder()..codecs.pyx*
...
codecs.getreader(encoding)                   *getreader()..codecs.pyx*
...
codecs.getwriter(encoding)                   *getwriter()..codecs.pyx*
...
codecs.register(search_function)              *register()..codecs.pyx*
...
codecs.unregister(search_function)          *unregister()..codecs.pyx*
...
codecs.BOM                                           *BOM..codecs.pyx*
codecs.BOM_BE                                     *BOM_BE..codecs.pyx*
codecs.BOM_LE                                     *BOM_LE..codecs.pyx*
codecs.BOM_UTF8                                 *BOM_UTF8..codecs.pyx*
codecs.BOM_UTF16                               *BOM_UTF16..codecs.pyx*
codecs.BOM_UTF16_BE                         *BOM_UTF16_BE..codecs.pyx*
codecs.BOM_UTF16_LE                         *BOM_UTF16_LE..codecs.pyx*
codecs.BOM_UTF32                               *BOM_UTF32..codecs.pyx*
codecs.BOM_UTF32_BE                         *BOM_UTF32_BE..codecs.pyx*
codecs.BOM_UTF32_LE                         *BOM_UTF32_LE..codecs.pyx*
...
codecs.lookup_error(name)                 *lookup_error()..codecs.pyx*
...
codecs.strict_errors(exception)          *strict_errors()..codecs.pyx*

   Implements the "'strict'" error handling.

   Each encoding or decoding error raises a "UnicodeError".

codecs.ignore_errors(exception)          *ignore_errors()..codecs.pyx*
...
codecs.replace_errors(exception)        *replace_errors()..codecs.pyx*
   ...
   (U+FFFD, the official REPLACEMENT CHARACTER) for decoding errors.
                               ...
                               *backslashreplace_errors()..codecs.pyx*
codecs.backslashreplace_errors(exception)
   ...
   Changed in version 3.5: Works with decoding and translating.
                              ...
                              *xmlcharrefreplace_errors()..codecs.pyx*
...
Codec.encode(input, errors='strict')      *Codec.encode()..codecs.pyx*
...
Codec.decode(input, errors='strict')      *Codec.decode()..codecs.pyx*
...
class codecs.IncrementalEncoder(errors='strict')
   ...
   the "IncrementalEncoder" object.
                             ...
                             *IncrementalEncoder.encode()..codecs.pyx*
   ...
   reset()                       *IncrementalEncoder.reset()..codecs.pyx*
   ...
   getstate()                 *IncrementalEncoder.getstate()..codecs.pyx*
   ...
   setstate(state)            *IncrementalEncoder.setstate()..codecs.pyx*
...
class codecs.IncrementalDecoder(errors='strict')
   ...
   the "IncrementalDecoder" object.
                             ...
                             *IncrementalDecoder.decode()..codecs.pyx*
   ...
   reset()                       *IncrementalDecoder.reset()..codecs.pyx*

      Reset the decoder to the initial state.

   getstate()                 *IncrementalDecoder.getstate()..codecs.pyx*
   ...
   setstate(state)            *IncrementalDecoder.setstate()..codecs.pyx*
...
class codecs.StreamWriter(stream, errors='strict')
   ...
   write(object)                       *StreamWriter.write()..codecs.pyx*

      Writes the object’s contents encoded to the stream.

   writelines(list)               *StreamWriter.writelines()..codecs.pyx*
   ...
   reset()                             *StreamWriter.reset()..codecs.pyx*
...
class codecs.StreamReader(stream, errors='strict')
   ...
   read(size=-1, chars=-1, firstline=False)
      ...
      should be read too.
                                 ...
                                 *StreamReader.readline()..codecs.pyx*
   readline(size=None, keepends=True)
      ...
      lines returned.
                                ...
                                *StreamReader.readlines()..codecs.pyx*
   ...
   reset()                             *StreamReader.reset()..codecs.pyx*
