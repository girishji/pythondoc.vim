*collections.abc.pyx*                         Last change: 2023 Sep 15
...
class collections.abc.Container       *Container..collections.abc.pyx*

   ABC for classes that provide the "__contains__()" method.

class collections.abc.Hashable         *Hashable..collections.abc.pyx*

   ABC for classes that provide the "__hash__()" method.

class collections.abc.Sized               *Sized..collections.abc.pyx*

   ABC for classes that provide the "__len__()" method.

class collections.abc.Callable         *Callable..collections.abc.pyx*

   ABC for classes that provide the "__call__()" method.

class collections.abc.Iterable         *Iterable..collections.abc.pyx*
...
class collections.abc.Collection     *Collection..collections.abc.pyx*

   ABC for sized iterable container classes.

   New in version 3.6.

class collections.abc.Iterator         *Iterator..collections.abc.pyx*

   ABC for classes that provide the "__iter__()" and "__next__()"
   methods.  See also the definition of _iterator_.

class collections.abc.Reversible     *Reversible..collections.abc.pyx*
...
class collections.abc.Generator       *Generator..collections.abc.pyx*
...
class collections.abc.Sequence         *Sequence..collections.abc.pyx*

                                *MutableSequence..collections.abc.pyx*
class collections.abc.MutableSequence
class collections.abc.ByteString     *ByteString..collections.abc.pyx*
...
class collections.abc.Set                   *Set..collections.abc.pyx*
class collections.abc.MutableSet     *MutableSet..collections.abc.pyx*

   ABCs for read-only and mutable sets.

class collections.abc.Mapping           *Mapping..collections.abc.pyx*

                                 *MutableMapping..collections.abc.pyx*
class collections.abc.MutableMapping

   ABCs for read-only and mutable _mappings_.

class collections.abc.MappingView   *MappingView..collections.abc.pyx*
class collections.abc.ItemsView       *ItemsView..collections.abc.pyx*
class collections.abc.KeysView         *KeysView..collections.abc.pyx*
class collections.abc.ValuesView     *ValuesView..collections.abc.pyx*

   ABCs for mapping, items, keys, and values _views_.

class collections.abc.Awaitable       *Awaitable..collections.abc.pyx*
   ...
   Note:
     ...
     "types.coroutine()") are _awaitables_, even though they do not
...
class collections.abc.Coroutine       *Coroutine..collections.abc.pyx*
   ...
   New in version 3.5.
                                  ...
                                  *AsyncIterable..collections.abc.pyx*
class collections.abc.AsyncIterable
   ...
   New in version 3.5.
                                  ...
                                  *AsyncIterator..collections.abc.pyx*
class collections.abc.AsyncIterator
   ...
   New in version 3.5.
                                 ...
                                 *AsyncGenerator..collections.abc.pyx*
...
class collections.abc.Buffer             *Buffer..collections.abc.pyx*
