*collections.pyx*                             Last change: 2023 Sep 15
...
class collections.ChainMap(*maps)          *ChainMap..collections.pyx*
   ...
   maps                                  *ChainMap.maps..collections.pyx*
   ...
   new_child(m=None, **kwargs)    *ChainMap.new_child()..collections.pyx*
   ...
   parents                            *ChainMap.parents..collections.pyx*
...
class collections.Counter([iterable-or-mapping])
   ...
   elements()                       *Counter.elements()..collections.pyx*
   ...
   most_common([n])              *Counter.most_common()..collections.pyx*
      ...
      [('a', 5), ('b', 2), ('r', 2)]
                                 ...
                                 *Counter.subtract()..collections.pyx*
   ...
   total()                             *Counter.total()..collections.pyx*
   ...
   fromkeys(iterable)               *Counter.fromkeys()..collections.pyx*

      This class method is not implemented for "Counter" objects.

   update([iterable-or-mapping])      *Counter.update()..collections.pyx*
...
class collections.deque([iterable[, maxlen]])
   ...
   append(x)                            *deque.append()..collections.pyx*

      Add _x_ to the right side of the deque.

   appendleft(x)                    *deque.appendleft()..collections.pyx*

      Add _x_ to the left side of the deque.

   clear()                               *deque.clear()..collections.pyx*

      Remove all elements from the deque leaving it with length 0.

   copy()                                 *deque.copy()..collections.pyx*

      Create a shallow copy of the deque.

      New in version 3.5.

   count(x)                              *deque.count()..collections.pyx*

      Count the number of deque elements equal to _x_.

      New in version 3.2.

   extend(iterable)                     *deque.extend()..collections.pyx*

      Extend the right side of the deque by appending elements from
      the iterable argument.

   extendleft(iterable)             *deque.extendleft()..collections.pyx*
   ...
   index(x[, start[, stop]])             *deque.index()..collections.pyx*
   ...
   insert(i, x)                         *deque.insert()..collections.pyx*
   ...
   rotate(n=1)                          *deque.rotate()..collections.pyx*
   ...
   maxlen                                 *deque.maxlen..collections.pyx*
...
class collections.defaultdict(default_factory=None, /[, ...])
   ...
   __missing__(key)          *defaultdict.__missing__()..collections.pyx*
   ...
   default_factory         *defaultdict.default_factory..collections.pyx*
...
underscore.
                             ...
                             *somenamedtuple._make()..collections.pyx*
...
>
      ...
      Point(x=11, y=22)
<
somenamedtuple._asdict()   *somenamedtuple._asdict()..collections.pyx*
...
<
   ...
   "OrderedDict(nt._asdict())".
                          ...
                          *somenamedtuple._replace()..collections.pyx*
...
somenamedtuple._fields       *somenamedtuple._fields..collections.pyx*
...
<
                     ...
                     *somenamedtuple._field_defaults..collections.pyx*
...
class collections.OrderedDict([items])
   ...
   popitem(last=True)            *OrderedDict.popitem()..collections.pyx*
      ...
      first-out) order if false.
                          ...
                          *OrderedDict.move_to_end()..collections.pyx*
...
class collections.UserDict([initialdata])
   ...
   data                                  *UserDict.data..collections.pyx*
...
class collections.UserList([list])         *UserList..collections.pyx*
   ...
   data                                  *UserList.data..collections.pyx*
...
class collections.UserString(seq)        *UserString..collections.pyx*
   ...
   data                                *UserString.data..collections.pyx*
