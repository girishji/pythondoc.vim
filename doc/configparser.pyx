*configparser.pyx*                            Last change: 2023 Sep 15
...
them from "get()" calls.
                                ...
                                *BasicInterpolation..configparser.pyx*
...
<
   ...
   "%(home_dir)s/lumberjack" as the value of "my_dir".
                             ...
                             *ExtendedInterpolation..configparser.pyx*
...
assignment.
                       ...
                       *ConfigParser.BOOLEAN_STATES..configparser.pyx*
...
<
   ...
   "enabled"/"disabled".
                        ...
                        *ConfigParser.optionxform()..configparser.pyx*
...
ConfigParser.SECTCRE          *ConfigParser.SECTCRE..configparser.pyx*
...
class configparser.ConfigParser(defaults=None, dict_type=dict, allow_no_value=False, delimiters=('=', ':'), comment_prefixes=('#', ';'), inline_comment_prefixes=None, strict=True, empty_lines_in_values=True, default_section=configparser.DEFAULTSECT, interpolation=BasicInterpolation(), converters={})
   ...
   defaults()                 *ConfigParser.defaults()..configparser.pyx*

      Return a dictionary containing the instance-wide defaults.

   sections()                 *ConfigParser.sections()..configparser.pyx*

      Return a list of the sections available; the _default section_
      is not included in the list.

   add_section(section)    *ConfigParser.add_section()..configparser.pyx*
   ...
   has_option(section, option)
      ...
      _section_ is "None" or an empty string, DEFAULT is assumed.
                               ...
                               *ConfigParser.read()..configparser.pyx*
...
<
      ...
      object.
                          ...
                          *ConfigParser.read_file()..configparser.pyx*
   read_file(f, source=None)
      ...
      New in version 3.2: Replaces "readfp()".
                        ...
                        *ConfigParser.read_string()..configparser.pyx*
   read_string(string, source='<string>')
      ...
      New in version 3.2.
                          ...
                          *ConfigParser.read_dict()..configparser.pyx*
   read_dict(dictionary, source='<dict>')
      ...
      New in version 3.2.
                                ...
                                *ConfigParser.get()..configparser.pyx*
   get(section, option, *, raw=False, vars=None[, fallback])
      ...
      mapping protocol).
                             ...
                             *ConfigParser.getint()..configparser.pyx*
   getint(section, option, *, raw=False, vars=None[, fallback])
      ...
      _vars_ and _fallback_.
                           ...
                           *ConfigParser.getfloat()..configparser.pyx*
   getfloat(section, option, *, raw=False, vars=None[, fallback])
      ...
      explanation of _raw_, _vars_ and _fallback_.
                         ...
                         *ConfigParser.getboolean()..configparser.pyx*
   ...
   items(raw=False, vars=None)   *ConfigParser.items()..configparser.pyx*
   ...
   set(section, option, value)     *ConfigParser.set()..configparser.pyx*
      ...
      _value_ must be strings; if not, "TypeError" is raised.
                              ...
                              *ConfigParser.write()..configparser.pyx*
   ...
   Note:
     ...
     _inline_comment_prefix_.
                      ...
                      *ConfigParser.remove_option()..configparser.pyx*
   remove_option(section, option)
      ...
      "False".
                     ...
                     *ConfigParser.remove_section()..configparser.pyx*
...
<
      ...
      the option names is stripped before "optionxform()" is called.
                           ...
                           *MAX_INTERPOLATION_DEPTH..configparser.pyx*
...
=======================
                                   ...
                                   *RawConfigParser..configparser.pyx*
class configparser.RawConfigParser(defaults=None, dict_type=dict, allow_no_value=False, *, delimiters=('=', ':'), comment_prefixes=('#', ';'), inline_comment_prefixes=None, strict=True, empty_lines_in_values=True, default_section=configparser.DEFAULTSECT[, interpolation])
   ...
   Note:
     ...
     you can use "ConfigParser(interpolation=None)".
                     ...
                     *RawConfigParser.add_section()..configparser.pyx*
   add_section(section)
      ...
      cause internal errors.
                             ...
                             *RawConfigParser.set()..configparser.pyx*
...
exception configparser.Error                 *Error..configparser.pyx*

   Base class for all other "configparser" exceptions.

                                    *NoSectionError..configparser.pyx*
exception configparser.NoSectionError

   Exception raised when a specified section is not found.

                             *DuplicateSectionError..configparser.pyx*
exception configparser.DuplicateSectionError
   ...
   arguments to "__init__()" were added.
                              ...
                              *DuplicateOptionError..configparser.pyx*
...
exception configparser.InterpolationSyntaxError
   ...
   "InterpolationError".
                         ...
                         *MissingSectionHeaderError..configparser.pyx*
exception configparser.MissingSectionHeaderError

   Exception raised when attempting to parse a file which has no
   section headers.

exception configparser.ParsingError   *ParsingError..configparser.pyx*

   Exception raised when errors occur attempting to parse a file.

Changed in version 3.12: The "filename" attribute and "__init__()"
constructor argument were removed.  They have been available using the
name "source" since 3.2.
