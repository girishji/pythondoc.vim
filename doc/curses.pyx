*curses.pyx*                                  Last change: 2023 Sep 15
...
exception curses.error                             *error..curses.pyx*
...
curses.baudrate()                             *baudrate()..curses.pyx*
...
curses.beep()                                     *beep()..curses.pyx*

   Emit a short attention sound.

curses.can_change_color()             *can_change_color()..curses.pyx*

   Return "True" or "False", depending on whether the programmer can
   change the colors displayed by the terminal.

curses.cbreak()                                 *cbreak()..curses.pyx*
...
curses.color_content(color_number)       *color_content()..curses.pyx*
...
curses.color_pair(pair_number)              *color_pair()..curses.pyx*
...
curses.curs_set(visibility)                   *curs_set()..curses.pyx*
...
curses.def_prog_mode()                   *def_prog_mode()..curses.pyx*
...
curses.def_shell_mode()                 *def_shell_mode()..curses.pyx*
...
curses.delay_output(ms)                   *delay_output()..curses.pyx*

   Insert an _ms_ millisecond pause in output.

curses.doupdate()                             *doupdate()..curses.pyx*
...
curses.filter()                                 *filter()..curses.pyx*
...
curses.flushinp()                             *flushinp()..curses.pyx*
...
curses.getmouse()                             *getmouse()..curses.pyx*
...
curses.has_colors()                         *has_colors()..curses.pyx*

   Return "True" if the terminal can display colors; otherwise, return
   "False".

                            *has_extended_color_support()..curses.pyx*
...
curses.has_ic()                                 *has_ic()..curses.pyx*
...
curses.has_il()                                 *has_il()..curses.pyx*
...
curses.init_color(color_number, r, g, b)    *init_color()..curses.pyx*
...
curses.init_pair(pair_number, fg, bg)        *init_pair()..curses.pyx*
...
curses.initscr()                               *initscr()..curses.pyx*
...
curses.killchar()                             *killchar()..curses.pyx*
...
curses.longname()                             *longname()..curses.pyx*
...
curses.mousemask(mousemask)                  *mousemask()..curses.pyx*
...
curses.napms(ms)                                 *napms()..curses.pyx*

   Sleep for _ms_ milliseconds.

curses.newpad(nlines, ncols)                    *newpad()..curses.pyx*
...
curses.newwin(nlines, ncols)                    *newwin()..curses.pyx*
...
curses.nocbreak()                             *nocbreak()..curses.pyx*

   Leave cbreak mode.  Return to normal “cooked” mode with line
   buffering.

curses.noecho()                                 *noecho()..curses.pyx*

   Leave echo mode.  Echoing of input characters is turned off.

curses.nonl()                                     *nonl()..curses.pyx*
...
curses.noqiflush()                           *noqiflush()..curses.pyx*
...
curses.qiflush([flag])                         *qiflush()..curses.pyx*
...
curses.reset_prog_mode()               *reset_prog_mode()..curses.pyx*

   Restore the  terminal  to “program” mode, as previously saved  by
   "def_prog_mode()".

curses.reset_shell_mode()             *reset_shell_mode()..curses.pyx*

   Restore the  terminal  to “shell” mode, as previously saved  by
   "def_shell_mode()".

curses.resetty()                               *resetty()..curses.pyx*

   Restore the state of the terminal modes to what it was at the last
   call to "savetty()".

curses.resize_term(nlines, ncols)          *resize_term()..curses.pyx*
...
curses.resizeterm(nlines, ncols)            *resizeterm()..curses.pyx*
...
curses.savetty()                               *savetty()..curses.pyx*

   Save the current state of the terminal modes in a buffer, usable by
   "resetty()".

curses.get_escdelay()                     *get_escdelay()..curses.pyx*

   Retrieves the value set by "set_escdelay()".

   New in version 3.9.

curses.set_escdelay(ms)                   *set_escdelay()..curses.pyx*
...
curses.get_tabsize()                       *get_tabsize()..curses.pyx*

   Retrieves the value set by "set_tabsize()".

   New in version 3.9.

curses.set_tabsize(size)                   *set_tabsize()..curses.pyx*
...
curses.start_color()                       *start_color()..curses.pyx*
...
curses.termattrs()                           *termattrs()..curses.pyx*
...
curses.tigetnum(capname)                      *tigetnum()..curses.pyx*
...
curses.tigetstr(capname)                      *tigetstr()..curses.pyx*
...
curses.tparm(str[, ...])                         *tparm()..curses.pyx*
...
curses.typeahead(fd)                         *typeahead()..curses.pyx*
...
curses.unctrl(ch)                               *unctrl()..curses.pyx*
...
curses.ungetch(ch)                             *ungetch()..curses.pyx*
...
curses.update_lines_cols()           *update_lines_cols()..curses.pyx*
...
curses.unget_wch(ch)                         *unget_wch()..curses.pyx*
...
curses.ungetmouse(id, x, y, z, bstate)      *ungetmouse()..curses.pyx*

   Push a "KEY_MOUSE" event onto the input queue, associating the
   given state data with it.

curses.use_env(flag)                           *use_env()..curses.pyx*
...
curses.use_default_colors()         *use_default_colors()..curses.pyx*
...
curses.wrapper(func, /, *args, **kwargs)       *wrapper()..curses.pyx*
...
window.addch(ch[, attr])                  *window.addch()..curses.pyx*
...
window.addnstr(str, n[, attr])          *window.addnstr()..curses.pyx*
...
window.addstr(str[, attr])               *window.addstr()..curses.pyx*
...
window.bkgdset(ch[, attr])              *window.bkgdset()..curses.pyx*
...
window.box([vertch, horch])                 *window.box()..curses.pyx*
...
window.chgat(attr)                        *window.chgat()..curses.pyx*
...
window.delch([y, x])                      *window.delch()..curses.pyx*

   Delete any character at "(y, x)".

window.deleteln()                      *window.deleteln()..curses.pyx*

   Delete the line under the cursor. All following lines are moved up
   by one line.

window.derwin(begin_y, begin_x)          *window.derwin()..curses.pyx*
...
window.echochar(ch[, attr])            *window.echochar()..curses.pyx*

   Add character _ch_ with attribute _attr_, and immediately  call
   "refresh()" on the window.

window.enclose(y, x)                    *window.enclose()..curses.pyx*
...
window.encoding                          *window.encoding..curses.pyx*
...
window.erase()                            *window.erase()..curses.pyx*

   Clear the window.

window.getbegyx()                      *window.getbegyx()..curses.pyx*

   Return a tuple "(y, x)" of co-ordinates of upper-left corner.

window.getbkgd()                        *window.getbkgd()..curses.pyx*

   Return the given window’s current background character/attribute
   pair.

window.getch([y, x])                      *window.getch()..curses.pyx*
...
window.get_wch([y, x])                  *window.get_wch()..curses.pyx*
...
window.getkey([y, x])                    *window.getkey()..curses.pyx*
...
window.inch([y, x])                        *window.inch()..curses.pyx*
...
window.insertln()                      *window.insertln()..curses.pyx*

   Insert a blank line under the cursor. All following lines are moved
   down by one line.

window.insnstr(str, n[, attr])          *window.insnstr()..curses.pyx*
...
window.insstr(str[, attr])               *window.insstr()..curses.pyx*
...
window.instr([n])                         *window.instr()..curses.pyx*
window.instr(y, x[, n])
...
window.is_linetouched(line)      *window.is_linetouched()..curses.pyx*
...
window.leaveok(flag)                    *window.leaveok()..curses.pyx*
...
window.move(new_y, new_x)                  *window.move()..curses.pyx*

   Move cursor to "(new_y, new_x)".

window.mvderwin(y, x)                  *window.mvderwin()..curses.pyx*
...
window.mvwin(new_y, new_x)                *window.mvwin()..curses.pyx*

   Move the window so its upper-left corner is at "(new_y, new_x)".

window.nodelay(flag)                    *window.nodelay()..curses.pyx*

   If _flag_ is "True", "getch()" will be non-blocking.

window.notimeout(flag)                *window.notimeout()..curses.pyx*
...
window.noutrefresh()                *window.noutrefresh()..curses.pyx*
...
window.redrawwin()                    *window.redrawwin()..curses.pyx*

   Touch the entire window, causing it to be completely redrawn on the
   next "refresh()" call.

                                        *window.refresh()..curses.pyx*
...
window.resize(nlines, ncols)             *window.resize()..curses.pyx*
...
window.scroll([lines=1])                 *window.scroll()..curses.pyx*

   Scroll the screen or scrolling region upward by _lines_ lines.

window.scrollok(flag)                  *window.scrollok()..curses.pyx*
...
window.syncdown()                      *window.syncdown()..curses.pyx*
...
window.syncok(flag)                      *window.syncok()..curses.pyx*

   If _flag_ is "True", then "syncup()" is called automatically
   whenever there is a change in the window.

window.syncup()                          *window.syncup()..curses.pyx*

   Touch all locations in ancestors of the window that have been
   changed in  the window.

window.timeout(delay)                   *window.timeout()..curses.pyx*
...
window.touchwin()                      *window.touchwin()..curses.pyx*

   Pretend the whole window has been changed, for purposes of drawing
   optimizations.

window.untouchwin()                  *window.untouchwin()..curses.pyx*

   Mark all lines in  the  window  as unchanged since the last call to
   "refresh()".

window.vline(ch, n[, attr])               *window.vline()..curses.pyx*
...
curses.ERR                                           *ERR..curses.pyx*

   Some curses routines  that  return  an integer, such as "getch()",
   return "ERR" upon failure.

curses.OK                                             *OK..curses.pyx*

   Some curses routines  that  return  an integer, such as  "napms()",
   return "OK" upon success.

curses.version                                   *version..curses.pyx*

curses.__version__                           *__version__..curses.pyx*

   A bytes object representing the current version of the module.

curses.ncurses_version                   *ncurses_version..curses.pyx*
...
class curses.textpad.Textbox(win)                *Textbox..curses.pyx*
   ...
   edit([validator])                         *Textbox.edit()..curses.pyx*
   ...
   do_command(ch)                      *Textbox.do_command()..curses.pyx*
