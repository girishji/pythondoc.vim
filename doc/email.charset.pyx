*email.charset.pyx*                           Last change: 2023 Sep 15
...
class email.charset.Charset(input_charset=DEFAULT_CHARSET)
   ...
   input_charset               *Charset.input_charset..email.charset.pyx*
   ...
   header_encoding           *Charset.header_encoding..email.charset.pyx*
   ...
   body_encoding               *Charset.body_encoding..email.charset.pyx*
   ...
   output_charset             *Charset.output_charset..email.charset.pyx*
   ...
   input_codec                   *Charset.input_codec..email.charset.pyx*
   ...
   output_codec                 *Charset.output_codec..email.charset.pyx*
   ...
   get_body_encoding()   *Charset.get_body_encoding()..email.charset.pyx*
      ...
      "BASE64", and returns the string "7bit" otherwise.
                     ...
                     *Charset.get_output_charset()..email.charset.pyx*
   get_output_charset()
   ...
   header_encode(string)     *Charset.header_encode()..email.charset.pyx*
      ...
      on the _header_encoding_ attribute.
                    ...
                    *Charset.header_encode_lines()..email.charset.pyx*
   ...
   body_encode(string)         *Charset.body_encode()..email.charset.pyx*
