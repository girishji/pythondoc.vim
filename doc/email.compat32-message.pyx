*email.compat32-message.pyx*                  Last change: 2023 Sep 15
...
Here are the methods of the "Message" class:
                                 ...
                                 *Message..email.compat32-message.pyx*
class email.message.Message(policy=compat32)
   ...
   Changed in version 3.3: The _policy_ keyword argument was added.
                     ...
                     *Message.as_string()..email.compat32-message.pyx*
...
<
   ...
   __str__()              *Message.__str__()..email.compat32-message.pyx*

      Equivalent to "as_string()".  Allows "str(msg)" to produce a
      string containing the formatted message.

                      *Message.as_bytes()..email.compat32-message.pyx*
...
<
   ...
   __bytes__()          *Message.__bytes__()..email.compat32-message.pyx*
   ...
   is_multipart()    *Message.is_multipart()..email.compat32-message.pyx*
      ...
      "Message" is of type "message/rfc822".)
                  ...
                  *Message.set_unixfrom()..email.compat32-message.pyx*
   set_unixfrom(unixfrom)

      Set the message’s envelope header to _unixfrom_, which should be
      a string.

   get_unixfrom()    *Message.get_unixfrom()..email.compat32-message.pyx*

      Return the message’s envelope header.  Defaults to "None" if the
      envelope header was never set.

   attach(payload)         *Message.attach()..email.compat32-message.pyx*
      ...
      "make" and "add" methods.
                   ...
                   *Message.get_payload()..email.compat32-message.pyx*
   get_payload(i=None, decode=False)
      ...
      functionality is replaced by "get_content()" and "iter_parts()".
                   ...
                   *Message.set_payload()..email.compat32-message.pyx*
   set_payload(payload, charset=None)
      ...
      functionality is replaced by "set_content()".
                   ...
                   *Message.set_charset()..email.compat32-message.pyx*
   set_charset(charset)
   ...
   get_charset()      *Message.get_charset()..email.compat32-message.pyx*
   ...
   __len__()              *Message.__len__()..email.compat32-message.pyx*

      Return the total number of headers, including duplicates.

                  *Message.__contains__()..email.compat32-message.pyx*
   __contains__(name)
...
<
                   ...
                   *Message.__getitem__()..email.compat32-message.pyx*
   __getitem__(name)
      ...
      values of all the extant named headers.
                   ...
                   *Message.__setitem__()..email.compat32-message.pyx*
...
<
                   ...
                   *Message.__delitem__()..email.compat32-message.pyx*
   __delitem__(name)
   ...
   keys()                    *Message.keys()..email.compat32-message.pyx*

      Return a list of all the message’s header field names.

   values()                *Message.values()..email.compat32-message.pyx*

      Return a list of all the message’s field values.

   items()                  *Message.items()..email.compat32-message.pyx*

      Return a list of 2-tuples containing all the message’s field
      headers and values.

   get(name, failobj=None)    *Message.get()..email.compat32-message.pyx*
   ...
   Here are some additional useful methods:
                       ...
                       *Message.get_all()..email.compat32-message.pyx*
   get_all(name, failobj=None)
      ...
      returned (defaults to "None").
                    ...
                    *Message.add_header()..email.compat32-message.pyx*
...
<
                ...
                *Message.replace_header()..email.compat32-message.pyx*
   replace_header(_name, _value)
      ...
      case.  If no matching header was found, a "KeyError" is raised.
              ...
              *Message.get_content_type()..email.compat32-message.pyx*
   get_content_type()
   ...
   get_default_type()
      ...
      default content type of _message/rfc822_.
              ...
              *Message.set_default_type()..email.compat32-message.pyx*
   set_default_type(ctype)
      ...
      header.
                    ...
                    *Message.get_params()..email.compat32-message.pyx*
   get_params(failobj=None, header='content-type', unquote=True)
      ...
      individual header objects returned by the header access methods.
                     ...
                     *Message.get_param()..email.compat32-message.pyx*
...
<
      ...
      individual header objects returned by the header access methods.
                     ...
                     *Message.set_param()..email.compat32-message.pyx*
   set_param(param, value, header='Content-Type', requote=True, charset=None, language='', replace=False)
      ...
      Changed in version 3.4: "replace" keyword was added.
                     ...
                     *Message.del_param()..email.compat32-message.pyx*
   del_param(param, header='content-type', requote=True)
      ...
      _header_ specifies an alternative to _Content-Type_.
                      ...
                      *Message.set_type()..email.compat32-message.pyx*
   set_type(type, header='Content-Type', requote=True)
      ...
      functionality is replaced by the "make_" and "add_" methods.
                  ...
                  *Message.get_filename()..email.compat32-message.pyx*
   get_filename(failobj=None)
      ...
      "email.utils.unquote()".
                  ...
                  *Message.get_boundary()..email.compat32-message.pyx*
   get_boundary(failobj=None)
      ...
      will always be unquoted as per "email.utils.unquote()".
                  ...
                  *Message.set_boundary()..email.compat32-message.pyx*
   set_boundary(boundary)
      ...
      have been present in the original _Content-Type_ header.
           ...
           *Message.get_content_charset()..email.compat32-message.pyx*
   get_content_charset(failobj=None)
      ...
      body.
                  ...
                  *Message.get_charsets()..email.compat32-message.pyx*
   get_charsets(failobj=None)
       ...
       *Message.get_content_disposition()..email.compat32-message.pyx*
   ...
   walk()                    *Message.walk()..email.compat32-message.pyx*
...
<
   ...
   preamble                *Message.preamble..email.compat32-message.pyx*
   ...
   epilogue                *Message.epilogue..email.compat32-message.pyx*
   ...
   defects                  *Message.defects..email.compat32-message.pyx*
