*email.errors.pyx*                            Last change: 2023 Sep 15
...
exception email.errors.MessageError   *MessageError..email.errors.pyx*
   ...
   defines no additional methods.
                                 ...
                                 *MessageParseError..email.errors.pyx*
exception email.errors.MessageParseError
   ...
   internally by the parser used by "headerregistry".
                                  ...
                                  *HeaderParseError..email.errors.pyx*
exception email.errors.HeaderParseError
   ...
   like a header).
                                     ...
                                     *BoundaryError..email.errors.pyx*
exception email.errors.BoundaryError

   Deprecated and no longer used.

                          *MultipartConversionError..email.errors.pyx*
