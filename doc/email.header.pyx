*email.header.pyx*                            Last change: 2023 Sep 15
...
class email.header.Header(s=None, charset=None, maxlinelen=None, header_name=None, continuation_ws=' ', errors='strict')
   ...
   method.
                                   ...
                                   *Header.append()..email.header.pyx*
   append(s, charset=None, errors='strict')
      ...
      call if _s_ is a byte string.
                                   ...
                                   *Header.encode()..email.header.pyx*
   ...
   __str__()                         *Header.__str__()..email.header.pyx*
   ...
   __eq__(other)                      *Header.__eq__()..email.header.pyx*

      This method allows you to compare two "Header" instances for
      equality.

   __ne__(other)                      *Header.__ne__()..email.header.pyx*
...
functions.
                                   ...
                                   *decode_header()..email.header.pyx*
