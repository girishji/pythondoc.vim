*email.headerregistry.pyx*                    Last change: 2023 Sep 15
...
the data parsed from structured headers.
                                ...
                                *BaseHeader..email.headerregistry.pyx*
class email.headerregistry.BaseHeader(name, value)
   ...
   name                       *BaseHeader.name..email.headerregistry.pyx*
   ...
   defects                 *BaseHeader.defects..email.headerregistry.pyx*
   ...
   max_count             *BaseHeader.max_count..email.headerregistry.pyx*
   ...
   fold(*, policy)          *BaseHeader.fold()..email.headerregistry.pyx*
...
<
   ...
   method.
                        ...
                        *UnstructuredHeader..email.headerregistry.pyx*
class email.headerregistry.UnstructuredHeader
   ...
   This header type provides no additional attributes.
                                ...
                                *DateHeader..email.headerregistry.pyx*
class email.headerregistry.DateHeader
   ...
   **RFC 5322** specifies a very specific format for dates within
   ...
   datetime               *DateHeader.datetime..email.headerregistry.pyx*
...
<
   ...
   using the current timezone offset.
                             ...
                             *AddressHeader..email.headerregistry.pyx*
class email.headerregistry.AddressHeader
   ...
   groups                *AddressHeader.groups..email.headerregistry.pyx*
   ...
   addresses          *AddressHeader.addresses..email.headerregistry.pyx*
   ...
   header.
                       ...
                       *SingleAddressHeader..email.headerregistry.pyx*
class email.headerregistry.SingleAddressHeader

   A subclass of "AddressHeader" that adds one additional attribute:

   address        *SingleAddressHeader.address..email.headerregistry.pyx*
...
"Unique" variant, "max_count" is set to 1.
                         ...
                         *MIMEVersionHeader..email.headerregistry.pyx*
class email.headerregistry.MIMEVersionHeader
   ...
   version          *MIMEVersionHeader.version..email.headerregistry.pyx*

      The version number as a string, with any whitespace and/or
      comments removed.

   major              *MIMEVersionHeader.major..email.headerregistry.pyx*

      The major version number as an integer

   minor              *MIMEVersionHeader.minor..email.headerregistry.pyx*

      The minor version number as an integer

                   *ParameterizedMIMEHeader..email.headerregistry.pyx*
class email.headerregistry.ParameterizedMIMEHeader
   ...
   params      *ParameterizedMIMEHeader.params..email.headerregistry.pyx*

      A dictionary mapping parameter names to parameter values.

                         *ContentTypeHeader..email.headerregistry.pyx*
class email.headerregistry.ContentTypeHeader

   A "ParameterizedMIMEHeader" class that handles the _Content-Type_
   header.

            *ContentTypeHeader.content_type..email.headerregistry.pyx*
   content_type

      The content type string, in the form "maintype/subtype".

   maintype        *ContentTypeHeader.maintype..email.headerregistry.pyx*

   subtype          *ContentTypeHeader.subtype..email.headerregistry.pyx*

                  *ContentDispositionHeader..email.headerregistry.pyx*
class email.headerregistry.ContentDispositionHeader

   A "ParameterizedMIMEHeader" class that handles the _Content-
   Disposition_ header.

*ContentDispositionHeader.content_disposition..email.headerregistry.pyx*
   content_disposition

      "inline" and "attachment" are the only valid values in common
      use.

                   *ContentTransferEncoding..email.headerregistry.pyx*
class email.headerregistry.ContentTransferEncoding

   Handles the _Content-Transfer-Encoding_ header.

   cte            *ContentTransferEncoding.cte..email.headerregistry.pyx*

      Valid values are "7bit", "8bit", "base64", and "quoted-
      printable".  See **RFC 2045** for more information.

                            *HeaderRegistry..email.headerregistry.pyx*
class email.headerregistry.HeaderRegistry(base_class=BaseHeader, default_class=UnstructuredHeader, use_default_map=True)
   ...
   "HeaderRegistry" has the following methods:
              ...
              *HeaderRegistry.map_to_type()..email.headerregistry.pyx*
   map_to_type(self, name, cls)
      ...
      the class used to instantiate headers that match _name_.
              ...
              *HeaderRegistry.__getitem__()..email.headerregistry.pyx*
   __getitem__(name)

      Construct and return a class to handle creating a _name_ header.

                 *HeaderRegistry.__call__()..email.headerregistry.pyx*
   __call__(name, value)
...
program to construct structured values to assign to specific headers.
                                   ...
                                   *Address..email.headerregistry.pyx*
...
<
   ...
   display_name          *Address.display_name..email.headerregistry.pyx*
   ...
   username                  *Address.username..email.headerregistry.pyx*

      The "username" portion of the address, with all quoting removed.

   domain                      *Address.domain..email.headerregistry.pyx*

      The "domain" portion of the address.

   addr_spec                *Address.addr_spec..email.headerregistry.pyx*
   ...
   __str__()                *Address.__str__()..email.headerregistry.pyx*
   ...
   then the string value of the "Address" is "<>".
                                     ...
                                     *Group..email.headerregistry.pyx*
...
<
   ...
   display_name            *Group.display_name..email.headerregistry.pyx*
   ...
   addresses                  *Group.addresses..email.headerregistry.pyx*

      A possibly empty tuple of "Address" objects representing the
      addresses in the group.

   __str__()                  *Group.__str__()..email.headerregistry.pyx*
