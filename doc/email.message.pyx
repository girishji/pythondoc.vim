*email.message.pyx*                           Last change: 2023 Sep 15
...
objects.
                                     ...
                                     *EmailMessage..email.message.pyx*
class email.message.EmailMessage(policy=default)
   ...
   information see the "policy" documentation.
                         ...
                         *EmailMessage.as_string()..email.message.pyx*
   ...
   __str__()                  *EmailMessage.__str__()..email.message.pyx*
      ...
      "as_string()".
                          ...
                          *EmailMessage.as_bytes()..email.message.pyx*
   ...
   __bytes__()              *EmailMessage.__bytes__()..email.message.pyx*

      Equivalent to "as_bytes()".  Allows "bytes(msg)" to produce a
      bytes object containing the serialized message.

   is_multipart()        *EmailMessage.is_multipart()..email.message.pyx*
      ...
      "EmailMessage" is of type "message/rfc822".
                      ...
                      *EmailMessage.set_unixfrom()..email.message.pyx*
   ...
   get_unixfrom()        *EmailMessage.get_unixfrom()..email.message.pyx*
   ...
   __len__()                  *EmailMessage.__len__()..email.message.pyx*

      Return the total number of headers, including duplicates.

   __contains__(name)    *EmailMessage.__contains__()..email.message.pyx*
...
<
   __getitem__(name)      *EmailMessage.__getitem__()..email.message.pyx*
      ...
      "email.headerregistry.BaseHeader".
                       ...
                       *EmailMessage.__setitem__()..email.message.pyx*
...
<
   ...
   __delitem__(name)      *EmailMessage.__delitem__()..email.message.pyx*
   ...
   keys()                        *EmailMessage.keys()..email.message.pyx*

      Return a list of all the message’s header field names.

   values()                    *EmailMessage.values()..email.message.pyx*

      Return a list of all the message’s field values.

   items()                      *EmailMessage.items()..email.message.pyx*

      Return a list of 2-tuples containing all the message’s field
      headers and values.

   get(name, failobj=None)        *EmailMessage.get()..email.message.pyx*
   ...
   Here are some additional useful header related methods:
                           ...
                           *EmailMessage.get_all()..email.message.pyx*
   get_all(name, failobj=None)
      ...
      returned (defaults to "None").
                        ...
                        *EmailMessage.add_header()..email.message.pyx*
...
<
                    ...
                    *EmailMessage.replace_header()..email.message.pyx*
   replace_header(_name, _value)
      ...
      "KeyError".
                  ...
                  *EmailMessage.get_content_type()..email.message.pyx*
   get_content_type()
   ...
   get_default_type()
      ...
      default content type of _message/rfc822_.
                  ...
                  *EmailMessage.set_default_type()..email.message.pyx*
   set_default_type(ctype)
      ...
      present in the message.
                         ...
                         *EmailMessage.set_param()..email.message.pyx*
   set_param(param, value, header='Content-Type', requote=True, charset=None, language='', replace=False)
      ...
      Changed in version 3.4: "replace" keyword was added.
                         ...
                         *EmailMessage.del_param()..email.message.pyx*
   del_param(param, header='content-type', requote=True)
      ...
      deprecated.
                      ...
                      *EmailMessage.get_filename()..email.message.pyx*
   get_filename(failobj=None)
      ...
      "email.utils.unquote()".
                      ...
                      *EmailMessage.get_boundary()..email.message.pyx*
   get_boundary(failobj=None)
      ...
      will always be unquoted as per "email.utils.unquote()".
                      ...
                      *EmailMessage.set_boundary()..email.message.pyx*
   set_boundary(boundary)
      ...
      the order of the _Content-Type_ header in the list of headers.
               ...
               *EmailMessage.get_content_charset()..email.message.pyx*
   get_content_charset(failobj=None)
      ...
      returned.
                      ...
                      *EmailMessage.get_charsets()..email.message.pyx*
   ...
   is_attachment()      *EmailMessage.is_attachment()..email.message.pyx*
      ...
      of a property, for consistency with "is_multipart()".
           ...
           *EmailMessage.get_content_disposition()..email.message.pyx*
   ...
   walk()                        *EmailMessage.walk()..email.message.pyx*
...
<
      ...
      descends into the subparts.
                          ...
                          *EmailMessage.get_body()..email.message.pyx*
   get_body(preferencelist=('related', 'html', 'plain'))
      ...
      occasionally cause "get_body" to return unexpected results.
                  ...
                  *EmailMessage.iter_attachments()..email.message.pyx*
   iter_attachments()
   ...
   iter_parts()            *EmailMessage.iter_parts()..email.message.pyx*

      Return an iterator over all of the immediate sub-parts of the
      message, which will be empty for a non-"multipart".  (See also
      "walk()".)

                       *EmailMessage.get_content()..email.message.pyx*
   get_content(*args, content_manager=None, **kw)
      ...
      specified by the current "policy".
                       ...
                       *EmailMessage.set_content()..email.message.pyx*
   set_content(*args, content_manager=None, **kw)
      ...
      specified by the current "policy".
                      ...
                      *EmailMessage.make_related()..email.message.pyx*
   make_related(boundary=None)
      ...
      is needed (for example, when the message is serialized).
                  ...
                  *EmailMessage.make_alternative()..email.message.pyx*
   make_alternative(boundary=None)
      ...
      serialized).
                        ...
                        *EmailMessage.make_mixed()..email.message.pyx*
   make_mixed(boundary=None)
      ...
      the message is serialized).
                       ...
                       *EmailMessage.add_related()..email.message.pyx*
   add_related(*args, content_manager=None, **kw)
      ...
      value "inline".
                   ...
                   *EmailMessage.add_alternative()..email.message.pyx*
   add_alternative(*args, content_manager=None, **kw)
      ...
      specified by the current "policy".
                    ...
                    *EmailMessage.add_attachment()..email.message.pyx*
   ...
   clear()                      *EmailMessage.clear()..email.message.pyx*

      Remove the payload and all of the headers.

   clear_content()      *EmailMessage.clear_content()..email.message.pyx*
   ...
   preamble                    *EmailMessage.preamble..email.message.pyx*
   ...
   epilogue                    *EmailMessage.epilogue..email.message.pyx*
   ...
   defects                      *EmailMessage.defects..email.message.pyx*
