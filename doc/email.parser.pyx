*email.parser.pyx*                            Last change: 2023 Sep 15
...
Here is the API for the "BytesFeedParser":
                                   ...
                                   *BytesFeedParser..email.parser.pyx*
class email.parser.BytesFeedParser(_factory=None, *, policy=policy.compat32)
   ...
   feed(data)                  *BytesFeedParser.feed()..email.parser.pyx*
   ...
   close()                    *BytesFeedParser.close()..email.parser.pyx*
...
class email.parser.BytesParser(_class=None, *, policy=policy.compat32)
   ...
   parse(fp, headersonly=False)   *BytesParser.parse()..email.parser.pyx*
      ...
      **RFC 5322** (or, if "utf8" is "True", **RFC 6532**) style
      ...
      "False", meaning it parses the entire contents of the file.
                          ...
                          *BytesParser.parsebytes()..email.parser.pyx*
   ...
   New in version 3.2.
                                 ...
                                 *BytesHeaderParser..email.parser.pyx*
...
class email.parser.Parser(_class=None, *, policy=policy.compat32)
   ...
   parse(fp, headersonly=False)        *Parser.parse()..email.parser.pyx*
      ...
      "BytesParser.parse()".
                                 ...
                                 *Parser.parsestr()..email.parser.pyx*
...
namespace.
                              ...
                              *message_from_bytes()..email.parser.pyx*
email.message_from_bytes(s, _class=None, *, policy=policy.compat32)
   ...
   _policy_ keyword.
                        ...
                        *message_from_binary_file()..email.parser.pyx*
email.message_from_binary_file(fp, _class=None, *, policy=policy.compat32)
   ...
   _policy_ keyword.
                             ...
                             *message_from_string()..email.parser.pyx*
email.message_from_string(s, _class=None, *, policy=policy.compat32)
   ...
   _policy_ keyword.
                               ...
                               *message_from_file()..email.parser.pyx*
