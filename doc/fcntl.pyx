*fcntl.pyx*                                   Last change: 2023 Sep 15
...
fcntl.fcntl(fd, cmd, arg=0)                       *fcntl()..fcntl.pyx*
...
fcntl.flock(fd, operation)                        *flock()..fcntl.pyx*
...
fcntl.lockf(fd, cmd, len=0, start=0, whence=0)    *lockf()..fcntl.pyx*
