*fnmatch.pyx*                                 Last change: 2023 Sep 15
...
fnmatch.fnmatch(filename, pattern)            *fnmatch()..fnmatch.pyx*
...
fnmatch.translate(pattern)                  *translate()..fnmatch.pyx*
