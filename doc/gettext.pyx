*gettext.pyx*                                 Last change: 2023 Sep 15
...
gettext.textdomain(domain=None)            *textdomain()..gettext.pyx*
...
gettext.gettext(message)                      *gettext()..gettext.pyx*
...
gettext.dgettext(domain, message)            *dgettext()..gettext.pyx*

   Like "gettext()", but look the message up in the specified
   _domain_.

gettext.ngettext(singular, plural, n)        *ngettext()..gettext.pyx*
   ...
   files and the formulas for a variety of languages.
                                            ...
                                            *dngettext()..gettext.pyx*
gettext.dngettext(domain, singular, plural, n)

   Like "ngettext()", but look the message up in the specified
   _domain_.

gettext.pgettext(context, message)           *pgettext()..gettext.pyx*

                                            *dpgettext()..gettext.pyx*
gettext.dpgettext(domain, context, message)

                                            *npgettext()..gettext.pyx*
gettext.npgettext(context, singular, plural, n)

                                           *dnpgettext()..gettext.pyx*
...
class gettext.NullTranslations(fp=None)
   ...
   _parse(fp)                    *NullTranslations._parse()..gettext.pyx*
      ...
      should override this method to parse your format.
                        ...
                        *NullTranslations.add_fallback()..gettext.pyx*
   ...
   ngettext(singular, plural, n)
      ...
      _plural_ otherwise. Overridden in derived classes.
                            ...
                            *NullTranslations.pgettext()..gettext.pyx*
   pgettext(context, message)
      ...
      New in version 3.8.
                           ...
                           *NullTranslations.npgettext()..gettext.pyx*
   ...
   info()                          *NullTranslations.info()..gettext.pyx*

      Return the “protected” "_info" variable, a dictionary containing
      the metadata found in the message catalog file.

   charset()                    *NullTranslations.charset()..gettext.pyx*

      Return the encoding of the message catalog file.

   install(names=None)          *NullTranslations.install()..gettext.pyx*
...
class gettext.GNUTranslations           *GNUTranslations..gettext.pyx*

   The following methods are overridden from the base class
   implementation:

   gettext(message)              *GNUTranslations.gettext()..gettext.pyx*
      ...
      method.  Otherwise, the _message_ id is returned.
                             ...
                             *GNUTranslations.ngettext()..gettext.pyx*
   ngettext(singular, plural, n)
...
>
         ...
         message = cat.ngettext(
             ...
             n) % {'num': n}
<
   pgettext(context, message)   *GNUTranslations.pgettext()..gettext.pyx*
      ...
      New in version 3.8.
                            ...
                            *GNUTranslations.npgettext()..gettext.pyx*
   npgettext(context, singular, plural, n)
