*graphlib.pyx*                                Last change: 2023 Sep 15
...
======================================================================
                                     ...
                                     *TopologicalSorter..graphlib.pyx*
...
<
   add(node, *predecessors)       *TopologicalSorter.add()..graphlib.pyx*
   ...
   prepare()                  *TopologicalSorter.prepare()..graphlib.pyx*
   ...
   is_active()              *TopologicalSorter.is_active()..graphlib.pyx*
...
<
   ...
   done(*nodes)                  *TopologicalSorter.done()..graphlib.pyx*
   ...
   get_ready()              *TopologicalSorter.get_ready()..graphlib.pyx*
   ...
   static_order()        *TopologicalSorter.static_order()..graphlib.pyx*
...
exception graphlib.CycleError               *CycleError..graphlib.pyx*
