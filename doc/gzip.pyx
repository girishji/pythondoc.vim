*gzip.pyx*                                    Last change: 2023 Sep 15
...
exception gzip.BadGzipFile                     *BadGzipFile..gzip.pyx*
...
gzip.decompress(data)                         *decompress()..gzip.pyx*
