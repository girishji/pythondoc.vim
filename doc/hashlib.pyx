*hashlib.pyx*                                 Last change: 2023 Sep 15
...
hashlib.md5([data], \*, usedforsecurity=True)     *md5()..hashlib.pyx*

hashlib.sha1([data], \*, usedforsecurity=True)   *sha1()..hashlib.pyx*
...
hashlib.algorithms_guaranteed     *algorithms_guaranteed..hashlib.pyx*
...
hashlib.algorithms_available       *algorithms_available..hashlib.pyx*
...
hash.digest_size                       *hash.digest_size..hashlib.pyx*

   The size of the resulting hash in bytes.

hash.block_size                         *hash.block_size..hashlib.pyx*

   The internal block size of the hash algorithm in bytes.

A hash object has the following attributes:

hash.name                                     *hash.name..hashlib.pyx*
...
hash.update(data)                         *hash.update()..hashlib.pyx*
...
hash.digest()                             *hash.digest()..hashlib.pyx*
...
hash.hexdigest()                       *hash.hexdigest()..hashlib.pyx*
...
hash.copy()                                 *hash.copy()..hashlib.pyx*
...
shake.digest(length)                     *shake.digest()..hashlib.pyx*

   Return the digest of the data passed to the "update()" method so
   far. This is a bytes object of size _length_ which may contain
   bytes in the whole range from 0 to 255.

shake.hexdigest(length)               *shake.hexdigest()..hashlib.pyx*
...
hashlib.file_digest(fileobj, digest, /)   *file_digest()..hashlib.pyx*
...
blake2b.SALT_SIZE                     *blake2b.SALT_SIZE..hashlib.pyx*

blake2s.SALT_SIZE                     *blake2s.SALT_SIZE..hashlib.pyx*

Salt length (maximum length accepted by constructors).

blake2b.PERSON_SIZE                 *blake2b.PERSON_SIZE..hashlib.pyx*

blake2s.PERSON_SIZE                 *blake2s.PERSON_SIZE..hashlib.pyx*

Personalization string length (maximum length accepted by
constructors).

blake2b.MAX_KEY_SIZE               *blake2b.MAX_KEY_SIZE..hashlib.pyx*

blake2s.MAX_KEY_SIZE               *blake2s.MAX_KEY_SIZE..hashlib.pyx*

Maximum key size.

blake2b.MAX_DIGEST_SIZE         *blake2b.MAX_DIGEST_SIZE..hashlib.pyx*

blake2s.MAX_DIGEST_SIZE         *blake2s.MAX_DIGEST_SIZE..hashlib.pyx*
