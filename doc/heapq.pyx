*heapq.pyx*                                   Last change: 2023 Sep 15
...
heapq.heappush(heap, item)                     *heappush()..heapq.pyx*

   Push the value _item_ onto the _heap_, maintaining the heap
   invariant.

heapq.heappop(heap)                             *heappop()..heapq.pyx*
...
heapq.heappushpop(heap, item)               *heappushpop()..heapq.pyx*
...
heapq.heapify(x)                                *heapify()..heapq.pyx*

   Transform list _x_ into a heap, in-place, in linear time.

heapq.heapreplace(heap, item)               *heapreplace()..heapq.pyx*
...
heapq.nlargest(n, iterable, key=None)          *nlargest()..heapq.pyx*
...
heapq.nsmallest(n, iterable, key=None)        *nsmallest()..heapq.pyx*
