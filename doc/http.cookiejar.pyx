*http.cookiejar.pyx*                          Last change: 2023 Sep 15
...
exception http.cookiejar.LoadError     *LoadError..http.cookiejar.pyx*
...
class http.cookiejar.CookieJar(policy=None)
   ...
   from a file or database.
                                   ...
                                   *FileCookieJar..http.cookiejar.pyx*
...
class http.cookiejar.Cookie               *Cookie..http.cookiejar.pyx*
...
"CookieJar" has the following methods:
                   ...
                   *CookieJar.add_cookie_header()..http.cookiejar.pyx*
CookieJar.add_cookie_header(request)
   ...
   "get_origin_req_host()" has been removed.
                     ...
                     *CookieJar.extract_cookies()..http.cookiejar.pyx*
CookieJar.extract_cookies(response, request)
   ...
   "get_origin_req_host()" has been removed.
                          ...
                          *CookieJar.set_policy()..http.cookiejar.pyx*
CookieJar.set_policy(policy)

   Set the "CookiePolicy" instance to be used.

                        *CookieJar.make_cookies()..http.cookiejar.pyx*
CookieJar.make_cookies(response, request)
   ...
   required of the _response_ and _request_ arguments.
                    ...
                    *CookieJar.set_cookie_if_ok()..http.cookiejar.pyx*
CookieJar.set_cookie_if_ok(cookie, request)

   Set a "Cookie" if policy says it’s OK to do so.

                          *CookieJar.set_cookie()..http.cookiejar.pyx*
CookieJar.set_cookie(cookie)

   Set a "Cookie", without checking with policy to see whether or not
   it should be set.

                               *CookieJar.clear()..http.cookiejar.pyx*
CookieJar.clear([domain[, path[, name]]])
   ...
   Raises "KeyError" if no matching cookie exists.
               ...
               *CookieJar.clear_session_cookies()..http.cookiejar.pyx*
...
"FileCookieJar" implements the following additional methods:
                            ...
                            *FileCookieJar.save()..http.cookiejar.pyx*
FileCookieJar.save(filename=None, ignore_discard=False, ignore_expires=False)
   ...
   "load()" or "revert()" methods.
                            ...
                            *FileCookieJar.load()..http.cookiejar.pyx*
FileCookieJar.load(filename=None, ignore_discard=False, ignore_expires=False)
   ...
   alias of "OSError".
                          ...
                          *FileCookieJar.revert()..http.cookiejar.pyx*
...
FileCookieJar.filename    *FileCookieJar.filename..http.cookiejar.pyx*

   Filename of default file in which to keep cookies.  This attribute
   may be assigned to.

                         *FileCookieJar.delayload..http.cookiejar.pyx*
...
writing.
                                ...
                                *MozillaCookieJar..http.cookiejar.pyx*
class http.cookiejar.MozillaCookieJar(filename=None, delayload=None, policy=None)
   ...
   clobbered by Mozilla.
                                    ...
                                    *LWPCookieJar..http.cookiejar.pyx*
...
methods:
                           ...
                           *CookiePolicy.set_ok()..http.cookiejar.pyx*
CookiePolicy.set_ok(cookie, request)
   ...
   "CookieJar.extract_cookies()".
                        ...
                        *CookiePolicy.return_ok()..http.cookiejar.pyx*
CookiePolicy.return_ok(cookie, request)
   ...
   "CookieJar.add_cookie_header()".
                 ...
                 *CookiePolicy.domain_return_ok()..http.cookiejar.pyx*
CookiePolicy.domain_return_ok(domain, request)
   ...
   The _request_ argument is as documented for "return_ok()".
                   ...
                   *CookiePolicy.path_return_ok()..http.cookiejar.pyx*
...
CookiePolicy.netscape      *CookiePolicy.netscape..http.cookiejar.pyx*

   Implement Netscape protocol.

CookiePolicy.rfc2965        *CookiePolicy.rfc2965..http.cookiejar.pyx*

   Implement **RFC 2965** protocol.

                       *CookiePolicy.hide_cookie2..http.cookiejar.pyx*
...
"DefaultCookiePolicy" implements the following additional methods:
           ...
           *DefaultCookiePolicy.blocked_domains()..http.cookiejar.pyx*
DefaultCookiePolicy.blocked_domains()

   Return the sequence of blocked domains (as a tuple).

       *DefaultCookiePolicy.set_blocked_domains()..http.cookiejar.pyx*
DefaultCookiePolicy.set_blocked_domains(blocked_domains)

   Set the sequence of blocked domains.

                *DefaultCookiePolicy.is_blocked()..http.cookiejar.pyx*
DefaultCookiePolicy.is_blocked(domain)

   Return "True" if _domain_ is on the blocklist for setting or
   receiving cookies.

           *DefaultCookiePolicy.allowed_domains()..http.cookiejar.pyx*
DefaultCookiePolicy.allowed_domains()

   Return "None", or the sequence of allowed domains (as a tuple).

       *DefaultCookiePolicy.set_allowed_domains()..http.cookiejar.pyx*
DefaultCookiePolicy.set_allowed_domains(allowed_domains)

   Set the sequence of allowed domains, or "None".

            *DefaultCookiePolicy.is_not_allowed()..http.cookiejar.pyx*
...
and which may all be assigned to.
         ...
         *DefaultCookiePolicy.rfc2109_as_netscape..http.cookiejar.pyx*
...
General strictness switches:
               ...
               *DefaultCookiePolicy.strict_domain..http.cookiejar.pyx*
 ...
 *DefaultCookiePolicy.strict_rfc2965_unverifiable..http.cookiejar.pyx*
...
Netscape protocol strictness switches:
      ...
      *DefaultCookiePolicy.strict_ns_unverifiable..http.cookiejar.pyx*
DefaultCookiePolicy.strict_ns_unverifiable

   Apply **RFC 2965** rules on unverifiable transactions even to
   Netscape cookies.

            *DefaultCookiePolicy.strict_ns_domain..http.cookiejar.pyx*
DefaultCookiePolicy.strict_ns_domain

   Flags indicating how strict to be with domain-matching rules for
   Netscape cookies.  See below for acceptable values.

*DefaultCookiePolicy.strict_ns_set_initial_dollar..http.cookiejar.pyx*
DefaultCookiePolicy.strict_ns_set_initial_dollar

   Ignore cookies in Set-Cookie: headers that have names starting with
   "'$'".

          *DefaultCookiePolicy.strict_ns_set_path..http.cookiejar.pyx*
...
"DomainStrictNoDots|DomainStrictNonDomain" means both flags are set).
          ...
          *DefaultCookiePolicy.DomainStrictNoDots..http.cookiejar.pyx*
DefaultCookiePolicy.DomainStrictNoDots
   ...
   "www.foo" contains a dot).
       ...
       *DefaultCookiePolicy.DomainStrictNonDomain..http.cookiejar.pyx*
DefaultCookiePolicy.DomainStrictNonDomain
   ...
   "example.com" that had no "domain" cookie-attribute).
          ...
          *DefaultCookiePolicy.DomainRFC2965Match..http.cookiejar.pyx*
...
most useful combinations of the above flags:
               ...
               *DefaultCookiePolicy.DomainLiberal..http.cookiejar.pyx*
DefaultCookiePolicy.DomainLiberal

   Equivalent to 0 (ie. all of the above Netscape domain strictness
   flags switched off).

                *DefaultCookiePolicy.DomainStrict..http.cookiejar.pyx*
...
Cookie.version                    *Cookie.version..http.cookiejar.pyx*
...
Cookie.name                          *Cookie.name..http.cookiejar.pyx*

   Cookie name (a string).

Cookie.value                        *Cookie.value..http.cookiejar.pyx*

   Cookie value (a string), or "None".

Cookie.port                          *Cookie.port..http.cookiejar.pyx*

   String representing a port or a set of ports (eg. ‘80’, or
   ‘80,8080’), or "None".

Cookie.path                          *Cookie.path..http.cookiejar.pyx*

   Cookie path (a string, eg. "'/acme/rocket_launchers'").

Cookie.secure                      *Cookie.secure..http.cookiejar.pyx*

   "True" if cookie should only be returned over a secure connection.

Cookie.expires                    *Cookie.expires..http.cookiejar.pyx*

   Integer expiry date in seconds since epoch, or "None".  See also
   the "is_expired()" method.

Cookie.discard                    *Cookie.discard..http.cookiejar.pyx*

   "True" if this is a session cookie.

Cookie.comment                    *Cookie.comment..http.cookiejar.pyx*

   String comment from the server explaining the function of this
   cookie, or "None".

Cookie.comment_url            *Cookie.comment_url..http.cookiejar.pyx*

   URL linking to a comment from the server explaining the function of
   this cookie, or "None".

Cookie.rfc2109                    *Cookie.rfc2109..http.cookiejar.pyx*
...
Cookie.port_specified      *Cookie.port_specified..http.cookiejar.pyx*

   "True" if a port or set of ports was explicitly specified by the
   server (in the _Set-Cookie_ / _Set-Cookie2_ header).

                         *Cookie.domain_specified..http.cookiejar.pyx*
Cookie.domain_specified

   "True" if a domain was explicitly specified by the server.

                       *Cookie.domain_initial_dot..http.cookiejar.pyx*
...
be accessed using the following methods:
                   ...
                   *Cookie.has_nonstandard_attr()..http.cookiejar.pyx*
Cookie.has_nonstandard_attr(name)

   Return "True" if cookie has the named cookie-attribute.

                   *Cookie.get_nonstandard_attr()..http.cookiejar.pyx*
Cookie.get_nonstandard_attr(name, default=None)

   If cookie has the named cookie-attribute, return its value.
   Otherwise, return _default_.

                   *Cookie.set_nonstandard_attr()..http.cookiejar.pyx*
...
The "Cookie" class also defines the following method:
                             ...
                             *Cookie.is_expired()..http.cookiejar.pyx*
