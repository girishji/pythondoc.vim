*http.server.pyx*                             Last change: 2023 Sep 15
...
class http.server.HTTPServer(server_address, RequestHandlerClass)
   ...
   through the handler’s "server" instance variable.
                                ...
                                *ThreadingHTTPServer..http.server.pyx*
...
three different variants:
                             ...
                             *BaseHTTPRequestHandler..http.server.pyx*
class http.server.BaseHTTPRequestHandler(request, client_address, server)
   ...
   "BaseHTTPRequestHandler" has the following instance variables:
              ...
              *BaseHTTPRequestHandler.client_address..http.server.pyx*
   client_address

      Contains a tuple of the form "(host, port)" referring to the
      client’s address.

   server                *BaseHTTPRequestHandler.server..http.server.pyx*

      Contains the server instance.

            *BaseHTTPRequestHandler.close_connection..http.server.pyx*
   close_connection
   ...
   requestline      *BaseHTTPRequestHandler.requestline..http.server.pyx*
   ...
   command              *BaseHTTPRequestHandler.command..http.server.pyx*

      Contains the command (request type). For example, "'GET'".

   path                    *BaseHTTPRequestHandler.path..http.server.pyx*
      ...
      "query".
             ...
             *BaseHTTPRequestHandler.request_version..http.server.pyx*
   request_version

      Contains the version string from the request. For example,
      "'HTTP/1.0'".

   headers              *BaseHTTPRequestHandler.headers..http.server.pyx*
   ...
   rfile                  *BaseHTTPRequestHandler.rfile..http.server.pyx*

      An "io.BufferedIOBase" input stream, ready to read from the
      start of the optional input data.

   wfile                  *BaseHTTPRequestHandler.wfile..http.server.pyx*
   ...
   "BaseHTTPRequestHandler" has the following attributes:
              ...
              *BaseHTTPRequestHandler.server_version..http.server.pyx*
   server_version
   ...
   sys_version      *BaseHTTPRequestHandler.sys_version..http.server.pyx*

      Contains the Python system version, in a form usable by the
      "version_string" method and the "server_version" class variable.
      For example, "'Python/1.4'".

        *BaseHTTPRequestHandler.error_message_format..http.server.pyx*
   error_message_format
      ...
      the status code that passed to "send_error()".
          ...
          *BaseHTTPRequestHandler.error_content_type..http.server.pyx*
   error_content_type

      Specifies the Content-Type HTTP header of error responses sent
      to the client.  The default value is "'text/html'".

            *BaseHTTPRequestHandler.protocol_version..http.server.pyx*
   protocol_version
   ...
   MessageClass    *BaseHTTPRequestHandler.MessageClass..http.server.pyx*

      Specifies an "email.message.Message"-like class to parse HTTP
      headers.  Typically, this is not overridden, and it defaults to
      "http.client.HTTPMessage".

   responses          *BaseHTTPRequestHandler.responses..http.server.pyx*
   ...
   handle()            *BaseHTTPRequestHandler.handle()..http.server.pyx*
      ...
      appropriate "do_*()" methods.
        ...
        *BaseHTTPRequestHandler.handle_one_request()..http.server.pyx*
   handle_one_request()
      ...
      it.
         ...
         *BaseHTTPRequestHandler.handle_expect_100()..http.server.pyx*
   handle_expect_100()
      ...
      New in version 3.2.
                ...
                *BaseHTTPRequestHandler.send_error()..http.server.pyx*
   send_error(code, message=None, explain=None)
      ...
      Length header. Added the _explain_ argument.
             ...
             *BaseHTTPRequestHandler.send_response()..http.server.pyx*
   send_response(code, message=None)
      ...
      and "end_headers()" needs to be called explicitly.
               ...
               *BaseHTTPRequestHandler.send_header()..http.server.pyx*
   send_header(keyword, value)
      ...
      buffer.
        ...
        *BaseHTTPRequestHandler.send_response_only()..http.server.pyx*
   send_response_only(code, message=None)
      ...
      New in version 3.2.
               ...
               *BaseHTTPRequestHandler.end_headers()..http.server.pyx*
   end_headers()
      ...
      output stream.
             ...
             *BaseHTTPRequestHandler.flush_headers()..http.server.pyx*
   flush_headers()
      ...
      New in version 3.3.
               ...
               *BaseHTTPRequestHandler.log_request()..http.server.pyx*
   ...
   log_error(...)   *BaseHTTPRequestHandler.log_error()..http.server.pyx*
      ...
      arguments (_format_ and additional values).
               ...
               *BaseHTTPRequestHandler.log_message()..http.server.pyx*
   log_message(format, ...)
      ...
      and time are prefixed to every message logged.
            ...
            *BaseHTTPRequestHandler.version_string()..http.server.pyx*
   version_string()
      ...
      attributes.
          ...
          *BaseHTTPRequestHandler.date_time_string()..http.server.pyx*
   date_time_string(timestamp=None)
      ...
      *BaseHTTPRequestHandler.log_date_time_string()..http.server.pyx*
   log_date_time_string()

      Returns the current date and time, formatted for logging.

            *BaseHTTPRequestHandler.address_string()..http.server.pyx*
   address_string()
      ...
      address.
                           ...
                           *SimpleHTTPRequestHandler..http.server.pyx*
class http.server.SimpleHTTPRequestHandler(request, client_address, server, directory=None)
   ...
   "SimpleHTTPRequestHandler":
            ...
            *SimpleHTTPRequestHandler.server_version..http.server.pyx*
   server_version

      This will be ""SimpleHTTP/" + __version__", where "__version__"
      is defined at the module level.

            *SimpleHTTPRequestHandler.extensions_map..http.server.pyx*
   extensions_map
   ...
   do_HEAD()        *SimpleHTTPRequestHandler.do_HEAD()..http.server.pyx*
   ...
   do_GET()          *SimpleHTTPRequestHandler.do_GET()..http.server.pyx*
...
New in version 3.11: "--protocol" argument was introduced.
                              ...
                              *CGIHTTPRequestHandler..http.server.pyx*
class http.server.CGIHTTPRequestHandler(request, client_address, server)
   ...
   The "CGIHTTPRequestHandler" defines the following data member:
              ...
              *CGIHTTPRequestHandler.cgi_directories..http.server.pyx*
   cgi_directories
   ...
   do_POST()           *CGIHTTPRequestHandler.do_POST()..http.server.pyx*
