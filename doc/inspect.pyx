*inspect.pyx*                                 Last change: 2023 Sep 15
...
inspect.getmembers(object[, predicate])    *getmembers()..inspect.pyx*
...
inspect.getmodulename(path)             *getmodulename()..inspect.pyx*
...
inspect.ismodule(object)                     *ismodule()..inspect.pyx*

   Return "True" if the object is a module.

inspect.isclass(object)                       *isclass()..inspect.pyx*

   Return "True" if the object is a class, whether built-in or created
   in Python code.

inspect.ismethod(object)                     *ismethod()..inspect.pyx*

   Return "True" if the object is a bound method written in Python.

inspect.isfunction(object)                 *isfunction()..inspect.pyx*

   Return "True" if the object is a Python function, which includes
   functions created by a _lambda_ expression.

                                  *isgeneratorfunction()..inspect.pyx*
...
inspect.isgenerator(object)               *isgenerator()..inspect.pyx*

   Return "True" if the object is a generator.

                                  *iscoroutinefunction()..inspect.pyx*
inspect.iscoroutinefunction(object)
   ...
   "markcoroutinefunction()" now return "True".
                                ...
                                *markcoroutinefunction()..inspect.pyx*
...
inspect.iscoroutine(object)               *iscoroutine()..inspect.pyx*
...
inspect.isawaitable(object)               *isawaitable()..inspect.pyx*
...
<
   New in version 3.5.
                                   ...
                                   *isasyncgenfunction()..inspect.pyx*
...
inspect.isasyncgen(object)                 *isasyncgen()..inspect.pyx*
...
inspect.istraceback(object)               *istraceback()..inspect.pyx*

   Return "True" if the object is a traceback.

inspect.isframe(object)                       *isframe()..inspect.pyx*

   Return "True" if the object is a frame.

inspect.iscode(object)                         *iscode()..inspect.pyx*

   Return "True" if the object is a code.

inspect.isbuiltin(object)                   *isbuiltin()..inspect.pyx*

   Return "True" if the object is a built-in function or a bound
   built-in method.

inspect.ismethodwrapper(object)       *ismethodwrapper()..inspect.pyx*
...
inspect.isroutine(object)                   *isroutine()..inspect.pyx*

   Return "True" if the object is a user-defined or built-in function
   or method.

inspect.isabstract(object)                 *isabstract()..inspect.pyx*

   Return "True" if the object is an abstract base class.

                                   *ismethoddescriptor()..inspect.pyx*
...
inspect.isdatadescriptor(object)     *isdatadescriptor()..inspect.pyx*
   ...
   members have both of these attributes), but this is not guaranteed.
                                   ...
                                   *isgetsetdescriptor()..inspect.pyx*
inspect.isgetsetdescriptor(object)
   ...
   **CPython implementation detail:** getsets are attributes defined
   ...
   "False".
                                   ...
                                   *ismemberdescriptor()..inspect.pyx*
...
inspect.getdoc(object)                         *getdoc()..inspect.pyx*
...
inspect.getcomments(object)               *getcomments()..inspect.pyx*
...
inspect.getfile(object)                       *getfile()..inspect.pyx*
...
inspect.getmodule(object)                   *getmodule()..inspect.pyx*

   Try to guess which module an object was defined in. Return "None"
   if the module cannot be determined.

inspect.getsourcefile(object)           *getsourcefile()..inspect.pyx*
...
inspect.getsourcelines(object)         *getsourcelines()..inspect.pyx*
...
inspect.getsource(object)                   *getsource()..inspect.pyx*
...
inspect.cleandoc(doc)                        *cleandoc()..inspect.pyx*
...
class inspect.Signature(parameters=None, *, return_annotation=Signature.empty)
   ...
   empty                                   *Signature.empty..inspect.pyx*

      A special class-level marker to specify absence of a return
      annotation.

   parameters                         *Signature.parameters..inspect.pyx*
   ...
   bind(*args, **kwargs)                  *Signature.bind()..inspect.pyx*
      ...
      match the signature, or raises a "TypeError".
                               ...
                               *Signature.bind_partial()..inspect.pyx*
...
<
      ...
      "copy.replace()".
                              ...
                              *Signature.from_callable()..inspect.pyx*
...
class inspect.Parameter(name, kind, *, default=Parameter.empty, annotation=Parameter.empty)
   ...
   empty                                   *Parameter.empty..inspect.pyx*

      A special class-level marker to specify absence of default
      values and annotations.

   name                                     *Parameter.name..inspect.pyx*
...
>
         ...
         Parameter: c
<
   kind.description             *Parameter.kind.description..inspect.pyx*
...
>
         ...
         "foo:'spam'"
<
      Parameter objects are also supported by generic function
      "copy.replace()".
...
class inspect.BoundArguments             *BoundArguments..inspect.pyx*

   Result of a "Signature.bind()" or "Signature.bind_partial()" call.
   Holds the mapping of arguments to the function’s parameters.

   arguments                      *BoundArguments.arguments..inspect.pyx*
...
inspect.getfullargspec(func)           *getfullargspec()..inspect.pyx*
...
inspect.getargvalues(frame)              *getargvalues()..inspect.pyx*
...
inspect.getmro(cls)                            *getmro()..inspect.pyx*
...
inspect.getclosurevars(func)           *getclosurevars()..inspect.pyx*
...
inspect.unwrap(func, *, stop=None)             *unwrap()..inspect.pyx*
...
class inspect.Traceback                       *Traceback..inspect.pyx*

   filename                             *Traceback.filename..inspect.pyx*

      The file name associated with the code being executed by the
      frame this traceback corresponds to.

   lineno                                 *Traceback.lineno..inspect.pyx*

      The line number of the current line associated with the code
      being executed by the frame this traceback corresponds to.

   function                             *Traceback.function..inspect.pyx*

      The function name that is being executed by the frame this
      traceback corresponds to.

   code_context                     *Traceback.code_context..inspect.pyx*

      A list of lines of context from the source code that’s being
      executed by the frame this traceback corresponds to.

   index                                   *Traceback.index..inspect.pyx*

      The index of the current line being executed in the
      "code_context" list.

   positions                           *Traceback.positions..inspect.pyx*
...
inspect.getframeinfo(frame, context=1)   *getframeinfo()..inspect.pyx*
...
inspect.currentframe()                   *currentframe()..inspect.pyx*
...
inspect.stack(context=1)                        *stack()..inspect.pyx*
...
inspect.trace(context=1)                        *trace()..inspect.pyx*
...
inspect.getasyncgenstate(agen)       *getasyncgenstate()..inspect.pyx*
...
is being updated as expected:
                                   ...
                                   *getgeneratorlocals()..inspect.pyx*
inspect.getgeneratorlocals(generator)
   ...
   **CPython implementation detail:** This function relies on the
   ...
   New in version 3.3.
                                   ...
                                   *getcoroutinelocals()..inspect.pyx*
...
inspect.getasyncgenlocals(agen)     *getasyncgenlocals()..inspect.pyx*
...
inspect.CO_OPTIMIZED                       *CO_OPTIMIZED..inspect.pyx*

   The code object is optimized, using fast locals.

inspect.CO_NEWLOCALS                       *CO_NEWLOCALS..inspect.pyx*

   If set, a new dict will be created for the frame’s "f_locals" when
   the code object is executed.

inspect.CO_VARARGS                           *CO_VARARGS..inspect.pyx*

   The code object has a variable positional parameter ("*args"-like).

inspect.CO_VARKEYWORDS                   *CO_VARKEYWORDS..inspect.pyx*

   The code object has a variable keyword parameter ("**kwargs"-like).

inspect.CO_NESTED                             *CO_NESTED..inspect.pyx*

   The flag is set when the code object is a nested function.

inspect.CO_GENERATOR                       *CO_GENERATOR..inspect.pyx*
...
inspect.CO_COROUTINE                       *CO_COROUTINE..inspect.pyx*
...
inspect.CO_ITERABLE_COROUTINE     *CO_ITERABLE_COROUTINE..inspect.pyx*
...
inspect.CO_ASYNC_GENERATOR           *CO_ASYNC_GENERATOR..inspect.pyx*
...
class inspect.BufferFlags                   *BufferFlags..inspect.pyx*
   ...
   SIMPLE                               *BufferFlags.SIMPLE..inspect.pyx*

   WRITABLE                           *BufferFlags.WRITABLE..inspect.pyx*

   FORMAT                               *BufferFlags.FORMAT..inspect.pyx*

   ND                                       *BufferFlags.ND..inspect.pyx*

   STRIDES                             *BufferFlags.STRIDES..inspect.pyx*

   C_CONTIGUOUS                   *BufferFlags.C_CONTIGUOUS..inspect.pyx*

   F_CONTIGUOUS                   *BufferFlags.F_CONTIGUOUS..inspect.pyx*

   ANY_CONTIGUOUS               *BufferFlags.ANY_CONTIGUOUS..inspect.pyx*

   INDIRECT                           *BufferFlags.INDIRECT..inspect.pyx*

   CONTIG                               *BufferFlags.CONTIG..inspect.pyx*

   CONTIG_RO                         *BufferFlags.CONTIG_RO..inspect.pyx*

   STRIDED                             *BufferFlags.STRIDED..inspect.pyx*

   STRIDED_RO                       *BufferFlags.STRIDED_RO..inspect.pyx*

   RECORDS                             *BufferFlags.RECORDS..inspect.pyx*

   RECORDS_RO                       *BufferFlags.RECORDS_RO..inspect.pyx*

   FULL                                   *BufferFlags.FULL..inspect.pyx*

   FULL_RO                             *BufferFlags.FULL_RO..inspect.pyx*

   READ                                   *BufferFlags.READ..inspect.pyx*

   WRITE                                 *BufferFlags.WRITE..inspect.pyx*
