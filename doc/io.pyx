*io.pyx*                                      Last change: 2023 Sep 15
...
io.DEFAULT_BUFFER_SIZE                   *DEFAULT_BUFFER_SIZE..io.pyx*
...
io.open_code(path)                               *open_code()..io.pyx*
...
exception io.BlockingIOError                 *BlockingIOError..io.pyx*

   This is a compatibility alias for the builtin "BlockingIOError"
   exception.

exception io.UnsupportedOperation       *UnsupportedOperation..io.pyx*
...
<
   ...
   closed                                         *IOBase.closed..io.pyx*

      "True" if the stream is closed.

   fileno()                                     *IOBase.fileno()..io.pyx*
   ...
   readlines(hint=-1, /)                     *IOBase.readlines()..io.pyx*
   ...
   seek(offset, whence=os.SEEK_SET, /)            *IOBase.seek()..io.pyx*
   ...
   seekable()                                 *IOBase.seekable()..io.pyx*

      Return "True" if the stream supports random access.  If "False",
      "seek()", "tell()" and "truncate()" will raise "OSError".

   tell()                                         *IOBase.tell()..io.pyx*

      Return the current stream position.

   truncate(size=None, /)                     *IOBase.truncate()..io.pyx*
   ...
   writable()                                 *IOBase.writable()..io.pyx*

      Return "True" if the stream supports writing.  If "False",
      "write()" and "truncate()" will raise "OSError".

   writelines(lines, /)                     *IOBase.writelines()..io.pyx*
...
class io.RawIOBase                                 *RawIOBase..io.pyx*
   ...
   read(size=-1, /)                            *RawIOBase.read()..io.pyx*
   ...
   write(b, /)                                *RawIOBase.write()..io.pyx*
...
class io.BufferedIOBase                       *BufferedIOBase..io.pyx*
   ...
   detach()                             *BufferedIOBase.detach()..io.pyx*
   ...
   read(size=-1, /)                       *BufferedIOBase.read()..io.pyx*
   ...
   read1(size=-1, /)                     *BufferedIOBase.read1()..io.pyx*
   ...
   readinto(b, /)                     *BufferedIOBase.readinto()..io.pyx*
   ...
   readinto1(b, /)                   *BufferedIOBase.readinto1()..io.pyx*
   ...
   write(b, /)                           *BufferedIOBase.write()..io.pyx*
...
class io.FileIO(name, mode='r', closefd=True, opener=None)
   ...
   * an integer representing the number of an existing OS-level file
   ...
   mode                                             *FileIO.mode..io.pyx*

      The mode as given in the constructor.

   name                                             *FileIO.name..io.pyx*
...
class io.BytesIO(initial_bytes=b'')                  *BytesIO..io.pyx*
   ...
   getbuffer()                              *BytesIO.getbuffer()..io.pyx*
...
<
   ...
   getvalue()                                *BytesIO.getvalue()..io.pyx*

      Return "bytes" containing the entire contents of the buffer.

   read1(size=-1, /)                            *BytesIO.read1()..io.pyx*

      In "BytesIO", this is the same as "read()".

      Changed in version 3.7: The _size_ argument is now optional.

   readinto1(b, /)                          *BytesIO.readinto1()..io.pyx*

      In "BytesIO", this is the same as "readinto()".

      New in version 3.5.

                                              *BufferedReader..io.pyx*
class io.BufferedReader(raw, buffer_size=DEFAULT_BUFFER_SIZE)
   ...
   peek(size=0, /)                        *BufferedReader.peek()..io.pyx*
...
class io.BufferedWriter(raw, buffer_size=DEFAULT_BUFFER_SIZE)
   ...
   * when the "BufferedWriter" object is closed or destroyed.
   ...
   flush()                               *BufferedWriter.flush()..io.pyx*

      Force bytes held in the buffer into the raw stream.  A
      "BlockingIOError" should be raised if the raw stream blocks.

   write(b, /)                           *BufferedWriter.write()..io.pyx*
...
class io.TextIOBase                               *TextIOBase..io.pyx*
   ...
   detach()                                 *TextIOBase.detach()..io.pyx*
   ...
   seek(offset, whence=SEEK_SET, /)           *TextIOBase.seek()..io.pyx*
...
class io.TextIOWrapper(buffer, encoding=None, errors=None, newline=None, line_buffering=False, write_through=False)
   ...
   * When writing output to the stream, if _newline_ is "None", any
   ...
   line_buffering                  *TextIOWrapper.line_buffering..io.pyx*

      Whether line buffering is enabled.

   write_through                    *TextIOWrapper.write_through..io.pyx*
      ...
      New in version 3.7.
                                 ...
                                 *TextIOWrapper.reconfigure()..io.pyx*
   ...
   seek(cookie, whence=os.SEEK_SET, /)     *TextIOWrapper.seek()..io.pyx*
   ...
   tell()                                  *TextIOWrapper.tell()..io.pyx*
...
class io.StringIO(initial_value='', newline='\n')   *StringIO..io.pyx*
   ...
   getvalue()                               *StringIO.getvalue()..io.pyx*
...
<
                                   ...
                                   *IncrementalNewlineDecoder..io.pyx*
