*linecache.pyx*                               Last change: 2023 Sep 15
...
linecache.clearcache()                   *clearcache()..linecache.pyx*

   Clear the cache.  Use this function if you no longer need lines
   from files previously read using "getline()".

linecache.checkcache(filename=None)      *checkcache()..linecache.pyx*
