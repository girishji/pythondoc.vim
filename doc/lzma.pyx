*lzma.pyx*                                    Last change: 2023 Sep 15
...
exception lzma.LZMAError                         *LZMAError..lzma.pyx*
...
class lzma.LZMAFile(filename=None, mode='r', *, format=None, check=-1, preset=None, filters=None)
   ...
   peek(size=-1)                              *LZMAFile.peek()..lzma.pyx*
...
class lzma.LZMACompressor(format=FORMAT_XZ, check=-1, preset=None, filters=None)
   ...
   * "CHECK_SHA256": 256-bit Secure Hash Algorithm.
   ...
   compress(data)                   *LZMACompressor.compress()..lzma.pyx*
   ...
   flush()                             *LZMACompressor.flush()..lzma.pyx*
...
class lzma.LZMADecompressor(format=FORMAT_AUTO, memlimit=None, filters=None)
   ...
   Note:
     ...
     stream.
                             ...
                             *LZMADecompressor.decompress()..lzma.pyx*
   ...
   check                               *LZMADecompressor.check..lzma.pyx*
   ...
   eof                                   *LZMADecompressor.eof..lzma.pyx*

      "True" if the end-of-stream marker has been reached.

   unused_data                   *LZMADecompressor.unused_data..lzma.pyx*

      Data found after the end of the compressed stream.

      Before the end of the stream is reached, this will be "b""".

   needs_input                   *LZMADecompressor.needs_input..lzma.pyx*
...
lzma.is_check_supported(check)        *is_check_supported()..lzma.pyx*
