*mailbox.pyx*                                 Last change: 2023 Sep 15
...
class mailbox.Mailbox                           *Mailbox..mailbox.pyx*
   ...
   add(message)                              *Mailbox.add()..mailbox.pyx*
   ...
   remove(key)                            *Mailbox.remove()..mailbox.pyx*
   __delitem__(key)                  *Mailbox.__delitem__()..mailbox.pyx*
   discard(key)                          *Mailbox.discard()..mailbox.pyx*
   ...
   __setitem__(key, message)         *Mailbox.__setitem__()..mailbox.pyx*
   ...
   iterkeys()                           *Mailbox.iterkeys()..mailbox.pyx*
   keys()                                   *Mailbox.keys()..mailbox.pyx*

      Return an iterator over all keys if called as "iterkeys()" or
      return a list of keys if called as "keys()".

   itervalues()                       *Mailbox.itervalues()..mailbox.pyx*
   __iter__()                           *Mailbox.__iter__()..mailbox.pyx*
   values()                               *Mailbox.values()..mailbox.pyx*
   ...
   iteritems()                         *Mailbox.iteritems()..mailbox.pyx*
   items()                                 *Mailbox.items()..mailbox.pyx*
   ...
   get(key, default=None)                    *Mailbox.get()..mailbox.pyx*
   __getitem__(key)                  *Mailbox.__getitem__()..mailbox.pyx*
   ...
   get_message(key)                  *Mailbox.get_message()..mailbox.pyx*
   ...
   get_bytes(key)                      *Mailbox.get_bytes()..mailbox.pyx*
   ...
   get_string(key)                    *Mailbox.get_string()..mailbox.pyx*
   ...
   get_file(key)                        *Mailbox.get_file()..mailbox.pyx*
   ...
   __contains__(key)                *Mailbox.__contains__()..mailbox.pyx*

      Return "True" if _key_ corresponds to a message, "False"
      otherwise.

   __len__()                             *Mailbox.__len__()..mailbox.pyx*

      Return a count of messages in the mailbox.

   clear()                                 *Mailbox.clear()..mailbox.pyx*

      Delete all messages from the mailbox.

   pop(key, default=None)                    *Mailbox.pop()..mailbox.pyx*
   ...
   popitem()                             *Mailbox.popitem()..mailbox.pyx*
   ...
   update(arg)                            *Mailbox.update()..mailbox.pyx*
   ...
   flush()                                 *Mailbox.flush()..mailbox.pyx*
   ...
   unlock()                               *Mailbox.unlock()..mailbox.pyx*

      Release the lock on the mailbox, if any.

   close()                                 *Mailbox.close()..mailbox.pyx*
...
<
   ...
   list_folders()                   *Maildir.list_folders()..mailbox.pyx*

      Return a list of the names of all folders.

   get_folder(folder)                 *Maildir.get_folder()..mailbox.pyx*
   ...
   add_folder(folder)                 *Maildir.add_folder()..mailbox.pyx*

      Create a folder whose name is _folder_ and return a "Maildir"
      instance representing it.

   remove_folder(folder)           *Maildir.remove_folder()..mailbox.pyx*
   ...
   clean()                                 *Maildir.clean()..mailbox.pyx*
   ...
   add(message)                              *Maildir.add()..mailbox.pyx*
   __setitem__(key, message)         *Maildir.__setitem__()..mailbox.pyx*
   update(arg)                            *Maildir.update()..mailbox.pyx*
...
class mailbox.MH(path, factory=None, create=True)    *MH..mailbox.pyx*
   ...
   remove(key)                                 *MH.remove()..mailbox.pyx*
   __delitem__(key)                       *MH.__delitem__()..mailbox.pyx*
   discard(key)                               *MH.discard()..mailbox.pyx*
   ...
   lock()                                        *MH.lock()..mailbox.pyx*
   unlock()                                    *MH.unlock()..mailbox.pyx*
...
class mailbox.Babyl(path, factory=None, create=True)
   ...
   get_labels()                         *Babyl.get_labels()..mailbox.pyx*
   ...
   get_file(key)                          *Babyl.get_file()..mailbox.pyx*
   ...
   lock()                                     *Babyl.lock()..mailbox.pyx*
   unlock()                                 *Babyl.unlock()..mailbox.pyx*
...
class mailbox.MMDF(path, factory=None, create=True)
   ...
   get_file(key)                           *MMDF.get_file()..mailbox.pyx*

      Using the file after calling "flush()" or "close()" on the
      "MMDF" instance may yield unpredictable results or raise an
      exception.

   lock()                                      *MMDF.lock()..mailbox.pyx*
   unlock()                                  *MMDF.unlock()..mailbox.pyx*
...
class mailbox.Message(message=None)             *Message..mailbox.pyx*
...
class mailbox.MaildirMessage(message=None)
   ...
   get_subdir()                *MaildirMessage.get_subdir()..mailbox.pyx*
   ...
   set_subdir(subdir)          *MaildirMessage.set_subdir()..mailbox.pyx*

      Set the subdirectory the message should be stored in. Parameter
      _subdir_ must be either “new” or “cur”.

   get_flags()                  *MaildirMessage.get_flags()..mailbox.pyx*
   ...
   set_flags(flags)             *MaildirMessage.set_flags()..mailbox.pyx*

      Set the flags specified by _flags_ and unset all others.

   add_flag(flag)                *MaildirMessage.add_flag()..mailbox.pyx*
   ...
   remove_flag(flag)          *MaildirMessage.remove_flag()..mailbox.pyx*
   ...
   get_date()                    *MaildirMessage.get_date()..mailbox.pyx*

      Return the delivery date of the message as a floating-point
      number representing seconds since the epoch.

   set_date(date)                *MaildirMessage.set_date()..mailbox.pyx*

      Set the delivery date of the message to _date_, a floating-point
      number representing seconds since the epoch.

   get_info()                    *MaildirMessage.get_info()..mailbox.pyx*
   ...
   set_info(info)                *MaildirMessage.set_info()..mailbox.pyx*
...
class mailbox.mboxMessage(message=None)     *mboxMessage..mailbox.pyx*
   ...
   get_from()                       *mboxMessage.get_from()..mailbox.pyx*
   ...
   set_from(from_, time_=None)      *mboxMessage.set_from()..mailbox.pyx*
   ...
   get_flags()                     *mboxMessage.get_flags()..mailbox.pyx*
   ...
   set_flags(flags)                *mboxMessage.set_flags()..mailbox.pyx*
   ...
   add_flag(flag)                   *mboxMessage.add_flag()..mailbox.pyx*

      Set the flag(s) specified by _flag_ without changing other
      flags. To add more than one flag at a time, _flag_ may be a
      string of more than one character.

   remove_flag(flag)             *mboxMessage.remove_flag()..mailbox.pyx*
...
class mailbox.MHMessage(message=None)         *MHMessage..mailbox.pyx*
   ...
   get_sequences()               *MHMessage.get_sequences()..mailbox.pyx*

      Return a list of the names of sequences that include this
      message.

   set_sequences(sequences)      *MHMessage.set_sequences()..mailbox.pyx*

      Set the list of sequences that include this message.

   add_sequence(sequence)         *MHMessage.add_sequence()..mailbox.pyx*

      Add _sequence_ to the list of sequences that include this
      message.

   remove_sequence(sequence)   *MHMessage.remove_sequence()..mailbox.pyx*
...
class mailbox.BabylMessage(message=None)   *BabylMessage..mailbox.pyx*
   ...
   get_labels()                  *BabylMessage.get_labels()..mailbox.pyx*

      Return a list of labels on the message.

   set_labels(labels)            *BabylMessage.set_labels()..mailbox.pyx*

      Set the list of labels on the message to _labels_.

   add_label(label)               *BabylMessage.add_label()..mailbox.pyx*

      Add _label_ to the list of labels on the message.

   remove_label(label)         *BabylMessage.remove_label()..mailbox.pyx*

      Remove _label_ from the list of labels on the message.

   get_visible()                *BabylMessage.get_visible()..mailbox.pyx*

      Return an "Message" instance whose headers are the message’s
      visible headers and whose body is empty.

   set_visible(visible)         *BabylMessage.set_visible()..mailbox.pyx*
   ...
   update_visible()          *BabylMessage.update_visible()..mailbox.pyx*
...
class mailbox.MMDFMessage(message=None)     *MMDFMessage..mailbox.pyx*
   ...
   get_from()                       *MMDFMessage.get_from()..mailbox.pyx*

      Return a string representing the “From “ line that marks the
      start of the message in an mbox mailbox. The leading “From “ and
      the trailing newline are excluded.

   set_from(from_, time_=None)      *MMDFMessage.set_from()..mailbox.pyx*
   ...
   get_flags()                     *MMDFMessage.get_flags()..mailbox.pyx*
   ...
   set_flags(flags)                *MMDFMessage.set_flags()..mailbox.pyx*
   ...
   add_flag(flag)                   *MMDFMessage.add_flag()..mailbox.pyx*

      Set the flag(s) specified by _flag_ without changing other
      flags. To add more than one flag at a time, _flag_ may be a
      string of more than one character.

   remove_flag(flag)             *MMDFMessage.remove_flag()..mailbox.pyx*
...
exception mailbox.Error                           *Error..mailbox.pyx*

   The based class for all other module-specific exceptions.

                                     *NoSuchMailboxError..mailbox.pyx*
...
exception mailbox.FormatError               *FormatError..mailbox.pyx*
