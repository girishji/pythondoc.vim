*marshal.pyx*                                 Last change: 2023 Sep 15
...
marshal.dump(value, file[, version])             *dump()..marshal.pyx*
...
marshal.load(file)                               *load()..marshal.pyx*
...
marshal.dumps(value[, version])                 *dumps()..marshal.pyx*
...
marshal.loads(bytes)                            *loads()..marshal.pyx*
...
marshal.version                                 *version..marshal.pyx*
