*modulefinder.pyx*                            Last change: 2023 Sep 15
...
class modulefinder.ModuleFinder(path=None, debug=0, excludes=[], replace_paths=[])
   ...
   report()                     *ModuleFinder.report()..modulefinder.pyx*
   ...
   run_script(pathname)     *ModuleFinder.run_script()..modulefinder.pyx*

      Analyze the contents of the _pathname_ file, which must contain
      Python code.

   modules                       *ModuleFinder.modules..modulefinder.pyx*
