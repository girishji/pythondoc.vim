*netrc.pyx*                                   Last change: 2023 Sep 15
...
class netrc.netrc([file])                           *netrc..netrc.pyx*
...
exception netrc.NetrcParseError           *NetrcParseError..netrc.pyx*
   ...
   msg                                   *NetrcParseError.msg..netrc.pyx*

      Textual explanation of the error.

   filename                         *NetrcParseError.filename..netrc.pyx*

      The name of the source file.

   lineno                             *NetrcParseError.lineno..netrc.pyx*
...
netrc.authenticators(host)         *netrc.authenticators()..netrc.pyx*
...
netrc.__repr__()                         *netrc.__repr__()..netrc.pyx*
