*optparse.pyx*                                Last change: 2023 Sep 15
...
Deprecated since version 3.2: The "optparse" module is _soft
deprecated_ and will not be developed further; development will
...
programmatically with option groups is:
                       ...
                       *OptionParser.get_option_group()..optparse.pyx*
...
string:
                          ...
                          *OptionParser.print_version()..optparse.pyx*
OptionParser.print_version(file=None)
   ...
   undefined.
                            ...
                            *OptionParser.get_version()..optparse.pyx*
...
class optparse.OptionParser(...)          *OptionParser..optparse.pyx*
...
"add_option()" method of "OptionParser".
                             ...
                             *OptionParser.add_option()..optparse.pyx*
...
class optparse.Values                           *Values..optparse.pyx*
...
class optparse.Option                           *Option..optparse.pyx*
...
Option.action                            *Option.action..optparse.pyx*
...
Option.type                                *Option.type..optparse.pyx*
...
Option.dest                                *Option.dest..optparse.pyx*
...
Option.default                          *Option.default..optparse.pyx*
...
Option.nargs                              *Option.nargs..optparse.pyx*
...
Option.const                              *Option.const..optparse.pyx*

   For actions that store a constant value, the constant value to
   store.

Option.choices                          *Option.choices..optparse.pyx*

   For options of type ""choice"", the list of strings the user may
   choose from.

Option.callback                        *Option.callback..optparse.pyx*
...
Option.callback_args              *Option.callback_args..optparse.pyx*
Option.callback_kwargs          *Option.callback_kwargs..optparse.pyx*

   Additional positional and keyword arguments to pass to "callback"
   after the four standard callback arguments.

Option.help                                *Option.help..optparse.pyx*
...
Option.metavar                          *Option.metavar..optparse.pyx*
...
its "parse_args()" method.
                             ...
                             *OptionParser.parse_args()..optparse.pyx*
...
OptionParser provides several methods to help you out:
              ...
              *OptionParser.disable_interspersed_args()..optparse.pyx*
...
<
   ...
   different set of options.
               ...
               *OptionParser.enable_interspersed_args()..optparse.pyx*
...
OptionParser supports several other public methods:
                              ...
                              *OptionParser.set_usage()..optparse.pyx*
OptionParser.set_usage(usage)
   ...
   usage message.
                            ...
                            *OptionParser.print_usage()..optparse.pyx*
...
OptionParser.get_usage()      *OptionParser.get_usage()..optparse.pyx*

   Same as "print_usage()" but returns the usage string instead of
   printing it.

                           *OptionParser.set_defaults()..optparse.pyx*
...
Option.TYPES                              *Option.TYPES..optparse.pyx*

   A tuple of type names; in your subclass, simply define a new tuple
   "TYPES" that builds on the standard one.

Option.TYPE_CHECKER                *Option.TYPE_CHECKER..optparse.pyx*
...
Option.ACTIONS                          *Option.ACTIONS..optparse.pyx*

   All actions must be listed in ACTIONS.

Option.STORE_ACTIONS              *Option.STORE_ACTIONS..optparse.pyx*

   “store” actions are additionally listed here.

Option.TYPED_ACTIONS              *Option.TYPED_ACTIONS..optparse.pyx*

   “typed” actions are additionally listed here.

                           *Option.ALWAYS_TYPED_ACTIONS..optparse.pyx*
...
exception optparse.OptionError             *OptionError..optparse.pyx*

   Raised if an "Option" instance is created with invalid or
   inconsistent arguments.

                                   *OptionConflictError..optparse.pyx*
exception optparse.OptionConflictError

   Raised if conflicting options are added to an "OptionParser".

exception optparse.OptionValueError   *OptionValueError..optparse.pyx*

   Raised if an invalid option value is encountered on the command
   line.

exception optparse.BadOptionError       *BadOptionError..optparse.pyx*

   Raised if an invalid option is passed on the command line.

                                  *AmbiguousOptionError..optparse.pyx*
