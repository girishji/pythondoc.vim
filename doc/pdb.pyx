*pdb.pyx*                                     Last change: 2023 Sep 15
...
pdb.run(statement, globals=None, locals=None)         *run()..pdb.pyx*
...
pdb.runcall(function, *args, **kwds)              *runcall()..pdb.pyx*
...
pdb.set_trace(*, header=None)                   *set_trace()..pdb.pyx*
...
pdb.post_mortem(traceback=None)               *post_mortem()..pdb.pyx*
...
<
   ...
   run(statement, globals=None, locals=None)         *Pdb.run()..pdb.pyx*

                                              *Pdb.runeval()..pdb.pyx*
   runeval(expression, globals=None, locals=None)
   runcall(function, *args, **kwds)              *Pdb.runcall()..pdb.pyx*
   set_trace()                                 *Pdb.set_trace()..pdb.pyx*
