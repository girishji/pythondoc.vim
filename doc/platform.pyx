*platform.pyx*                                Last change: 2023 Sep 15
...
<
platform.machine()                           *machine()..platform.pyx*

   Returns the machine type, e.g. "'AMD64'". An empty string is
   returned if the value cannot be determined.

platform.node()                                 *node()..platform.pyx*

   Returns the computer’s network name (may not be fully qualified!).
   An empty string is returned if the value cannot be determined.

                                            *platform()..platform.pyx*
...
platform.processor()                       *processor()..platform.pyx*
...
platform.python_build()                 *python_build()..platform.pyx*

   Returns a tuple "(buildno, builddate)" stating the Python build
   number and date as strings.

platform.python_compiler()           *python_compiler()..platform.pyx*

   Returns a string identifying the compiler used for compiling
   Python.

platform.python_branch()               *python_branch()..platform.pyx*

   Returns a string identifying the Python implementation SCM branch.

                               *python_implementation()..platform.pyx*
platform.python_implementation()

   Returns a string identifying the Python implementation. Possible
   return values are: ‘CPython’, ‘IronPython’, ‘Jython’, ‘PyPy’.

platform.python_revision()           *python_revision()..platform.pyx*

   Returns a string identifying the Python implementation SCM
   revision.

platform.python_version()             *python_version()..platform.pyx*
   ...
   always include the patchlevel (it defaults to 0).
                                ...
                                *python_version_tuple()..platform.pyx*
...
platform.version()                           *version()..platform.pyx*

   Returns the system’s release version, e.g. "'#3 on degas'". An
   empty string is returned if the value cannot be determined.

platform.uname()                               *uname()..platform.pyx*
...
platform.win32_edition()               *win32_edition()..platform.pyx*
...
platform.win32_is_iot()                 *win32_is_iot()..platform.pyx*
...
===============
                              ...
                              *freedesktop_os_release()..platform.pyx*
