*plistlib.pyx*                                Last change: 2023 Sep 15
...
class plistlib.UID(data)                           *UID..plistlib.pyx*
...
plistlib.FMT_XML                               *FMT_XML..plistlib.pyx*

   The XML format for plist files.

   New in version 3.4.

plistlib.FMT_BINARY                         *FMT_BINARY..plistlib.pyx*
