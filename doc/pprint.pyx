*pprint.pyx*                                  Last change: 2023 Sep 15
...
pprint.isreadable(object)                   *isreadable()..pprint.pyx*
...
pprint.isrecursive(object)                 *isrecursive()..pprint.pyx*
...
pprint.saferepr(object)                       *saferepr()..pprint.pyx*
...
PrettyPrinter.pformat(object)    *PrettyPrinter.pformat()..pprint.pyx*
...
PrettyPrinter.pprint(object)      *PrettyPrinter.pprint()..pprint.pyx*
...
don’t need to be created.
                              ...
                              *PrettyPrinter.isreadable()..pprint.pyx*
PrettyPrinter.isreadable(object)
   ...
   deeper than allowed, this returns "False".
                             ...
                             *PrettyPrinter.isrecursive()..pprint.pyx*
...
the internals of the "saferepr()" implementation.
                                  ...
                                  *PrettyPrinter.format()..pprint.pyx*
