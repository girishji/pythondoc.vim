*profile.pyx*                                 Last change: 2023 Sep 15
...
recursion. The next line: "Ordered by: cumulative time", indicates
...
profile.run(command, filename=None, sort=-1)      *run()..profile.pyx*
...
class pstats.Stats(*filenames or profile, stream=sys.stdout)
   ...
   strip_dirs()                         *Stats.strip_dirs()..profile.pyx*
   ...
   add(*filenames)                             *Stats.add()..profile.pyx*
   ...
   dump_stats(filename)                 *Stats.dump_stats()..profile.pyx*
   ...
   sort_stats(*keys)                    *Stats.sort_stats()..profile.pyx*
   ...
   reverse_order()                   *Stats.reverse_order()..profile.pyx*
   ...
   print_stats(*restrictions)          *Stats.print_stats()..profile.pyx*
...
<
   ...
   print_callers(*restrictions)      *Stats.print_callers()..profile.pyx*
   ...
   print_callees(*restrictions)      *Stats.print_callees()..profile.pyx*
   ...
   get_stats_profile()           *Stats.get_stats_profile()..profile.pyx*
