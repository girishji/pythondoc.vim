*re.pyx*                                      Last change: 2023 Sep 15
...
class re.RegexFlag                                 *RegexFlag..re.pyx*
...
re.U                                                       *U..re.pyx*
re.UNICODE                                           *UNICODE..re.pyx*

   In Python 2, this flag made special sequences include Unicode
   characters in matches. Since Python 3, Unicode characters are
   matched by default.
...
re.compile(pattern, flags=0)                       *compile()..re.pyx*
...
re.search(pattern, string, flags=0)                 *search()..re.pyx*
...
re.match(pattern, string, flags=0)                   *match()..re.pyx*
...
re.fullmatch(pattern, string, flags=0)           *fullmatch()..re.pyx*
...
re.split(pattern, string, maxsplit=0, flags=0)       *split()..re.pyx*
...
re.findall(pattern, string, flags=0)               *findall()..re.pyx*
...
re.finditer(pattern, string, flags=0)             *finditer()..re.pyx*
...
re.sub(pattern, repl, string, count=0, flags=0)        *sub()..re.pyx*
...
re.subn(pattern, repl, string, count=0, flags=0)      *subn()..re.pyx*

   Perform the same operation as "sub()", but return a tuple
   "(new_string, number_of_subs_made)".

re.escape(pattern)                                  *escape()..re.pyx*
...
exception re.error(msg, pattern=None, pos=None)        *error..re.pyx*
   ...
   msg                                                *error.msg..re.pyx*

      The unformatted error message.

   pattern                                        *error.pattern..re.pyx*

      The regular expression pattern.

   pos                                                *error.pos..re.pyx*

      The index in _pattern_ where compilation failed (may be "None").

   lineno                                          *error.lineno..re.pyx*

      The line corresponding to _pos_ (may be "None").

   colno                                            *error.colno..re.pyx*
...
class re.Pattern                                     *Pattern..re.pyx*
...
Pattern.search(string[, pos[, endpos]])     *Pattern.search()..re.pyx*
...
<
Pattern.match(string[, pos[, endpos]])       *Pattern.match()..re.pyx*
...
Pattern.split(string, maxsplit=0)            *Pattern.split()..re.pyx*

   Identical to the "split()" function, using the compiled pattern.

Pattern.findall(string[, pos[, endpos]])   *Pattern.findall()..re.pyx*
...
Pattern.sub(repl, string, count=0)             *Pattern.sub()..re.pyx*

   Identical to the "sub()" function, using the compiled pattern.

Pattern.subn(repl, string, count=0)           *Pattern.subn()..re.pyx*

   Identical to the "subn()" function, using the compiled pattern.

Pattern.flags                                  *Pattern.flags..re.pyx*
...
Pattern.groups                                *Pattern.groups..re.pyx*

   The number of capturing groups in the pattern.

Pattern.groupindex                        *Pattern.groupindex..re.pyx*
...
Pattern.pattern                              *Pattern.pattern..re.pyx*
...
Match.expand(template)                        *Match.expand()..re.pyx*
...
Match.group([group1, ...])                     *Match.group()..re.pyx*
...
>
      ...
      'c3'
<
Match.__getitem__(g)                     *Match.__getitem__()..re.pyx*
...
Match.groups(default=None)                    *Match.groups()..re.pyx*
...
>
      ...
      ('24', '0')
<
Match.groupdict(default=None)              *Match.groupdict()..re.pyx*
...
<
Match.start([group])                           *Match.start()..re.pyx*
Match.end([group])                               *Match.end()..re.pyx*
...
>
      ...
      'tony@tiger.net'
<
Match.span([group])                             *Match.span()..re.pyx*
...
Match.endpos                                    *Match.endpos..re.pyx*
...
Match.lastindex                              *Match.lastindex..re.pyx*
