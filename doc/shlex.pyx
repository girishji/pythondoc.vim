*shlex.pyx*                                   Last change: 2023 Sep 15
...
shlex.split(s, comments=False, posix=True)        *split()..shlex.pyx*
...
shlex.join(split_command)                          *join()..shlex.pyx*
...
shlex.get_token()                       *shlex.get_token()..shlex.pyx*
...
shlex.push_token(str)                  *shlex.push_token()..shlex.pyx*

   Push the argument onto the token stack.

shlex.read_token()                     *shlex.read_token()..shlex.pyx*
...
shlex.sourcehook(filename)             *shlex.sourcehook()..shlex.pyx*
...
shlex.pop_source()                     *shlex.pop_source()..shlex.pyx*
...
shlex.whitespace                         *shlex.whitespace..shlex.pyx*
...
shlex.infile                                 *shlex.infile..shlex.pyx*
...
shlex.instream                             *shlex.instream..shlex.pyx*

   The input stream from which this "shlex" instance is reading
   characters.

shlex.source                                 *shlex.source..shlex.pyx*
...
shlex.debug                                   *shlex.debug..shlex.pyx*
...
shlex.lineno                                 *shlex.lineno..shlex.pyx*

   Source line number (count of newlines seen so far plus one).

shlex.token                                   *shlex.token..shlex.pyx*

   The token buffer.  It may be useful to examine this when catching
   exceptions.

shlex.eof                                       *shlex.eof..shlex.pyx*

   Token used to determine end of file. This will be set to the empty
   string ("''"), in non-POSIX mode, and to "None" in POSIX mode.

shlex.punctuation_chars           *shlex.punctuation_chars..shlex.pyx*
