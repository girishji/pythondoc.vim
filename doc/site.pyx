*site.pyx*                                    Last change: 2023 Sep 15
...
site.PREFIXES                                     *PREFIXES..site.pyx*

   A list of prefixes for site-packages directories.

site.ENABLE_USER_SITE                     *ENABLE_USER_SITE..site.pyx*
...
site.USER_SITE                                   *USER_SITE..site.pyx*
...
site.USER_BASE                                   *USER_BASE..site.pyx*
...
site.addsitedir(sitedir, known_paths=None)    *addsitedir()..site.pyx*

   Add a directory to sys.path and process its ".pth" files.
   Typically used in "sitecustomize" or "usercustomize" (see above).

site.getsitepackages()                   *getsitepackages()..site.pyx*

   Return a list containing all global site-packages directories.

   New in version 3.2.

site.getuserbase()                           *getuserbase()..site.pyx*
...
site.getusersitepackages()           *getusersitepackages()..site.pyx*
