*smtplib.pyx*                                 Last change: 2023 Sep 15
...
exception smtplib.SMTPException           *SMTPException..smtplib.pyx*
   ...
   Changed in version 3.4: SMTPException became subclass of "OSError"
                                 ...
                                 *SMTPServerDisconnected..smtplib.pyx*
exception smtplib.SMTPServerDisconnected
   ...
   connecting it to a server.
                                  ...
                                  *SMTPResponseException..smtplib.pyx*
...
exception smtplib.SMTPSenderRefused   *SMTPSenderRefused..smtplib.pyx*
   ...
   string that the SMTP server refused.
                                  ...
                                  *SMTPRecipientsRefused..smtplib.pyx*
...
exception smtplib.SMTPDataError           *SMTPDataError..smtplib.pyx*

   The SMTP server refused to accept the message data.

exception smtplib.SMTPConnectError     *SMTPConnectError..smtplib.pyx*

   Error occurred during establishment of a connection  with the
   server.

exception smtplib.SMTPHeloError           *SMTPHeloError..smtplib.pyx*

   The server refused our "HELO" message.

                                  *SMTPNotSupportedError..smtplib.pyx*
exception smtplib.SMTPNotSupportedError
   ...
   New in version 3.5.
                                ...
                                *SMTPAuthenticationError..smtplib.pyx*
...
SMTP.set_debuglevel(level)        *SMTP.set_debuglevel()..smtplib.pyx*
...
SMTP.docmd(cmd, args='')                   *SMTP.docmd()..smtplib.pyx*
...
SMTP.connect(host='localhost', port=0)   *SMTP.connect()..smtplib.pyx*
...
SMTP.helo(name='')                          *SMTP.helo()..smtplib.pyx*
...
SMTP.ehlo(name='')                          *SMTP.ehlo()..smtplib.pyx*
   ...
   implicitly called by "sendmail()" when necessary.
                          ...
                          *SMTP.ehlo_or_helo_if_needed()..smtplib.pyx*
...
SMTP.starttls(*, context=None)          *SMTP.starttls()..smtplib.pyx*
...
SMTP.quit()                                 *SMTP.quit()..smtplib.pyx*
