*socket.pyx*                                  Last change: 2023 Sep 15
...
* "AF_PACKET" is a low-level interface directly to network devices.
  ...
  * _proto_ - The Ethernet protocol number. May be "ETH_P_ALL" to
    ...
    other Ethernet protocol number. Value must be in network-byte-
    order.
...
exception socket.error                             *error..socket.pyx*
...
exception socket.herror                           *herror..socket.pyx*
...
exception socket.gaierror                       *gaierror..socket.pyx*
...
exception socket.timeout                         *timeout..socket.pyx*
...
socket.AF_UNIX                                   *AF_UNIX..socket.pyx*
socket.AF_INET                                   *AF_INET..socket.pyx*
socket.AF_INET6                                 *AF_INET6..socket.pyx*
...
socket.SOCK_STREAM                           *SOCK_STREAM..socket.pyx*
socket.SOCK_DGRAM                             *SOCK_DGRAM..socket.pyx*
socket.SOCK_RAW                                 *SOCK_RAW..socket.pyx*
socket.SOCK_RDM                                 *SOCK_RDM..socket.pyx*
socket.SOCK_SEQPACKET                     *SOCK_SEQPACKET..socket.pyx*
...
socket.SOCK_CLOEXEC                         *SOCK_CLOEXEC..socket.pyx*
socket.SOCK_NONBLOCK                       *SOCK_NONBLOCK..socket.pyx*
...
SO_*
socket.SOMAXCONN                               *SOMAXCONN..socket.pyx*
MSG_*
SOL_*
SCM_*
IPPROTO_*
...
socket.AF_CAN                                     *AF_CAN..socket.pyx*
socket.PF_CAN                                     *PF_CAN..socket.pyx*
SOL_CAN_*
CAN_*
...
socket.CAN_BCM                                   *CAN_BCM..socket.pyx*
CAN_BCM_*
...
socket.CAN_RAW_FD_FRAMES               *CAN_RAW_FD_FRAMES..socket.pyx*
...
socket.CAN_RAW_JOIN_FILTERS         *CAN_RAW_JOIN_FILTERS..socket.pyx*
...
socket.CAN_ISOTP                               *CAN_ISOTP..socket.pyx*
...
socket.CAN_J1939                               *CAN_J1939..socket.pyx*
...
socket.AF_DIVERT                               *AF_DIVERT..socket.pyx*
socket.PF_DIVERT                               *PF_DIVERT..socket.pyx*
...
socket.AF_PACKET                               *AF_PACKET..socket.pyx*
socket.PF_PACKET                               *PF_PACKET..socket.pyx*
PACKET_*
...
socket.ETH_P_ALL                               *ETH_P_ALL..socket.pyx*
...
socket.AF_RDS                                     *AF_RDS..socket.pyx*
socket.PF_RDS                                     *PF_RDS..socket.pyx*
socket.SOL_RDS                                   *SOL_RDS..socket.pyx*
RDS_*
...
socket.SIO_RCVALL                             *SIO_RCVALL..socket.pyx*
socket.SIO_KEEPALIVE_VALS             *SIO_KEEPALIVE_VALS..socket.pyx*
socket.SIO_LOOPBACK_FAST_PATH     *SIO_LOOPBACK_FAST_PATH..socket.pyx*
RCVALL_*
...
socket.AF_ALG                                     *AF_ALG..socket.pyx*
socket.SOL_ALG                                   *SOL_ALG..socket.pyx*
ALG_*
...
socket.AF_VSOCK                                 *AF_VSOCK..socket.pyx*

                          *IOCTL_VM_SOCKETS_GET_LOCAL_CID..socket.pyx*
...
socket.AF_LINK                                   *AF_LINK..socket.pyx*

   Availability: BSD, macOS.

   New in version 3.4.

socket.has_ipv6                                 *has_ipv6..socket.pyx*

   This constant contains a boolean value which indicates if IPv6 is
   supported on this platform.

socket.BDADDR_ANY                             *BDADDR_ANY..socket.pyx*
socket.BDADDR_LOCAL                         *BDADDR_LOCAL..socket.pyx*
...
socket.HCI_FILTER                             *HCI_FILTER..socket.pyx*
socket.HCI_TIME_STAMP                     *HCI_TIME_STAMP..socket.pyx*
socket.HCI_DATA_DIR                         *HCI_DATA_DIR..socket.pyx*
...
socket.AF_QIPCRTR                             *AF_QIPCRTR..socket.pyx*
...
socket.SCM_CREDS2                             *SCM_CREDS2..socket.pyx*
socket.LOCAL_CREDS                           *LOCAL_CREDS..socket.pyx*
socket.LOCAL_CREDS_PERSISTENT     *LOCAL_CREDS_PERSISTENT..socket.pyx*
...
socket.SO_INCOMING_CPU                   *SO_INCOMING_CPU..socket.pyx*
...
socket.AF_HYPERV                               *AF_HYPERV..socket.pyx*
socket.HV_PROTOCOL_RAW                   *HV_PROTOCOL_RAW..socket.pyx*

                                *HVSOCKET_CONNECT_TIMEOUT..socket.pyx*
socket.HVSOCKET_CONNECT_TIMEOUT

                            *HVSOCKET_CONNECT_TIMEOUT_MAX..socket.pyx*
socket.HVSOCKET_CONNECT_TIMEOUT_MAX

                              *HVSOCKET_CONNECTED_SUSPEND..socket.pyx*
socket.HVSOCKET_CONNECTED_SUSPEND

                          *HVSOCKET_ADDRESS_FLAG_PASSTHRU..socket.pyx*
socket.HVSOCKET_ADDRESS_FLAG_PASSTHRU
socket.HV_GUID_ZERO                         *HV_GUID_ZERO..socket.pyx*
socket.HV_GUID_WILDCARD                 *HV_GUID_WILDCARD..socket.pyx*
socket.HV_GUID_BROADCAST               *HV_GUID_BROADCAST..socket.pyx*
socket.HV_GUID_CHILDREN                 *HV_GUID_CHILDREN..socket.pyx*
socket.HV_GUID_LOOPBACK                 *HV_GUID_LOOPBACK..socket.pyx*
socket.HV_GUID_PARENT                     *HV_GUID_PARENT..socket.pyx*
...
socket.ETHERTYPE_ARP                       *ETHERTYPE_ARP..socket.pyx*
socket.ETHERTYPE_IP                         *ETHERTYPE_IP..socket.pyx*
socket.ETHERTYPE_IPV6                     *ETHERTYPE_IPV6..socket.pyx*
socket.ETHERTYPE_VLAN                     *ETHERTYPE_VLAN..socket.pyx*
...
socket.has_dualstack_ipv6()         *has_dualstack_ipv6()..socket.pyx*
...
socket.fromfd(fd, family, type, proto=0)        *fromfd()..socket.pyx*
...
socket.fromshare(data)                       *fromshare()..socket.pyx*
...
socket.SocketType                             *SocketType..socket.pyx*
...
socket.close(fd)                                 *close()..socket.pyx*
...
socket.getfqdn([name])                         *getfqdn()..socket.pyx*
...
socket.gethostbyname(hostname)           *gethostbyname()..socket.pyx*
...
socket.gethostbyname_ex(hostname)     *gethostbyname_ex()..socket.pyx*
...
socket.gethostname()                       *gethostname()..socket.pyx*
...
socket.gethostbyaddr(ip_address)         *gethostbyaddr()..socket.pyx*
...
socket.getnameinfo(sockaddr, flags)        *getnameinfo()..socket.pyx*
...
socket.getprotobyname(protocolname)     *getprotobyname()..socket.pyx*
...
socket.ntohl(x)                                  *ntohl()..socket.pyx*
...
socket.ntohs(x)                                  *ntohs()..socket.pyx*
...
socket.htonl(x)                                  *htonl()..socket.pyx*
...
socket.htons(x)                                  *htons()..socket.pyx*
...
socket.inet_aton(ip_string)                  *inet_aton()..socket.pyx*
...
socket.inet_ntoa(packed_ip)                  *inet_ntoa()..socket.pyx*
...
socket.CMSG_LEN(length)                       *CMSG_LEN()..socket.pyx*
...
socket.CMSG_SPACE(length)                   *CMSG_SPACE()..socket.pyx*
...
socket.getdefaulttimeout()           *getdefaulttimeout()..socket.pyx*
...
socket.setdefaulttimeout(timeout)    *setdefaulttimeout()..socket.pyx*
...
socket.sethostname(name)                   *sethostname()..socket.pyx*
...
socket.if_nameindex()                     *if_nameindex()..socket.pyx*
...
socket.if_nametoindex(if_name)          *if_nametoindex()..socket.pyx*
...
socket.if_indextoname(if_index)         *if_indextoname()..socket.pyx*
...
socket.accept()                          *socket.accept()..socket.pyx*
...
socket.bind(address)                       *socket.bind()..socket.pyx*
...
socket.close()                            *socket.close()..socket.pyx*
...
socket.connect(address)                 *socket.connect()..socket.pyx*
...
socket.connect_ex(address)           *socket.connect_ex()..socket.pyx*
...
socket.detach()                          *socket.detach()..socket.pyx*
...
socket.dup()                                *socket.dup()..socket.pyx*
...
socket.fileno()                          *socket.fileno()..socket.pyx*
...
socket.get_inheritable()        *socket.get_inheritable()..socket.pyx*
...
socket.getpeername()                *socket.getpeername()..socket.pyx*
...
socket.getsockname()                *socket.getsockname()..socket.pyx*
...
socket.getblocking()                *socket.getblocking()..socket.pyx*
...
socket.gettimeout()                  *socket.gettimeout()..socket.pyx*
...
socket.ioctl(control, option)             *socket.ioctl()..socket.pyx*
...
socket.listen([backlog])                 *socket.listen()..socket.pyx*
...
socket.recv(bufsize[, flags])              *socket.recv()..socket.pyx*
...
socket.recvfrom(bufsize[, flags])      *socket.recvfrom()..socket.pyx*
...
<
   ...
   (see **PEP 475** for the rationale).
                                   ...
                                   *socket.recvmsg_into()..socket.pyx*
...
<
   ...
   New in version 3.3.
                                  ...
                                  *socket.recvfrom_into()..socket.pyx*
...
socket.send(bytes[, flags])                *socket.send()..socket.pyx*
...
socket.sendall(bytes[, flags])          *socket.sendall()..socket.pyx*
...
socket.sendto(bytes, address)            *socket.sendto()..socket.pyx*
...
<
   ...
   (see **PEP 475** for the rationale).
                                  ...
                                  *socket.sendmsg_afalg()..socket.pyx*
...
socket.sendfile(file, offset=0, count=None)
   ...
   New in version 3.5.
                                ...
                                *socket.set_inheritable()..socket.pyx*
...
socket.setblocking(flag)            *socket.setblocking()..socket.pyx*
...
socket.settimeout(value)             *socket.settimeout()..socket.pyx*
...
socket.shutdown(how)                   *socket.shutdown()..socket.pyx*
...
socket.share(process_id)                  *socket.share()..socket.pyx*
...
socket.family                              *socket.family..socket.pyx*

   The socket family.

socket.type                                  *socket.type..socket.pyx*

   The socket type.

socket.proto                                *socket.proto..socket.pyx*
