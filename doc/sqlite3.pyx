*sqlite3.pyx*                                 Last change: 2023 Sep 15
...
sqlite3.connect(database, timeout=5.0, detect_types=0, isolation_level='DEFERRED', check_same_thread=True, factory=sqlite3.Connection, cached_statements=128, uri=False, *, autocommit=sqlite3.LEGACY_TRANSACTION_CONTROL)
   ...
   New in version 3.12: The _autocommit_ parameter.
   ...
   become keyword-only parameters in Python 3.15.
                                   ...
                                   *complete_statement()..sqlite3.pyx*
...
<
   ...
   See "runsource()" in Lib/sqlite3/__main__.py for real-world use.
                           ...
                           *enable_callback_tracebacks()..sqlite3.pyx*
...
sqlite3.register_adapter(type, adapter, /)
   ...
   that SQLite natively understands.
                                   ...
                                   *register_converter()..sqlite3.pyx*
...
----------------
                             ...
                             *LEGACY_TRANSACTION_CONTROL..sqlite3.pyx*
...
sqlite3.PARSE_COLNAMES                   *PARSE_COLNAMES..sqlite3.pyx*
...
sqlite3.PARSE_DECLTYPES                 *PARSE_DECLTYPES..sqlite3.pyx*
...
sqlite3.SQLITE_OK                             *SQLITE_OK..sqlite3.pyx*
sqlite3.SQLITE_DENY                         *SQLITE_DENY..sqlite3.pyx*
sqlite3.SQLITE_IGNORE                     *SQLITE_IGNORE..sqlite3.pyx*
...
sqlite3.sqlite_version                   *sqlite_version..sqlite3.pyx*

   Version number of the runtime SQLite library as a "string".

sqlite3.sqlite_version_info         *sqlite_version_info..sqlite3.pyx*

   Version number of the runtime SQLite library as a "tuple" of
   "integers".

sqlite3.threadsafety                       *threadsafety..sqlite3.pyx*
...
sqlite3.version                                 *version..sqlite3.pyx*
...
sqlite3.version_info                       *version_info..sqlite3.pyx*
   ...
   "sqlite3". Today, it carries no meaning or practical value.
                              ...
                              *SQLITE_DBCONFIG_DEFENSIVE..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_DEFENSIVE

                                *SQLITE_DBCONFIG_DQS_DDL..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_DQS_DDL

                                *SQLITE_DBCONFIG_DQS_DML..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_DQS_DML

                            *SQLITE_DBCONFIG_ENABLE_FKEY..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_ENABLE_FKEY

                  *SQLITE_DBCONFIG_ENABLE_FTS3_TOKENIZER..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_ENABLE_FTS3_TOKENIZER

                  *SQLITE_DBCONFIG_ENABLE_LOAD_EXTENSION..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_ENABLE_LOAD_EXTENSION

                            *SQLITE_DBCONFIG_ENABLE_QPSG..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_ENABLE_QPSG

                         *SQLITE_DBCONFIG_ENABLE_TRIGGER..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_ENABLE_TRIGGER

                            *SQLITE_DBCONFIG_ENABLE_VIEW..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_ENABLE_VIEW

                     *SQLITE_DBCONFIG_LEGACY_ALTER_TABLE..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_LEGACY_ALTER_TABLE

                     *SQLITE_DBCONFIG_LEGACY_FILE_FORMAT..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_LEGACY_FILE_FORMAT

                       *SQLITE_DBCONFIG_NO_CKPT_ON_CLOSE..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_NO_CKPT_ON_CLOSE

                         *SQLITE_DBCONFIG_RESET_DATABASE..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_RESET_DATABASE

                            *SQLITE_DBCONFIG_TRIGGER_EQP..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_TRIGGER_EQP

                         *SQLITE_DBCONFIG_TRUSTED_SCHEMA..sqlite3.pyx*
sqlite3.SQLITE_DBCONFIG_TRUSTED_SCHEMA

                        *SQLITE_DBCONFIG_WRITABLE_SCHEMA..sqlite3.pyx*
...
class sqlite3.Connection                     *Connection..sqlite3.pyx*
   ...
   cursor(factory=Cursor)              *Connection.cursor()..sqlite3.pyx*
      ...
      _callable_ returning an instance of "Cursor" or its subclasses.
                                  ...
                                  *Connection.blobopen()..sqlite3.pyx*
   ...
   commit()                            *Connection.commit()..sqlite3.pyx*
   ...
   rollback()                        *Connection.rollback()..sqlite3.pyx*
   ...
   close()                              *Connection.close()..sqlite3.pyx*
...
<
      ...
      positional-only in Python 3.15.
                          ...
                          *Connection.create_aggregate()..sqlite3.pyx*
...
<
      ...
      parameters will become positional-only in Python 3.15.
                    ...
                    *Connection.create_window_function()..sqlite3.pyx*
...
<
                          ...
                          *Connection.create_collation()..sqlite3.pyx*
...
<
   ...
   interrupt()                      *Connection.interrupt()..sqlite3.pyx*
      ...
      raise an "OperationalError".
                            ...
                            *Connection.set_authorizer()..sqlite3.pyx*
   set_authorizer(authorizer_callback)
      ...
      Passing _authorizer_callback_ as a keyword argument to is
      deprecated. The parameter will become positional-only in Python
      3.15.

                      *Connection.set_progress_handler()..sqlite3.pyx*
   set_progress_handler(progress_handler, n)
      ...
      Passing _progress_handler_ as a keyword argument to is
      deprecated. The parameter will become positional-only in Python
      3.15.

                        *Connection.set_trace_callback()..sqlite3.pyx*
   set_trace_callback(trace_callback)
      ...
      Passing _trace_callback_ as a keyword argument to is deprecated.
      The parameter will become positional-only in Python 3.15.

                     *Connection.enable_load_extension()..sqlite3.pyx*
...
<
                            ...
                            *Connection.load_extension()..sqlite3.pyx*
   load_extension(path, /, *, entrypoint=None)
      ...
      New in version 3.12: The _entrypoint_ parameter.

   iterdump()                        *Connection.iterdump()..sqlite3.pyx*
...
<
   ...
   getlimit(category, /)             *Connection.getlimit()..sqlite3.pyx*
...
<
   ...
   setlimit(category, limit, /)      *Connection.setlimit()..sqlite3.pyx*
...
<
   ...
   getconfig(op, /)                 *Connection.getconfig()..sqlite3.pyx*
   ...
   setconfig(op, enable=True, /)    *Connection.setconfig()..sqlite3.pyx*
   ...
   serialize(*, name='main')        *Connection.serialize()..sqlite3.pyx*
      ...
      New in version 3.11.
                               ...
                               *Connection.deserialize()..sqlite3.pyx*
   ...
   autocommit                        *Connection.autocommit..sqlite3.pyx*
   ...
   in_transaction                *Connection.in_transaction..sqlite3.pyx*
   ...
   isolation_level              *Connection.isolation_level..sqlite3.pyx*
   ...
   row_factory                      *Connection.row_factory..sqlite3.pyx*
   ...
   text_factory                    *Connection.text_factory..sqlite3.pyx*
...
>
         ...
         con.close()
<
   total_changes                  *Connection.total_changes..sqlite3.pyx*
...
>
      for row in cur.execute("SELECT t FROM data"):
          print(row)
<
class sqlite3.Cursor                             *Cursor..sqlite3.pyx*

   A "Cursor" instance has the following attributes and methods.

   execute(sql, parameters=(), /)         *Cursor.execute()..sqlite3.pyx*
   ...
   executemany(sql, parameters, /)    *Cursor.executemany()..sqlite3.pyx*
...
<
   ...
   executescript(sql_script, /)     *Cursor.executescript()..sqlite3.pyx*
...
>
         ...
         """)
<
   fetchone()                            *Cursor.fetchone()..sqlite3.pyx*
   ...
   fetchmany(size=cursor.arraysize)     *Cursor.fetchmany()..sqlite3.pyx*
   ...
   fetchall()                            *Cursor.fetchall()..sqlite3.pyx*
   ...
   close()                                  *Cursor.close()..sqlite3.pyx*
   ...
   setinputsizes(sizes, /)          *Cursor.setinputsizes()..sqlite3.pyx*

      Required by the DB-API. Does nothing in "sqlite3".

                                 *Cursor.setoutputsize()..sqlite3.pyx*
   setoutputsize(size, column=None, /)

      Required by the DB-API. Does nothing in "sqlite3".

   arraysize                              *Cursor.arraysize..sqlite3.pyx*
   ...
   connection                            *Cursor.connection..sqlite3.pyx*
...
>
         ...
         True
<
   description                          *Cursor.description..sqlite3.pyx*
   ...
   lastrowid                              *Cursor.lastrowid..sqlite3.pyx*
   ...
   rowcount                                *Cursor.rowcount..sqlite3.pyx*
   ...
   row_factory                          *Cursor.row_factory..sqlite3.pyx*
...
class sqlite3.Row                                   *Row..sqlite3.pyx*
...
class sqlite3.Blob                                 *Blob..sqlite3.pyx*
...
<
   ...
   read(length=-1, /)                          *Blob.read()..sqlite3.pyx*
   ...
   write(data, /)                             *Blob.write()..sqlite3.pyx*
   ...
   tell()                                      *Blob.tell()..sqlite3.pyx*

      Return the current access position of the blob.

   seek(offset, origin=os.SEEK_SET, /)         *Blob.seek()..sqlite3.pyx*
...
class sqlite3.PrepareProtocol           *PrepareProtocol..sqlite3.pyx*
...
exception sqlite3.Warning                       *Warning..sqlite3.pyx*
...
exception sqlite3.Error                           *Error..sqlite3.pyx*
   ...
   sqlite_errorcode                 *Error.sqlite_errorcode..sqlite3.pyx*

      The numeric error code from the SQLite API

      New in version 3.11.

   sqlite_errorname                 *Error.sqlite_errorname..sqlite3.pyx*

      The symbolic name of the numeric error code from the SQLite API

      New in version 3.11.

exception sqlite3.InterfaceError         *InterfaceError..sqlite3.pyx*
...
exception sqlite3.DatabaseError           *DatabaseError..sqlite3.pyx*
...
exception sqlite3.DataError                   *DataError..sqlite3.pyx*
...
exception sqlite3.OperationalError     *OperationalError..sqlite3.pyx*
...
exception sqlite3.IntegrityError         *IntegrityError..sqlite3.pyx*

   Exception raised when the relational integrity of the database is
   affected, e.g. a foreign key check fails.  It is a subclass of
   "DatabaseError".

exception sqlite3.InternalError           *InternalError..sqlite3.pyx*
...
exception sqlite3.ProgrammingError     *ProgrammingError..sqlite3.pyx*
...
exception sqlite3.NotSupportedError   *NotSupportedError..sqlite3.pyx*
