*struct.pyx*                                  Last change: 2023 Sep 15
...
exception struct.error                             *error..struct.pyx*

   Exception raised on various occasions; argument is a string
   describing what is wrong.

struct.pack(format, v1, v2, ...)                  *pack()..struct.pyx*
...
struct.unpack(format, buffer)                   *unpack()..struct.pyx*
...
struct.iter_unpack(format, buffer)         *iter_unpack()..struct.pyx*
...
struct.calcsize(format)                       *calcsize()..struct.pyx*
...
class struct.Struct(format)                       *Struct..struct.pyx*
   ...
   iter_unpack(buffer)                 *Struct.iter_unpack()..struct.pyx*
   ...
   format                                     *Struct.format..struct.pyx*
