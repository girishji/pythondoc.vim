*sysconfig.pyx*                               Last change: 2023 Sep 15
...
sysconfig.get_config_vars(*args)    *get_config_vars()..sysconfig.pyx*
...
sysconfig.get_config_var(name)       *get_config_var()..sysconfig.pyx*
...
* _nt_venv_: scheme for "Python virtual environments" on NT platforms;
  by default it is the same as _nt_.
...
sysconfig.get_scheme_names()       *get_scheme_names()..sysconfig.pyx*

   Return a tuple containing all schemes currently supported in
   "sysconfig".

sysconfig.get_default_scheme()   *get_default_scheme()..sysconfig.pyx*
   ...
   environment, the _venv_ scheme is returned.
                               ...
                               *get_preferred_scheme()..sysconfig.pyx*
sysconfig.get_preferred_scheme(key)
   ...
   environment and "key="prefix"", the _venv_ scheme is returned.
                             ...
                             *_get_preferred_schemes()..sysconfig.pyx*
...
sysconfig.get_path_names()           *get_path_names()..sysconfig.pyx*

   Return a tuple containing all path names currently supported in
   "sysconfig".

                                           *get_path()..sysconfig.pyx*
...
sysconfig.get_python_version()   *get_python_version()..sysconfig.pyx*

   Return the "MAJOR.MINOR" Python version number as a string.
   Similar to "'%d.%d' % sys.version_info[:2]".

sysconfig.get_platform()               *get_platform()..sysconfig.pyx*
...
sysconfig.is_python_build()         *is_python_build()..sysconfig.pyx*
...
sysconfig.parse_config_h(fp[, vars])
   ...
   the file.
                              ...
                              *get_config_h_filename()..sysconfig.pyx*
sysconfig.get_config_h_filename()

   Return the path of "pyconfig.h".

                              *get_makefile_filename()..sysconfig.pyx*
