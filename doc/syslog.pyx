*syslog.pyx*                                  Last change: 2023 Sep 15
...
syslog.syslog(message)                          *syslog()..syslog.pyx*
...
syslog.closelog()                             *closelog()..syslog.pyx*
...
syslog.setlogmask(maskpri)                  *setlogmask()..syslog.pyx*
