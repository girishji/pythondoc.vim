*tabnanny.pyx*                                Last change: 2023 Sep 15
...
tabnanny.check(file_or_dir)                    *check()..tabnanny.pyx*
...
exception tabnanny.NannyNag                   *NannyNag..tabnanny.pyx*

   Raised by "process_tokens()" if detecting an ambiguous indent.
   Captured and handled in "check()".

tabnanny.process_tokens(tokens)       *process_tokens()..tabnanny.pyx*
