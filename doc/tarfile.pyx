*tarfile.pyx*                                 Last change: 2023 Sep 15
...
tarfile.ENCODING                               *ENCODING..tarfile.pyx*
...
tarfile.USTAR_FORMAT                       *USTAR_FORMAT..tarfile.pyx*

   POSIX.1-1988 (ustar) format.

tarfile.GNU_FORMAT                           *GNU_FORMAT..tarfile.pyx*

   GNU tar format.

tarfile.PAX_FORMAT                           *PAX_FORMAT..tarfile.pyx*

   POSIX.1-2001 (pax) format.

tarfile.DEFAULT_FORMAT                   *DEFAULT_FORMAT..tarfile.pyx*
...
classmethod TarFile.open(...)            *TarFile.open()..tarfile.pyx*

   Alternative constructor. The "tarfile.open()" function is actually
   a shortcut to this classmethod.

TarFile.getmember(name)             *TarFile.getmember()..tarfile.pyx*
...
TarFile.next()                           *TarFile.next()..tarfile.pyx*

   Return the next member of the archive as a "TarInfo" object, when
   "TarFile" is opened for reading. Return "None" if there is no more
   available.

                                   *TarFile.extractall()..tarfile.pyx*
...
TarFile.extractfile(member)       *TarFile.extractfile()..tarfile.pyx*
...
TarFile.errorlevel: int              *TarFile.errorlevel..tarfile.pyx*
...
TarFile.extraction_filter     *TarFile.extraction_filter..tarfile.pyx*
...
TarFile.addfile(tarinfo, fileobj=None)
   ...
   objects directly, or by using "gettarinfo()".
                                   ...
                                   *TarFile.gettarinfo()..tarfile.pyx*
...
TarFile.close()                         *TarFile.close()..tarfile.pyx*

   Close the "TarFile". In write mode, two finishing zero blocks are
   appended to the archive.

TarFile.pax_headers                 *TarFile.pax_headers..tarfile.pyx*
...
class tarfile.TarInfo(name='')                  *TarInfo..tarfile.pyx*

   Create a "TarInfo" object.

                                      *TarInfo.frombuf()..tarfile.pyx*
...
TarInfo.name: str                          *TarInfo.name..tarfile.pyx*

   Name of the archive member.

TarInfo.size: int                          *TarInfo.size..tarfile.pyx*

   Size in bytes.

TarInfo.mtime: int | float                *TarInfo.mtime..tarfile.pyx*
...
TarInfo.mode: int                          *TarInfo.mode..tarfile.pyx*
...
TarInfo.type                               *TarInfo.type..tarfile.pyx*
...
TarInfo.linkname: str                  *TarInfo.linkname..tarfile.pyx*
...
TarInfo.uid: int                            *TarInfo.uid..tarfile.pyx*
...
TarInfo.gid: int                            *TarInfo.gid..tarfile.pyx*
...
TarInfo.uname: str                        *TarInfo.uname..tarfile.pyx*
...
TarInfo.gname: str                        *TarInfo.gname..tarfile.pyx*
...
TarInfo.pax_headers: dict           *TarInfo.pax_headers..tarfile.pyx*
...
TarInfo.isfile()                       *TarInfo.isfile()..tarfile.pyx*

   Return "True" if the "Tarinfo" object is a regular file.

TarInfo.isreg()                         *TarInfo.isreg()..tarfile.pyx*

   Same as "isfile()".

TarInfo.isdir()                         *TarInfo.isdir()..tarfile.pyx*

   Return "True" if it is a directory.

TarInfo.issym()                         *TarInfo.issym()..tarfile.pyx*

   Return "True" if it is a symbolic link.

TarInfo.islnk()                         *TarInfo.islnk()..tarfile.pyx*

   Return "True" if it is a hard link.

TarInfo.ischr()                         *TarInfo.ischr()..tarfile.pyx*

   Return "True" if it is a character device.

TarInfo.isblk()                         *TarInfo.isblk()..tarfile.pyx*

   Return "True" if it is a block device.

TarInfo.isfifo()                       *TarInfo.isfifo()..tarfile.pyx*

   Return "True" if it is a FIFO.

TarInfo.isdev()                         *TarInfo.isdev()..tarfile.pyx*
...
be reused in custom filters:
                                 ...
                                 *fully_trusted_filter()..tarfile.pyx*
...
tarfile.tar_filter(member, path)           *tar_filter()..tarfile.pyx*
...
tarfile.data_filter(member, path)         *data_filter()..tarfile.pyx*
