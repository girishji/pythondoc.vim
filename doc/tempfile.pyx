*tempfile.pyx*                                Last change: 2023 Sep 15
...
tempfile.TemporaryFile(mode='w+b', buffering=-1, encoding=None, newline=None, suffix=None, prefix=None, dir=None, *, errors=None)
   ...
   Changed in version 3.8: Added _errors_ parameter.
                                  ...
                                  *NamedTemporaryFile()..tempfile.pyx*
tempfile.NamedTemporaryFile(mode='w+b', buffering=-1, encoding=None, newline=None, suffix=None, prefix=None, dir=None, delete=True, *, errors=None, delete_on_close=True)
   ...
   * To manage the named file, it extends the parameters of
   ...
   attribute is the underlying true file object. This _file-like
   object_ can be used in a "with" statement, just like a normal file.
   The name of the temporary file can be retrieved from the "name"
   ...
   * On Windows, make sure that at least one of the following
     conditions are fulfilled:
        ...
        * _delete_ is true but _delete_on_close_ is false. Note, that
          in this case the additional opens that do not share delete
          access (e.g. created via builtin "open()") must be closed
          before exiting the context manager, else the "os.unlink()"
   ...
   Changed in version 3.12: Added _delete_on_close_ parameter.
                                  ...
                                  *SpooledTemporaryFile..tempfile.pyx*
class tempfile.SpooledTemporaryFile(max_size=0, mode='w+b', buffering=-1, encoding=None, newline=None, suffix=None, prefix=None, dir=None, *, errors=None)
   ...
   binary or text _mode_ was specified).
                                    ...
                                    *TemporaryDirectory..tempfile.pyx*
...
tempfile.gettempdir()                     *gettempdir()..tempfile.pyx*
...
tempfile.tempdir                               *tempdir..tempfile.pyx*
