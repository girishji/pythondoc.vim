*tkinter.scrolledtext.pyx*                    Last change: 2023 Sep 15
...
are available:
                              ...
                              *ScrolledText..tkinter.scrolledtext.pyx*
class tkinter.scrolledtext.ScrolledText(master=None, **kw)

   frame                   *ScrolledText.frame..tkinter.scrolledtext.pyx*

      The frame which surrounds the text and scroll bar widgets.

   vbar                     *ScrolledText.vbar..tkinter.scrolledtext.pyx*
