*tkinter.ttk.pyx*                             Last change: 2023 Sep 15
...
class tkinter.ttk.Widget                     *Widget..tkinter.ttk.pyx*

   identify(x, y)                    *Widget.identify()..tkinter.ttk.pyx*
      ...
      _x_ and _y_ are pixel coordinates relative to the widget.
                                   ...
                                   *Widget.instate()..tkinter.ttk.pyx*
   ...
   state(statespec=None)                *Widget.state()..tkinter.ttk.pyx*
...
class tkinter.ttk.Combobox                 *Combobox..tkinter.ttk.pyx*

   current(newindex=None)           *Combobox.current()..tkinter.ttk.pyx*
   ...
   get()                                *Combobox.get()..tkinter.ttk.pyx*

      Returns the current value of the combobox.

   set(value)                           *Combobox.set()..tkinter.ttk.pyx*
...
class tkinter.ttk.Spinbox                   *Spinbox..tkinter.ttk.pyx*

   get()                                 *Spinbox.get()..tkinter.ttk.pyx*

      Returns the current value of the spinbox.

   set(value)                            *Spinbox.set()..tkinter.ttk.pyx*
...
class tkinter.ttk.Notebook                 *Notebook..tkinter.ttk.pyx*

   add(child, **kw)                     *Notebook.add()..tkinter.ttk.pyx*
   ...
   forget(tab_id)                    *Notebook.forget()..tkinter.ttk.pyx*

      Removes the tab specified by _tab_id_, unmaps and unmanages the
      associated window.

   hide(tab_id)                        *Notebook.hide()..tkinter.ttk.pyx*
   ...
   select(tab_id=None)               *Notebook.select()..tkinter.ttk.pyx*
   ...
   tab(tab_id, option=None, **kw)       *Notebook.tab()..tkinter.ttk.pyx*
   ...
   tabs()                              *Notebook.tabs()..tkinter.ttk.pyx*

      Returns a list of windows managed by the notebook.

   enable_traversal()      *Notebook.enable_traversal()..tkinter.ttk.pyx*
...
class tkinter.ttk.Progressbar           *Progressbar..tkinter.ttk.pyx*

   start(interval=None)            *Progressbar.start()..tkinter.ttk.pyx*
   ...
   step(amount=None)                *Progressbar.step()..tkinter.ttk.pyx*

      Increments the progress bar’s value by _amount_.

      _amount_ defaults to 1.0 if omitted.

   stop()                           *Progressbar.stop()..tkinter.ttk.pyx*
...
class tkinter.ttk.Treeview                 *Treeview..tkinter.ttk.pyx*

   bbox(item, column=None)             *Treeview.bbox()..tkinter.ttk.pyx*
   ...
   get_children(item=None)     *Treeview.get_children()..tkinter.ttk.pyx*

      Returns the list of children belonging to _item_.

      If _item_ is not specified, returns root children.

                            *Treeview.set_children()..tkinter.ttk.pyx*
   set_children(item, *newchildren)
      ...
      results in detaching _item_’s children.
                                  ...
                                  *Treeview.column()..tkinter.ttk.pyx*
   ...
   delete(*items)                    *Treeview.delete()..tkinter.ttk.pyx*

      Delete all specified _items_ and all their descendants.

      The root item may not be deleted.

   detach(*items)                    *Treeview.detach()..tkinter.ttk.pyx*
   ...
   identify(component, x, y)       *Treeview.identify()..tkinter.ttk.pyx*
   ...
   identify_row(y)             *Treeview.identify_row()..tkinter.ttk.pyx*

      Returns the item ID of the item at position _y_.

   identify_column(x)       *Treeview.identify_column()..tkinter.ttk.pyx*

      Returns the data column identifier of the cell at position _x_.

      The tree column has ID #0.

   identify_region(x, y)    *Treeview.identify_region()..tkinter.ttk.pyx*
      ...
      Availability: Tk 8.6.
                        ...
                        *Treeview.identify_element()..tkinter.ttk.pyx*
   ...
   index(item)                        *Treeview.index()..tkinter.ttk.pyx*

      Returns the integer index of _item_ within its parent’s list of
      children.

                                  *Treeview.insert()..tkinter.ttk.pyx*
   ...
   item(item, option=None, **kw)       *Treeview.item()..tkinter.ttk.pyx*
   ...
   move(item, parent, index)           *Treeview.move()..tkinter.ttk.pyx*
   ...
   selection()                    *Treeview.selection()..tkinter.ttk.pyx*
   ...
   selection_set(*items)      *Treeview.selection_set()..tkinter.ttk.pyx*
   ...
   selection_add(*items)      *Treeview.selection_add()..tkinter.ttk.pyx*
      ...
      arguments, not just as a single tuple.
                        ...
                        *Treeview.selection_remove()..tkinter.ttk.pyx*
   selection_remove(*items)
      ...
      arguments, not just as a single tuple.
                        ...
                        *Treeview.selection_toggle()..tkinter.ttk.pyx*
   ...
   set(item, column=None, value=None)   *Treeview.set()..tkinter.ttk.pyx*
      ...
      specified _value_.
                                ...
                                *Treeview.tag_bind()..tkinter.ttk.pyx*
   tag_bind(tagname, sequence=None, callback=None)
      ...
      for each of the item’s tags option are called.
                           ...
                           *Treeview.tag_configure()..tkinter.ttk.pyx*
   ...
   tag_has(tagname, item=None)      *Treeview.tag_has()..tkinter.ttk.pyx*
   ...
   xview(*args)                       *Treeview.xview()..tkinter.ttk.pyx*

      Query or modify horizontal position of the treeview.

   yview(*args)                       *Treeview.yview()..tkinter.ttk.pyx*
...
class tkinter.ttk.Style                       *Style..tkinter.ttk.pyx*

   This class is used to manipulate the style database.

                                  *Style.configure()..tkinter.ttk.pyx*
...
>
         ...
         root.mainloop()
<
   map(style, query_opt=None, **kw)        *Style.map()..tkinter.ttk.pyx*
...
<
   layout(style, layoutspec=None)       *Style.layout()..tkinter.ttk.pyx*
...
<
                             ...
                             *Style.element_create()..tkinter.ttk.pyx*
   ...
   element_names()               *Style.element_names()..tkinter.ttk.pyx*

      Returns the list of elements defined in the current theme.

                            *Style.element_options()..tkinter.ttk.pyx*
   element_options(elementname)

      Returns the list of _elementname_’s options.

                               *Style.theme_create()..tkinter.ttk.pyx*
   theme_create(themename, parent=None, settings=None)
      ...
      "theme_settings()".
                             ...
                             *Style.theme_settings()..tkinter.ttk.pyx*
...
>
         ...
         root.mainloop()
<
   theme_names()                   *Style.theme_names()..tkinter.ttk.pyx*

      Returns a list of all known themes.

   theme_use(themename=None)         *Style.theme_use()..tkinter.ttk.pyx*
