*tokenize.pyx*                                Last change: 2023 Sep 15
...
tokenize.tokenize(readline)                 *tokenize()..tokenize.pyx*
...
tokenize.generate_tokens(readline)   *generate_tokens()..tokenize.pyx*
...
tokenize.untokenize(iterable)             *untokenize()..tokenize.pyx*
...
tokenize.detect_encoding(readline)   *detect_encoding()..tokenize.pyx*
...
tokenize.open(filename)                         *open()..tokenize.pyx*
...
exception tokenize.TokenError               *TokenError..tokenize.pyx*
