*tracemalloc.pyx*                             Last change: 2023 Sep 15
...
tracemalloc.clear_traces()           *clear_traces()..tracemalloc.pyx*

   Clear traces of memory blocks allocated by Python.

   See also "stop()".

                             *get_object_traceback()..tracemalloc.pyx*
tracemalloc.get_object_traceback(obj)
   ...
   See also "gc.get_referrers()" and "sys.getsizeof()" functions.
                              ...
                              *get_traceback_limit()..tracemalloc.pyx*
tracemalloc.get_traceback_limit()
   ...
   The limit is set by the "start()" function.
                                ...
                                *get_traced_memory()..tracemalloc.pyx*
tracemalloc.get_traced_memory()

   Get the current size and peak size of memory blocks traced by the
   "tracemalloc" module as a tuple: "(current: int, peak: int)".

tracemalloc.reset_peak()               *reset_peak()..tracemalloc.pyx*
...
tracemalloc.start(nframe: int = 1)          *start()..tracemalloc.pyx*
...
tracemalloc.stop()                           *stop()..tracemalloc.pyx*
...
tracemalloc.take_snapshot()         *take_snapshot()..tracemalloc.pyx*
...
class tracemalloc.DomainFilter(inclusive: bool, domain: int)
   ...
   inclusive                    *DomainFilter.inclusive..tracemalloc.pyx*
   ...
   domain                          *DomainFilter.domain..tracemalloc.pyx*
...
class tracemalloc.Filter(inclusive: bool, filename_pattern: str, lineno: int = None, all_frames: bool = False, domain: int = None)
   ...
   * "Filter(False, "<unknown>")" excludes empty tracebacks
   ...
   domain                                *Filter.domain..tracemalloc.pyx*
   ...
   inclusive                          *Filter.inclusive..tracemalloc.pyx*
   ...
   lineno                                *Filter.lineno..tracemalloc.pyx*

      Line number ("int") of the filter. If _lineno_ is "None", the
      filter matches any line number.

   filename_pattern            *Filter.filename_pattern..tracemalloc.pyx*

      Filename pattern of the filter ("str"). Read-only property.

   all_frames                        *Filter.all_frames..tracemalloc.pyx*
...
class tracemalloc.Frame                       *Frame..tracemalloc.pyx*

   Frame of a traceback.

   The "Traceback" class is a sequence of "Frame" instances.

   filename                             *Frame.filename..tracemalloc.pyx*

      Filename ("str").

   lineno                                 *Frame.lineno..tracemalloc.pyx*
...
class tracemalloc.Snapshot                 *Snapshot..tracemalloc.pyx*

   Snapshot of traces of memory blocks allocated by Python.

   The "take_snapshot()" function creates a snapshot instance.

                              *Snapshot.compare_to()..tracemalloc.pyx*
   ...
   dump(filename)                      *Snapshot.dump()..tracemalloc.pyx*

      Write the snapshot into a file.

      Use "load()" to reload the snapshot.

   filter_traces(filters)     *Snapshot.filter_traces()..tracemalloc.pyx*
   ...
   classmethod load(filename)          *Snapshot.load()..tracemalloc.pyx*

      Load a snapshot from a file.

      See also "dump()".

                              *Snapshot.statistics()..tracemalloc.pyx*
...
class tracemalloc.Statistic               *Statistic..tracemalloc.pyx*
   ...
   count                               *Statistic.count..tracemalloc.pyx*

      Number of memory blocks ("int").

   size                                 *Statistic.size..tracemalloc.pyx*

      Total size of memory blocks in bytes ("int").

   traceback                       *Statistic.traceback..tracemalloc.pyx*
...
class tracemalloc.StatisticDiff       *StatisticDiff..tracemalloc.pyx*
   ...
   traceback                   *StatisticDiff.traceback..tracemalloc.pyx*
...
class tracemalloc.Trace                       *Trace..tracemalloc.pyx*
   ...
   domain                                 *Trace.domain..tracemalloc.pyx*
   ...
   size                                     *Trace.size..tracemalloc.pyx*

      Size of the memory block in bytes ("int").

   traceback                           *Trace.traceback..tracemalloc.pyx*
...
class tracemalloc.Traceback               *Traceback..tracemalloc.pyx*
   ...
   total_nframe                 *Traceback.total_nframe..tracemalloc.pyx*
   ...
   added.
                                 ...
                                 *Traceback.format()..tracemalloc.pyx*
