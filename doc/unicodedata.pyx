*unicodedata.pyx*                             Last change: 2023 Sep 15
...
unicodedata.lookup(name)                   *lookup()..unicodedata.pyx*
...
unicodedata.name(chr[, default])             *name()..unicodedata.pyx*
...
unicodedata.decimal(chr[, default])       *decimal()..unicodedata.pyx*
...
unicodedata.digit(chr[, default])           *digit()..unicodedata.pyx*
...
unicodedata.numeric(chr[, default])       *numeric()..unicodedata.pyx*

   Returns the numeric value assigned to the character _chr_ as float.
   If no such value is defined, _default_ is returned, or, if not
   given, "ValueError" is raised.

unicodedata.category(chr)                *category()..unicodedata.pyx*

   Returns the general category assigned to the character _chr_ as
   string.

unicodedata.bidirectional(chr)      *bidirectional()..unicodedata.pyx*

   Returns the bidirectional class assigned to the character _chr_ as
   string. If no such value is defined, an empty string is returned.

unicodedata.combining(chr)              *combining()..unicodedata.pyx*
   ...
   _chr_ as integer. Returns "0" if no combining class is defined.
                                 ...
                                 *east_asian_width()..unicodedata.pyx*
unicodedata.east_asian_width(chr)

   Returns the east asian width assigned to the character _chr_ as
   string.

unicodedata.mirrored(chr)                *mirrored()..unicodedata.pyx*
...
unicodedata.decomposition(chr)      *decomposition()..unicodedata.pyx*
...
unicodedata.normalize(form, unistr)     *normalize()..unicodedata.pyx*
...
unicodedata.unidata_version         *unidata_version..unicodedata.pyx*

   The version of the Unicode database used in this module.

unicodedata.ucd_3_2_0                     *ucd_3_2_0..unicodedata.pyx*
