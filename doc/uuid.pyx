*uuid.pyx*                                    Last change: 2023 Sep 15
...
class uuid.SafeUUID                               *SafeUUID..uuid.pyx*

   New in version 3.7.

   safe                                         *SafeUUID.safe..uuid.pyx*

      The UUID was generated by the platform in a multiprocessing-safe
      way.

   unsafe                                     *SafeUUID.unsafe..uuid.pyx*

      The UUID was not generated in a multiprocessing-safe way.

   unknown                                   *SafeUUID.unknown..uuid.pyx*
...
UUID.hex                                          *UUID.hex..uuid.pyx*

   The UUID as a 32-character lowercase hexadecimal string.

UUID.int                                          *UUID.int..uuid.pyx*

   The UUID as a 128-bit integer.

UUID.urn                                          *UUID.urn..uuid.pyx*

   The UUID as a URN as specified in **RFC 4122**.

UUID.variant                                  *UUID.variant..uuid.pyx*
...
UUID.version                                  *UUID.version..uuid.pyx*

   The UUID version number (1 through 5, meaningful only when the
   variant is "RFC_4122").

UUID.is_safe                                  *UUID.is_safe..uuid.pyx*
...
uuid.uuid1(node=None, clock_seq=None)              *uuid1()..uuid.pyx*
...
uuid.uuid3(namespace, name)                        *uuid3()..uuid.pyx*

   Generate a UUID based on the MD5 hash of a namespace identifier
   (which is a UUID) and a name (which is a "bytes" object or a string
   that will be encoded using UTF-8).

uuid.uuid4()                                       *uuid4()..uuid.pyx*

   Generate a random UUID.

uuid.uuid5(namespace, name)                        *uuid5()..uuid.pyx*
...
uuid.RESERVED_NCS                             *RESERVED_NCS..uuid.pyx*

   Reserved for NCS compatibility.

uuid.RFC_4122                                     *RFC_4122..uuid.pyx*

   Specifies the UUID layout given in **RFC 4122**.

uuid.RESERVED_MICROSOFT                 *RESERVED_MICROSOFT..uuid.pyx*

   Reserved for Microsoft compatibility.

uuid.RESERVED_FUTURE                       *RESERVED_FUTURE..uuid.pyx*
