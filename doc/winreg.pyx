*winreg.pyx*                                  Last change: 2023 Sep 15
...
winreg.CloseKey(hkey)                         *CloseKey()..winreg.pyx*
...
winreg.CreateKey(key, sub_key)               *CreateKey()..winreg.pyx*
...
winreg.DeleteKey(key, sub_key)               *DeleteKey()..winreg.pyx*
...
winreg.DeleteValue(key, value)             *DeleteValue()..winreg.pyx*
...
winreg.EnumKey(key, index)                     *EnumKey()..winreg.pyx*
...
winreg.EnumValue(key, index)                 *EnumValue()..winreg.pyx*
   ...
   Changed in version 3.3: See above.
                              ...
                              *ExpandEnvironmentStrings()..winreg.pyx*
...
winreg.FlushKey(key)                          *FlushKey()..winreg.pyx*
...
winreg.LoadKey(key, sub_key, file_name)        *LoadKey()..winreg.pyx*
...
winreg.QueryInfoKey(key)                  *QueryInfoKey()..winreg.pyx*
...
winreg.QueryValue(key, sub_key)             *QueryValue()..winreg.pyx*
...
winreg.QueryValueEx(key, value_name)      *QueryValueEx()..winreg.pyx*
...
winreg.SaveKey(key, file_name)                 *SaveKey()..winreg.pyx*
...
winreg.SetValue(key, sub_key, type, value)    *SetValue()..winreg.pyx*
...
winreg.SetValueEx(key, value_name, reserved, type, value)
   ...
   "sub_key", "type", "value".
                                  ...
                                  *DisableReflectionKey()..winreg.pyx*
...
winreg.EnableReflectionKey(key)    *EnableReflectionKey()..winreg.pyx*
...
winreg.QueryReflectionKey(key)      *QueryReflectionKey()..winreg.pyx*
...
winreg.HKEY_CLASSES_ROOT               *HKEY_CLASSES_ROOT..winreg.pyx*
...
winreg.HKEY_CURRENT_USER               *HKEY_CURRENT_USER..winreg.pyx*
...
winreg.HKEY_LOCAL_MACHINE             *HKEY_LOCAL_MACHINE..winreg.pyx*
...
winreg.HKEY_USERS                             *HKEY_USERS..winreg.pyx*

   Registry entries subordinate to this key define the default user
   configuration for new users on the local computer and the user
   configuration for the current user.

winreg.HKEY_PERFORMANCE_DATA       *HKEY_PERFORMANCE_DATA..winreg.pyx*
...
winreg.HKEY_CURRENT_CONFIG           *HKEY_CURRENT_CONFIG..winreg.pyx*

   Contains information about the current hardware profile of the
   local computer system.

winreg.HKEY_DYN_DATA                       *HKEY_DYN_DATA..winreg.pyx*
...
winreg.KEY_ALL_ACCESS                     *KEY_ALL_ACCESS..winreg.pyx*

   Combines the STANDARD_RIGHTS_REQUIRED, "KEY_QUERY_VALUE",
   "KEY_SET_VALUE", "KEY_CREATE_SUB_KEY", "KEY_ENUMERATE_SUB_KEYS",
   "KEY_NOTIFY", and "KEY_CREATE_LINK" access rights.

winreg.KEY_WRITE                               *KEY_WRITE..winreg.pyx*

   Combines the STANDARD_RIGHTS_WRITE, "KEY_SET_VALUE", and
   "KEY_CREATE_SUB_KEY" access rights.

winreg.KEY_READ                                 *KEY_READ..winreg.pyx*

   Combines the STANDARD_RIGHTS_READ, "KEY_QUERY_VALUE",
   "KEY_ENUMERATE_SUB_KEYS", and "KEY_NOTIFY" values.

winreg.KEY_EXECUTE                           *KEY_EXECUTE..winreg.pyx*

   Equivalent to "KEY_READ".

winreg.KEY_QUERY_VALUE                   *KEY_QUERY_VALUE..winreg.pyx*

   Required to query the values of a registry key.

winreg.KEY_SET_VALUE                       *KEY_SET_VALUE..winreg.pyx*

   Required to create, delete, or set a registry value.

winreg.KEY_CREATE_SUB_KEY             *KEY_CREATE_SUB_KEY..winreg.pyx*

   Required to create a subkey of a registry key.

winreg.KEY_ENUMERATE_SUB_KEYS     *KEY_ENUMERATE_SUB_KEYS..winreg.pyx*

   Required to enumerate the subkeys of a registry key.

winreg.KEY_NOTIFY                             *KEY_NOTIFY..winreg.pyx*

   Required to request change notifications for a registry key or for
   subkeys of a registry key.

winreg.KEY_CREATE_LINK                   *KEY_CREATE_LINK..winreg.pyx*
...
winreg.KEY_WOW64_64KEY                   *KEY_WOW64_64KEY..winreg.pyx*
...
winreg.KEY_WOW64_32KEY                   *KEY_WOW64_32KEY..winreg.pyx*
...
winreg.REG_BINARY                             *REG_BINARY..winreg.pyx*

   Binary data in any form.

winreg.REG_DWORD                               *REG_DWORD..winreg.pyx*

   32-bit number.

winreg.REG_DWORD_LITTLE_ENDIAN   *REG_DWORD_LITTLE_ENDIAN..winreg.pyx*

   A 32-bit number in little-endian format. Equivalent to "REG_DWORD".

winreg.REG_DWORD_BIG_ENDIAN         *REG_DWORD_BIG_ENDIAN..winreg.pyx*

   A 32-bit number in big-endian format.

winreg.REG_EXPAND_SZ                       *REG_EXPAND_SZ..winreg.pyx*

   Null-terminated string containing references to environment
   variables ("%PATH%").

winreg.REG_LINK                                 *REG_LINK..winreg.pyx*

   A Unicode symbolic link.

winreg.REG_MULTI_SZ                         *REG_MULTI_SZ..winreg.pyx*

   A sequence of null-terminated strings, terminated by two null
   characters. (Python handles this termination automatically.)

winreg.REG_NONE                                 *REG_NONE..winreg.pyx*

   No defined value type.

winreg.REG_QWORD                               *REG_QWORD..winreg.pyx*

   A 64-bit number.

   New in version 3.6.

winreg.REG_QWORD_LITTLE_ENDIAN   *REG_QWORD_LITTLE_ENDIAN..winreg.pyx*

   A 64-bit number in little-endian format. Equivalent to "REG_QWORD".

   New in version 3.6.

winreg.REG_RESOURCE_LIST               *REG_RESOURCE_LIST..winreg.pyx*

   A device-driver resource list.

                            *REG_FULL_RESOURCE_DESCRIPTOR..winreg.pyx*
winreg.REG_FULL_RESOURCE_DESCRIPTOR

   A hardware setting.

                          *REG_RESOURCE_REQUIREMENTS_LIST..winreg.pyx*
winreg.REG_RESOURCE_REQUIREMENTS_LIST

   A hardware resource list.

winreg.REG_SZ                                     *REG_SZ..winreg.pyx*
...
PyHKEY.Close()                            *PyHKEY.Close()..winreg.pyx*

   Closes the underlying Windows handle.

   If the handle is already closed, no error is raised.

PyHKEY.Detach()                          *PyHKEY.Detach()..winreg.pyx*
...
PyHKEY.__enter__()                    *PyHKEY.__enter__()..winreg.pyx*
PyHKEY.__exit__(*exc_info)             *PyHKEY.__exit__()..winreg.pyx*
