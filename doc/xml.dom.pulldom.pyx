*xml.dom.pulldom.pyx*                         Last change: 2023 Sep 15
...
switch to DOM-related processing.
                                        ...
                                        *PullDom..xml.dom.pulldom.pyx*
class xml.dom.pulldom.PullDom(documentFactory=None)

   Subclass of "xml.sax.handler.ContentHandler".

                                        *SAX2DOM..xml.dom.pulldom.pyx*
class xml.dom.pulldom.SAX2DOM(documentFactory=None)

   Subclass of "xml.sax.handler.ContentHandler".

                                        *parse()..xml.dom.pulldom.pyx*
...
======================
                                 ...
                                 *DOMEventStream..xml.dom.pulldom.pyx*
class xml.dom.pulldom.DOMEventStream(stream, parser, bufsize)

   Changed in version 3.11: Support for "__getitem__()" method has
   been removed.

   getEvent()            *DOMEventStream.getEvent()..xml.dom.pulldom.pyx*
   ...
   expandNode(node)    *DOMEventStream.expandNode()..xml.dom.pulldom.pyx*
...
>
         ...
         for event, node in doc:
             if event == pulldom.START_ELEMENT and node.tagName == 'p':
                 ...
                 print(node.toxml())
<
   reset()                  *DOMEventStream.reset()..xml.dom.pulldom.pyx*
