*xml.dom.pyx*                                 Last change: 2023 Sep 15
...
The "xml.dom" contains the following functions:
                            ...
                            *registerDOMImplementation()..xml.dom.pyx*
xml.dom.registerDOMImplementation(name, factory)
   ...
   supports some customization).
                                 ...
                                 *getDOMImplementation()..xml.dom.pyx*
...
xml.dom.EMPTY_NAMESPACE                 *EMPTY_NAMESPACE..xml.dom.pyx*
...
DOMImplementation.createDocument(namespaceUri, qualifiedName, doctype)
   ...
   indicate that no "Element" child is to be created.
                 ...
                 *DOMImplementation.createDocumentType()..xml.dom.pyx*
...
Node.nodeType                             *Node.nodeType..xml.dom.pyx*
...
Node.parentNode                         *Node.parentNode..xml.dom.pyx*
...
Node.attributes                         *Node.attributes..xml.dom.pyx*
...
Node.previousSibling               *Node.previousSibling..xml.dom.pyx*
...
Node.nextSibling                       *Node.nextSibling..xml.dom.pyx*
...
Node.nodeValue                           *Node.nodeValue..xml.dom.pyx*

   This has a different meaning for each node type; see the DOM
   specification for details.  The situation is similar to that with
   "nodeName".  The value is a string or "None".

Node.hasAttributes()               *Node.hasAttributes()..xml.dom.pyx*

   Return "True" if the node has any attributes.

Node.hasChildNodes()               *Node.hasChildNodes()..xml.dom.pyx*

   Return "True" if the node has any child nodes.

Node.isSameNode(other)                *Node.isSameNode()..xml.dom.pyx*
...
Node.removeChild(oldChild)           *Node.removeChild()..xml.dom.pyx*
...
Node.cloneNode(deep)                   *Node.cloneNode()..xml.dom.pyx*
...
NodeList.item(i)                        *NodeList.item()..xml.dom.pyx*
...
NodeList.length                         *NodeList.length..xml.dom.pyx*
...
DocumentType.publicId             *DocumentType.publicId..xml.dom.pyx*

   The public identifier for the external subset of the document type
   definition. This will be a string or "None".

DocumentType.systemId             *DocumentType.systemId..xml.dom.pyx*

   The system identifier for the external subset of the document type
   definition. This will be a URI as a string, or "None".

                            *DocumentType.internalSubset..xml.dom.pyx*
...
DocumentType.name                     *DocumentType.name..xml.dom.pyx*

   The name of the root element as given in the "DOCTYPE" declaration,
   if present.

DocumentType.entities             *DocumentType.entities..xml.dom.pyx*
...
DocumentType.notations           *DocumentType.notations..xml.dom.pyx*
...
Document.documentElement       *Document.documentElement..xml.dom.pyx*

   The one and only root element of the document.

                               *Document.createElement()..xml.dom.pyx*
Document.createElement(tagName)
   ...
   "appendChild()".
                             ...
                             *Document.createElementNS()..xml.dom.pyx*
Document.createElementNS(namespaceURI, tagName)
   ...
   the other methods such as "insertBefore()" or "appendChild()".
                              ...
                              *Document.createTextNode()..xml.dom.pyx*
...
Document.createComment(data)   *Document.createComment()..xml.dom.pyx*

   Create and return a comment node containing the data passed as a
   parameter.  As with the other creation methods, this one does not
   insert the node into the tree.

                 *Document.createProcessingInstruction()..xml.dom.pyx*
Document.createProcessingInstruction(target, data)
   ...
   creation methods, this one does not insert the node into the tree.
                             ...
                             *Document.createAttribute()..xml.dom.pyx*
Document.createAttribute(name)
   ...
   the newly created attribute instance.
                           ...
                           *Document.createAttributeNS()..xml.dom.pyx*
...
Element.tagName                         *Element.tagName..xml.dom.pyx*

   The element type name.  In a namespace-using document it may have
   colons in it. The value is a string.

                         *Element.getElementsByTagName()..xml.dom.pyx*
Element.getElementsByTagName(tagName)

   Same as equivalent method in the "Document" class.

                       *Element.getElementsByTagNameNS()..xml.dom.pyx*
Element.getElementsByTagNameNS(namespaceURI, localName)

   Same as equivalent method in the "Document" class.

Element.hasAttribute(name)       *Element.hasAttribute()..xml.dom.pyx*

   Return "True" if the element has an attribute named by _name_.

                               *Element.hasAttributeNS()..xml.dom.pyx*
Element.hasAttributeNS(namespaceURI, localName)

   Return "True" if the element has an attribute named by
   _namespaceURI_ and _localName_.

Element.getAttribute(name)       *Element.getAttribute()..xml.dom.pyx*
   ...
   attribute had no value.
                             ...
                             *Element.getAttributeNode()..xml.dom.pyx*
Element.getAttributeNode(attrname)

   Return the "Attr" node for the attribute named by _attrname_.

                               *Element.getAttributeNS()..xml.dom.pyx*
...
Element.setAttributeNode(newAttr)
   ...
   _newAttr_ is already in use, "InuseAttributeErr" will be raised.
                           ...
                           *Element.setAttributeNodeNS()..xml.dom.pyx*
Element.setAttributeNodeNS(newAttr)
   ...
   "InuseAttributeErr" will be raised.
                               ...
                               *Element.setAttributeNS()..xml.dom.pyx*
...
Attr.name                                     *Attr.name..xml.dom.pyx*

   The attribute name. In a namespace-using document it may include a
   colon.

Attr.localName                           *Attr.localName..xml.dom.pyx*

   The part of the name following the colon if there is one, else the
   entire name. This is a read-only attribute.

Attr.prefix                                 *Attr.prefix..xml.dom.pyx*

   The part of the name preceding the colon if there is one, else the
   empty string.

Attr.value                                   *Attr.value..xml.dom.pyx*
...
NamedNodeMap.length                 *NamedNodeMap.length..xml.dom.pyx*

   The length of the attribute list.

NamedNodeMap.item(index)            *NamedNodeMap.item()..xml.dom.pyx*
...
Comment.data                               *Comment.data..xml.dom.pyx*
...
Text.data                                     *Text.data..xml.dom.pyx*
...
exception xml.dom.DOMException             *DOMException..xml.dom.pyx*

   Base exception class used for all specific DOM exceptions.  This
   exception class cannot be directly instantiated.

exception xml.dom.DomstringSizeErr     *DomstringSizeErr..xml.dom.pyx*
...
exception xml.dom.InvalidCharacterErr
   ...
   this error to be raised.
                                 ...
                                 *InvalidModificationErr..xml.dom.pyx*
exception xml.dom.InvalidModificationErr

   Raised when an attempt is made to modify the type of a node.

exception xml.dom.InvalidStateErr       *InvalidStateErr..xml.dom.pyx*

   Raised when an attempt is made to use an object that is not defined
   or is no longer usable.

exception xml.dom.NamespaceErr             *NamespaceErr..xml.dom.pyx*
...
exception xml.dom.NotFoundErr               *NotFoundErr..xml.dom.pyx*
...
exception xml.dom.NotSupportedErr       *NotSupportedErr..xml.dom.pyx*

   Raised when the implementation does not support the requested type
   of object or operation.

exception xml.dom.NoDataAllowedErr     *NoDataAllowedErr..xml.dom.pyx*

   This is raised if data is specified for a node which does not
   support data.

                               *NoModificationAllowedErr..xml.dom.pyx*
exception xml.dom.NoModificationAllowedErr

   Raised on attempts to modify an object where modifications are not
   allowed (such as for read-only nodes).

exception xml.dom.SyntaxErr                   *SyntaxErr..xml.dom.pyx*

   Raised when an invalid or illegal string is specified.

exception xml.dom.WrongDocumentErr     *WrongDocumentErr..xml.dom.pyx*
