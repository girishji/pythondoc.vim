*zipimport.pyx*                               Last change: 2023 Sep 15
...
exception zipimport.ZipImportError     *ZipImportError..zipimport.pyx*
...
class zipimport.zipimporter(archivepath)
   ...
   create_module(spec)       *zipimporter.create_module()..zipimport.pyx*
   ...
   exec_module(module)         *zipimporter.exec_module()..zipimport.pyx*

      Implementation of "importlib.abc.Loader.exec_module()".

      New in version 3.10.

                              *zipimporter.find_spec()..zipimport.pyx*
   ...
   get_code(fullname)             *zipimporter.get_code()..zipimport.pyx*

      Return the code object for the specified module. Raise
      "ZipImportError" if the module couldn’t be imported.

   get_data(pathname)             *zipimporter.get_data()..zipimport.pyx*
   ...
   get_filename(fullname)     *zipimporter.get_filename()..zipimport.pyx*
   ...
   get_source(fullname)         *zipimporter.get_source()..zipimport.pyx*
   ...
   is_package(fullname)         *zipimporter.is_package()..zipimport.pyx*

      Return "True" if the module specified by _fullname_ is a
      package. Raise "ZipImportError" if the module couldn’t be found.

   load_module(fullname)       *zipimporter.load_module()..zipimport.pyx*
   ...
   invalidate_caches()   *zipimporter.invalidate_caches()..zipimport.pyx*
   ...
   archive                           *zipimporter.archive..zipimport.pyx*

      The file name of the importer’s associated ZIP file, without a
      possible subpath.

   prefix                             *zipimporter.prefix..zipimport.pyx*
